import { ACL_APP_ABILITIES, CASL_ABILITY_BINDING, CASL_ABILITY_IMPORT } from "../const/acl.const";
import { GenerateType, type GenerateTypeParams, type Import } from "../types/generate";
import { getAclData, getAppAbilitiesType } from "../utils/generate/generate.acl.utils";
