...
const updateCargo = (officeId: string, quoteId: string, cargoId: string, data: CommonModels.UpdatePositionCargoDTO) => {
...
const createBulkCargos = (numberOfCargos: number, officeId: string, quoteId: string, data: CommonModels.CreatePositionCargoDTO) => {
