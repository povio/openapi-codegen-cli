...
const create = (officeId: string, positionId: string, data: CommonModels.CreateInvolvedPartyRequestDto) => {
...
const update = (officeId: string, positionId: string, partyId: string, data: CommonModels.UpdateInvolvedPartyDto) => {
