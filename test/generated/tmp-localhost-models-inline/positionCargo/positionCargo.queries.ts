...
const createCargo = (officeId: string, positionId: string, data: CommonModels.CreatePositionCargoDTO) => {
...
const updateCargo = (officeId: string, positionId: string, cargoId: string, data: CommonModels.UpdatePositionCargoDTO) => {
...
const createBulkCargos = (numberOfCargos: number, officeId: string, positionId: string, data: CommonModels.CreatePositionCargoDTO) => {
  return AppRestClient.post(
