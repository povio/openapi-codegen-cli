...
const createRoutePoint = (officeId: string, quoteId: string, routeId: string, data: CommonModels.CreateRoutePointRequestDto) => {
...
const updateRoutePoint = (officeId: string, quoteId: string, routeId: string, pointId: string, data: CommonModels.UpdateRoutePointRequestDto) => {
...
const mergeRoutes = (officeId: string, quoteId: string, data: CommonModels.MergeRoutesRequestDto) => {
  return AppRestClient.post(
    { resSchema: z.void() },
...
const copyRoute = (officeId: string, quoteId: string, routeId: string, data: CommonModels.CopyRouteRequestDto) => {
  return AppRestClient.post(
    { resSchema: z.void() },
