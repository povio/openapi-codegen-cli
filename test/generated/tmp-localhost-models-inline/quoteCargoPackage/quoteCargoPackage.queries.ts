...
const createPackage = (officeId: string, quoteId: string, cargoId: string, data: CommonModels.CreatePositionCargoPackageDTO) => {
...
const updatePackage = (officeId: string, quoteId: string, cargoId: string, packageId: string, data: CommonModels.UpdatePositionCargoPackageDTO) => {
...
const movePackage = (officeId: string, quoteId: string, cargoId: string, packageId: string, data: CommonModels.MovePositionCargoPackageRequestDTO) => {
  return AppRestClient.patch(
    { resSchema: CommonModels.PositionCargoPackageResponseDTOSchema },
