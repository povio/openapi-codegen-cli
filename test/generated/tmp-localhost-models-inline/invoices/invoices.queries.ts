...
const findByOffice = (officeId: string, limit: number, order?: string, filter?: CommonModels.OfficeInvoiceFilterDto, page?: number, cursor?: string) => {
  return AppRestClient.get(
...
const listAvailablePartnersFor = (officeId: string, invoiceId: string, search?: string, useCase?: CommonModels.PositionAvailablePartnersUseCase) => {
  return AppRestClient.get(
