...
export namespace MasterDataModels {
   ...
   * @type { enum }
   */
  export const MasterDataTypeEnumSchema = z.enum([
    "BusinessPartner",
    "Depot",
    "City",
    "Warehouse",
   ...
   */
  export const MasterDataItemResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the item"),
      name: z.string().describe("Name of the item"),
      type: MasterDataTypeEnumSchema.describe("Type of the item"),
    })
    .readonly();
   ...
   */
  export const MasterDataItemsResponseDTOSchema = z
    .object({ items: z.array(MasterDataItemResponseDTOSchema).readonly().describe("List of master data items") })
    .readonly();
   ...
   * @property { MasterDataTypeEnum } type Type of the item
   */
  export const MasterDataLabelResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the item"),
      label: z.string().describe("Label of the item"),
      type: MasterDataTypeEnumSchema.describe("Type of the item"),
    })
    .readonly();
   ...
   */
  export const MasterDataPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(MasterDataLabelResponseDTOSchema).readonly() }).readonly().shape,
  });
