...
export namespace MasterDataQueries {
  ...
  export const keys = {
    ...
    findAll: (officeId: string, types?: MasterDataModels.MasterDataFindAllTypesParam, search?: string) =>
      [...keys.all, "/offices/:officeId/master-data/autocomplete", officeId, types, search] as const,
    paginate: (
      officeId: string,
      types?: MasterDataModels.MasterDataPaginateTypesParam,
      limit?: number,
      search?: string,
      page?: number,
      cursor?: string,
  ...
  export const useFindAll = <TData>(
    {
      ...
      types,
      search,
    }: { officeId: string; types: MasterDataModels.MasterDataFindAllTypesParam; search?: string },
    options?: AppQueryOptions<typeof MasterDataApi.findAll, TData>,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof MasterDataApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof MasterDataApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
