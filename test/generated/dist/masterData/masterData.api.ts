...
export namespace MasterDataApi {
  export const findAll = (
    officeId: string,
    types: MasterDataModels.MasterDataFindAllTypesParam,
    search?: string,
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/master-data/autocomplete`,
      {
        ...config,
        params: {
          types: ZodExtended.parse(MasterDataModels.MasterDataFindAllTypesParamSchema, types, {
            type: "query",
            name: "types",
          }),
  ...
  export const paginate = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/master-data/labels/paginated`,
      {
        ...config,
        params: {
          types: ZodExtended.parse(MasterDataModels.MasterDataPaginateTypesParamSchema, types, {
            type: "query",
            name: "types",
          }),
          search: ZodExtended.parse(z.string().nullish(), search, { type: "query", name: "search" }),
