...
export namespace DunningSystemsQueries {
  ...
  export const keys = {
    ...
    paginateLabels: (
      ...
      limit?: number,
      order?: string,
      filter?: DunningSystemsModels.DunningSystemLabelFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    paginate: (
      ...
      limit?: number,
      order?: string,
      filter?: DunningSystemsModels.DunningSystemFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/dunning-systems", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      ...
      [...keys.all, "/offices/:officeId/dunning-systems", "infinite", officeId, limit, order, filter, cursor] as const,
    findById: (id: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/dunning-systems/:id", id, officeId] as const,
  };
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof DunningSystemsApi.paginateLabels, TData>,
  ...
  export const usePaginateLabelsInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof DunningSystemsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof DunningSystemsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof DunningSystemsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof DunningSystemsApi.create,
      { officeId: string; data: DunningSystemsModels.CreateDunningSystemRequestDTO }
    > &
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof DunningSystemsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof DunningSystemsApi.update,
      { id: string; officeId: string; data: DunningSystemsModels.UpdateDunningSystemRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof DunningSystemsApi.archive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof DunningSystemsApi.unarchive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
