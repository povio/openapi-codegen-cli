...
export namespace DunningSystemsAcl {
  ...
  export const canUsePaginateLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("DunningSystem", object) : "DunningSystem"] as AbilityTuple<
      "Read",
      "DunningSystem" | (ForcedSubject<"DunningSystem"> & { officeId: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("DunningSystem", object) : "DunningSystem"] as AbilityTuple<
      "Create",
      "DunningSystem" | (ForcedSubject<"DunningSystem"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("DunningSystem", object) : "DunningSystem"] as AbilityTuple<
      "Update",
      "DunningSystem" | (ForcedSubject<"DunningSystem"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("DunningSystem", object) : "DunningSystem"] as AbilityTuple<
      "Archive",
      "DunningSystem" | (ForcedSubject<"DunningSystem"> & { officeId: string })
    >;
