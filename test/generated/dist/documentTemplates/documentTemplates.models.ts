...
export namespace DocumentTemplatesModels {
   ...
   */
  export const DocumentTemplateResponseDTOSchema = z
    .object({
      id: z.string(),
      officeId: z.string(),
      name: z.string(),
      isArchived: z.boolean(),
      createdById: z.string().describe("ID of the employee who created this template").nullish(),
      createdBy: DocumentTemplateEmployeeDTOSchema.describe("Employee who created this template").nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().describe("ID of the employee who last updated this template").nullish(),
      updatedBy: DocumentTemplateEmployeeDTOSchema.describe("Employee who last updated this template").nullish(),
   ...
   */
  export const TemplateBlocksDTOSchema = z
    .object({
      titleBlock: CommonModels.TitleBlockDTOSchema,
      receiverBlock: CommonModels.ReceiverBlockDTOSchema,
      ourInformationBlock: CommonModels.OurInformationBlockDTOSchema,
      routeTableBlock: CommonModels.RouteTableBlockDTOSchema,
      cargoTableBlock: CommonModels.CargoTableBlockDTOSchema,
      cargoSummaryBlock: CommonModels.CargoSummaryBlockDTOSchema,
      financeTableBlock: CommonModels.FinanceTableBlockDTOSchema,
      remarkBlocks: z.array(CommonModels.RemarkBlockDTOSchema).readonly(),
      footerBlock: CommonModels.FooterBlockDTOSchema,
      termsBlock: CommonModels.TermsBlockDTOSchema,
      cutOffDatesBlock: CommonModels.CutOffDatesBlockDTOSchema,
    })
    .readonly();
   ...
   */
  export const CreateDocumentTemplateRequestDTOSchema = z
    .object({ name: z.string().describe("Template name"), blocks: TemplateBlocksDTOSchema.nullish() })
    .readonly();
   ...
   * @property { TemplateBlocksDTO } blocks
   */
  export const UpdateDocumentTemplateRequestDTOSchema = z
    .object({ name: z.string().describe("Template name"), isArchived: z.boolean(), blocks: TemplateBlocksDTOSchema })
    .readonly();
   ...
   */
  export const CreateRemarkBlockRequestDTOSchema = z
    .object({
      content: CommonModels.EditorContentUpdateDtoSchema,
      position: z.number().gte(1).describe("1-based position of the remark block").nullish(),
   ...
   * @type { enum }
   */
  export const DocumentTemplatesPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
  ...
  export type DocumentTemplatesPaginateLabelsOrderParamEnum = z.infer<
    typeof DocumentTemplatesPaginateLabelsOrderParamEnumSchema
  >;
   ...
   */
  export const DocumentTemplatesPaginateLabelsResponseSchema = z.object({
   ...
   * @type { enum }
   */
  export const DocumentTemplatesListOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const DocumentTemplatesListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(DocumentTemplateResponseDTOSchema).readonly() }).readonly().shape,
  });
