...
export namespace ChargeTypesModels {
   ...
   */
  export const ChargeTypeLabelFilterDtoSchema = z
    .object({
      direction: CommonModels.DirectionEnumSchema,
      transportModes: z.array(CommonModels.TransportModeEnumSchema).readonly(),
      search: z.string(),
    })
    .readonly();
   ...
   */
  export const ChargeTypeTranslationDtoSchema = z
    .object({ language: CommonModels.LanguageEnumSchema, value: z.string() })
    .readonly();
   ...
   */
  export const ChargeTypeResponseDTOSchema = z
    .object({
      id: z.string(),
      matchCode: z.string(),
      ...
      modules: z.array(CommonModels.TransportModeEnumSchema).readonly(),
      directions: z.array(CommonModels.DirectionEnumSchema).readonly(),
      translations: z.array(ChargeTypeTranslationDtoSchema).readonly(),
      createdById: z.string().nullish(),
      createdBy: ChargeTypeEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: ChargeTypeEmployeeDTOSchema.nullish(),
   ...
   * @property { CommonModels.TransportModeEnum[] } transportModes
   */
  export const ChargeTypePaginationFilterDtoSchema = z
    .object({
      name: z.string(),
      search: z.string(),
      archived: z.boolean(),
   ...
   * @property { string } value
   */
  export const CreateChargeTypeTranslationDtoSchema = z
    .object({ language: CommonModels.LanguageEnumSchema, value: z.string() })
    .readonly();
   ...
   */
  export const CreateChargeTypeRequestDTOSchema = z
    .object({
      matchCode: z.string(),
      ...
      modules: z.array(CommonModels.TransportModeEnumSchema).readonly(),
      directions: z.array(CommonModels.DirectionEnumSchema).readonly(),
      translations: z.array(CreateChargeTypeTranslationDtoSchema).readonly().nullish(),
    })
    .readonly();
   ...
   * @property { string } value
   */
  export const UpdateChargeTypeTranslationDtoSchema = z
    .object({ language: CommonModels.LanguageEnumSchema, value: z.string() })
    .readonly();
   ...
   */
  export const UpdateChargeTypeRequestDTOSchema = z
    .object({
      matchCode: z.string(),
      englishName: z.string(),
      archived: z.boolean(),
      ...
      modules: z.array(CommonModels.TransportModeEnumSchema).readonly(),
      directions: z.array(CommonModels.DirectionEnumSchema).readonly(),
      translations: z.array(UpdateChargeTypeTranslationDtoSchema).readonly(),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const ChargeTypesFindAllOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const ChargeTypesFindAllResponseSchema = z.object({
   ...
   * @type { enum }
   */
  export const ChargeTypesPaginateOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const ChargeTypesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(ChargeTypeResponseDTOSchema).readonly() }).readonly().shape,
  });
