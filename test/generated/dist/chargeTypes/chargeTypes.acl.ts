...
export namespace ChargeTypesAcl {
   ...
   */
  export const canUseFindAll = () => ["Read", "ChargeType"] as AbilityTuple<"Read", "ChargeType">;
   ...
   */
  export const canUsePaginate = () => ["Read", "ChargeType"] as AbilityTuple<"Read", "ChargeType">;
   ...
   */
  export const canUseCreate = () => ["Create", "ChargeType"] as AbilityTuple<"Create", "ChargeType">;
   ...
   */
  export const canUseFindById = () => ["Read", "ChargeType"] as AbilityTuple<"Read", "ChargeType">;
   ...
   */
  export const canUseUpdate = () => ["Update", "ChargeType"] as AbilityTuple<"Update", "ChargeType">;
   ...
   */
  export const canUseArchive = () => ["Archive", "ChargeType"] as AbilityTuple<"Archive", "ChargeType">;
   ...
   */
  export const canUseUnarchive = () => ["Archive", "ChargeType"] as AbilityTuple<"Archive", "ChargeType">;
}
