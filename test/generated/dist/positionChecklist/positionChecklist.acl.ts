...
export namespace PositionChecklistAcl {
   ...
   */
  export const canUseApplyTemplates = (object?: { officeId: string }) =>
   ...
   */
  export const canUseComplete = (object?: { officeId: string }) =>
    ["Update", object ? subject("Position", object) : "Position"] as AbilityTuple<
      "Update",
      "Position" | (ForcedSubject<"Position"> & { officeId: string })
    >;
   ...
   */
  export const canUseUncomplete = (object?: { officeId: string }) =>
    ["Update", object ? subject("Position", object) : "Position"] as AbilityTuple<
      "Update",
      "Position" | (ForcedSubject<"Position"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateNotes = (object?: { officeId: string }) =>
    ["Update", object ? subject("Position", object) : "Position"] as AbilityTuple<
      "Update",
      "Position" | (ForcedSubject<"Position"> & { officeId: string })
    >;
