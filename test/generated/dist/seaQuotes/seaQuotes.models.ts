...
export namespace SeaQuotesModels {
   ...
   */
  export const SeaQuoteResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier for the sea quote"),
      bookingMatchingCode: z.string().describe("Code for matching bookings"),
      validFrom: z.iso.datetime({ offset: true }).describe("Start date of quote validity").nullable(),
      validUntil: z.iso.datetime({ offset: true }).describe("End date of quote validity").nullable(),
      buyServiceContract: z.string().describe("Service contract for buying"),
      sellServiceContract: z.string().describe("Service contract for selling"),
      routing: CommonModels.SeaRoutingEnumSchema.nullish(),
      splitRoute: z.boolean().describe("Indicates if the route is split").nullish(),
    })
    .readonly();
   ...
   * @property { CommonModels.SeaRoutingEnum } routing
   */
  export const UpdateSeaQuoteRequestDTOSchema = z
    .object({
      bookingMatchingCode: z.string().describe("Code for matching bookings"),
      validFrom: z.iso.datetime({ offset: true }).describe("Start date of quote validity"),
      validUntil: z.iso.datetime({ offset: true }).describe("End date of quote validity"),
      buyServiceContract: z.string().describe("Service contract for buying"),
      sellServiceContract: z.string().describe("Service contract for selling"),
