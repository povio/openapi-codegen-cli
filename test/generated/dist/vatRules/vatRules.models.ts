...
export namespace VatRulesModels {
   ...
   */
  export const VatRuleFilterDtoSchema = z
    .object({
      matchcode: z.string().describe("Matchcode to filter by"),
      name: z.string().describe("Name to filter by"),
      type: VatRuleTypeEnumSchema,
      officeId: z.string().describe("Office ID to filter by"),
      archived: z.boolean().describe("Filter by archived status"),
      search: z.string().describe("Search to filter by"),
    })
    .readonly();
   ...
   */
  export const VatRuleResponseDTOSchema = z
    .object({
      id: z.string(),
      matchcode: z.string(),
      name: z.string(),
      vatPercentage: z.number(),
      vatNumber: z.number().describe("VAT rule reference number").nullish(),
      noTax: z.boolean().nullish(),
      type: VatRuleTypeEnumSchema,
      archived: z.boolean(),
      isReverseCharge: z.boolean(),
      createdById: z.string().nullish(),
      createdBy: VatRuleEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: VatRuleEmployeeDTOSchema.nullish(),
      updatedAt: z.iso.datetime({ offset: true }),
      officeId: z.string(),
      office: VatRuleOfficeDTOSchema.nullish(),
      bookkeepingId: z.string().nullish(),
      bookkeepingTargetAccountNumber: z.string().nullish(),
    })
    .readonly();
   ...
   */
  export const CreateVatRuleRequestDTOSchema = z
    .object({
      matchcode: z.string().describe("Unique matchcode for the VAT rule"),
      name: z.string().describe("Name of the VAT rule"),
      noTax: z.boolean().nullish(),
      vatPercentage: z.number().gte(0).lte(100).describe("VAT percentage (0-100)"),
      vatNumber: z.number().describe("VAT rule reference number").nullish(),
      type: VatRuleTypeEnumSchema.describe("Type of VAT rule"),
      officeId: z.string().describe("Office ID"),
      isReverseCharge: z.boolean().describe("Is reverse charge VAT rule").nullish(),
      bookkeepingId: z.string().describe("Bookkeeping ID").nullish(),
      bookkeepingTargetAccountNumber: z.string().describe("Bookkeeping target account number").nullish(),
    })
    .readonly();
   ...
   * @property { string } bookkeepingTargetAccountNumber Bookkeeping target account number
   */
  export const UpdateVatRuleRequestDTOSchema = z
    .object({
      matchcode: z.string().describe("Unique matchcode for the VAT rule"),
      name: z.string().describe("Name of the VAT rule"),
      noTax: z.boolean(),
      vatPercentage: z.number().gte(0).lte(100).describe("VAT percentage (0-100)"),
      vatNumber: z.number().gte(0).describe("VAT rule reference number").nullable(),
      type: VatRuleTypeEnumSchema.describe("Type of VAT rule"),
      officeId: z.string().describe("Office ID"),
      isReverseCharge: z.boolean().describe("Is reverse charge VAT rule"),
      bookkeepingId: z.string().describe("Bookkeeping ID").nullable(),
      bookkeepingTargetAccountNumber: z.string().describe("Bookkeeping target account number").nullable(),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const VatRulesPaginateLabelsOrderParamEnumSchema = z.enum([
    "matchcode",
    "name",
    "type",
    "createdAt",
   ...
   */
  export const VatRulesPaginateLabelsResponseSchema = z.object({
   ...
   * @type { enum }
   */
  export const VatRulesListOrderParamEnumSchema = z.enum([
    "matchcode",
    "name",
    "type",
    "createdAt",
   ...
   */
  export const VatRulesListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(VatRuleResponseDTOSchema).readonly() }).readonly().shape,
  });
