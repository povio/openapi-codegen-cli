...
export namespace InttraOfficeIntegrationModels {
   ...
   */
  export const OfficeInttraCredentialsResponseDtoSchema = z
    .object({
      id: z.string(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedAt: z.iso.datetime({ offset: true }),
      rotatedByUserId: z.string().nullish(),
      officeId: z.string(),
      sftpUsername: z.string().nullish(),
      sftpPublicKey: z.string().nullish(),
      partnerCode: z.string().nullish(),
      ediId: z.string().nullish(),
   ...
   * @property { string } rotatedByUserId
   */
  export const GenerateInttraCredentialsResponseDtoSchema = z
    .object({ publicKey: z.string(), rotatedAt: z.iso.datetime({ offset: true }), rotatedByUserId: z.string() })
    .readonly();
   ...
   * @property { string } notificationEmail
   */
  export const UpdateInttraCredentialsRequestDtoSchema = z
    .object({
   ...
   * @property { string } rotatedByUserId
   */
  export const UpdateInttraCredentialsResponseDtoSchema = z
    .object({ rotatedAt: z.iso.datetime({ offset: true }), rotatedByUserId: z.string() })
    .readonly();
