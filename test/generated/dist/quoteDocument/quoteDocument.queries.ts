...
export namespace QuoteDocumentQueries {
  ...
  export const keys = {
    ...
    get: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/document", officeId, quoteId] as const,
  };
  ...
  export const useGet = <TData>(
    ...
    options?: AppQueryOptions<typeof QuoteDocumentApi.get, TData>,
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof QuoteDocumentApi.update,
      { officeId: string; quoteId: string; data: QuoteDocumentModels.UpdateQuoteDocumentRequestDto }
    > &
  ...
  export const useGetPreview = (
    options?: AppMutationOptions<
      typeof QuoteDocumentApi.getPreview,
      { officeId: string; quoteId: string; data: QuoteDocumentModels.GenerateQuoteDocumentPreviewRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useGenerate = (
    options?: AppMutationOptions<
      typeof QuoteDocumentApi.generate,
      { officeId: string; quoteId: string; data: QuoteDocumentModels.GenerateQuoteDocumentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGenerateEml = (
    options?: AppMutationOptions<
      typeof QuoteDocumentApi.generateEml,
      { officeId: string; quoteId: string; data: QuoteDocumentModels.GenerateQuoteDocumentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
