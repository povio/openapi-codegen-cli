...
export namespace PositionAccountModels {
   ...
   */
  export const PositionAccountTotalsResponseDtoSchema = z
    .object({
      totalBuyRates: z.number().describe("Total buy rates"),
      totalSellRates: z.number().describe("Total sell rates"),
      totalProfit: z.number().describe("Total profit"),
      margin: z.number().describe("Margin percentage").nullish(),
      displayAmount: z.number().describe("Display amount"),
      displayCurrencyCode: z.string().describe("Display currency code"),
    })
    .readonly();
   ...
   */
  export const PositionAccountMasterTotalsDtoSchema = z
    .object({
      totals: PositionAccountTotalsResponseDtoSchema,
      totalsPerCurrency: z.array(PositionAccountTotalsResponseDtoSchema).readonly(),
    })
    .readonly();
   ...
   */
  export const ChildPositionAccountReferenceDtoSchema = z
    .object({ positionId: z.string().nullish(), positionNumber: z.string(), accountId: z.string() })
    .readonly();
   ...
   */
  export const PositionAccountResponseDtoSchema = z
    .object({
      id: z.string().describe("Account ID"),
      positionId: z.string().describe("Position ID").nullish(),
      invoiceId: z.string().describe("Invoice ID").nullish(),
      items: z.array(CommonModels.PositionAccountItemDtoResponseSchema).readonly().describe("Account items"),
      totals: PositionAccountTotalsResponseDtoSchema,
      totalsPerCurrency: z.array(PositionAccountTotalsResponseDtoSchema).readonly(),
      masterTotals: PositionAccountMasterTotalsDtoSchema.nullish(),
      childPositionAccounts: z.array(ChildPositionAccountReferenceDtoSchema).readonly().nullish(),
    })
    .readonly();
