...
export namespace QuotesAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Create",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseExportQuotes = (object?: { officeId: string }) =>
    ["Export", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Export",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetInvolvedParties = (object?: { officeId: string }) =>
    ["ReadInvolvedParties", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "ReadInvolvedParties",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseCreateInvolvedParty = (object?: { officeId: string }) =>
    ["CreateInvolvedParties", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
   ...
   */
  export const canUseUpdateInvolvedParty = (object?: { officeId: string }) =>
    ["UpdateInvolvedParties", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
   ...
   */
  export const canUseDeleteInvolvedParty = (object?: { officeId: string }) =>
    ["DeleteInvolvedParties", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
