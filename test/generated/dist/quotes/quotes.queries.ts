...
export namespace QuotesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/quotes", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: QuotesModels.QuoteFilterDto,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/quotes", "infinite", officeId, limit, order, filter, cursor] as const,
    ...
    getById: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId", officeId, quoteId] as const,
    getInvolvedParties: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/involved-parties", officeId, quoteId] as const,
  };
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof QuotesApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { officeId: string; limit: number; order?: string; filter?: QuotesModels.QuoteFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof QuotesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof QuotesApi.create,
      { officeId: string; data: QuotesModels.CreateQuoteRequestDTO }
    > &
  ...
  export const useListAvailablePartnersFor = <TData>(
    {
      ...
      search,
      useCase,
    }: { officeId: string; quoteId: string; search?: string; useCase?: CommonModels.PositionAvailablePartnersUseCase },
    options?: AppQueryOptions<typeof QuotesApi.listAvailablePartnersFor, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useExportQuotes = (
    options?: AppMutationOptions<
      typeof QuotesApi.exportQuotes,
      { officeId: string; data: QuotesModels.QuoteExportRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useGetById = <TData>(
    ...
    options?: AppQueryOptions<typeof QuotesApi.getById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof QuotesApi.update,
      { officeId: string; quoteId: string; data: QuotesModels.UpdateQuoteRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useCancel = (
    options?: AppMutationOptions<typeof QuotesApi.cancel, { officeId: string; quoteId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useDuplicate = (
    options?: AppMutationOptions<
      typeof QuotesApi.duplicate,
      { officeId: string; quoteId: string; data: QuotesModels.DuplicateQuoteRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGetInvolvedParties = <TData>(
    { officeId, quoteId }: { officeId: string; quoteId: string },
    options?: AppQueryOptions<typeof QuotesApi.getInvolvedParties, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [201, 401]
   */
  export const useCreateInvolvedParty = (
    options?: AppMutationOptions<
      typeof QuotesApi.createInvolvedParty,
      { officeId: string; quoteId: string; data: CommonModels.CreateInvolvedPartyRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useUpdateInvolvedParty = (
    options?: AppMutationOptions<
      typeof QuotesApi.updateInvolvedParty,
      { officeId: string; quoteId: string; partyId: string; data: CommonModels.UpdateInvolvedPartyDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useDeleteInvolvedParty = (
    options?: AppMutationOptions<
      typeof QuotesApi.deleteInvolvedParty,
      { officeId: string; quoteId: string; partyId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
