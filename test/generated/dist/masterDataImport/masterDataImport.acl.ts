...
export namespace MasterDataImportAcl {
   ...
   */
  export const canUseUpload = (object?: { officeId: string }) =>
    ["Import", object ? subject("MasterData", object) : "MasterData"] as AbilityTuple<
      "Import",
      "MasterData" | (ForcedSubject<"MasterData"> & { officeId: string })
    >;
   ...
   */
  export const canUsePostOfficesMasterDataImportByOfficeId = (object?: { officeId: string }) =>
    ["Import", object ? subject("MasterData", object) : "MasterData"] as AbilityTuple<
      "Import",
      "MasterData" | (ForcedSubject<"MasterData"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetImportStatus = (object?: { officeId: string }) =>
    ["Import", object ? subject("MasterData", object) : "MasterData"] as AbilityTuple<
      "Import",
      "MasterData" | (ForcedSubject<"MasterData"> & { officeId: string })
    >;
