...
export namespace MasterDataImportQueries {
  ...
  export const keys = {
    ...
    getImportStatus: (jobId: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/master-data/import/:jobId/status", jobId, officeId] as const,
  };
  ...
  export const useUpload = (
    options?: AppMutationOptions<
      typeof MasterDataImportApi.upload,
      {
        officeId: string;
        data: MasterDataImportModels.MasterDataImportUploadRequestDto;
        file?: File;
   ...
   * @statusCodes [201, 401]
   */
  export const usePostOfficesMasterDataImportByOfficeId = (
    options?: AppMutationOptions<
      typeof MasterDataImportApi.postOfficesMasterDataImportByOfficeId,
      { officeId: string; data: MasterDataImportModels.MasterDataImportRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGetImportStatus = <TData>(
    { jobId, officeId }: { jobId: string; officeId: string },
    options?: AppQueryOptions<typeof MasterDataImportApi.getImportStatus, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
