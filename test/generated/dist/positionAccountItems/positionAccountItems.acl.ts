...
export namespace PositionAccountItemsAcl {
   ...
   */
  export const canUseDeletePositionAccountItems = (object?: { officeId: string }) =>
    ["Update", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Update",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string })
    >;
  ...
  export const canUseDuplicate = (object?: { officeId: string }) =>
    ["Duplicate", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Duplicate",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string })
    >;
   ...
   */
  export const canUseReassign = (object?: { officeId: string }) =>
    ["Reassign", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Reassign",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string })
    >;
   ...
   */
  export const canUseReorder = (object?: { officeId: string }) =>
    ["Update", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Update",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string })
    >;
