...
export namespace WorkingDocumentsHouseAwbQueries {
  ...
  export const keys = {
    ...
    getHouseAwbData: (positionId: string, hawbId: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/hawbs/:hawbId", positionId, hawbId, officeId] as const,
    previewHouseAwb: (positionId: string, hawbId: string, officeId: string) =>
      [
        ...keys.all,
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof WorkingDocumentsHouseAwbApi.create, { positionId: string; officeId: string }> &
   ...
   * @statusCodes [200, 401]
   */
  export const useGetHouseAwbData = <TData>(
    { positionId, hawbId, officeId }: { positionId: string; hawbId: string; officeId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsHouseAwbApi.getHouseAwbData, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useUpdateHouseAwbData = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsHouseAwbApi.updateHouseAwbData,
      {
        positionId: string;
        hawbId: string;
        officeId: string;
   ...
   */
  export const useDeleteHouseAwb = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsHouseAwbApi.deleteHouseAwb,
      { positionId: string; hawbId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const usePreviewHouseAwb = <TData>(
    { positionId, hawbId, officeId }: { positionId: string; hawbId: string; officeId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsHouseAwbApi.previewHouseAwb, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePreviewHouseAwbMutation = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsHouseAwbApi.previewHouseAwb,
      { positionId: string; hawbId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [201, 401]
   */
  export const useGenerateHouseAwb = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsHouseAwbApi.generateHouseAwb,
      { positionId: string; hawbId: string; officeId: string; data: CommonModels.GenerateWorkingDocumentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
