...
export namespace ControlTowerContainersQueries {
  ...
  export const keys = {
    ...
    findAll: (
      limit?: number,
      order?: string,
      filter?: ControlTowerContainersModels.ContainerFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/containers", limit, order, filter, page, cursor] as const,
    findAllInfinite: (
      limit?: number,
      order?: string,
      filter?: ControlTowerContainersModels.ContainerFilterDto,
      cursor?: string,
    ) => [...keys.all, "/containers", "infinite", limit, order, filter, cursor] as const,
  ...
  export const useFindAll = <TData>(
    ...
    options?: AppQueryOptions<typeof ControlTowerContainersApi.findAll, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.findAll(limit, order, filter, page, cursor),
      queryFn: () => ControlTowerContainersApi.findAll(limit, order, filter, page, cursor, config),
      ...options,
    });
  };
  ...
  export const useFindAllInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: ControlTowerContainersModels.ContainerFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof ControlTowerContainersApi.findAll, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useInfiniteQuery({
      queryKey: keys.findAllInfinite(limit, order, filter, cursor),
      queryFn: ({ pageParam }) => ControlTowerContainersApi.findAll(limit, order, filter, pageParam, cursor, config),
      initialPageParam: 1,
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof ControlTowerContainersApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.findById(id),
      queryFn: () => ControlTowerContainersApi.findById(id, config),
      ...options,
    });
  };
   ...
   * @statusCodes [200, 401]
   */
  export const useGetJourney = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof ControlTowerContainersApi.getJourney, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.getJourney(id),
      queryFn: () => ControlTowerContainersApi.getJourney(id, config),
      ...options,
    });
  };
}
