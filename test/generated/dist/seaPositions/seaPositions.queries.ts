...
export namespace SeaPositionsQueries {
  ...
  export const keys = {
    ...
    get: (officeId: string, positionId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/sea-position", officeId, positionId] as const,
  };
  ...
  export const useGet = <TData>(
    ...
    options?: AppQueryOptions<typeof SeaPositionsApi.get, TData>,
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof SeaPositionsApi.update,
      { officeId: string; positionId: string; data: SeaPositionsModels.UpdateSeaPositionRequestDTO }
    > &
