...
export namespace AirPositionsQueries {
  ...
  export const keys = {
    ...
    get: (officeId: string, positionId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/air-position", officeId, positionId] as const,
  };
  ...
  export const useGet = <TData>(
    ...
    options?: AppQueryOptions<typeof AirPositionsApi.get, TData>,
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof AirPositionsApi.update,
      { officeId: string; positionId: string; data: AirPositionsModels.UpdateAirPositionRequestDTO }
    > &
