...
export namespace EmployeeAcl {
  ...
  export const canUsePaginate = (object?: { officeId?: string }) =>
    ["Read", object ? subject("Employee", object) : "Employee"] as AbilityTuple<
      "Read",
      "Employee" | (ForcedSubject<"Employee"> & { officeId?: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId?: string }) =>
    ["Create", object ? subject("Employee", object) : "Employee"] as AbilityTuple<
      "Create",
      "Employee" | (ForcedSubject<"Employee"> & { officeId?: string })
    >;
   ...
   */
  export const canUseFindAll = () => ["Read", "Employee"] as AbilityTuple<"Read", "Employee">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "Employee"] as AbilityTuple<"Read", "Employee">;
   ...
   */
  export const canUseResendOnboardingWithOffice = (object?: { officeId: string }) =>
    ["Create", object ? subject("Employee", object) : "Employee"] as AbilityTuple<
      "Create",
      "Employee" | (ForcedSubject<"Employee"> & { officeId: string })
    >;
   ...
   */
  export const canUseGet = () => ["Read", "Employee"] as AbilityTuple<"Read", "Employee">;
   ...
   */
  export const canUseUpdate = () => ["Update", "Employee"] as AbilityTuple<"Update", "Employee">;
   ...
   */
  export const canUseGetWithOffice = (object?: { officeId: string }) =>
    ["Read", object ? subject("Employee", object) : "Employee"] as AbilityTuple<
      "Read",
      "Employee" | (ForcedSubject<"Employee"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateWithOffice = (object?: { officeId: string }) =>
    ["Update", object ? subject("Employee", object) : "Employee"] as AbilityTuple<
      "Update",
      "Employee" | (ForcedSubject<"Employee"> & { officeId: string })
    >;
   ...
   */
  export const canUseListRoles = () => ["ListRoles", "Employee"] as AbilityTuple<"ListRoles", "Employee">;
   ...
   */
  export const canUseUpdateRoles = () => ["UpdateRoles", "Employee"] as AbilityTuple<"UpdateRoles", "Employee">;
   ...
   */
  export const canUseArchive = () => ["Archive", "Employee"] as AbilityTuple<"Archive", "Employee">;
   ...
   */
  export const canUseUnarchive = () => ["Unarchive", "Employee"] as AbilityTuple<"Unarchive", "Employee">;
}
