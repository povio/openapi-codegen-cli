...
export namespace EmployeeModels {
  ...
  export const EmployeeResponseSchema = z
    .object({
      ...
      archived: z.boolean().describe("Archived").nullish(),
      primaryOfficeId: z.string().describe("Primary office id").nullish(),
      primaryOffice: CommonModels.EmployeeOfficeResponseSchema.describe("Primary office").nullish(),
      employments: z.array(CommonModels.EmploymentResponseSchema).readonly().describe("Employments").nullish(),
      roles: z.array(CommonModels.EmployeeRoleResponseSchema).readonly().describe("Global Roles").nullish(),
   ...
   */
  export const EmployeeOneStepCreateEmploymentRequestSchema = z
    .object({
      officeId: z.string(),
      roleIds: z.array(z.string()).readonly().describe("Array of office role IDs").nullish(),
    })
    .readonly();
   ...
   */
  export const EmployeeOneStepCreateRequestSchema = z
    .object({
      locale: CommonModels.LocaleEnumSchema.nullish(),
      firstName: z.string().describe("First name"),
      lastName: z.string().describe("Last name"),
      email: z.email().describe("Email"),
      phone: z.string().describe("Phone number").nullish(),
      roleIds: z.array(z.string()).readonly().describe("Array of global role IDs").nullish(),
      primaryOfficeId: z.string().describe("Primary office ID").nullish(),
      employments: z.array(EmployeeOneStepCreateEmploymentRequestSchema).readonly().min(1).describe("Employments"),
    })
    .readonly();
  ...
  export const EmployeeUpdateRequestSchema = z
    .object({
      firstName: z.string().describe("First name"),
      lastName: z.string().describe("Last name"),
      phone: z.string().describe("Phone number of the employee"),
   ...
   */
  export const EmployeeFilterDtoSchema = z
    .object({
      office: z.string().describe("Office ID (single select, offices the user has access to)"),
      roles: z.array(z.string()).readonly().describe("Role IDs (multiselect)"),
      primaryOfficeId: z.string().describe("Primary office id"),
      firstName: z.string().describe("First name"),
      lastName: z.string().describe("Last name"),
      ...
      archived: z
        ...
        .describe(`Archived
 set to true to only return archived employees
 does not return archived employees by default`)
        .default(false),
      search: z.string().describe("Free text search multiple fields"),
      officeRole: z.string().describe("Office role"),
    })
    .readonly();
   ...
   */
  export const EmployeeRoleMemberResponseSchema = z
    .object({
      roleId: z.string(),
      name: z.string().describe("Name of the role"),
      color: z.string().describe("Color associated with the role").nullish(),
      description: z.string().describe("Description of the role").nullish(),
      permissions: z.array(z.string()).readonly().describe("Permissions associated with the role"),
    })
    .readonly();
   ...
   */
  export const EmployeeRoleMembershipsUpdateRequestSchema = z
    .object({ roleIds: z.array(z.string()).readonly().describe("Array of role IDs") })
    .readonly();
   ...
   * @type { enum }
   */
  export const EmployeePopulateFieldSchema = z.enum([
    "employments",
    "primaryOffice",
    "roles",
    "employments.roles",
   ...
   */
  export const EmployeePaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmployeeResponseSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const EmployeePaginateLabelsOrderParamEnumSchema = z.enum([
    "firstName",
    "lastName",
    "email",
    "name",
   ...
   */
  export const EmployeePaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
   ...
   */
  export const EmployeeListRolesResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmployeeRoleMemberResponseSchema).readonly() }).readonly().shape,
  });
   ...
   * @property { EmployeeRoleMemberResponse[] } items
   */
  export const EmployeeUpdateRolesResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmployeeRoleMemberResponseSchema).readonly() }).readonly().shape,
  });
