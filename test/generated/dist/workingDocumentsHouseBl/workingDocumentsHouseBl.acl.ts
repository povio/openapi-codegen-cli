...
export namespace WorkingDocumentsHouseBlAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Create",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetHouseBlData = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Read",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateHouseBlData = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Update",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteHouseBl = (object?: { officeId: string }) =>
    ["Delete", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Delete",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewHouseBl = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Read",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewHouseBlEml = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Read",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateHouseBl = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Update",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateDocumentEml = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-house-bl", object) : "WorkingDocument-house-bl"] as AbilityTuple<
      "Update",
      "WorkingDocument-house-bl" | (ForcedSubject<"WorkingDocument-house-bl"> & { officeId: string })
    >;
