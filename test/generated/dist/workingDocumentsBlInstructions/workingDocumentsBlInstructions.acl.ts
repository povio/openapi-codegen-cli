...
export namespace WorkingDocumentsBlInstructionsAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    [
      ...
      "Create",
      "WorkingDocument-bl-instructions" | (ForcedSubject<"WorkingDocument-bl-instructions"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetBlInstructionsData = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-bl-instructions", object) : "WorkingDocument-bl-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseUpdateBlInstructionsData = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-bl-instructions", object) : "WorkingDocument-bl-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseDeleteBlInstructions = (object?: { officeId: string }) =>
    [
      "Delete",
      object ? subject("WorkingDocument-bl-instructions", object) : "WorkingDocument-bl-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUsePreviewBlInstructions = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-bl-instructions", object) : "WorkingDocument-bl-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseGenerateBlInstructions = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-bl-instructions", object) : "WorkingDocument-bl-instructions",
    ] as AbilityTuple<
