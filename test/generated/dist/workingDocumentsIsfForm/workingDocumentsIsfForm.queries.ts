...
export namespace WorkingDocumentsIsfFormQueries {
  ...
  export const keys = {
    ...
    getIsfData: (positionId: string, isfId: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/isfs/:isfId", positionId, isfId, officeId] as const,
    previewIsf: (positionId: string, isfId: string, officeId: string) =>
      [
        ...keys.all,
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof WorkingDocumentsIsfFormApi.create, { positionId: string; officeId: string }> &
   ...
   * @statusCodes [200, 401]
   */
  export const useGetIsfData = <TData>(
    { positionId, isfId, officeId }: { positionId: string; isfId: string; officeId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsIsfFormApi.getIsfData, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useUpdateIsfData = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsIsfFormApi.updateIsfData,
      {
        positionId: string;
        isfId: string;
        officeId: string;
        data: WorkingDocumentsIsfFormModels.UpdateIsfDocumentRequestDTO;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   */
  export const useDeleteIsf = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsIsfFormApi.deleteIsf,
      { positionId: string; isfId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const usePreviewIsf = <TData>(
    { positionId, isfId, officeId }: { positionId: string; isfId: string; officeId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsIsfFormApi.previewIsf, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePreviewIsfMutation = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsIsfFormApi.previewIsf,
      { positionId: string; isfId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [201, 401]
   */
  export const useGenerateIsf = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsIsfFormApi.generateIsf,
      { positionId: string; isfId: string; officeId: string; data: CommonModels.GenerateWorkingDocumentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
