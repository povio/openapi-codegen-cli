...
export namespace CitiesModels {
   ...
   */
  export const CityCountryDtoSchema = z
    .object({
      id: z.string().describe("Unique identifier of the country"),
      name: z.string().describe("Name of the country"),
      isoCode2: z.string().describe("2 character iso code of the country"),
      isoCode3: z.string().describe("3 character iso code of the country"),
    })
    .readonly();
   ...
   */
  export const CityResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the city"),
      name: z.string().describe("Name of the city"),
      isoCode: z.string().describe("ISO code of the city").nullish(),
      stateCode: z.string().describe("State code of the city").nullish(),
      archived: z.boolean().describe("Whether the city is archived").nullish(),
      countryId: z.string().describe("Country ID").nullish(),
      country: CityCountryDtoSchema.nullish(),
      createdById: z.string().nullish(),
      createdBy: CityEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: CityEmployeeDTOSchema.nullish(),
   ...
   */
  export const CityLabelResponseDTOSchema = z
    .object({ id: z.string(), label: z.string(), country: CityLabelCountryDtoSchema.nullish() })
    .readonly();
   ...
   */
  export const CityPaginationFilterDtoSchema = z
   ...
   * @property { string } countryId Country ID
   */
  export const CreateCityRequestDTOSchema = z
    .object({
      name: z.string().describe("Name of the city"),
      isoCode: z.string().describe("ISO code of the city").nullish(),
      stateCode: z.string().describe("State code of the city").nullish(),
   ...
   * @property { string } countryId Country ID
   */
  export const UpdateCityRequestDTOSchema = z
    .object({
      name: z.string().describe("Name of the city"),
      isoCode: z.string().describe("ISO code of the city"),
      stateCode: z.string().describe("State code of the city"),
      countryId: z.string().describe("Country ID"),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const CitiesPaginateOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const CitiesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(CityResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const ListCityLabelsOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const ListCityLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(CityLabelResponseDTOSchema).readonly() }).readonly().shape,
  });
