...
export namespace ProjectLiteApi {
  export const create = (
    officeId: string,
    data: ProjectLiteModels.CreateProjectLiteRequestDTO,
      ...
      `/offices/${officeId}/project-lite`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(ProjectLiteModels.ProjectLitePaginateOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(ProjectLiteModels.ProjectLiteFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const paginateProjectLabels = (
    officeId: string,
    limit: number,
    order?: string,
    filter?: ProjectLiteModels.ProjectLiteFilterDto,
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/project-lite/labels/paginate`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(ProjectLiteModels.PaginateProjectLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(ProjectLiteModels.ProjectLiteFilterDtoSchema.optional(), filter, {
  ...
  export const update = (
    id: string,
    officeId: string,
    data: ProjectLiteModels.UpdateProjectLiteRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
