...
export namespace RemarkTemplatesAcl {
  ...
  export const canUsePaginateLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("RemarkTemplate", object) : "RemarkTemplate"] as AbilityTuple<
      "Read",
      "RemarkTemplate" | (ForcedSubject<"RemarkTemplate"> & { officeId: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("RemarkTemplate", object) : "RemarkTemplate"] as AbilityTuple<
      "Create",
      "RemarkTemplate" | (ForcedSubject<"RemarkTemplate"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("RemarkTemplate", object) : "RemarkTemplate"] as AbilityTuple<
      "Update",
      "RemarkTemplate" | (ForcedSubject<"RemarkTemplate"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("RemarkTemplate", object) : "RemarkTemplate"] as AbilityTuple<
      "Archive",
      "RemarkTemplate" | (ForcedSubject<"RemarkTemplate"> & { officeId: string })
    >;
  ...
  export const canUseUnarchive = (object?: { officeId: string }) =>
    ["Unarchive", object ? subject("RemarkTemplate", object) : "RemarkTemplate"] as AbilityTuple<
      "Unarchive",
      "RemarkTemplate" | (ForcedSubject<"RemarkTemplate"> & { officeId: string })
    >;
}
