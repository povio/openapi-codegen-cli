...
export namespace BusinessPartnersAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Create",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetById = (object?: { officeId: string }) =>
    ["Read", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Read",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Archive",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseLock = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUnlock = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetRemarks = (object?: { officeId: string }) =>
    ["ReadRemark", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "ReadRemark",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseCreateRemark = (object?: { officeId: string }) =>
    ["CreateRemark", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "CreateRemark",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateRemark = (object?: { officeId: string }) =>
    ["UpdateRemark", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "UpdateRemark",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteRemark = (object?: { officeId: string }) =>
    ["DeleteRemark", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "DeleteRemark",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetBasicInfo = (object?: { officeId: string }) =>
    ["Read", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Read",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateBasicInfo = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartnerBasicTab", object) : "BusinessPartnerBasicTab"] as AbilityTuple<
      "Update",
      "BusinessPartnerBasicTab" | (ForcedSubject<"BusinessPartnerBasicTab"> & { officeId: string })
    >;
   ...
   */
  export const canUseCreateSignatureUploadInstructions = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartnerBasicTab", object) : "BusinessPartnerBasicTab"] as AbilityTuple<
      "Update",
      "BusinessPartnerBasicTab" | (ForcedSubject<"BusinessPartnerBasicTab"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetCargoAgentInfo = (object?: { officeId: string }) =>
    ["Read", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Read",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateCargoAgent = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetCarrierInformation = (object?: { officeId: string }) =>
    ["Read", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Read",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateCarrier = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
