...
export namespace BusinessPartnersApi {
      ...
      `/offices/${officeId}/business-partners`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(BusinessPartnersModels.BusinessPartnersPaginateOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(BusinessPartnersModels.BusinessPartnerFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const create = (
    officeId: string,
    data: BusinessPartnersModels.CreateBusinessPartnerRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const paginateLabels = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/business-partners/paginate/labels`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(BusinessPartnersModels.BusinessPartnersPaginateLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(BusinessPartnersModels.BusinessPartnerLabelsFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const update = (
    officeId: string,
    id: string,
    data: BusinessPartnersModels.UpdateBusinessPartnerRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const createRemark = (
    officeId: string,
    id: string,
    data: BusinessPartnersModels.CreateBusinessPartnerRemarkRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
  ...
  export const updateBasicInfo = (
    officeId: string,
    id: string,
    data: BusinessPartnersModels.UpdateBusinessPartnerBasicRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: BusinessPartnersModels.BusinessPartnerBasicResponseDTOSchema },
  ...
  export const createSignatureUploadInstructions = (
    officeId: string,
    id: string,
  ...
  export const updateCargoAgent = (
    officeId: string,
    id: string,
    data: BusinessPartnersModels.UpdateCargoAgentDTO,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: BusinessPartnersModels.CargoAgentResponseDTOSchema },
  ...
  export const updateCarrier = (
    officeId: string,
    id: string,
    data: BusinessPartnersModels.UpdateCarrierDTO,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: BusinessPartnersModels.CarrierResponseDTOSchema },
