...
export namespace WorkingDocumentsExportDeclarationApi {
  ...
  export const getExportDeclarationData = (
    officeId: string,
    positionId: string,
  ...
  export const updateExportDeclarationData = (
    officeId: string,
    positionId: string,
    exportDeclarationId: string,
  ...
  export const deleteExportDeclaration = (
    positionId: string,
    exportDeclarationId: string,
    officeId: string,
    config?: AxiosRequestConfig,
  ...
  export const previewExportDeclaration = (
    officeId: string,
    positionId: string,
    exportDeclarationId: string,
    config?: AxiosRequestConfig,
  ...
  export const generateExportDeclaration = (
    officeId: string,
    positionId: string,
    exportDeclarationId: string,
