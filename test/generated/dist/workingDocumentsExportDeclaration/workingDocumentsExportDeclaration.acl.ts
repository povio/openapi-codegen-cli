...
export namespace WorkingDocumentsExportDeclarationAcl {
   ...
   */
  export const canUseGetExportDeclarationData = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-export-declaration", object) : "WorkingDocument-export-declaration",
    ] as AbilityTuple<
   ...
   */
  export const canUseUpdateExportDeclarationData = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-export-declaration", object) : "WorkingDocument-export-declaration",
    ] as AbilityTuple<
   ...
   */
  export const canUseDeleteExportDeclaration = (object?: { officeId: string }) =>
    [
      "Delete",
      object ? subject("WorkingDocument-export-declaration", object) : "WorkingDocument-export-declaration",
    ] as AbilityTuple<
   ...
   */
  export const canUsePreviewExportDeclaration = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-export-declaration", object) : "WorkingDocument-export-declaration",
    ] as AbilityTuple<
   ...
   */
  export const canUseGenerateExportDeclaration = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-export-declaration", object) : "WorkingDocument-export-declaration",
    ] as AbilityTuple<
