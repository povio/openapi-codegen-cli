...
export namespace EmployeeRolesQueries {
  ...
  export const keys = {
    ...
    list: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/employees/roles", limit, order, filter, page, cursor] as const,
    listInfinite: (
      limit?: number,
      order?: string,
      filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/employees/roles", "infinite", limit, order, filter, cursor] as const,
    labels: (search?: string, context?: CommonModels.EmployeeRoleContext) =>
      [...keys.all, "/employees/roles/labels", search, context] as const,
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof EmployeeRolesApi.list, TData>,
  ...
  export const useListInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof EmployeeRolesApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof EmployeeRolesApi.create,
      { data: EmployeeRolesModels.EmployeeRoleCreateRequest }
    > &
   ...
   * @statusCodes [200, 401]
   */
  export const useLabels = <TData>(
    { search, context }: { search?: string; context?: CommonModels.EmployeeRoleContext },
    options?: AppQueryOptions<typeof EmployeeRolesApi.labels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFind = <TData>(
    ...
    options?: AppQueryOptions<typeof EmployeeRolesApi.find, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof EmployeeRolesApi.update,
      { roleId: string; data: EmployeeRolesModels.EmployeeRoleUpdateRequest }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useDeleteEmployeesRolesByRoleId = (
    options?: AppMutationOptions<typeof EmployeeRolesApi.deleteEmployeesRolesByRoleId, { roleId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginatePermissions = <TData>(
    { roleId }: { roleId: string },
    options?: AppQueryOptions<typeof EmployeeRolesApi.paginatePermissions, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useTogglePermission = (
    options?: AppMutationOptions<
      typeof EmployeeRolesApi.togglePermission,
      { roleId: string; permission: string; data: EmployeeRolesModels.EmployeeRoleTogglePermissionRequest }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useCopy = (
    options?: AppMutationOptions<
      typeof EmployeeRolesApi.copy,
      { roleId: string; data: EmployeeRolesModels.CopyEmployeeRoleDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
