...
export namespace EmployeeRolesModels {
   ...
   */
  export const EmployeeRoleListItemResponseSchema = z
    .object({
      ...
      context: CommonModels.EmployeeRoleContextSchema.describe("Role context").nullish(),
      permissions: z.array(z.string()).readonly().describe("Permissions associated with the role"),
      numberOfUsers: z.number().describe("Number of users associated with the role"),
    })
    .readonly();
   ...
   */
  export const EmployeeRolePaginationFilterDtoSchema = z
    .object({
   ...
   */
  export const EmployeeRoleCreateRequestSchema = z
    .object({
      name: z.string().describe("Name of the role"),
      color: z.string().describe("Color of the role"),
      description: z.string().describe("Color of the role").nullish(),
      context: CommonModels.EmployeeRoleContextSchema.describe(`Role context
 - office or global`),
      permissions: z
        .array(z.string())
        .readonly()
        .describe(`Permission IDs associated with the role
 can only be either office or global`)
        .default([]),
    })
    .readonly();
   ...
   */
  export const EmployeeRolePermissionDtoSchema = z
    .object({
   ...
   */
  export const EmployeeRoleUpdateRequestSchema = z
    .object({
      name: z.string().describe("Role Id"),
      color: z.string().describe("Role Color"),
   ...
   */
  export const EmployeeRoleTogglePermissionRequestSchema = z
    .object({ toggled: z.boolean().describe("Turn the permission on or off") })
    .readonly();
   ...
   */
  export const EmployeeRolesListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmployeeRoleListItemResponseSchema).readonly() }).readonly().shape,
  });
   ...
   */
  export const EmployeeRolesPaginatePermissionsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmployeeRolePermissionDtoSchema).readonly() }).readonly().shape,
  });
