...
export namespace OfficesApi {
  export const paginate = (
    ...
    return AppRestClient.get({ resSchema: OfficesModels.OfficesPaginateResponseSchema }, `/offices`, {
      ...config,
      params: {
        order: ZodExtended.parse(
          ZodExtended.sortExp(OfficesModels.OfficesPaginateOrderParamEnumSchema).optional(),
          order,
          { type: "query", name: "order" },
        ),
        filter: ZodExtended.parse(OfficesModels.OfficeFilterDtoSchema.optional(), filter, {
          type: "query",
          name: "filter",
        }),
  ...
  export const findAllLabels = (search?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get({ resSchema: OfficesModels.FindAllLabelsResponseSchema }, `/offices/labels`, {
      ...config,
      params: {
  ...
  export const paginateLabels = (
    ...
    return AppRestClient.get(
      ...
      `/offices/labels/paginate`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(OfficesModels.OfficesPaginateLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(OfficesModels.OfficeLabelFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const get = (id: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get({ resSchema: OfficesModels.OfficeDetailResponseDtoSchema }, `/offices/${id}`, config);
  };
  ...
  export const createBankAccount = (
    officeId: string,
    data: OfficesModels.CreateOfficeBankAccountDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
  ...
  export const updateBankAccount = (
    accountId: string,
    officeId: string,
    data: OfficesModels.UpdateOfficeBankAccountDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const uploadBankAccountFooter = (
    accountId: string,
    officeId: string,
