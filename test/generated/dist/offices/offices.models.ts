...
export namespace OfficesModels {
   ...
   */
  export const OfficeBankAccountCurrencyMappingResponseDtoSchema = z
    .object({ currency: z.string(), bankAccountId: z.string(), bankAccountName: z.string() })
    .readonly();
  export type OfficeBankAccountCurrencyMappingResponseDto = z.infer<
    typeof OfficeBankAccountCurrencyMappingResponseDtoSchema
  >;
   ...
   */
  export const OfficeBookkeepingResponseDtoSchema = z
    .object({
      generalLedgerSystem: z.string(),
      defaultCurrency: OfficeCurrencyResponseDtoSchema.nullish(),
      availableCurrencies: z.array(OfficeCurrencyResponseDtoSchema).readonly(),
      showPaymentInstructions: z.boolean(),
      showCompanyRegistrationNumber: z.boolean(),
      showInvoiceVatLinesInOfficeCurrency: z.boolean(),
      reportInvoicesToHungarianTaxAuthority: z.boolean(),
      bankAccountCurrencyMapping: z.array(OfficeBankAccountCurrencyMappingResponseDtoSchema).readonly(),
      costCenterId: z.string().nullish(),
      minimumOutgoingInvoiceDate: z.iso.datetime({ offset: true }).nullish(),
      minimumOutgoingInvoiceServiceDate: z.iso.datetime({ offset: true }).nullish(),
      minimumIncomingInvoiceDate: z.iso.datetime({ offset: true }).nullish(),
      minimumIncomingInvoiceServiceDate: z.iso.datetime({ offset: true }).nullish(),
      factoringReportingEnabled: z.boolean(),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const OfficeDocumentPartEnumSchema = z.enum([
    "DocumentFooter",
    "DocumentHeader",
    "GeneralTermsAndConditions",
    "BLTermsAndConditions",
    "FinanceDocumentFooter",
  ]);
   ...
   */
  export const OfficeDocumentSettingsResponseDtoSchema = z
    .object({
      id: z.string(),
      mediaUrl: z.string(),
      language: CommonModels.LanguageEnumSchema,
      documentPart: OfficeDocumentPartEnumSchema,
    })
    .readonly();
  ...
  export const AddressResponseDTOSchema = z
    .object({
      id: z.string().describe("ID of the address"),
      street: z.string().describe("Street address"),
      secondaryStreet: z.string().describe("Secondary street address"),
      zip: z.string().describe("ZIP/Postal code"),
      city: z.string().describe("City name"),
      district: z.string().describe("District"),
      isoCode2: z.string().describe("2 letter country code"),
      country: z.string().describe("Country name"),
      isoCode3: z.string().describe("3 letter country code"),
    })
    .readonly();
   ...
   */
  export const OfficeRepresentingBusinessPartnerResponseDtoSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      types: z.array(z.string()).readonly(),
      email: z.array(z.string()).readonly().nullish(),
      phone: z.array(z.string()).readonly().nullish(),
      addressId: z.string().nullish(),
      address: AddressResponseDTOSchema.nullish(),
    })
    .readonly();
  export type OfficeRepresentingBusinessPartnerResponseDto = z.infer<
    typeof OfficeRepresentingBusinessPartnerResponseDtoSchema
  >;
   ...
   */
  export const OfficePaymentTermsResponseDtoSchema = z
    .object({ days: z.number(), relativeTo: CommonModels.OfficePaymentTermsDateTypeSchema })
    .readonly();
   ...
   */
  export const OfficeBankAccountResponseDtoSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      bankName: z.string(),
   ...
   */
  export const OfficeDetailResponseDtoSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      symbol: z.string().nullable(),
      invoicePrefix: z.number().nullable(),
      autoClosePositionsAfterDays: z.number().nullish(),
      defaultLanguage: z.string().nullable(),
      locale: CommonModels.LocaleEnumSchema.nullish(),
      vatId: z.string().nullable(),
      taxNumber: z.string().nullable(),
      restrictPositionInvolvedParties: z.boolean(),
      showWatermarkOnDocuments: z.boolean(),
      usePartnerMatchCodes: z.boolean(),
      restrictFinancePartnersToRelationship: z.boolean(),
      termsExport: OfficePaymentTermsResponseDtoSchema.nullable(),
      termsImport: OfficePaymentTermsResponseDtoSchema.nullable(),
      country: OfficeCountryResponseDtoSchema.nullable(),
      bankAccounts: z.array(OfficeBankAccountResponseDtoSchema).readonly(),
      bookkeeping: OfficeBookkeepingResponseDtoSchema,
      documentSettings: z.array(OfficeDocumentSettingsResponseDtoSchema).readonly(),
      representingBusinessPartner: OfficeRepresentingBusinessPartnerResponseDtoSchema.nullable(),
      hasInttraCredentials: z.boolean().nullish(),
    })
    .readonly();
   ...
   * @property { boolean } factoringReportingEnabled
   */
  export const OfficeResponseDtoSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      symbol: z.string().nullable(),
      ...
      defaultCurrencyId: z.string().nullable(),
      availableCurrencyIds: z.array(z.string()).readonly().nullable(),
      generalLedgerSystem: z.string().nullable(),
      representingBusinessPartnerId: z.string().nullable(),
      representingBusinessPartner: OfficeRepresentingBusinessPartnerResponseDtoSchema.nullable(),
      factoringReportingEnabled: z.boolean(),
    })
    .readonly();
   ...
   * @property { string } relativeTo
   */
  export const UpdateOfficePaymentTermsRequestSchema = z
    .object({ days: z.number(), relativeTo: CommonModels.OfficePaymentTermsDateTypeSchema })
    .readonly();
   ...
   * @property { string } bankAccountId
   */
  export const UpdateOfficeBankAccountCurrencyMappingSchema = z
    .object({ currency: z.string(), bankAccountId: z.string() })
    .readonly();
   ...
   */
  export const UpdateOfficeRequestSchema = z
    .object({
      name: z.string().describe("Office Name"),
      symbol: z.string().describe("Office Symbol"),
      invoicePrefix: z.number().describe("Office Invoice Prefix"),
      autoClosePositionsAfterDays: z.number(),
      defaultLanguage: z.string().describe("Office Default Language"),
      locale: CommonModels.LocaleEnumSchema,
      vatId: z.string().describe("Office Vat Id"),
      taxNumber: z.string().describe("Office Tax Number"),
      termsExport: UpdateOfficePaymentTermsRequestSchema.describe("Office Terms Export"),
      termsImport: UpdateOfficePaymentTermsRequestSchema.describe("Office Terms Import"),
      showPaymentInstructions: z.boolean().describe("Office Show Payment Instructions"),
      showCompanyRegistrationNumber: z.boolean(),
      reportInvoicesToHungarianTaxAuthority: z.boolean(),
      restrictPositionInvolvedParties: z.boolean(),
      showWatermarkOnDocuments: z.boolean(),
      ...
      minimumOutgoingInvoiceDate: z.iso.datetime({ offset: true }),
      minimumOutgoingInvoiceServiceDate: z.iso.datetime({ offset: true }),
      minimumIncomingInvoiceDate: z.iso.datetime({ offset: true }),
      minimumIncomingInvoiceServiceDate: z.iso.datetime({ offset: true }),
      countryId: z.string().describe("Office country id"),
      defaultCurrencyId: z.string().describe("Office default currency id"),
      representingBusinessPartnerId: z.string().describe("Representing business partner id"),
      availableCurrencyIds: z.array(z.string()).readonly().describe("Office availableCurrencyIds"),
      generalLedgerSystem: z.string().describe("Office general ledger system"),
      factoringReportingEnabled: z.boolean(),
      bankAccountCurrencyMapping: z
        .array(UpdateOfficeBankAccountCurrencyMappingSchema)
        .readonly()
        .describe("Office bank account currency mapping"),
    })
    .readonly();
   ...
   */
  export const UploadOfficeDocumentRequestDtoSchema = z
    .object({
      fileName: z.string().describe("File name with extension"),
      mimeType: z.string().describe("MIME type of the file"),
      fileSize: z.number().describe("Size of the file"),
      language: CommonModels.LanguageEnumSchema.describe("Language of the document"),
      documentPart: OfficeDocumentPartEnumSchema.describe("Part of the document this image represents"),
    })
    .readonly();
   ...
   */
  export const OfficeListItemResponseSchema = z
    .object({ id: z.string(), name: z.string(), numberOfEmployees: z.number() })
    .readonly();
   ...
   */
  export const DocumentImageUploadInstructionsDtoSchema = z
    .object({
      method: z.string().describe("HTTP method to use for upload"),
      url: z.string().describe("URL to upload the file to"),
      documentId: z.string().describe("ID of the created/updated document setting"),
    })
    .readonly();
   ...
   */
  export const CreateOfficeBankAccountDtoSchema = z
    .object({
      name: z.string().describe("Bank account name"),
      bankName: z.string().describe("Bank name"),
      iban: z.string().describe("IBAN"),
      swiftBic: z.string().describe("SWIFT/BIC code"),
      useFooterOnInvoice: z.boolean().describe("Use footer on invoice"),
    })
    .readonly();
   ...
   */
  export const UpdateOfficeBankAccountDtoSchema = z
    .object({
      name: z.string().describe("Bank account name"),
      bankName: z.string().describe("Bank name"),
      iban: z.string().describe("IBAN"),
      swiftBic: z.string().describe("SWIFT/BIC code"),
      useFooterOnInvoice: z.boolean().describe("Use footer on invoice"),
      isFactoringBank: z.boolean().describe("Is factoring bank"),
    })
    .readonly();
   ...
   * @property { number } fileSize Size of the file
   */
  export const UploadOfficeBankAccountFooterRequestDtoSchema = z
    .object({
   ...
   */
  export const OfficesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(OfficeListItemResponseSchema).readonly() }).readonly().shape,
  });
   ...
   */
  export const OfficesPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
