...
export namespace OfficesAcl {
   ...
   */
  export const canUseCreate = () => ["Create", "Office"] as AbilityTuple<"Create", "Office">;
   ...
   */
  export const canUseGet = () => ["Read", "Office"] as AbilityTuple<"Read", "Office">;
   ...
   */
  export const canUseUpdate = () => ["Update", "Office"] as AbilityTuple<"Update", "Office">;
   ...
   */
  export const canUseUploadDocumentImage = (object?: { officeId: string }) =>
   ...
   */
  export const canUseCreateBankAccount = (object?: { officeId: string }) =>
    ["Update", object ? subject("Office", object) : "Office"] as AbilityTuple<
      "Update",
      "Office" | (ForcedSubject<"Office"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateBankAccount = (object?: { officeId: string }) =>
    ["Update", object ? subject("Office", object) : "Office"] as AbilityTuple<
      "Update",
      "Office" | (ForcedSubject<"Office"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteBankAccount = (object?: { officeId: string }) =>
    ["Update", object ? subject("Office", object) : "Office"] as AbilityTuple<
      "Update",
      "Office" | (ForcedSubject<"Office"> & { officeId: string })
    >;
   ...
   */
  export const canUseUploadBankAccountFooter = (object?: { officeId: string }) =>
    ["Update", object ? subject("Office", object) : "Office"] as AbilityTuple<
      "Update",
      "Office" | (ForcedSubject<"Office"> & { officeId: string })
    >;
