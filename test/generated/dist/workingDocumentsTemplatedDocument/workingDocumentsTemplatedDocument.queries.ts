...
export namespace WorkingDocumentsTemplatedDocumentQueries {
  ...
  export const keys = {
    ...
    getTemplatedDocument: (officeId: string, positionId: string, templatedDocumentId: string) =>
      [
        ...keys.all,
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.create,
      {
        positionId: string;
        officeId: string;
        data: WorkingDocumentsTemplatedDocumentModels.CreateTemplatedDocumentRequestDto;
      }
    > &
   ...
   * @statusCodes [200, 401]
   */
  export const useGetTemplatedDocument = <TData>(
    {
      officeId,
      positionId,
      templatedDocumentId,
    }: { officeId: string; positionId: string; templatedDocumentId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsTemplatedDocumentApi.getTemplatedDocument, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.getTemplatedDocument(
          officeId,
          positionId,
          templatedDocumentId,
          config,
   ...
   * @statusCodes [200, 401]
   */
  export const useUpdateTemplatedDocument = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.updateTemplatedDocument,
      {
        officeId: string;
        positionId: string;
        templatedDocumentId: string;
        data: WorkingDocumentsTemplatedDocumentModels.UpdateTemplatedDocumentRequestDto;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, templatedDocumentId, data }) => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.updateTemplatedDocument(
          officeId,
          positionId,
          templatedDocumentId,
          data,
   ...
   */
  export const useDeleteTemplatedDocument = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.deleteTemplatedDocument,
      { positionId: string; templatedDocumentId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ positionId, templatedDocumentId, officeId }) => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.deleteTemplatedDocument(
          positionId,
          templatedDocumentId,
          officeId,
          config,
   ...
   */
  export const usePreviewTemplatedDocument = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.previewTemplatedDocument,
      {
        officeId: string;
        positionId: string;
        templatedDocumentId: string;
        data: WorkingDocumentsTemplatedDocumentModels.GenerateWorkingDocumentPreviewRequestDto;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, templatedDocumentId, data }) => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.previewTemplatedDocument(
          officeId,
          positionId,
          templatedDocumentId,
          data,
   ...
   * @statusCodes [201, 401]
   */
  export const useIssueTemplatedDocument = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.issueTemplatedDocument,
      {
        officeId: string;
        positionId: string;
        templatedDocumentId: string;
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, templatedDocumentId, data }) => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.issueTemplatedDocument(
          officeId,
          positionId,
          templatedDocumentId,
          data,
  ...
  export const useGenerateDocumentEml = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsTemplatedDocumentApi.generateDocumentEml,
      {
        officeId: string;
        positionId: string;
        templatedDocumentId: string;
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, templatedDocumentId, data }) => {
        ...
        return WorkingDocumentsTemplatedDocumentApi.generateDocumentEml(
          officeId,
          positionId,
          templatedDocumentId,
          data,
