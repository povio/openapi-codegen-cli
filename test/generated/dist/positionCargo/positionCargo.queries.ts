...
export namespace PositionCargoQueries {
  ...
  export const keys = {
    ...
    listCargosByPositionId: (
      officeId: string,
      positionId: string,
      limit?: number,
      order?: PositionCargoModels.ListCargosByPositionIdOrderParam,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    listCargosByPositionIdInfinite: (
      officeId: string,
      positionId: string,
      limit?: number,
      order?: PositionCargoModels.ListCargosByPositionIdOrderParam,
    ...
    listCargoLabels: (officeId: string, positionId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/cargos/labels", officeId, positionId] as const,
    getCargoSummary: (officeId: string, positionId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/cargos/summary", officeId, positionId] as const,
    getCargoById: (officeId: string, positionId: string, cargoId: string) =>
      [...keys.all, "/offices/:officeId/positions/:positionId/cargos/:cargoId", officeId, positionId, cargoId] as const,
  };
  ...
  export const useListCargosByPositionId = <TData>(
    ...
    options?: AppQueryOptions<typeof PositionCargoApi.listCargosByPositionId, TData>,
   ...
   * @statusCodes [200, 401]
   */
  export const useListCargosByPositionIdInfinite = <TData>(
    {
      officeId,
      positionId,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof PositionCargoApi.listCargosByPositionId, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreateCargo = (
    options?: AppMutationOptions<
      typeof PositionCargoApi.createCargo,
      { officeId: string; positionId: string; data: CommonModels.CreatePositionCargoDTO }
    > &
   ...
   * @statusCodes [200, 401]
   */
  export const useListCargoLabels = <TData>(
    { officeId, positionId }: { officeId: string; positionId: string },
    options?: AppQueryOptions<typeof PositionCargoApi.listCargoLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCargoSummary = <TData>(
    { officeId, positionId }: { officeId: string; positionId: string },
    options?: AppQueryOptions<typeof PositionCargoApi.getCargoSummary, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCargoById = <TData>(
    { officeId, positionId, cargoId }: { officeId: string; positionId: string; cargoId: string },
    options?: AppQueryOptions<typeof PositionCargoApi.getCargoById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateCargo = (
    options?: AppMutationOptions<
      typeof PositionCargoApi.updateCargo,
      { officeId: string; positionId: string; cargoId: string; data: CommonModels.UpdatePositionCargoDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDeleteCargo = (
    options?: AppMutationOptions<
      typeof PositionCargoApi.deleteCargo,
      { officeId: string; positionId: string; cargoId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [201, 401]
   */
  export const useCreateBulkCargos = (
    options?: AppMutationOptions<
      typeof PositionCargoApi.createBulkCargos,
      { numberOfCargos: number; officeId: string; positionId: string; data: CommonModels.CreatePositionCargoDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [201, 401]
   */
  export const useDuplicateCargo = (
    options?: AppMutationOptions<
      typeof PositionCargoApi.duplicateCargo,
      { officeId: string; positionId: string; cargoId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
