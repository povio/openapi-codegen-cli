...
export namespace WorkingDocumentsAmsInstructionsAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    [
      ...
      "Create",
      "WorkingDocument-ams-instructions" | (ForcedSubject<"WorkingDocument-ams-instructions"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetAMSInstructionsData = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-ams-instructions", object) : "WorkingDocument-ams-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseUpdateAMSInstructionsData = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-ams-instructions", object) : "WorkingDocument-ams-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseDeleteAMSInstructions = (object?: { officeId: string }) =>
    [
      "Delete",
      object ? subject("WorkingDocument-ams-instructions", object) : "WorkingDocument-ams-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUsePreviewAMSInstructions = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-ams-instructions", object) : "WorkingDocument-ams-instructions",
    ] as AbilityTuple<
   ...
   */
  export const canUseGenerateAMSInstructions = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-ams-instructions", object) : "WorkingDocument-ams-instructions",
    ] as AbilityTuple<
