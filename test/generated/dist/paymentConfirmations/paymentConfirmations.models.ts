...
export namespace PaymentConfirmationsModels {
   ...
   */
  export const PaymentConfirmationItemDtoSchema = z
    .object({
      invoiceId: z.string().describe("Invoice ID"),
      invoiceNumber: z.string().describe("Invoice number"),
      invoiceDate: z.iso.datetime({ offset: true }).describe("Invoice date"),
      invoiceAmount: z.number().describe("Invoice amount"),
      amount: z.number().describe("Payment amount"),
      currencyNotation: z.string().describe("Currency notation"),
      reference: z.string().describe("Reference").nullish(),
      position: PaymentConfirmationPositionDtoSchema.describe("Position information"),
   ...
   * @property { string } paymentDate Payment date
   */
  export const PaymentConfirmationItemFilterDtoSchema = z
    .object({
      businessPartnerId: z.string().describe("Business partner ID"),
      paymentDate: z.iso.datetime({ offset: true }).describe("Payment date"),
    })
    .readonly();
   ...
   */
  export const GeneratePaymentConfirmationRequestDtoSchema = z
    .object({
      businessPartnerId: z.string().describe("Business partner ID"),
      paymentDate: z.iso.datetime({ offset: true }).describe("Payment date"),
      positionId: z.string().describe("Position ID (optional)").nullish(),
    })
    .readonly();
   ...
   */
  export const PaymentConfirmationsGetResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(PaymentConfirmationItemDtoSchema).readonly() }).readonly().shape,
  });
