...
export namespace BookkeepingExportAcl {
   ...
   */
  export const canUseCreateBatch = (object?: { officeId: string }) =>
    ["Create", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Create",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUsePaginateBatches = (object?: { officeId: string }) =>
    ["Read", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Read",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetBatch = (object?: { officeId: string }) =>
    ["Read", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Read",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateBatchFormat = (object?: { officeId: string }) =>
    ["Update", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Update",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateBatchItem = (object?: { officeId: string }) =>
    ["Update", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Update",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUsePaginateBatchItems = (object?: { officeId: string }) =>
    ["Read", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Read",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseValidateBookkeepingBatch = (object?: { officeId: string }) =>
    ["Export", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Export",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseExportBookkeepingBatch = (object?: { officeId: string }) =>
    ["Export", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Export",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseRevertBookkeepingBatch = (object?: { officeId: string }) =>
    ["Update", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Update",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetVatLineItems = (object?: { officeId: string }) =>
    ["Read", object ? subject("BookkeepingExportBatch", object) : "BookkeepingExportBatch"] as AbilityTuple<
      "Read",
      "BookkeepingExportBatch" | (ForcedSubject<"BookkeepingExportBatch"> & { officeId: string })
    >;
