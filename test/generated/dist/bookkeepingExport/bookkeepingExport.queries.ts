...
export namespace BookkeepingExportQueries {
  ...
  export const keys = {
    ...
    paginateBatches: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/bookkeeping-exports", officeId, limit, order, filter, page, cursor] as const,
    paginateBatchesInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto,
    ...
    getBatch: (officeId: string, batchId: string) =>
      [...keys.all, "/offices/:officeId/bookkeeping-exports/:batchId", officeId, batchId] as const,
    paginateBatchItems: (
      officeId: string,
      batchId: string,
      limit?: number,
    ...
    getVatLineItems: (officeId: string, batchId: string, order?: string) =>
      [
        ...keys.all,
  ...
  export const useCreateBatch = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.createBatch,
      { officeId: string; data: BookkeepingExportModels.CreateBookkeepingExportBatchRequestDto }
    > &
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateBatches = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppQueryOptions<typeof BookkeepingExportApi.paginateBatches, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateBatchesInfinite = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppInfiniteQueryOptions<typeof BookkeepingExportApi.paginateBatches, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetBatch = <TData>(
    { officeId, batchId }: { officeId: string; batchId: string },
    options?: AppQueryOptions<typeof BookkeepingExportApi.getBatch, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateBatchFormat = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.updateBatchFormat,
      { officeId: string; batchId: string; data: BookkeepingExportModels.UpdateBookkeepingExportBatchRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useUpdateBatchItem = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.updateBatchItem,
      { officeId: string; batchId: string; data: BookkeepingExportModels.UpdateBookkeepingExportBatchItemRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateBatchItems = <TData>(
    {
      officeId,
      batchId,
      limit,
    ...
    options?: AppQueryOptions<typeof BookkeepingExportApi.paginateBatchItems, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateBatchItemsInfinite = <TData>(
    {
      officeId,
      batchId,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof BookkeepingExportApi.paginateBatchItems, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useInfiniteQuery({
      ...
      queryFn: ({ pageParam }) => {
        checkAcl(BookkeepingExportAcl.canUsePaginateBatchItems({ officeId }));
        return BookkeepingExportApi.paginateBatchItems(
          officeId,
          batchId,
          limit,
          order,
  ...
  export const useValidateBookkeepingBatch = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.validateBookkeepingBatch,
      { officeId: string; batchId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useExportBookkeepingBatch = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.exportBookkeepingBatch,
      { officeId: string; batchId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [200, 401]
   */
  export const useRevertBookkeepingBatch = (
    options?: AppMutationOptions<
      typeof BookkeepingExportApi.revertBookkeepingBatch,
      { officeId: string; batchId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [200, 401]
   */
  export const useGetVatLineItems = <TData>(
    { officeId, batchId, order }: { officeId: string; batchId: string; order?: string },
    options?: AppQueryOptions<typeof BookkeepingExportApi.getVatLineItems, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
