...
export namespace ControlTowerCalendarModels {
   ...
   */
  export const CalendarEventRelationDtoSchema = z
    .object({ type: EventRelationTypeEnumSchema, id: z.string(), number: z.string() })
    .readonly();
   ...
   */
  export const CalendarEventDtoSchema = z
    .object({
      entityId: z.string(),
      entityNumber: z.string(),
      entityType: CalendarTypeEnumSchema,
      date: z.iso.datetime({ offset: true }),
      title: z.string(),
      relations: z.array(CalendarEventRelationDtoSchema).readonly(),
    })
    .readonly();
   ...
   */
  export const FiltersDtoSchema = z
    .object({
      poNumbers: z.array(z.string()).readonly(),
      bookingNumbers: z.array(z.string()).readonly(),
      containerNumbers: z.array(z.string()).readonly(),
    })
    .readonly();
   ...
   */
  export const CalendarDtoSchema = z
    .object({ events: z.array(CalendarEventDtoSchema).readonly(), filters: FiltersDtoSchema })
    .readonly();
