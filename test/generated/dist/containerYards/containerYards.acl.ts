...
export namespace ContainerYardsAcl {
   ...
   */
  export const canUsePaginate = () => ["Read", "ContainerYard"] as AbilityTuple<"Read", "ContainerYard">;
   ...
   */
  export const canUseCreate = () => ["Create", "ContainerYard"] as AbilityTuple<"Create", "ContainerYard">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "ContainerYard"] as AbilityTuple<"Read", "ContainerYard">;
   ...
   */
  export const canUseGetLabelById = () => ["Read", "ContainerYard"] as AbilityTuple<"Read", "ContainerYard">;
   ...
   */
  export const canUseArchive = () => ["Update", "ContainerYard"] as AbilityTuple<"Update", "ContainerYard">;
   ...
   */
  export const canUseUnarchive = () => ["Update", "ContainerYard"] as AbilityTuple<"Update", "ContainerYard">;
   ...
   */
  export const canUseUpdate = () => ["Update", "ContainerYard"] as AbilityTuple<"Update", "ContainerYard">;
   ...
   */
  export const canUseFindById = () => ["Read", "ContainerYard"] as AbilityTuple<"Read", "ContainerYard">;
}
