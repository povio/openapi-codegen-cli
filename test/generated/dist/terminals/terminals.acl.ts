...
export namespace TerminalsAcl {
   ...
   */
  export const canUseCreate = () => ["Create", "Terminal"] as AbilityTuple<"Create", "Terminal">;
   ...
   */
  export const canUsePaginate = () => ["Read", "Terminal"] as AbilityTuple<"Read", "Terminal">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "Terminal"] as AbilityTuple<"Read", "Terminal">;
   ...
   */
  export const canUseGetById = () => ["Read", "Terminal"] as AbilityTuple<"Read", "Terminal">;
   ...
   */
  export const canUseUpdate = () => ["Update", "Terminal"] as AbilityTuple<"Update", "Terminal">;
   ...
   */
  export const canUseArchive = () => ["Archive", "Terminal"] as AbilityTuple<"Archive", "Terminal">;
   ...
   */
  export const canUseUnarchive = () => ["Unarchive", "Terminal"] as AbilityTuple<"Unarchive", "Terminal">;
}
