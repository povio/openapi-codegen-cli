...
export namespace QuoteCargoPackageQueries {
  ...
  export const useCreatePackage = (
    options?: AppMutationOptions<
      typeof QuoteCargoPackageApi.createPackage,
      { officeId: string; quoteId: string; cargoId: string; data: CommonModels.CreatePositionCargoPackageDTO }
    > &
  ...
  export const useUpdatePackage = (
    options?: AppMutationOptions<
      typeof QuoteCargoPackageApi.updatePackage,
      {
        officeId: string;
        quoteId: string;
        cargoId: string;
  ...
  export const useDeletePackage = (
    options?: AppMutationOptions<
      typeof QuoteCargoPackageApi.deletePackage,
      { officeId: string; quoteId: string; cargoId: string; packageId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDuplicatePackage = (
    options?: AppMutationOptions<
      typeof QuoteCargoPackageApi.duplicatePackage,
      { officeId: string; quoteId: string; cargoId: string; packageId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [200, 401]
   */
  export const useMovePackage = (
    options?: AppMutationOptions<
      typeof QuoteCargoPackageApi.movePackage,
      {
        officeId: string;
        quoteId: string;
        cargoId: string;
