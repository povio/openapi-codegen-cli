...
export namespace BusinessPartnerBookkeepingMappingsModels {
   ...
   */
  export const BusinessPartnerBookkeepingMappingResponseDtoSchema = z
    .object({
      id: z.string(),
      ...
      paysTaxInEurForFactoring: z.boolean().nullish(),
    })
    .readonly();
  export type BusinessPartnerBookkeepingMappingResponseDto = z.infer<
    typeof BusinessPartnerBookkeepingMappingResponseDtoSchema
  >;
   ...
   */
  export const BusinessPartnerBookkeepingMappingsResponseDtoSchema = z
    .object({ bookkeepingMappings: z.array(BusinessPartnerBookkeepingMappingResponseDtoSchema).readonly() })
    .readonly();
  export type BusinessPartnerBookkeepingMappingsResponseDto = z.infer<
    typeof BusinessPartnerBookkeepingMappingsResponseDtoSchema
  >;
   ...
   */
  export const UpdateBookkeepingMappingDtoSchema = z
    .object({
      debtorId: z.string(),
      creditorId: z.string(),
      currencyNotation: z.string(),
      paysTaxInEurForFactoring: z.boolean().describe("Pays tax in EUR for factoring (Logvin case)"),
    })
    .readonly();
   ...
   */
  export const UpdateBookkeepingMappingRequestDtoSchema = z
    .object({ bookkeepingMappings: z.array(UpdateBookkeepingMappingDtoSchema).readonly() })
    .readonly();
   ...
   * @property { boolean } paysTaxInEurForFactoring Pays tax in EUR for factoring (Logvin case)
   */
  export const CreateBookkeepingMappingDtoSchema = z
    .object({
      debtorId: z.string(),
      creditorId: z.string(),
      currencyNotation: z.string(),
   ...
   * @type { array }
   */
  export const UpdateBookkeepingMappingResponseSchema = z
    .array(BusinessPartnerBookkeepingMappingResponseDtoSchema)
    .readonly();
