...
export namespace QuoteProfitChangeTrackingAcl {
   ...
   */
  export const canUseFindProfitChangeGroups = (object?: { officeId: string; quoteId: string }) =>
    ["Read", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Read",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string; quoteId: string })
    >;
   ...
   */
  export const canUseFindProfitChangeGroupDetail = (object?: { officeId: string; quoteId: string }) =>
    ["Read", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Read",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string; quoteId: string })
    >;
