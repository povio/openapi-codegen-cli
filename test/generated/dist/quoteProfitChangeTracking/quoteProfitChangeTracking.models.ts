...
export namespace QuoteProfitChangeTrackingModels {
   ...
   */
  export const QuoteAccountProfitChangeGroupDtoSchema = z
    .object({
      id: z.string(),
   ...
   */
  export const QuoteAccountProfitChangeEntryDtoSchema = z
    .object({
      timestamp: z.iso.datetime({ offset: true }),
   ...
   */
  export const QuoteAccountProfitChangeGroupDetailDtoSchema = z
    .object({
      id: z.string(),
      timestamp: z.iso.datetime({ offset: true }),
      currencyCode: z.string(),
      entries: z.array(QuoteAccountProfitChangeEntryDtoSchema).readonly(),
    })
    .readonly();
   ...
   */
  export const QuoteProfitChangeTrackingFindProfitChangeGroupsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(QuoteAccountProfitChangeGroupDtoSchema).readonly() }).readonly().shape,
  });
  export type QuoteProfitChangeTrackingFindProfitChangeGroupsResponse = z.infer<
    typeof QuoteProfitChangeTrackingFindProfitChangeGroupsResponseSchema
  >;
}
