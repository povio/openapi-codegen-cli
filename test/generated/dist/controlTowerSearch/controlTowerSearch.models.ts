...
export namespace ControlTowerSearchModels {
   ...
   */
  export const SearchItemDtoSchema = z
    .object({ type: SearchItemTypeEnumSchema, id: z.string(), label: z.string().nullable() })
    .readonly();
   ...
   */
  export const SearchResponseDtoSchema = z
    .object({
      items: z.array(SearchItemDtoSchema).readonly(),
