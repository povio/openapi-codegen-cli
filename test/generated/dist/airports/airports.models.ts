...
export namespace AirportsModels {
   ...
   */
  export const AirportResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the airport"),
      name: z.string().describe("Name of the airport"),
      matchCode: z.string().describe("Match code for the airport"),
      iataCode: z.string().describe("IATA code of the airport"),
      createdById: z.string().nullish(),
      createdBy: AirportEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: AirportEmployeeDTOSchema.nullish(),
   ...
   */
  export const AirportPaginationFilterDtoSchema = z
    .object({ search: z.string().describe("Search term to filter airports by name, match code or IATA code") })
    .readonly();
   ...
   * @property { string } iataCode IATA code of the airport
   */
  export const CreateAirportRequestDTOSchema = z
    .object({
      name: z.string().describe("Name of the airport"),
      matchCode: z.string().describe("Match code for the airport"),
      iataCode: z.string().describe("IATA code of the airport"),
   ...
   * @property { string } iataCode IATA code of the airport
   */
  export const UpdateAirportRequestDTOSchema = z
    .object({
      name: z.string().describe("Name of the airport"),
      matchCode: z.string().describe("Match code for the airport"),
      iataCode: z.string().describe("IATA code of the airport"),
   ...
   * @type { enum }
   */
  export const AirportsPaginateOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "iataCode",
    "createdAt",
   ...
   */
  export const AirportsPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(AirportResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const AirportsPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "iataCode",
    "createdAt",
   ...
   */
  export const AirportsPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
