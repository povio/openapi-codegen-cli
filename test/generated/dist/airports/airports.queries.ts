...
export namespace AirportsQueries {
  ...
  export const keys = {
    ...
    paginate: (
      limit?: number,
      order?: string,
      filter?: AirportsModels.AirportPaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/airports", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: AirportsModels.AirportPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/airports", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      filter?: AirportsModels.AirportLabelFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/airports/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: AirportsModels.AirportLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/airports/labels/paginate", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof AirportsApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: AirportsModels.AirportPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof AirportsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof AirportsApi.create, { data: AirportsModels.CreateAirportRequestDTO }> &
  ...
  export const usePaginateLabels = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: AirportsModels.AirportLabelFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof AirportsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: AirportsModels.AirportLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof AirportsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof AirportsApi.update,
      { id: string; data: AirportsModels.UpdateAirportRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof AirportsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
