...
export namespace PositionCargoPackageQueries {
  ...
  export const useCreatePackage = (
    options?: AppMutationOptions<
      typeof PositionCargoPackageApi.createPackage,
      { officeId: string; positionId: string; cargoId: string; data: CommonModels.CreatePositionCargoPackageDTO }
    > &
  ...
  export const useUpdatePackage = (
    options?: AppMutationOptions<
      typeof PositionCargoPackageApi.updatePackage,
      {
        officeId: string;
        positionId: string;
        cargoId: string;
  ...
  export const useDeletePackage = (
    options?: AppMutationOptions<
      typeof PositionCargoPackageApi.deletePackage,
      { officeId: string; positionId: string; cargoId: string; packageId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDuplicatePackage = (
    options?: AppMutationOptions<
      typeof PositionCargoPackageApi.duplicatePackage,
      { officeId: string; positionId: string; cargoId: string; packageId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ...
  export const useMovePackage = (
    options?: AppMutationOptions<
      typeof PositionCargoPackageApi.movePackage,
      {
        officeId: string;
        positionId: string;
        cargoId: string;
