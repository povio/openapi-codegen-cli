...
export namespace BusinessPartnerContactsAcl {
   ...
   */
  export const canUseGetContacts = (object?: { officeId: string }) =>
   ...
   */
  export const canUseCreateContact = (object?: { officeId: string }) =>
   ...
   */
  export const canUsePaginateContactLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Read",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateContact = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteContact = (object?: { officeId: string }) =>
    ["Update", object ? subject("BusinessPartner", object) : "BusinessPartner"] as AbilityTuple<
      "Update",
      "BusinessPartner" | (ForcedSubject<"BusinessPartner"> & { officeId: string })
    >;
