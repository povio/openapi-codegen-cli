      ...
      `/packages`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(ControlTowerPackagesModels.ControlTowerPackagesFindAllOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(ControlTowerPackagesModels.PackageFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
