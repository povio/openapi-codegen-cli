...
export namespace WorkingDocumentsCmrFormModels {
   ...
   */
  export const CmrDocumentSettingsDtoDTOSchema = z
    .object({
      primaryLanguage: CmrDocumentLanguageSchema.describe("Primary language"),
      secondaryLanguage: CmrDocumentLanguageSchema.describe("Secondary language"),
    })
    .readonly();
   ...
   */
  export const CmrDocumentBusinessPartnerResponseDTOSchema = z
    .object({
   ...
   */
  export const CmrDocumentCityResponseDTOSchema = z
    .object({
      cityId: z.string().describe("ID of the city"),
      cityName: z.string().describe("Name of the city"),
      date: z.iso.datetime({ offset: true }).describe("Date of delivery/takeover").nullish(),
      countryName: z.string().describe("Country name").nullish(),
    })
    .readonly();
   ...
   */
  export const CmrDocumentCostsResponseDTOSchema = z
    .object({
      carriageCharges: z.number().describe("Carriage charges"),
      reductions: z.number().describe("Reductions"),
      balance: z.number().describe("Balance"),
      supplements: z.number().describe("Supplements"),
      miscellaneous: z.number().describe("Miscellaneous charges"),
   ...
   */
  export const CmrDocumentCargoResponseDTOSchema = z
    .object({
      ...
      statisticNumber: z.string(),
      positionNumber: z.string().describe("Position number of the cargo"),
      grossWeight: z.number().describe("Gross weight of the cargo"),
   ...
   */
  export const CmrDocumentResponseDTOSchema = z
    .object({
      ...
      nameSuffix: z.string().describe("Name suffix of the document").nullish(),
      ...
      cmrNumber: z.string().describe("CMR number").nullish(),
      consignee: CmrDocumentBusinessPartnerResponseDTOSchema.describe("Consignee information").nullish(),
      shipper: CmrDocumentBusinessPartnerResponseDTOSchema.describe("Shipper information").nullish(),
      carrier: CmrDocumentBusinessPartnerResponseDTOSchema.describe("Carrier information").nullish(),
      successiveCarrier: CmrDocumentBusinessPartnerResponseDTOSchema.describe(
        "Successive carrier information",
      ).nullish(),
      delivery: CmrDocumentCityResponseDTOSchema.describe("Delivery information").nullish(),
      takeover: CmrDocumentCityResponseDTOSchema.describe("Takeover information").nullish(),
      annexedDocuments: z.string().describe("Annexed documents").nullish(),
      carriersObservations: z.string().describe("Carriers observations").nullish(),
      senderInstructions: z.string().describe("Sender instructions").nullish(),
      reimbursement: z.string().describe("Reimbursement information").nullish(),
      specialAgreements: z.string().describe("Special agreements").nullish(),
      ...
      freightPaid: z.boolean().describe("Whether freight is paid"),
      freightToBePaid: z.boolean().describe("Whether freight is to be paid"),
      creationPlace: z.string().describe("Place of creation"),
      creationDate: z.string().describe("Date of creation"),
      costsForShipper: CmrDocumentCostsResponseDTOSchema.describe("Costs for shipper").nullish(),
      costsForConsignee: CmrDocumentCostsResponseDTOSchema.describe("Costs for consignee").nullish(),
      selectedCargoIds: z.array(z.string()).readonly().describe("List of selected cargo IDs"),
      cargo: z.array(CmrDocumentCargoResponseDTOSchema).readonly().describe("List of cargo information").nullish(),
      ...
      settings: CmrDocumentSettingsDtoDTOSchema.describe("Settings for the BL Instructions document").nullish(),
    })
    .readonly();
   ...
   * @property { CmrDocumentLanguage } secondaryLanguage Secondary language
   */
  export const UpdateCmrDocumentSettingsRequestDTOSchema = z
    .object({
      primaryLanguage: CmrDocumentLanguageSchema.describe("Primary language"),
      secondaryLanguage: CmrDocumentLanguageSchema.describe("Secondary language"),
    })
   ...
   */
  export const UpdateCmrDocumentBusinessPartnerRequestDTOSchema = z
    .object({
      id: z.string().describe("Business partner ID"),
      address: z.string().describe("Business partner address"),
    })
    .readonly();
  export type UpdateCmrDocumentBusinessPartnerRequestDTO = z.infer<
    typeof UpdateCmrDocumentBusinessPartnerRequestDTOSchema
  >;
   ...
   */
  export const UpdateCmrDocumentDeliveryRequestDTOSchema = z
    .object({
   ...
   */
  export const UpdateCmrDocumentCostsRequestDTOSchema = z
    .object({
      carriageCharges: z.number().describe("Carriage charges"),
      reductions: z.number().describe("Reductions"),
      balance: z.number().describe("Balance"),
      supplements: z.number().describe("Supplements"),
      miscellaneous: z.number().describe("Miscellaneous"),
   ...
   */
  export const UpdateCmrDocumentRequestDTOSchema = z
    .object({
      nameSuffix: z.string().describe("Name suffix"),
      cmrNumber: z.string().describe("CMR number"),
      consignee: UpdateCmrDocumentBusinessPartnerRequestDTOSchema.describe("Consignee information"),
      shipper: UpdateCmrDocumentBusinessPartnerRequestDTOSchema.describe("Shipper information"),
      carrier: UpdateCmrDocumentBusinessPartnerRequestDTOSchema.describe("Carrier information"),
      successiveCarrier: UpdateCmrDocumentBusinessPartnerRequestDTOSchema.describe("Successive carrier information"),
      delivery: UpdateCmrDocumentDeliveryRequestDTOSchema.describe("Delivery information"),
      takeover: UpdateCmrDocumentDeliveryRequestDTOSchema.describe("Takeover information"),
      annexedDocuments: z.string().describe("Annexed documents"),
      carriersObservations: z.string().describe("Carriers observations"),
      senderInstructions: z.string().describe("Sender instructions"),
      reimbursement: z.string().describe("Reimbursement"),
      specialAgreements: z.string().describe("Special agreements"),
      suppressWeight: z.boolean().describe("Whether to suppress weight information"),
      suppressMeasurement: z.boolean().describe("Whether to suppress measurement information"),
      freightPaid: z.boolean().describe("Whether freight is paid"),
      freightToBePaid: z.boolean().describe("Whether freight is to be paid"),
      creationPlace: z.string().describe("Place of creation"),
      creationDate: z.string().describe("Date of creation"),
      costsForShipper: UpdateCmrDocumentCostsRequestDTOSchema.describe("Costs for shipper"),
      costsForConsignee: UpdateCmrDocumentCostsRequestDTOSchema.describe("Costs for consignee"),
      selectedCargoIds: z.array(z.string()).readonly().describe("Selected cargo IDs"),
      ...
      settings: UpdateCmrDocumentSettingsRequestDTOSchema.describe("Settings"),
    })
    .readonly();
