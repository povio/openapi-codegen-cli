...
export namespace WorkingDocumentsCmrFormAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Create",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetCmrData = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Read",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateCmrData = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Update",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteCmr = (object?: { officeId: string }) =>
    ["Delete", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Delete",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewCmr = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Read",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateCmr = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-cmr-form", object) : "WorkingDocument-cmr-form"] as AbilityTuple<
      "Update",
      "WorkingDocument-cmr-form" | (ForcedSubject<"WorkingDocument-cmr-form"> & { officeId: string })
    >;
