...
export namespace QuoteRoutesQueries {
  ...
  export const keys = {
    ...
    listRoutes: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/routes", officeId, quoteId] as const,
  };
  ...
  export const useListRoutes = <TData>(
    ...
    options?: AppQueryOptions<typeof QuoteRoutesApi.listRoutes, TData>,
  ...
  export const useCreateRoutePoint = (
    options?: AppMutationOptions<
      typeof QuoteRoutesApi.createRoutePoint,
      { officeId: string; quoteId: string; routeId: string; data: CommonModels.CreateRoutePointRequestDto }
    > &
  ...
  export const useUpdateRoutePoint = (
    options?: AppMutationOptions<
      typeof QuoteRoutesApi.updateRoutePoint,
      {
        officeId: string;
        quoteId: string;
        routeId: string;
  ...
  export const useDeleteRoutePoint = (
    options?: AppMutationOptions<
      typeof QuoteRoutesApi.deleteRoutePoint,
      { officeId: string; quoteId: string; routeId: string; pointId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useSplitRoutes = (
    options?: AppMutationOptions<typeof QuoteRoutesApi.splitRoutes, { officeId: string; quoteId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useMergeRoutes = (
    options?: AppMutationOptions<
      typeof QuoteRoutesApi.mergeRoutes,
      { officeId: string; quoteId: string; data: CommonModels.MergeRoutesRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useCopyRoute = (
    options?: AppMutationOptions<
      typeof QuoteRoutesApi.copyRoute,
      { officeId: string; quoteId: string; routeId: string; data: CommonModels.CopyRouteRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
