...
export namespace EmploymentModels {
   ...
   */
  export const EmploymentFilterDtoSchema = z
    .object({ officeId: z.string().describe("Office IDs"), employeeId: z.string().describe("Employee IDs") })
    .readonly();
   ...
   */
  export const EmploymentRoleMemberResponseSchema = z
    .object({
      roleId: z.string(),
   ...
   */
  export const EmploymentRoleMembershipsUpdateRequestSchema = z
   ...
   */
  export const UpdateEmploymentRequestDtoSchema = z
    .object({ costCenter: z.string(), roleIds: z.array(z.string()).readonly() })
    .readonly();
   ...
   * @type { array }
   */
  export const EmploymentListPopulateParamSchema = z
    .array(EmploymentPaginationPopulateFieldsSchema)
    .readonly()
    .nullish();
  ...
  export const EmploymentListResponseSchema = z.object({
    ...
    ...z.object({ items: z.array(CommonModels.EmploymentResponseSchema).readonly() }).readonly().shape,
  });
   ...
   */
  export const EmploymentListRolesResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmploymentRoleMemberResponseSchema).readonly() }).readonly().shape,
  });
   ...
   * @property { EmploymentRoleMemberResponse[] } items
   */
  export const EmploymentUpdateRolesResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(EmploymentRoleMemberResponseSchema).readonly() }).readonly().shape,
  });
