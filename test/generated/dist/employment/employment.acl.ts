...
export namespace EmploymentAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "Create",
      "Employment" | (ForcedSubject<"Employment"> & { officeId: string })
    >;
  ...
  export const canUseList = (object?: { officeId?: string }) =>
    ["Read", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "Read",
      "Employment" | (ForcedSubject<"Employment"> & { officeId?: string })
    >;
   ...
   */
  export const canUseListRoles = (object?: { officeId: string }) =>
    ["ListRoles", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "ListRoles",
      "Employment" | (ForcedSubject<"Employment"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateRoles = (object?: { officeId: string }) =>
    ["UpdateRoles", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "UpdateRoles",
      "Employment" | (ForcedSubject<"Employment"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "Archive",
      "Employment" | (ForcedSubject<"Employment"> & { officeId: string })
    >;
  ...
  export const canUseUnarchive = (object?: { officeId: string }) =>
    ["Unarchive", object ? subject("Employment", object) : "Employment"] as AbilityTuple<
      "Unarchive",
      "Employment" | (ForcedSubject<"Employment"> & { officeId: string })
    >;
}
