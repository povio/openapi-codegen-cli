...
export namespace CustomersQueries {
  ...
  export const keys = {
    ...
    list: (
      limit?: number,
      order?: string,
      filter?: CustomersModels.CustomerPaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/customers", limit, order, filter, page, cursor] as const,
    listInfinite: (
      limit?: number,
      order?: string,
      filter?: CustomersModels.CustomerPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/customers", "infinite", limit, order, filter, cursor] as const,
   ...
   * @statusCodes [200, 401]
   */
  export const useFindProfile = <TData>(
    options?: AppQueryOptions<typeof CustomersApi.findProfile, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.findProfile(),
      queryFn: () => CustomersApi.findProfile(config),
      ...options,
    });
  };
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof CustomersApi.create, { data: CustomersModels.CreateCustomerDTO }> &
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof CustomersApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useListInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CustomersModels.CustomerPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CustomersApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof CustomersApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof CustomersApi.update,
      { customerId: string; data: CustomersModels.UpdateCustomerDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDeactivate = (
    options?: AppMutationOptions<typeof CustomersApi.deactivate, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useReactivate = (
    options?: AppMutationOptions<typeof CustomersApi.reactivate, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
