...
export namespace FoldersModels {
   ...
   */
  export const FolderSymlinkResponseDTOSchema = z
    .object({ targetEntityName: TargetEntityNameEnumSchema, targetEntityId: z.string() })
    .readonly();
   ...
   */
  export const FolderTreeResponseDTOSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      isSystem: z.boolean(),
      isSymlink: z.boolean(),
      symlink: FolderSymlinkResponseDTOSchema.nullable(),
      get folders() {
        return z.array(FolderTreeResponseDTOSchema).readonly();
      },
    })
    .readonly();
   ...
   */
  export const FolderResponseDTOSchema = z
    .object({
      id: z.string(),
      name: z.string(),
      archived: z.boolean(),
      ...
      createdBy: CommonModels.FolderEmployeeDTOSchema,
      updatedBy: CommonModels.FolderEmployeeDTOSchema,
      files: z.array(CommonModels.FileResponseDTOSchema).readonly(),
      get folders() {
        return z.array(FolderResponseDTOSchema).readonly();
      },
    })
    .readonly();
   ...
   */
  export const FolderContentFilterDtoSchema = z
    .object({ archived: z.boolean().describe("When omitted, both archived and unarchived files are returned.") })
    .readonly();
   ...
   */
  export const MoveFoldersRequestDTOSchema = z
    .object({ folderIds: z.array(z.string()).readonly().min(1), targetFolderId: z.string() })
    .readonly();
   ...
   */
  export const GetContentOrderParamSchema = z
    .array(z.string())
    .readonly()
    .describe("Order by fields (comma separated with +/- prefix): name, createdAt")
    .nullish();
