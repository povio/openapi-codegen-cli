...
export namespace ChecklistTemplatesAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("ChecklistTemplate", object) : "ChecklistTemplate"] as AbilityTuple<
      "Create",
      "ChecklistTemplate" | (ForcedSubject<"ChecklistTemplate"> & { officeId: string })
    >;
  ...
  export const canUsePaginate = (object?: { officeId: string }) =>
    ["Read", object ? subject("ChecklistTemplate", object) : "ChecklistTemplate"] as AbilityTuple<
      "Read",
      "ChecklistTemplate" | (ForcedSubject<"ChecklistTemplate"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("ChecklistTemplate", object) : "ChecklistTemplate"] as AbilityTuple<
      "Update",
      "ChecklistTemplate" | (ForcedSubject<"ChecklistTemplate"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("ChecklistTemplate", object) : "ChecklistTemplate"] as AbilityTuple<
      "Archive",
      "ChecklistTemplate" | (ForcedSubject<"ChecklistTemplate"> & { officeId: string })
    >;
