...
export namespace DepotsAcl {
   ...
   */
  export const canUseCreate = () => ["Create", "Depot"] as AbilityTuple<"Create", "Depot">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "Depot"] as AbilityTuple<"Read", "Depot">;
   ...
   */
  export const canUseFindById = () => ["Read", "Depot"] as AbilityTuple<"Read", "Depot">;
   ...
   */
  export const canUseUpdate = () => ["Update", "Depot"] as AbilityTuple<"Update", "Depot">;
   ...
   */
  export const canUseArchive = () => ["Archive", "Depot"] as AbilityTuple<"Archive", "Depot">;
   ...
   */
  export const canUseUnarchive = () => ["Archive", "Depot"] as AbilityTuple<"Archive", "Depot">;
}
