...
export namespace QuoteConversionQueries {
   ...
   */
  export const useConvertQuoteToPosition = (
    options?: AppMutationOptions<
      typeof QuoteConversionApi.convertQuoteToPosition,
      { officeId: string; quoteId: string; data: QuoteConversionModels.ConvertQuoteToPositionRequestDto }
    > &
