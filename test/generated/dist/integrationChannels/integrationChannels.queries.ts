...
export namespace IntegrationChannelsQueries {
  ...
  export const keys = {
    ...
    list: (
      ...
      limit?: number,
      order?: string,
      filter?: IntegrationChannelsModels.IntegrationChannelFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [...keys.all, "/offices/:officeId/integration-channels", officeId, limit, order, filter, page, cursor] as const,
    listInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
    ...
    findById: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/integration-channels/:id", officeId, id] as const,
    listMessages: (
      officeId: string,
      id: string,
      limit?: number,
      order?: string,
      filter?: IntegrationChannelsModels.IntegrationMessageFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof IntegrationChannelsApi.list, TData>,
  ...
  export const useListInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof IntegrationChannelsApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof IntegrationChannelsApi.create,
      { officeId: string; data: IntegrationChannelsModels.CreateIntegrationChannelRequestDto }
    > &
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof IntegrationChannelsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof IntegrationChannelsApi.update,
      { officeId: string; id: string; data: IntegrationChannelsModels.UpdateIntegrationChannelRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof IntegrationChannelsApi.archive, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof IntegrationChannelsApi.unarchive, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useTestConnection = (
    options?: AppMutationOptions<typeof IntegrationChannelsApi.testConnection, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useListMessages = <TData>(
    {
      officeId,
      id,
      limit,
    ...
    options?: AppQueryOptions<typeof IntegrationChannelsApi.listMessages, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useListMessagesInfinite = <TData>(
    {
      officeId,
      id,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof IntegrationChannelsApi.listMessages, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
