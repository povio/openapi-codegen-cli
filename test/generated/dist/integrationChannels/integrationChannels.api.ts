...
export namespace IntegrationChannelsApi {
      ...
      `/offices/${officeId}/integration-channels`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(IntegrationChannelsModels.IntegrationChannelsListOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(IntegrationChannelsModels.IntegrationChannelFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const create = (
    officeId: string,
    data: IntegrationChannelsModels.CreateIntegrationChannelRequestDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const update = (
    officeId: string,
    id: string,
    data: IntegrationChannelsModels.UpdateIntegrationChannelRequestDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const listMessages = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/integration-channels/${id}/messages`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(IntegrationChannelsModels.ListMessagesOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(IntegrationChannelsModels.IntegrationMessageFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
