...
export namespace FactoringExportModels {
   ...
   */
  export const FactoringExportBatchResponseDtoSchema = z
    .object({
      id: z.string(),
      officeId: z.string(),
      status: FactoringExportBatchStatusEnumSchema,
      totalInvoices: z.number(),
      totalAmount: z.number(),
      currencyNotation: z.string(),
      jobId: z.string().nullish(),
      eurFileUrl: z.string().nullish(),
      usdFileUrl: z.string().nullish(),
   ...
   */
  export const CreateFactoringExportRequestDtoSchema = z
    .object({
      invoiceDateFrom: z.iso.datetime({ offset: true }).describe("Invoice date from"),
      invoiceDateUntil: z.iso.datetime({ offset: true }).describe("Invoice date until"),
    })
    .readonly();
