...
export namespace PartnerNetworksAcl {
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "PartnerNetwork"] as AbilityTuple<"Read", "PartnerNetwork">;
   ...
   */
  export const canUsePaginate = () => ["Read", "PartnerNetwork"] as AbilityTuple<"Read", "PartnerNetwork">;
   ...
   */
  export const canUseCreate = () => ["Create", "PartnerNetwork"] as AbilityTuple<"Create", "PartnerNetwork">;
   ...
   */
  export const canUseFindById = () => ["Read", "PartnerNetwork"] as AbilityTuple<"Read", "PartnerNetwork">;
   ...
   */
  export const canUseUpdate = () => ["Update", "PartnerNetwork"] as AbilityTuple<"Update", "PartnerNetwork">;
   ...
   */
  export const canUseArchive = () => ["Archive", "PartnerNetwork"] as AbilityTuple<"Archive", "PartnerNetwork">;
   ...
   */
  export const canUseUnarchive = () => ["Archive", "PartnerNetwork"] as AbilityTuple<"Archive", "PartnerNetwork">;
}
