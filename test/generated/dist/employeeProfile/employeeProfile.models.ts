...
export namespace EmployeeProfileModels {
   ...
   */
  export const EmployeeProfileResponseDTOSchema = z
    .object({
      id: z.string(),
      ...
      phone: z.string().describe("Employee phone number").nullish(),
      defaultUrl: z.string().describe("Employee default URL").nullish(),
      locale: CommonModels.LocaleEnumSchema.describe("Employee locale").nullish(),
    })
    .readonly();
   ...
   */
  export const UpdateEmployeeProfileRequestDTOSchema = z
    .object({
      firstName: z.string().describe("Employee first name"),
      lastName: z.string().describe("Employee last name"),
      email: z.email().describe("Employee email address"),
      phone: z.string().describe("Employee phone number"),
      defaultUrl: z.url().describe("Default URL for the employee profile"),
      costCenter: z.string().describe("Employee cost center"),
      locale: CommonModels.LocaleEnumSchema.describe("Employee locale preference"),
    })
    .readonly();
