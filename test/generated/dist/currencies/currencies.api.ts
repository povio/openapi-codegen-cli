...
export namespace CurrenciesApi {
  export const list = (
    ...
    return AppRestClient.get({ resSchema: CurrenciesModels.CurrenciesListResponseSchema }, `/currencies`, {
      ...config,
      params: {
        order: ZodExtended.parse(
          ZodExtended.sortExp(CurrenciesModels.CurrenciesListOrderParamEnumSchema).optional(),
          order,
          { type: "query", name: "order" },
        ),
        filter: ZodExtended.parse(CurrenciesModels.CurrencyPaginationFilterDtoSchema.optional(), filter, {
          type: "query",
          name: "filter",
        }),
  ...
  export const paginateCurrencyLabels = (
    limit: number,
    order?: string,
    filter?: CurrenciesModels.CurrencyPaginationFilterDto,
    page?: number,
    ...
    return AppRestClient.get(
      ...
      `/currencies/labels/paginate`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(CurrenciesModels.PaginateCurrencyLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(CurrenciesModels.CurrencyPaginationFilterDtoSchema.optional(), filter, {
  ...
  export const paginateCurrencyLabelsByOffice = (
    officeId: string,
    limit: number,
    order?: string,
    filter?: CurrenciesModels.CurrencyPaginationFilterDto,
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/currencies/labels/paginate`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(CurrenciesModels.PaginateCurrencyLabelsByOfficeOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(CurrenciesModels.CurrencyPaginationFilterDtoSchema.optional(), filter, {
