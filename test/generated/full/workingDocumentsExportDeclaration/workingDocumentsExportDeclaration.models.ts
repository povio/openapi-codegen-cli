 ...
 */
export const ExportDeclarationDocumentBusinessPartnerResponseDTOSchema = z.object({ id: z.string().describe("ID of the business partner"), name: z.string().describe("Name of the business partner"), address: z.string().describe("Address of the business partner") }).readonly();
 ...
 */
export const ExportDeclarationDocumentRouteResponseDTOSchema = z.object({ pickupDate: z.string().describe("Pickup date"), deliveryDate: z.string().describe("Delivery date"), pickupCity: z.string().describe("Pickup city"), deliveryCity: z.string().describe("Delivery city") }).readonly();
