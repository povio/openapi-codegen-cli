...
export const findAll = (officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const paginate = (officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const create = (officeId: string, data: PositionsModels.CreatePositionRequestDto, config?: AxiosRequestConfig) => {
...
export const listAvailablePartnersFor = (officeId: string, positionId: string, search?: string, useCase?: CommonModels.PositionAvailablePartnersUseCase, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const exportPositions = (officeId: string, data: PositionsModels.PositionExportRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
...
export const update = (officeId: string, positionId: string, data: PositionsModels.UpdatePositionDto, config?: AxiosRequestConfig) => {
...
export const duplicate = (officeId: string, positionId: string, data: PositionsModels.DuplicatePositionRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: CommonModels.PositionCoreResponseDtoSchema },
...
export const linkChild = (officeId: string, positionId: string, data: PositionsModels.LinkChildPositionsRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: z.void() },
...
export const unlinkChild = (officeId: string, positionId: string, data: PositionsModels.UnlinkChildPositionsRequestDto, config?: AxiosRequestConfig) => {
...
export const listChild = (officeId: string, positionId: string, limit: number, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
