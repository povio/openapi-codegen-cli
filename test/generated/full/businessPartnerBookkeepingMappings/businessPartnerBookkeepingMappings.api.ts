...
export const createBookkeepingMapping = (officeId: string, businessPartnerId: string, data: BusinessPartnerBookkeepingMappingsModels.CreateBookkeepingMappingDto, config?: AxiosRequestConfig) => {
...
export const updateBookkeepingMapping = (officeId: string, businessPartnerId: string, data: BusinessPartnerBookkeepingMappingsModels.UpdateBookkeepingMappingRequestDto, config?: AxiosRequestConfig) => {
...
export const updateBookkeepingMappingById = (officeId: string, businessPartnerId: string, id: string, data: BusinessPartnerBookkeepingMappingsModels.UpdateBookkeepingMappingDto, config?: AxiosRequestConfig) => {
    return AppRestClient.patch(
        { resSchema: BusinessPartnerBookkeepingMappingsModels.BusinessPartnerBookkeepingMappingResponseDtoSchema },
...
export const deleteBookkeepingMapping = (officeId: string, businessPartnerId: string, id: string, config?: AxiosRequestConfig) => {
