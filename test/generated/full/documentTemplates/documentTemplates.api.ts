...
export const paginateLabels = (officeId: string, limit: number, order?: string, filter?: DocumentTemplatesModels.DocumentTemplateLabelFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const list = (officeId: string, limit: number, order?: string, filter?: DocumentTemplatesModels.DocumentTemplateFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const create = (officeId: string, data: DocumentTemplatesModels.CreateDocumentTemplateRequestDTO, config?: AxiosRequestConfig) => {
...
export const update = (documentTemplateId: string, officeId: string, data: DocumentTemplatesModels.UpdateDocumentTemplateRequestDTO, config?: AxiosRequestConfig) => {
...
export const addRemarkBlock = (documentTemplateId: string, officeId: string, data: DocumentTemplatesModels.CreateRemarkBlockRequestDTO, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: DocumentTemplatesModels.DocumentTemplateResponseDTOSchema },
...
export const deleteRemarkBlock = (documentTemplateId: string, remarkBlockId: string, officeId: string, config?: AxiosRequestConfig) => {
