...
export const paginate = (officeId: string, limit: number, order?: string, filter?: AWBStocksModels.AWBStockFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const create = (officeId: string, data: AWBStocksModels.CreateAWBStockRequestDTO, config?: AxiosRequestConfig) => {
...
export const update = (stockId: string, officeId: string, data: AWBStocksModels.UpdateAWBStockRequestDTO, config?: AxiosRequestConfig) => {
...
export const generateNextNumber = (officeId: string, data: AWBStocksModels.GenerateAWBNumberRequestDTO, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
