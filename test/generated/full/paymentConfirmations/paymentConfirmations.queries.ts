 ...
 * @statusCodes [200, 401]
 */
export const useGet = <TData>({ officeId, filter, limit, order, page, cursor }: { officeId: string, filter: PaymentConfirmationsModels.PaymentConfirmationItemFilterDto, limit: number, order?: string, page?: number, cursor?: string }, options?: AppQueryOptions<typeof PaymentConfirmationsApi.get, TData>, config?: AxiosRequestConfig) => {
 ...
 * @statusCodes [200, 401]
 */
export const useGetInfinite = <TData>({ officeId, filter, limit, order, cursor }: { officeId: string, filter: PaymentConfirmationsModels.PaymentConfirmationItemFilterDto, limit: number, order?: string, cursor?: string }, options?: AppInfiniteQueryOptions<typeof PaymentConfirmationsApi.get, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
 ...
 */
export const useGenerate = (options?: AppMutationOptions<typeof PaymentConfirmationsApi.generate, { officeId: string, data: PaymentConfirmationsModels.GeneratePaymentConfirmationRequestDto }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
 ...
 * @statusCodes [200, 201, 401]
 */
export const useGetEml = (options?: AppMutationOptions<typeof PaymentConfirmationsApi.getEml, { officeId: string, data: PaymentConfirmationsModels.GeneratePaymentConfirmationRequestDto }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
