...
export const list = (limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const updateRoles = (officeId: string, employmentId: string, data: EmploymentModels.EmploymentRoleMembershipsUpdateRequest, config?: AxiosRequestConfig) => {
...
export const update = (officeId: string, employmentId: string, data: EmploymentModels.UpdateEmploymentRequestDto, config?: AxiosRequestConfig) => {
