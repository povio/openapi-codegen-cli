...
export const paginate = (officeId: string, limit: number, order?: string, filter?: QuotesModels.QuoteFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const listAvailablePartnersFor = (officeId: string, quoteId: string, search?: string, useCase?: CommonModels.PositionAvailablePartnersUseCase, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const exportQuotes = (officeId: string, data: QuotesModels.QuoteExportRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
...
export const update = (officeId: string, quoteId: string, data: QuotesModels.UpdateQuoteRequestDTO, config?: AxiosRequestConfig) => {
...
export const duplicate = (officeId: string, quoteId: string, data: QuotesModels.DuplicateQuoteRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: QuotesModels.QuoteCoreResponseDTOSchema },
...
export const createInvolvedParty = (officeId: string, quoteId: string, data: CommonModels.CreateInvolvedPartyRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
...
export const updateInvolvedParty = (officeId: string, quoteId: string, partyId: string, data: CommonModels.UpdateInvolvedPartyDto, config?: AxiosRequestConfig) => {
    return AppRestClient.patch(
        { resSchema: CommonModels.InvolvedPartyResponseDtoSchema },
...
export const deleteInvolvedParty = (officeId: string, quoteId: string, partyId: string, config?: AxiosRequestConfig) => {
