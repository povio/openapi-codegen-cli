...
export const getHouseBlData = (positionId: string, houseBlId: string, officeId: string, config?: AxiosRequestConfig) => {
...
export const updateHouseBlData = (positionId: string, houseBlId: string, officeId: string, data: WorkingDocumentsHouseBlModels.UpdateHouseBlDocumentRequestDTO, config?: AxiosRequestConfig) => {
...
export const deleteHouseBl = (positionId: string, houseBlId: string, officeId: string, config?: AxiosRequestConfig) => {
...
export const previewHouseBl = (positionId: string, houseBlId: string, officeId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const generateDocumentEml = (positionId: string, houseBlId: string, officeId: string, data: CommonModels.GenerateWorkingDocumentRequestDto, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: z.instanceof(Blob) },
