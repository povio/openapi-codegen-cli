...
export const list = (limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    ...
    return AppRestClient.get(
        ...
        `/employees/roles/labels`,
        {
            ...
            params: {
                ...
                context: ZodExtended.parse(CommonModels.EmployeeRoleContextSchema.optional(), context, { type: "query", name: "context" }),
            },
        }
    )
};
...
export const update = (roleId: string, data: EmployeeRolesModels.EmployeeRoleUpdateRequest, config?: AxiosRequestConfig) => {
...
export const togglePermission = (roleId: string, permission: string, data: EmployeeRolesModels.EmployeeRoleTogglePermissionRequest, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: z.void() },
