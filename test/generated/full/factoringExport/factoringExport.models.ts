 ...
 */
export const CreateFactoringExportRequestDtoSchema = z.object({ invoiceDateFrom: z.iso.datetime({ offset: true }).describe("Invoice date from"), invoiceDateUntil: z.iso.datetime({ offset: true }).describe("Invoice date until") }).readonly();
