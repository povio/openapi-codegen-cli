...
export const createUpload = (officeId: string, folderId: string, data: FilesModels.CreateFileRequestDTO, config?: AxiosRequestConfig) => {
...
export const rename = (officeId: string, fileId: string, data: FilesModels.RenameFileRequestDTO, config?: AxiosRequestConfig) => {
...
export const archive = (officeId: string, data: FilesModels.SetFilesArchivedRequestDTO, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: z.void() },
...
export const unarchive = (officeId: string, data: FilesModels.SetFilesArchivedRequestDTO, config?: AxiosRequestConfig) => {
    return AppRestClient.post(
        { resSchema: z.void() },
