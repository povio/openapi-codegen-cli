 ...
 */
export const InvoiceBusinessPartnerResponseDtoSchema = z.object({ id: z.string(), name: z.string(), matchCode: z.string(), label: z.string() }).readonly();
 ...
 */
export const InvoiceRelatedInvoiceResponseDtoSchema = z.object({ id: z.string(), number: z.string().nullable(), internalNumber: z.string().nullish() }).readonly();
 ...
 */
export const InvoicePartnerDtoSchema = z.object({ id: z.string(), name: z.string(), matchCode: z.string(), label: z.string().describe("Display label: matchCode when office.usePartnerMatchCodes, else name") }).readonly();
 ...
 */
export const InvoiceVatRuleDtoSchema = z.object({ id: z.string(), name: z.string(), matchCode: z.string(), rate: z.number().nullish() }).readonly();
 ...
 */
export const InvoiceConfigDtoSchema = z.object({ footerImageUrl: z.string().nullish(), headerImageUrl: z.string().nullish(), showWatermarkOnDocuments: z.boolean(), locale: CommonModels.LocaleEnumSchema.nullish() }).readonly();
 ...
 */
export const InvoiceCustomerDtoSchema = z.object({ id: z.string(), name: z.string(), matchCode: z.string().nullish(), label: z.string().nullish(), address: z.string().nullish(), vatNumber: z.string(), reference: z.string().nullish(), contact: z.string().nullish(), partnerRegistrationNumber: z.string().nullish() }).readonly();
 ...
 */
export const InvoiceSalesRepDtoSchema = z.object({ id: z.string(), name: z.string(), phoneNumber: z.string().nullish() }).readonly();
 ...
 * @property { string } partnerRegistrationNumber  
 */
export const InvoiceServiceRecipientDtoSchema = z.object({ id: z.string(), name: z.string(), address: z.string().nullish(), vatNumber: z.string(), partnerRegistrationNumber: z.string().nullish() }).readonly();
 ...
 */
export const InvoiceBankAccountDtoSchema = z.object({ id: z.string(), displayValue: z.string(), iban: z.string(), bankName: z.string(), swiftBic: z.string(), name: z.string(), useFooterOnInvoice: z.boolean(), footer: z.object({ mediaUrl: z.string() }).readonly().nullish() }).readonly();
 ...
 */
export const InvoiceRemarksDtoSchema = z.object({ html: z.string(), json: z.object({}).catchall(z.any()).readonly() }).readonly();
 ...
 * @property { string } internalNumber  
 */
export const RelatedInvoiceDetailDtoSchema = z.object({ id: z.string(), number: z.string().nullable(), internalNumber: z.string().nullish() }).readonly();
 ...
 */
export const InvoicePreviewPositionDtoSchema = z.object({ id: z.string(), number: z.string(), externalSystemId: z.string().nullish() }).readonly();
 ...
 * @property { string } label  
 */
export const InvoicePreviewReceiverDtoSchema = z.object({ id: z.string(), name: z.string(), matchCode: z.string(), label: z.string() }).readonly();
 ...
 * @property { string } name  
 */
export const VatRuleLabelResponseDtoSchema = z.object({ id: z.string(), matchCode: z.string(), name: z.string() }).readonly();
 ...
 */
export const InvoiceExportRequestDtoSchema = z.object({ columns: z.array(InvoiceExportColumnSchema).readonly().min(1), order: z.array(z.string()).readonly(), filter: InvoiceExportFilterDtoSchema }).readonly();
 ...
 * @property { string } currencyNotation  
 */
export const UninvoicedChargeTotalAmountDtoSchema = z.object({ amount: z.number(), currencyNotation: z.string() }).readonly();
 ...
 * @property { number } totalItems Total available items 
 */
export const UninvoicedChargeListResponseDtoSchema = z.object({ items: z.array(z.string()).readonly().describe("Items"), totalAmounts: z.array(UninvoicedChargeTotalAmountDtoSchema).readonly(), page: z.number().describe("1-indexed page number to begin from").nullish(), cursor: z.string().describe("ID of item to start after").nullish(), nextCursor: z.string().describe("Cursor for next set of items").nullish(), limit: z.number().describe("Items per response"), totalItems: z.number().describe("Total available items") }).readonly();
 ...
 * @property { string } label Display label: matchCode when office.usePartnerMatchCodes, else name 
 */
export const ReceiverDtoSchema = z.object({ id: z.string().describe("Business Partner ID (Customer or Vendor)"), name: z.string().describe("Business Partner name"), matchCode: z.string().describe("Business Partner match code"), label: z.string().describe("Display label: matchCode when office.usePartnerMatchCodes, else name") }).readonly();
 ...
 * @property { string } matchcode  
 */
export const UninvoicedChargeVatRuleDtoSchema = z.object({ id: z.string(), name: z.string(), matchcode: z.string() }).readonly();
 ...
 */
export const UninvoicedChargeEmployeeDtoSchema = z.object({ id: z.string(), firstName: z.string(), lastName: z.string(), fullName: z.string() }).readonly();
 ...
 * @property { string[] } vatRuleIds  
 */
export const UninvoicedChargesExportFilterDtoSchema = z.object({ direction: CommonModels.InvoiceDirectionEnumSchema.describe("Filter by invoice direction"), chargeItemId: z.string(), receiverIds: z.array(z.string()).readonly(), positionIds: z.array(z.string()).readonly(), chargeTypeIds: z.array(z.string()).readonly(), serviceDate: CommonModels.DateRangeDtoSchema, currencies: z.array(z.string()).readonly(), vatRuleIds: z.array(z.string()).readonly() }).readonly();
 ...
 */
export const UninvoicedChargesExportRequestDtoSchema = z.object({ columns: z.array(UninvoicedChargeExportColumnSchema).readonly().min(1), order: z.array(z.string()).readonly(), filter: UninvoicedChargesExportFilterDtoSchema }).readonly();
 ...
 */
export const CreateDraftInvoiceRequestDtoSchema = z.object({ chargeItemIds: z.array(z.string()).readonly().min(1).describe("Charge item IDs to include in the invoice").nullish(), invoiceType: CommonModels.InvoiceTypeEnumSchema.describe("Type of invoice"), customerId: z.string().describe("Customer ID (required for outgoing invoices)"), direction: CommonModels.InvoiceDirectionEnumSchema.describe("Invoice direction") }).readonly();
 ...
 * @property { any } json.[key]  
 */
export const UpdateInvoiceRemarksDtoSchema = z.object({ html: z.string(), json: z.object({}).catchall(z.any()).readonly() }).readonly();
 ...
 * @property { string } contact  
 */
export const UpdateInvoiceCustomerDtoSchema = z.object({ name: z.string(), reference: z.string(), contact: z.string() }).readonly();
 ...
 * @property { any } json.[key]  
 */
export const FixInvoiceRemarksDtoSchema = z.object({ html: z.string(), json: z.object({}).catchall(z.any()).readonly() }).readonly();
 ...
 */
export const FixInvoiceCustomerDtoSchema = z.object({ reference: z.string().describe("Customer reference number") }).readonly();
 ...
 */
export const UpdateIssuedInvoiceChargesRequestDtoSchema = z.object({ charges: z.array(UpdateIssuedInvoiceChargeRequestDtoSchema).readonly().min(1).describe("Array of charge updates") }).readonly();
 ...
 * @property { string } currencyNotation  
 */
export const UpdateInvoiceChargeRequestDtoSchema = z.object({ positionChargeItemId: z.string().describe("Position charge item ID"), chargeTypeId: z.string().describe("Charge type ID").nullish(), additionalText: z.string().describe("Additional text for the charge").nullish(), quantity: z.number().gte(0).describe("Quantity").nullish(), amount: z.number().gte(0.01).describe("Amount (must be positive)").nullish(), vatRuleId: z.string().describe("VAT rule ID").nullish(), exchangeRate: z.number().nullish(), currencyNotation: z.string().nullish() }).readonly();
 ...
 */
export const UpdateInvoiceChargesRequestDtoSchema = z.object({ charges: z.array(UpdateInvoiceChargeRequestDtoSchema).readonly().min(1).describe("Array of charge updates") }).readonly();
 ...
 * @property { string } receiver Filter by invoice receiver/customer ID (UUID) 
 */
export const InvoiceFilterDtoSchema = z.object({ status: z.array(CommonModels.InvoiceStatusEnumSchema).readonly(), direction: CommonModels.InvoiceDirectionEnumSchema, receiver: z.string().describe("Filter by invoice receiver/customer ID (UUID)") }).readonly();
 ...
 * @property { string } vatRuleId VAT rule ID 
 */
export const UpdateIssuedInvoiceVatRulesRequestDtoSchema = z.object({ positionChargeItemId: z.string().describe("Position charge item ID"), vatRuleId: z.string().describe("VAT rule ID") }).readonly();
 ...
 */
export const PrepareUploadRequestDtoSchema = z.object({ filename: z.string().nullish(), mimeType: z.string(), fileSize: z.number() }).readonly();
 ...
 */
export const InvoiceUploadInstructionsDtoSchema = z.object({ url: z.string().describe("Pre-signed URL for the PUT request to storage"), method: z.string().describe("HTTP method to use for upload") }).readonly();
 ...
 */
export const InvoicesFindResponseSchema = z.object({ ...CommonModels.PaginationDtoSchema.shape, ...z.object({ items: z.array(InvoicePreviewDtoSchema).readonly() }).readonly().shape });
 ...
 */
export const FindByOfficeResponseSchema = z.object({ ...OfficeInvoiceListResponseDtoSchema.shape, ...z.object({ items: z.array(OfficeInvoicePreviewDtoSchema).readonly() }).readonly().shape });
 ...
 */
export const GetUnChargesResponseSchema = z.object({ ...UninvoicedChargeListResponseDtoSchema.shape, ...z.object({ items: z.array(UninvoicedChargeDtoSchema).readonly() }).readonly().shape });
 ...
 */
export const InvoicesListAvailablePartnersForResponseSchema = z.object({ ...CommonModels.PaginationDtoSchema.shape, ...z.object({ items: z.array(CommonModels.BusinessPartnerLabelResponseDTOSchema).readonly() }).readonly().shape });
 ...
 * @property { UninvoicedChargeDto[] } items  
 */
export const GetOfficeUnChargesResponseSchema = z.object({ ...UninvoicedChargeListResponseDtoSchema.shape, ...z.object({ items: z.array(UninvoicedChargeDtoSchema).readonly() }).readonly().shape });
