...
export const canUseCreate = (
  ...
  "Create",
  object ? subject("ChecklistItem", object) : "ChecklistItem"
] as AbilityTuple<"Create", "ChecklistItem" | ForcedSubject<"ChecklistItem"> & { officeId: string, }>;
...
export const canUsePaginate = (
  ...
  "Read",
  object ? subject("ChecklistItem", object) : "ChecklistItem"
] as AbilityTuple<"Read", "ChecklistItem" | ForcedSubject<"ChecklistItem"> & { officeId: string, }>;
...
export const canUseUpdate = (
  ...
  "Update",
  object ? subject("ChecklistItem", object) : "ChecklistItem"
] as AbilityTuple<"Update", "ChecklistItem" | ForcedSubject<"ChecklistItem"> & { officeId: string, }>;
...
export const canUseArchive = (
  ...
  "Archive",
  object ? subject("ChecklistItem", object) : "ChecklistItem"
] as AbilityTuple<"Archive", "ChecklistItem" | ForcedSubject<"ChecklistItem"> & { officeId: string, }>;
