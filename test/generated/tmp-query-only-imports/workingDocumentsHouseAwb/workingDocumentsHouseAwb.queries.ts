...
const getHouseAwbDataQueryOptions = ({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }) => ({
...
export const prefetchGetHouseAwbData = (queryClient: QueryClient, { positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getHouseAwbDataQueryOptions({ positionId, hawbId, officeId }), ...options });
};
...
const previewHouseAwbQueryOptions = ({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }) => ({
...
export const prefetchPreviewHouseAwb = (queryClient: QueryClient, { positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewHouseAwbQueryOptions({ positionId, hawbId, officeId }), ...options });
};
