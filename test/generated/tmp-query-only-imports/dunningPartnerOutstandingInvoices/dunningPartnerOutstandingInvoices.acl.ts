 ...
 */
export const canUseListPartnerOutstandingInvoiceSummaries = (
 ...
 */
export const canUseListPartnerOutstandingInvoices = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseListRecommendedDunningLevels = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
