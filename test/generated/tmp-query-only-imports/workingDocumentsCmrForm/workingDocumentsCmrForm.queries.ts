...
const getCmrDataQueryOptions = ({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }) => ({
...
const previewCmrQueryOptions = ({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }) => ({
