 ...
 */
export const canUseGetBookkeepingMappings = (
 ...
 */
export const canUseCreateBookkeepingMapping = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("BusinessPartnerBookkeeping", object) : "BusinessPartnerBookkeeping"
] as AbilityTuple<"Update", "BusinessPartnerBookkeeping" | ForcedSubject<"BusinessPartnerBookkeeping"> & { officeId: string, }>;
 ...
 */
export const canUseUpdateBookkeepingMapping = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("BusinessPartnerBookkeeping", object) : "BusinessPartnerBookkeeping"
 ...
 */
export const canUseUpdateBookkeepingMappingById = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("BusinessPartnerBookkeeping", object) : "BusinessPartnerBookkeeping"
 ...
 */
export const canUseDeleteBookkeepingMapping = (
  object?: { officeId: string,  } 
) => [
  "Delete",
  object ? subject("BusinessPartnerBookkeeping", object) : "BusinessPartnerBookkeeping"
] as AbilityTuple<"Delete", "BusinessPartnerBookkeeping" | ForcedSubject<"BusinessPartnerBookkeeping"> & { officeId: string, }>;
