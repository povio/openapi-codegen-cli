...
export const canUseCreate = (
  ...
  "Create",
  object ? subject("WorkingDocument-isf-form", object) : "WorkingDocument-isf-form"
] as AbilityTuple<"Create", "WorkingDocument-isf-form" | ForcedSubject<"WorkingDocument-isf-form"> & { officeId: string, }>;
 ...
 */
export const canUseGetIsfData = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("WorkingDocument-isf-form", object) : "WorkingDocument-isf-form"
] as AbilityTuple<"Read", "WorkingDocument-isf-form" | ForcedSubject<"WorkingDocument-isf-form"> & { officeId: string, }>;
 ...
 */
export const canUseUpdateIsfData = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("WorkingDocument-isf-form", object) : "WorkingDocument-isf-form"
] as AbilityTuple<"Update", "WorkingDocument-isf-form" | ForcedSubject<"WorkingDocument-isf-form"> & { officeId: string, }>;
 ...
 */
export const canUseDeleteIsf = (
  object?: { officeId: string,  } 
) => [
  "Delete",
  object ? subject("WorkingDocument-isf-form", object) : "WorkingDocument-isf-form"
] as AbilityTuple<"Delete", "WorkingDocument-isf-form" | ForcedSubject<"WorkingDocument-isf-form"> & { officeId: string, }>;
 ...
 */
export const canUseGenerateIsf = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("WorkingDocument-isf-form", object) : "WorkingDocument-isf-form"
