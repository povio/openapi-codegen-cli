...
const listQueryOptions = ({ positionId, officeId, limit, order, filter, page, cursor }: { positionId: string, officeId: string, limit: number, order?: string, filter?: WorkingDocumentsModels.WorkingDocumentFilterDto, page?: number, cursor?: string }) => ({
...
const listInfiniteQueryOptions = ({ positionId, officeId, limit, order, filter, cursor }: { positionId: string, officeId: string, limit: number, order?: string, filter?: WorkingDocumentsModels.WorkingDocumentFilterDto, cursor?: string }) => ({
...
const findByIdQueryOptions = ({ positionId, id, officeId }: { positionId: string, id: string, officeId: string }) => ({
