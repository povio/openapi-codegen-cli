...
const getQueryOptions = ({ officeId, positionId, id }: { officeId: string, positionId: string, id: string }) => ({
...
export const prefetchGet = (queryClient: QueryClient, { officeId, positionId, id }: { officeId: string, positionId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getQueryOptions({ officeId, positionId, id }), ...options });
};
...
const previewQueryOptions = ({ officeId, positionId, id }: { officeId: string, positionId: string, id: string }) => ({
...
export const prefetchPreview = (queryClient: QueryClient, { officeId, positionId, id }: { officeId: string, positionId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewQueryOptions({ officeId, positionId, id }), ...options });
};
