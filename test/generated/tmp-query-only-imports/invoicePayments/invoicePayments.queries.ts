...
const listOfficePaymentsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }) => ({
...
const listOfficePaymentsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }) => ({
...
const listQueryOptions = ({ officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }) => ({
...
const listInfiniteQueryOptions = ({ officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }) => ({
...
const getPaymentByIdQueryOptions = ({ officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }) => ({
