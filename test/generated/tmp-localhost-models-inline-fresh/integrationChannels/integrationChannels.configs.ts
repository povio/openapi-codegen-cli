...
export const labelsConfig = {
    ...
    readAll: {
        acl: IntegrationChannelsAcl.canUsePaginateLabels,
        schema: CommonModels.LabelResponseDTOSchema,
        paginated: IntegrationChannelsQueries.usePaginateLabels,
        infinite: IntegrationChannelsQueries.usePaginateLabelsInfinite,
        filters: {
            schema: IntegrationChannelsModels.IntegrationChannelLabelsFilterDtoSchema,
            filterDefs: dynamicInputs({
  schema: IntegrationChannelsModels.IntegrationChannelLabelsFilterDtoSchema,
  options: {
    inputs: {
  ...
  options: {
    ...
    sortable: IntegrationChannelsModels.IntegrationChannelsPaginateLabelsOrderParamEnumSchema,
  },
}),
    },
};
