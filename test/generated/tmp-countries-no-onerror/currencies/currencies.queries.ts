...
export const listQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchList = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

export const listInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }) => ({
...
export const prefetchListInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
...
export const paginateCurrencyLabelsQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateCurrencyLabels = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof CurrenciesApi.paginateCurrencyLabels, TData>) => {
  ...
  return useQuery({
    ...paginateCurrencyLabelsQueryOptions({ limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(CurrenciesAcl.canUsePaginateCurrencyLabels());
      return paginateCurrencyLabelsQueryOptions({ limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchPaginateCurrencyLabels = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...paginateCurrencyLabelsQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

export const paginateCurrencyLabelsInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }) => ({
...
export const usePaginateCurrencyLabelsInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof CurrenciesApi.paginateCurrencyLabels, TData>) => {
  ...
  return useInfiniteQuery({
    ...paginateCurrencyLabelsInfiniteQueryOptions({ limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(CurrenciesAcl.canUsePaginateCurrencyLabels());
      return paginateCurrencyLabelsInfiniteQueryOptions({ limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateCurrencyLabelsInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
  void queryClient.prefetchInfiniteQuery({ ...paginateCurrencyLabelsInfiniteQueryOptions({ limit, order, filter, cursor }), ...options });
};

export const getCurrencyByIdQueryOptions = ({ isoCode }: { isoCode: string }) => ({
...
export const useGetCurrencyById = <TData>({ isoCode }: { isoCode: string }, options?: AppQueryOptions<typeof CurrenciesApi.getCurrencyById, TData>) => {
  ...
  return useQuery({
    ...getCurrencyByIdQueryOptions({ isoCode }),
    queryFn: async () => {
    checkAcl(CurrenciesAcl.canUseGetCurrencyById());
      return getCurrencyByIdQueryOptions({ isoCode }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetCurrencyById = (queryClient: QueryClient, { isoCode }: { isoCode: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCurrencyByIdQueryOptions({ isoCode }), ...options });
};
...
export const paginateCurrencyLabelsByOfficeQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateCurrencyLabelsByOffice = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof CurrenciesApi.paginateCurrencyLabelsByOffice, TData>) => {
  ...
  return useQuery({
    ...paginateCurrencyLabelsByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(CurrenciesAcl.canUsePaginateCurrencyLabelsByOffice());
      return paginateCurrencyLabelsByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginateCurrencyLabelsByOffice = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...paginateCurrencyLabelsByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const paginateCurrencyLabelsByOfficeInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }) => ({
...
export const usePaginateCurrencyLabelsByOfficeInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof CurrenciesApi.paginateCurrencyLabelsByOffice, TData>) => {
  ...
  return useInfiniteQuery({
    ...paginateCurrencyLabelsByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(CurrenciesAcl.canUsePaginateCurrencyLabelsByOffice());
      return paginateCurrencyLabelsByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateCurrencyLabelsByOfficeInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: CurrenciesModels.CurrencyPaginationFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
  void queryClient.prefetchInfiniteQuery({ ...paginateCurrencyLabelsByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
