...
export const listDunnings = (officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, page?: number, cursor?: string, ) => {
...
export const createDunningWithInvoices = (partnerId: string, officeId: string, data: DunningManagementModels.CreateDunningWithInvoicesRequestDTO, ) => {
...
export const getDunningEml = (officeId: string, dunningId: string, ) => {
    return AppRestClient.get(
