 ...
 */
export const canUseCreateCurrency = (
) => [
  "Create",
  "Currency"
] as AbilityTuple<"Create", "Currency">;
 ...
 */
export const canUsePaginateCurrencyLabels = (
) => [
  "Read",
  "Currency"
] as AbilityTuple<"Read", "Currency">;
 ...
 */
export const canUseGetCurrencyById = (
) => [
  "Read",
  "Currency"
] as AbilityTuple<"Read", "Currency">;
 ...
 */
export const canUseUpdateCurrency = (
) => [
  "Update",
  "Currency"
] as AbilityTuple<"Update", "Currency">;
 ...
 */
export const canUsePaginateCurrencyLabelsByOffice = (
) => [
  "Read",
  "Currency"
] as AbilityTuple<"Read", "Currency">;
