...
export const canUseList = (
  ...
  "Read",
  object ? subject("Role", object) : "Role"
] as AbilityTuple<"Read", "Role" | ForcedSubject<"Role"> & { context?: string, }>;
 ...
 */
export const canUseLabels = (
) => [
  "Read",
  "Role"
] as AbilityTuple<"Read", "Role">;
 ...
 */
export const canUseDeleteEmployeesRolesByRoleId = (
) => [
  "Delete",
  "Role"
] as AbilityTuple<"Delete", "Role">;
 ...
 */
export const canUseTogglePermission = (
) => [
  "Update",
  "Role"
] as AbilityTuple<"Update", "Role">;
