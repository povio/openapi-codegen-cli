...
export const findAllQueryOptions = ({ officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => findAll(officeId, limit, filter, page, cursor),
});
...
export const prefetchFindAll = (queryClient: QueryClient, { officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...findAllQueryOptions({ officeId, limit, filter, page, cursor }), ...options });
};
...
export const findAllInfiniteQueryOptions = ({ officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => findAll(officeId, limit, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchFindAllInfinite = (queryClient: QueryClient, { officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...findAllInfiniteQueryOptions({ officeId, limit, filter, cursor }), ...options });
};
...
export const prefetchTotalProfit = (queryClient: QueryClient, { officeId }: { officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...totalProfitQueryOptions({ officeId }), ...options });
};
...
export const listAvailablePartnersForQueryOptions = ({ officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }) => ({
  ...
  queryFn: () => listAvailablePartnersFor(officeId, positionId, search, useCase),
});
...
export const prefetchListAvailablePartnersFor = (queryClient: QueryClient, { officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listAvailablePartnersForQueryOptions({ officeId, positionId, search, useCase }), ...options });
};
...
export const getQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
  ...
  queryFn: () => get(officeId, positionId),
});
...
export const prefetchGet = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getQueryOptions({ officeId, positionId }), ...options });
};
...
export const listRouteLabelsQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
  ...
  queryFn: () => listRouteLabels(officeId, positionId),
});
...
export const prefetchListRouteLabels = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listRouteLabelsQueryOptions({ officeId, positionId }), ...options });
};
...
export const getDuplicateDefaultParametersQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
  ...
  queryFn: () => getDuplicateDefaultParameters(officeId, positionId),
});
...
export const prefetchGetDuplicateDefaultParameters = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getDuplicateDefaultParametersQueryOptions({ officeId, positionId }), ...options });
};
...
export const listChildQueryOptions = ({ officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => listChild(officeId, positionId, limit, page, cursor),
});
...
export const prefetchListChild = (queryClient: QueryClient, { officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listChildQueryOptions({ officeId, positionId, limit, page, cursor }), ...options });
};
...
export const listChildInfiniteQueryOptions = ({ officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => listChild(officeId, positionId, limit, pageParam, cursor),
  initialPageParam: 1,
  getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
    const pageParam = page ?? 1;
    return pageParam * limitParam < totalItems ? pageParam + 1 : null;
...
export const prefetchListChildInfinite = (queryClient: QueryClient, { officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listChildInfiniteQueryOptions({ officeId, positionId, limit, cursor }), ...options });
};
