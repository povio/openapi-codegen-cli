...
export const getAMSInstructionsDataQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
  ...
  queryFn: () => getAMSInstructionsData(positionId, amsInstructionsId, officeId),
});
...
export const prefetchGetAMSInstructionsData = (queryClient: QueryClient, { positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getAMSInstructionsDataQueryOptions({ positionId, amsInstructionsId, officeId }), ...options });
};
...
export const previewAMSInstructionsQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
  ...
  queryFn: () => previewAMSInstructions(positionId, amsInstructionsId, officeId),
});
...
export const prefetchPreviewAMSInstructions = (queryClient: QueryClient, { positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...previewAMSInstructionsQueryOptions({ positionId, amsInstructionsId, officeId }), ...options });
};
