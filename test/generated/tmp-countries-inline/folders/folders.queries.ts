...
export const getTreeQueryOptions = ({ officeId, folderId }: { officeId: string, folderId: string }) => ({
  queryKey: keys.getTree(officeId, folderId),
  queryFn: () => getTree(officeId, folderId),
});
...
export const prefetchGetTree = (queryClient: QueryClient, { officeId, folderId }: { officeId: string, folderId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getTreeQueryOptions({ officeId, folderId }), ...options });
};

export const getContentQueryOptions = ({ officeId, folderId, limit, order, filter, page, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, page?: number, cursor?: string }) => ({
  queryKey: keys.getContent(officeId, folderId, limit, order, filter, page, cursor),
  queryFn: () => getContent(officeId, folderId, limit, order, filter, page, cursor),
});
...
export const prefetchGetContent = (queryClient: QueryClient, { officeId, folderId, limit, order, filter, page, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getContentQueryOptions({ officeId, folderId, limit, order, filter, page, cursor }), ...options });
};

export const getContentInfiniteQueryOptions = ({ officeId, folderId, limit, order, filter, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, cursor?: string }) => ({
  queryKey: keys.getContentInfinite(officeId, folderId, limit, order, filter, cursor),
  queryFn: ({ pageParam }: { pageParam: number }) => getContent(officeId, folderId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchGetContentInfinite = (queryClient: QueryClient, { officeId, folderId, limit, order, filter, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getContentInfiniteQueryOptions({ officeId, folderId, limit, order, filter, cursor }), ...options });
};
