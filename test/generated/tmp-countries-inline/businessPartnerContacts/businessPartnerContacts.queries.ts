...
export const getContactsQueryOptions = ({ officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }) => ({
  ...
  queryFn: () => getContacts(officeId, businessPartnerId),
});
...
export const prefetchGetContacts = (queryClient: QueryClient, { officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getContactsQueryOptions({ officeId, businessPartnerId }), ...options });
};
...
export const paginateContactLabelsQueryOptions = ({ officeId, businessPartnerId, limit, order, filter, page, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => paginateContactLabels(officeId, businessPartnerId, limit, order, filter, page, cursor),
});
...
export const prefetchPaginateContactLabels = (queryClient: QueryClient, { officeId, businessPartnerId, limit, order, filter, page, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...paginateContactLabelsQueryOptions({ officeId, businessPartnerId, limit, order, filter, page, cursor }), ...options });
};
...
export const paginateContactLabelsInfiniteQueryOptions = ({ officeId, businessPartnerId, limit, order, filter, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => paginateContactLabels(officeId, businessPartnerId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchPaginateContactLabelsInfinite = (queryClient: QueryClient, { officeId, businessPartnerId, limit, order, filter, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...paginateContactLabelsInfiniteQueryOptions({ officeId, businessPartnerId, limit, order, filter, cursor }), ...options });
};
