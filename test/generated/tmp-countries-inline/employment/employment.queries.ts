...
export const listQueryOptions = ({ limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => list(limit, order, populate, filter, page, cursor),
});
...
export const prefetchList = (queryClient: QueryClient, { limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listQueryOptions({ limit, order, populate, filter, page, cursor }), ...options });
};
...
export const listInfiniteQueryOptions = ({ limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => list(limit, order, populate, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchListInfinite = (queryClient: QueryClient, { limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listInfiniteQueryOptions({ limit, order, populate, filter, cursor }), ...options });
};
...
export const listRolesQueryOptions = ({ officeId, employmentId }: { officeId: string, employmentId: string }) => ({
  ...
  queryFn: () => listRoles(officeId, employmentId),
});
...
export const prefetchListRoles = (queryClient: QueryClient, { officeId, employmentId }: { officeId: string, employmentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listRolesQueryOptions({ officeId, employmentId }), ...options });
};
