...
export const getBlInstructionsDataQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
  ...
  queryFn: () => getBlInstructionsData(positionId, blInstructionsId, officeId),
});
...
export const prefetchGetBlInstructionsData = (queryClient: QueryClient, { positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getBlInstructionsDataQueryOptions({ positionId, blInstructionsId, officeId }), ...options });
};
...
export const previewBlInstructionsQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
  ...
  queryFn: () => previewBlInstructions(positionId, blInstructionsId, officeId),
});
...
export const prefetchPreviewBlInstructions = (queryClient: QueryClient, { positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...previewBlInstructionsQueryOptions({ positionId, blInstructionsId, officeId }), ...options });
};
