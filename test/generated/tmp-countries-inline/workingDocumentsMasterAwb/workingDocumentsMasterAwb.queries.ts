...
export const getMasterAwbDataQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
  ...
  queryFn: () => getMasterAwbData(positionId, mawbId, officeId),
});
...
export const prefetchGetMasterAwbData = (queryClient: QueryClient, { positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getMasterAwbDataQueryOptions({ positionId, mawbId, officeId }), ...options });
};
...
export const previewMasterAwbQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
  ...
  queryFn: () => previewMasterAwb(positionId, mawbId, officeId),
});
...
export const prefetchPreviewMasterAwb = (queryClient: QueryClient, { positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...previewMasterAwbQueryOptions({ positionId, mawbId, officeId }), ...options });
};
