...
export const listCargosByQuoteIdQueryOptions = ({ officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => listCargosByQuoteId(officeId, quoteId, limit, order, page, cursor),
});
...
export const prefetchListCargosByQuoteId = (queryClient: QueryClient, { officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listCargosByQuoteIdQueryOptions({ officeId, quoteId, limit, order, page, cursor }), ...options });
};
...
export const listCargosByQuoteIdInfiniteQueryOptions = ({ officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => listCargosByQuoteId(officeId, quoteId, limit, order, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchListCargosByQuoteIdInfinite = (queryClient: QueryClient, { officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listCargosByQuoteIdInfiniteQueryOptions({ officeId, quoteId, limit, order, cursor }), ...options });
};
...
export const listCargoLabelsQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
  ...
  queryFn: () => listCargoLabels(officeId, quoteId),
});
...
export const prefetchListCargoLabels = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listCargoLabelsQueryOptions({ officeId, quoteId }), ...options });
};
...
export const getCargoSummaryQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
  ...
  queryFn: () => getCargoSummary(officeId, quoteId),
});
...
export const prefetchGetCargoSummary = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getCargoSummaryQueryOptions({ officeId, quoteId }), ...options });
};
...
export const getCargoByIdQueryOptions = ({ officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }) => ({
  ...
  queryFn: () => getCargoById(officeId, quoteId, cargoId),
});
...
export const prefetchGetCargoById = (queryClient: QueryClient, { officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getCargoByIdQueryOptions({ officeId, quoteId, cargoId }), ...options });
};
