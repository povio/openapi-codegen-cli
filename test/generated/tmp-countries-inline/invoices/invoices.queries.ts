...
export const getInvoicesEmlQueryOptions = ({ officeId, invoiceIds }: { officeId: string, invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam }) => ({
  queryKey: keys.getInvoicesEml(officeId, invoiceIds),
  queryFn: () => getInvoicesEml(officeId, invoiceIds),
});
...
export const prefetchGetInvoicesEml = (queryClient: QueryClient, { officeId, invoiceIds }: { officeId: string, invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getInvoicesEmlQueryOptions({ officeId, invoiceIds }), ...options });
};
...
export const findQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, page?: number, cursor?: string }) => ({
  queryKey: keys.find(officeId, positionId, limit, order, filter, page, cursor),
  queryFn: () => find(officeId, positionId, limit, order, filter, page, cursor),
});
...
export const prefetchFind = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...findQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }), ...options });
};

export const findInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, cursor?: string }) => ({
  queryKey: keys.findInfinite(officeId, positionId, limit, order, filter, cursor),
  queryFn: ({ pageParam }: { pageParam: number }) => find(officeId, positionId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchFindInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...findInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }), ...options });
};
...
export const findByOfficeQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }) => ({
  queryKey: keys.findByOffice(officeId, limit, order, filter, page, cursor),
  queryFn: () => findByOffice(officeId, limit, order, filter, page, cursor),
});
 ...
 * @statusCodes [200, 401]
 */
export const useFindByOffice = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof findByOffice, TData>) => {
  const queryConfig = OpenApiQueryConfig.useConfig();
  const { checkAcl } = useAclCheck();
...
export const prefetchFindByOffice = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...findByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const findByOfficeInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }) => ({
  queryKey: keys.findByOfficeInfinite(officeId, limit, order, filter, cursor),
  queryFn: ({ pageParam }: { pageParam: number }) => findByOffice(officeId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
  getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
    const pageParam = page ?? 1;
    return pageParam * limitParam < totalItems ? pageParam + 1 : null;
 ...
 * @statusCodes [200, 401]
 */
export const useFindByOfficeInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof findByOffice, TData>) => {
  const queryConfig = OpenApiQueryConfig.useConfig();
  const { checkAcl } = useAclCheck();
...
export const prefetchFindByOfficeInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...findByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getUnChargesQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, page?: number, cursor?: string }) => ({
  queryKey: keys.getUnCharges(officeId, positionId, limit, order, filter, page, cursor),
  queryFn: () => getUnCharges(officeId, positionId, limit, order, filter, page, cursor),
});
...
export const prefetchGetUnCharges = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getUnChargesQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }), ...options });
};

export const getUnChargesInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, cursor?: string }) => ({
  queryKey: keys.getUnChargesInfinite(officeId, positionId, limit, order, filter, cursor),
  queryFn: ({ pageParam }: { pageParam: number }) => getUnCharges(officeId, positionId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
  getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
    const pageParam = page ?? 1;
    return pageParam * limitParam < totalItems ? pageParam + 1 : null;
...
export const prefetchGetUnChargesInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getUnChargesInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }), ...options });
};

export const listAvailablePartnersForQueryOptions = ({ officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }) => ({
  queryKey: keys.listAvailablePartnersFor(officeId, invoiceId, search, useCase),
  queryFn: () => listAvailablePartnersFor(officeId, invoiceId, search, useCase),
});
 ...
 * @statusCodes [200, 401]
 */
export const useListAvailablePartnersFor = <TData>({ officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }, options?: AppQueryOptions<typeof listAvailablePartnersFor, TData>) => {
  const queryConfig = OpenApiQueryConfig.useConfig();
  const { checkAcl } = useAclCheck();
...
export const prefetchListAvailablePartnersFor = (queryClient: QueryClient, { officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listAvailablePartnersForQueryOptions({ officeId, invoiceId, search, useCase }), ...options });
};

export const getOfficeUnChargesQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, page?: number, cursor?: string }) => ({
  queryKey: keys.getOfficeUnCharges(officeId, limit, order, filter, page, cursor),
  queryFn: () => getOfficeUnCharges(officeId, limit, order, filter, page, cursor),
});
...
export const prefetchGetOfficeUnCharges = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getOfficeUnChargesQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getOfficeUnChargesInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, cursor?: string }) => ({
  queryKey: keys.getOfficeUnChargesInfinite(officeId, limit, order, filter, cursor),
  queryFn: ({ pageParam }: { pageParam: number }) => getOfficeUnCharges(officeId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
  getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
    const pageParam = page ?? 1;
    return pageParam * limitParam < totalItems ? pageParam + 1 : null;
...
export const prefetchGetOfficeUnChargesInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getOfficeUnChargesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getDetailQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
  queryKey: keys.getDetail(officeId, invoiceId),
  queryFn: () => getDetail(officeId, invoiceId),
});
...
export const prefetchGetDetail = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getDetailQueryOptions({ officeId, invoiceId }), ...options });
};
...
export const getPreviewQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
  queryKey: keys.getPreview(officeId, invoiceId),
  queryFn: () => getPreview(officeId, invoiceId),
});
...
export const prefetchGetPreview = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewQueryOptions({ officeId, invoiceId }), ...options });
};
...
export const getInvoiceEmlQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
  queryKey: keys.getInvoiceEml(officeId, invoiceId),
  queryFn: () => getInvoiceEml(officeId, invoiceId),
});
...
export const prefetchGetInvoiceEml = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getInvoiceEmlQueryOptions({ officeId, invoiceId }), ...options });
};
