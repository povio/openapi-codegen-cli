...
export const listOfficePaymentsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => listOfficePayments(officeId, limit, order, filter, page, cursor),
});
...
export const prefetchListOfficePayments = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listOfficePaymentsQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};
...
export const listOfficePaymentsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => listOfficePayments(officeId, limit, order, filter, pageParam, cursor),
  initialPageParam: 1,
...
export const prefetchListOfficePaymentsInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listOfficePaymentsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const listQueryOptions = ({ officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }) => ({
  ...
  queryFn: () => list(officeId, invoiceId, limit, page, cursor),
});
...
export const prefetchList = (queryClient: QueryClient, { officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listQueryOptions({ officeId, invoiceId, limit, page, cursor }), ...options });
};
...
export const listInfiniteQueryOptions = ({ officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }) => ({
  ...
  queryFn: ({ pageParam }: { pageParam: number }) => list(officeId, invoiceId, limit, pageParam, cursor),
  initialPageParam: 1,
  getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
    const pageParam = page ?? 1;
    return pageParam * limitParam < totalItems ? pageParam + 1 : null;
...
export const prefetchListInfinite = (queryClient: QueryClient, { officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listInfiniteQueryOptions({ officeId, invoiceId, limit, cursor }), ...options });
};
...
export const getPaymentByIdQueryOptions = ({ officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }) => ({
  ...
  queryFn: () => getPaymentById(officeId, invoiceId, paymentId),
});
...
export const prefetchGetPaymentById = (queryClient: QueryClient, { officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaymentByIdQueryOptions({ officeId, invoiceId, paymentId }), ...options });
};
