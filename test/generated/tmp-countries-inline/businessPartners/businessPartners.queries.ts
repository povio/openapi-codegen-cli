...
export const paginateQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerFilterDto, page?: number, cursor?: string }) => ({
...
export const paginateInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerFilterDto, cursor?: string }) => ({
...
export const paginateLabelsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto, page?: number, cursor?: string }) => ({
...
export const paginateLabelsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto, cursor?: string }) => ({
...
export const getByIdQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
  queryKey: keys.getById(officeId, id),
  queryFn: () => getById(officeId, id),
});
...
export const prefetchGetById = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getByIdQueryOptions({ officeId, id }), ...options });
};
...
export const getRemarksQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
  queryKey: keys.getRemarks(officeId, id),
  queryFn: () => getRemarks(officeId, id),
});
...
export const prefetchGetRemarks = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getRemarksQueryOptions({ officeId, id }), ...options });
};
...
export const getBasicInfoQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
  queryKey: keys.getBasicInfo(officeId, id),
  queryFn: () => getBasicInfo(officeId, id),
});
...
export const prefetchGetBasicInfo = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getBasicInfoQueryOptions({ officeId, id }), ...options });
};
...
export const getCargoAgentInfoQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
  queryKey: keys.getCargoAgentInfo(officeId, id),
  queryFn: () => getCargoAgentInfo(officeId, id),
});
...
export const prefetchGetCargoAgentInfo = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getCargoAgentInfoQueryOptions({ officeId, id }), ...options });
};
...
export const getCarrierInformationQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
  queryKey: keys.getCarrierInformation(officeId, id),
  queryFn: () => getCarrierInformation(officeId, id),
});
...
export const prefetchGetCarrierInformation = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getCarrierInformationQueryOptions({ officeId, id }), ...options });
};
