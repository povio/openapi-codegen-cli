...
export const listQueryOptions = ({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, page?: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }) => ({
  queryKey: keys.list(officeId, positionId, shippingInstructionsId, limit, page, cursor, filter),
  queryFn: () => list(officeId, positionId, shippingInstructionsId, limit, page, cursor, filter),
});
...
export const prefetchList = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, page?: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...listQueryOptions({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }), ...options });
};

export const listInfiniteQueryOptions = ({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }) => ({
  queryKey: keys.listInfinite(officeId, positionId, shippingInstructionsId, limit, cursor, filter),
  queryFn: ({ pageParam }: { pageParam: number }) => list(officeId, positionId, shippingInstructionsId, limit, pageParam, cursor, filter),
  initialPageParam: 1,
...
export const prefetchListInfinite = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, limit, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...listInfiniteQueryOptions({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }), ...options });
};
...
export const getByIdQueryOptions = ({ officeId, positionId, shippingInstructionsId, messageId }: { officeId: string, positionId: string, shippingInstructionsId: string, messageId: string }) => ({
  queryKey: keys.getById(officeId, positionId, shippingInstructionsId, messageId),
  queryFn: () => getById(officeId, positionId, shippingInstructionsId, messageId),
});
...
export const prefetchGetById = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, messageId }: { officeId: string, positionId: string, shippingInstructionsId: string, messageId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getByIdQueryOptions({ officeId, positionId, shippingInstructionsId, messageId }), ...options });
};
