...
export const getTemplatedDocumentQueryOptions = ({ officeId, positionId, templatedDocumentId }: { officeId: string, positionId: string, templatedDocumentId: string }) => ({
  queryKey: keys.getTemplatedDocument(officeId, positionId, templatedDocumentId),
  queryFn: () => getTemplatedDocument(officeId, positionId, templatedDocumentId),
});
...
export const prefetchGetTemplatedDocument = (queryClient: QueryClient, { officeId, positionId, templatedDocumentId }: { officeId: string, positionId: string, templatedDocumentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getTemplatedDocumentQueryOptions({ officeId, positionId, templatedDocumentId }), ...options });
};
