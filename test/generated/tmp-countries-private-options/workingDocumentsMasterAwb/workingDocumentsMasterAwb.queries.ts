...
const getMasterAwbDataQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
...
const previewMasterAwbQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
