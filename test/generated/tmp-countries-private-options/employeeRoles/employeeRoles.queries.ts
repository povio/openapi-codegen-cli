...
const listQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchList = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

const listInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, cursor?: string }) => ({
...
export const prefetchListInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
...
const labelsQueryOptions = ({ search, context }: { search?: string, context?: EmployeeRolesModels.EmployeeRoleContext }) => ({
...
export const prefetchLabels = (queryClient: QueryClient, { search, context }: { search?: string, context?: EmployeeRolesModels.EmployeeRoleContext }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...labelsQueryOptions({ search, context }), ...options });
};

const findQueryOptions = ({ roleId }: { roleId: string }) => ({
...
export const prefetchFind = (queryClient: QueryClient, { roleId }: { roleId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...findQueryOptions({ roleId }), ...options });
};
...
const paginatePermissionsQueryOptions = ({ roleId }: { roleId: string }) => ({
...
export const prefetchPaginatePermissions = (queryClient: QueryClient, { roleId }: { roleId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...paginatePermissionsQueryOptions({ roleId }), ...options });
};
