...
const getIsfDataQueryOptions = ({ positionId, isfId, officeId }: { positionId: string, isfId: string, officeId: string }) => ({
...
export const prefetchGetIsfData = (queryClient: QueryClient, { positionId, isfId, officeId }: { positionId: string, isfId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getIsfDataQueryOptions({ positionId, isfId, officeId }), ...options });
};
...
const previewIsfQueryOptions = ({ positionId, isfId, officeId }: { positionId: string, isfId: string, officeId: string }) => ({
...
export const prefetchPreviewIsf = (queryClient: QueryClient, { positionId, isfId, officeId }: { positionId: string, isfId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewIsfQueryOptions({ positionId, isfId, officeId }), ...options });
};
