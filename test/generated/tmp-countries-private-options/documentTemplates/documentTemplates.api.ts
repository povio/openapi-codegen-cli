...
export const paginateLabels = (officeId: string, limit: number, order?: string, filter?: DocumentTemplatesModels.DocumentTemplateLabelFilterDto, page?: number, cursor?: string, ) => {
...
export const list = (officeId: string, limit: number, order?: string, filter?: DocumentTemplatesModels.DocumentTemplateFilterDto, page?: number, cursor?: string, ) => {
    return AppRestClient.get(
...
export const findById = (documentTemplateId: string, officeId: string, ) => {
    return AppRestClient.get(
        { resSchema: DocumentTemplatesModels.DocumentTemplateResponseDTOSchema },
...
export const update = (documentTemplateId: string, officeId: string, data: DocumentTemplatesModels.UpdateDocumentTemplateRequestDTO, ) => {
...
export const addRemarkBlock = (documentTemplateId: string, officeId: string, data: DocumentTemplatesModels.CreateRemarkBlockRequestDTO, ) => {
    return AppRestClient.post(
        { resSchema: DocumentTemplatesModels.DocumentTemplateResponseDTOSchema },
...
export const deleteRemarkBlock = (documentTemplateId: string, remarkBlockId: string, officeId: string, ) => {
...
export const archive = (documentTemplateId: string, officeId: string, ) => {
    return AppRestClient.post(
        { resSchema: DocumentTemplatesModels.DocumentTemplateResponseDTOSchema },
...
export const unarchive = (documentTemplateId: string, officeId: string, ) => {
    return AppRestClient.post(
        { resSchema: DocumentTemplatesModels.DocumentTemplateResponseDTOSchema },
