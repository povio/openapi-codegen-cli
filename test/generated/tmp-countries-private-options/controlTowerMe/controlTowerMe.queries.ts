...
export const prefetchGetUserProfile = (queryClient: QueryClient, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getUserProfileQueryOptions(), ...options });
};
