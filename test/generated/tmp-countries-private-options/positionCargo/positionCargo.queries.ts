...
const listCargosByPositionIdQueryOptions = ({ officeId, positionId, limit, order, page, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, page?: number, cursor?: string }) => ({
...
export const prefetchListCargosByPositionId = (queryClient: QueryClient, { officeId, positionId, limit, order, page, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listCargosByPositionIdQueryOptions({ officeId, positionId, limit, order, page, cursor }), ...options });
};

const listCargosByPositionIdInfiniteQueryOptions = ({ officeId, positionId, limit, order, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, cursor?: string }) => ({
...
export const prefetchListCargosByPositionIdInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
  void queryClient.prefetchInfiniteQuery({ ...listCargosByPositionIdInfiniteQueryOptions({ officeId, positionId, limit, order, cursor }), ...options });
};
...
const listCargoLabelsQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const prefetchListCargoLabels = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listCargoLabelsQueryOptions({ officeId, positionId }), ...options });
};

const getCargoSummaryQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const prefetchGetCargoSummary = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCargoSummaryQueryOptions({ officeId, positionId }), ...options });
};

const getCargoByIdQueryOptions = ({ officeId, positionId, cargoId }: { officeId: string, positionId: string, cargoId: string }) => ({
...
export const prefetchGetCargoById = (queryClient: QueryClient, { officeId, positionId, cargoId }: { officeId: string, positionId: string, cargoId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCargoByIdQueryOptions({ officeId, positionId, cargoId }), ...options });
};
