...
const findAllQueryOptions = ({ officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }) => ({
...
const findAllInfiniteQueryOptions = ({ officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }) => ({
...
const paginateQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, page?: number, cursor?: string }) => ({
...
const paginateInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, cursor?: string }) => ({
...
const totalProfitQueryOptions = ({ officeId }: { officeId: string }) => ({
...
const listAvailablePartnersForQueryOptions = ({ officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }) => ({
...
const getQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
const listRouteLabelsQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
const getDuplicateDefaultParametersQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
const listChildQueryOptions = ({ officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }) => ({
...
const listChildInfiniteQueryOptions = ({ officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }) => ({
