...
const getBlInstructionsDataQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
...
const previewBlInstructionsQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
