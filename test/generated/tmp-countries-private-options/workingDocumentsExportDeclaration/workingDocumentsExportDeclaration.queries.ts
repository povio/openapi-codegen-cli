...
const getExportDeclarationDataQueryOptions = ({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }) => ({
...
const previewExportDeclarationQueryOptions = ({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }) => ({
