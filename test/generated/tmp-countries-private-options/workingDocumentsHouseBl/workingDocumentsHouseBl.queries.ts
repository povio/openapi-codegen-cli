...
const getHouseBlDataQueryOptions = ({ positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }) => ({
...
export const prefetchGetHouseBlData = (queryClient: QueryClient, { positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getHouseBlDataQueryOptions({ positionId, houseBlId, officeId }), ...options });
};
...
const previewHouseBlQueryOptions = ({ positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }) => ({
...
export const prefetchPreviewHouseBl = (queryClient: QueryClient, { positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewHouseBlQueryOptions({ positionId, houseBlId, officeId }), ...options });
};
...
const previewHouseBlEmlQueryOptions = ({ positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }) => ({
...
export const prefetchPreviewHouseBlEml = (queryClient: QueryClient, { positionId, houseBlId, officeId }: { positionId: string, houseBlId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewHouseBlEmlQueryOptions({ positionId, houseBlId, officeId }), ...options });
};
