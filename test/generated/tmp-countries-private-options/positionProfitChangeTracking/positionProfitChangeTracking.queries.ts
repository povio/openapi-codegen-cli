...
const findProfitChangeGroupsQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, page?: number, cursor?: string }) => ({
...
const findProfitChangeGroupsInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, cursor?: string }) => ({
...
const findProfitChangeGroupDetailQueryOptions = ({ groupId, officeId, positionId }: { groupId: string, officeId: string, positionId: string }) => ({
