...
export namespace AWBStocksAcl {
  ...
  export const canUsePaginate = (object?: { officeId: string }) =>
    ["Read", object ? subject("AWBStock", object) : "AWBStock"] as AbilityTuple<
      "Read",
      "AWBStock" | (ForcedSubject<"AWBStock"> & { officeId: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("AWBStock", object) : "AWBStock"] as AbilityTuple<
      "Create",
      "AWBStock" | (ForcedSubject<"AWBStock"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("AWBStock", object) : "AWBStock"] as AbilityTuple<
      "Update",
      "AWBStock" | (ForcedSubject<"AWBStock"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateNextNumber = (object?: { officeId: string }) =>
    ["Update", object ? subject("AWBStock", object) : "AWBStock"] as AbilityTuple<
      "Update",
      "AWBStock" | (ForcedSubject<"AWBStock"> & { officeId: string })
    >;
