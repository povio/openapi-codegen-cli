...
export namespace AWBStocksModels {
   ...
   */
  export const AWBStockBusinessPartnerPreviewDTOSchema = z
    .object({
      id: z.string().describe("Business partner ID"),
      name: z.string().describe("Business partner name"),
      carrierPrefix: z.string().describe("Carrier prefix (3 digits)"),
    })
    .readonly();
   ...
   */
  export const AWBStockEmployeePreviewDTOSchema = z
    .object({ id: z.string().describe("Employee ID"), email: z.string().describe("Employee email") })
    .readonly();
   ...
   */
  export const AWBStockResponseDTOSchema = z
    .object({
      id: z.string().describe("AWB stock ID"),
      carrier: AWBStockBusinessPartnerPreviewDTOSchema.describe("Carrier business partner"),
      startNumber: z.number().describe("Start number"),
      lastUsedNumber: z.number().describe("Last used number").nullish(),
      stock: z.number().describe("Stock size"),
      usedCodes: z.number().describe("Used codes count"),
      priority: z.number().describe("Priority"),
      archived: z.boolean().describe("Is archived"),
      comments: z.string().describe("Comments").nullish(),
      createdAt: z.iso.datetime({ offset: true }).describe("Created at"),
      updatedAt: z.iso.datetime({ offset: true }).describe("Updated at"),
      createdBy: AWBStockEmployeePreviewDTOSchema.describe("User who created the stock"),
      updatedBy: AWBStockEmployeePreviewDTOSchema.describe("User who updated the stock").nullish(),
   ...
   */
  export const AWBStockFilterDtoSchema = z
    .object({ archived: z.boolean(), carrierId: z.string(), searchQuery: z.string(), used: z.boolean() })
    .readonly();
   ...
   * @property { string } officeId Office ID
   */
  export const CreateAWBStockRequestDTOSchema = z
    .object({
      carrierId: z.string().describe("Carrier business partner ID"),
      startNumber: z.number().gte(0).describe("Start number"),
      stock: z.number().describe("Stock size"),
      priority: z.number().describe("Priority"),
      comments: z.string().describe("Comments").nullish(),
      officeId: z.string().describe("Office ID"),
   ...
   */
  export const GenerateAWBNumberRequestDTOSchema = z
    .object({ carrierId: z.string().describe("Carrier ID") })
    .readonly();
   ...
   */
  export const GenerateAWBNumberResponseDTOSchema = z
    .object({ formattedAwbNumber: z.string().describe("Generated AWB number") })
    .readonly();
   ...
   * @type { enum }
   */
  export const AWBStocksPaginateOrderParamEnumSchema = z.enum([
    "createdAt",
    "updatedAt",
    "createdBy",
    "updatedBy",
   ...
   */
  export const AWBStocksPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(AWBStockResponseDTOSchema).readonly() }).readonly().shape,
  });
