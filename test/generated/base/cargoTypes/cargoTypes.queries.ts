...
export namespace CargoTypesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      limit?: number,
      order?: string,
      filter?: CargoTypesModels.CargoTypePaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/cargo-types", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: CargoTypesModels.CargoTypePaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/cargo-types", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      filter?: CargoTypesModels.CargoTypeLabelFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/cargo-types/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: CargoTypesModels.CargoTypeLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/cargo-types/labels/paginate", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof CargoTypesApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CargoTypesModels.CargoTypePaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CargoTypesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof CargoTypesApi.create, { data: CargoTypesModels.CreateCargoTypeRequestDTO }> &
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof CargoTypesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CargoTypesModels.CargoTypeLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CargoTypesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof CargoTypesApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof CargoTypesApi.update,
      { id: string; data: CargoTypesModels.UpdateCargoTypeRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof CargoTypesApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof CargoTypesApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
