...
export namespace PartnerNetworksQueries {
  ...
  export const keys = {
    ...
    paginateLabels: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/partner-networks/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: PartnerNetworksModels.PartnerNetworkLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/partner-networks/labels/paginate", "infinite", limit, order, filter, cursor] as const,
    paginate: (
      limit?: number,
      order?: string,
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/partner-networks", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: PartnerNetworksModels.PartnerNetworkPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/partner-networks", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof PartnerNetworksApi.paginateLabels, TData>,
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: PartnerNetworksModels.PartnerNetworkLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof PartnerNetworksApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof PartnerNetworksApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof PartnerNetworksApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof PartnerNetworksApi.create,
      { data: PartnerNetworksModels.CreatePartnerNetworkRequestDTO }
    > &
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof PartnerNetworksApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof PartnerNetworksApi.update,
      { id: string; data: PartnerNetworksModels.UpdatePartnerNetworkRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof PartnerNetworksApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof PartnerNetworksApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
