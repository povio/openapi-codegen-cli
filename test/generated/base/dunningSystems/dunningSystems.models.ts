...
export namespace DunningSystemsModels {
   ...
   */
  export const DunningSystemResponseDTOSchema = z
    .object({
      id: z.string(),
      officeId: z.string(),
      name: z.string(),
      ...
      createdBy: DunningSystemEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: DunningSystemEmployeeDTOSchema.nullish(),
   ...
   * @property { boolean } isDefault
   */
  export const DunningSystemFilterDtoSchema = z
    .object({ search: z.string(), archived: z.boolean(), isDefault: z.boolean() })
    .readonly();
   ...
   */
  export const CreateDunningSystemRequestDTOSchema = z
    .object({
      name: z.string().min(3).max(100).describe("Dunning system name"),
      isDefault: z.boolean().describe("Is default dunning system").nullish(),
    })
    .readonly();
   ...
   * @property { boolean } isDefault Is default dunning system
   */
  export const UpdateDunningSystemRequestDTOSchema = z
    .object({
      name: z.string().min(3).max(100).describe("Dunning system name"),
      isDefault: z.boolean().describe("Is default dunning system"),
    })
    .readonly();
  ...
  export type DunningSystemsPaginateLabelsOrderParamEnum = z.infer<
    typeof DunningSystemsPaginateLabelsOrderParamEnumSchema
  >;
   ...
   */
  export const DunningSystemsPaginateLabelsResponseSchema = z.object({
   ...
   */
  export const DunningSystemsPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(DunningSystemResponseDTOSchema).readonly() }).readonly().shape,
  });
