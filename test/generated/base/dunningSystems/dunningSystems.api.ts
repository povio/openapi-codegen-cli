...
export namespace DunningSystemsApi {
      ...
      `/offices/${officeId}/dunning-systems/paginate/labels`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(DunningSystemsModels.DunningSystemsPaginateLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(DunningSystemsModels.DunningSystemLabelFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const paginate = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/dunning-systems`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(DunningSystemsModels.DunningSystemsPaginateOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(DunningSystemsModels.DunningSystemFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const create = (
    officeId: string,
    data: DunningSystemsModels.CreateDunningSystemRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const update = (
    id: string,
    officeId: string,
    data: DunningSystemsModels.UpdateDunningSystemRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
