...
export namespace PositionChecklistModels {
   ...
   */
  export const PositionChecklistCompletedByResponseDtoSchema = z
   ...
   * @property { string } name
   */
  export const PositionChecklistItemResponseDtoSchema = z
    .object({
      id: z.string(),
      positionId: z.string(),
      ...
      completedBy: PositionChecklistCompletedByResponseDtoSchema.nullable(),
   ...
   */
  export const PositionChecklistResponseDtoSchema = z
    .object({
      items: z.array(PositionChecklistItemResponseDtoSchema).readonly(),
      appliedTemplateIds: z.array(z.string()).readonly(),
    })
    .readonly();
