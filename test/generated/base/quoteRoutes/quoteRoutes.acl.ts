...
export namespace QuoteRoutesAcl {
   ...
   */
  export const canUseListRoutes = (object?: { officeId: string }) =>
   ...
   */
  export const canUseCreateRoutePoint = (object?: { officeId: string }) =>
   ...
   */
  export const canUseUpdateRoutePoint = (object?: { officeId: string }) =>
    ["Update", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Update",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteRoutePoint = (object?: { officeId: string }) =>
    ["Update", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Update",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseSplitRoutes = (object?: { officeId: string }) =>
    ["Update", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Update",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseMergeRoutes = (object?: { officeId: string }) =>
    ["Update", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Update",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
   ...
   */
  export const canUseCopyRoute = (object?: { officeId: string }) =>
    ["Update", object ? subject("Quote", object) : "Quote"] as AbilityTuple<
      "Update",
      "Quote" | (ForcedSubject<"Quote"> & { officeId: string })
    >;
