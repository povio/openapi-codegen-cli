...
export namespace UserActivityModels {
   ...
   */
  export const UserSectionActivityDtoSchema = z
    .object({
      section: z.string().describe("Section name"),
      activityType: ActivityTypeEnumSchema.describe("Type of activity"),
      lastSeen: z.iso.datetime({ offset: true }).describe("Last seen timestamp"),
    })
    .readonly();
   ...
   */
  export const ActiveUserDtoSchema = z
    .object({
      userId: z.string().describe("User ID"),
      firstName: z.string().describe("User first name"),
      lastName: z.string().describe("User last name"),
      userAvatar: z.string().describe("User avatar URL").nullish(),
      section: UserSectionActivityDtoSchema.describe("User section activity"),
      lastSeen: z.iso.datetime({ offset: true }).describe("Last seen timestamp"),
      isCurrentlyActive: z.boolean().describe("Is currently active"),
    })
    .readonly();
   ...
   */
  export const ActivityMetadataDtoSchema = z
    .object({
      totalActiveUsers: z.number().describe("Total number of active users"),
      entityId: z.string().describe("Entity ID"),
      entityType: ActivityEntityTypeEnumSchema.describe("Entity type"),
      activeThresholdMinutes: z.number().describe("Active threshold in minutes"),
    })
    .readonly();
   ...
   */
  export const UserActivityResponseDtoSchema = z
    .object({
      activeUsers: z.array(ActiveUserDtoSchema).readonly().describe("List of active users"),
      metadata: ActivityMetadataDtoSchema.describe("Activity metadata"),
    })
    .readonly();
