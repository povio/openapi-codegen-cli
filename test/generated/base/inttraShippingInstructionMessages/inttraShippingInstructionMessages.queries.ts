...
export namespace InttraShippingInstructionMessagesQueries {
  ...
  export const keys = {
    ...
    list: (
      officeId: string,
      positionId: string,
      shippingInstructionsId: string,
      limit?: number,
      page?: number,
      cursor?: string,
      filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto,
    ) =>
      [
        ...keys.all,
    ...
    getById: (officeId: string, positionId: string, shippingInstructionsId: string, messageId: string) =>
      [
        ...keys.all,
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof InttraShippingInstructionMessagesApi.list, TData>,
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return InttraShippingInstructionMessagesApi.list(
          officeId,
          positionId,
          shippingInstructionsId,
          limit,
  ...
  export const useListInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof InttraShippingInstructionMessagesApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof InttraShippingInstructionMessagesApi.create,
      {
        officeId: string;
        positionId: string;
        shippingInstructionsId: string;
        data: InttraShippingInstructionMessagesModels.CreateShippingInstructionMessageRequestDto;
      }
    > &
  ...
  export const useGetById = <TData>(
    {
      ...
      shippingInstructionsId,
      messageId,
    }: { officeId: string; positionId: string; shippingInstructionsId: string; messageId: string },
    options?: AppQueryOptions<typeof InttraShippingInstructionMessagesApi.getById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return InttraShippingInstructionMessagesApi.getById(
          officeId,
          positionId,
          shippingInstructionsId,
          messageId,
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof InttraShippingInstructionMessagesApi.update,
      {
        officeId: string;
        positionId: string;
        shippingInstructionsId: string;
        messageId: string;
        data: InttraShippingInstructionMessagesModels.UpdateShippingInstructionMessageRequestDto;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, shippingInstructionsId, messageId, data }) => {
        ...
        return InttraShippingInstructionMessagesApi.update(
          officeId,
          positionId,
          shippingInstructionsId,
          messageId,
