...
export namespace WorkingDocumentsFcrFormModels {
   ...
   */
  export const FcrDocumentBusinessPartnerResponseDTOSchema = z
    .object({
   ...
   */
  export const FcrDocumentCargoResponseDTOSchema = z
    .object({
      ...
      quantity: z.number().describe("Quantity of the cargo"),
   ...
   */
  export const FcrDocumentResponseDTOSchema = z
    .object({
      ...
      fcrNumber: z.string().describe("FCR number").nullish(),
      edvNumber: z.string().describe("EDV number").nullish(),
      numberOfOriginals: z.number().describe("Number of originals"),
      placeOfLoading: z.string().describe("Place of loading").nullish(),
      dateOfLoading: z.iso.datetime({ offset: true }).describe("Date of loading").nullish(),
      viaCity: z.string().describe("Via city").nullish(),
      toDestination: z.string().describe("To destination").nullish(),
      transportMode: CommonModels.TransportModeEnumSchema.describe("Transport mode"),
      ...
      issuePlace: z.string().describe("Issue place").nullish(),
      issueDate: z.iso.datetime({ offset: true }).describe("Issue date").nullish(),
      deliveryTerms: z.string().describe("Delivery terms").nullish(),
      shipper: FcrDocumentBusinessPartnerResponseDTOSchema.describe("Shipper information").nullish(),
      consignee: FcrDocumentBusinessPartnerResponseDTOSchema.describe("Consignee information").nullish(),
      cargo: z.array(FcrDocumentCargoResponseDTOSchema).readonly().describe("List of cargo information").nullish(),
   ...
   */
  export const UpdateFcrDocumentRequestDTOSchema = z
    .object({
      nameSuffix: z.string().describe("Name suffix"),
      fcrNumber: z.string().describe("FCR number"),
      edvNumber: z.string().describe("EDV number"),
      numberOfOriginals: z.number().describe("Number of originals"),
      placeOfLoading: z.string().describe("Place of loading"),
      dateOfLoading: z.iso.datetime({ offset: true }).describe("Date of loading"),
      viaCity: z.string().describe("Via city"),
      toDestination: z.string().describe("To destination"),
      transportMode: z.string().describe("Transport mode"),
      issuePlace: z.string().describe("Issue place"),
      issueDate: z.iso.datetime({ offset: true }).describe("Issue date"),
      deliveryTerms: z.string().describe("Delivery terms"),
