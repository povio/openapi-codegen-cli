...
export namespace WorkingDocumentsFcrFormAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Create",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetFcrData = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Read",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateFcrData = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Update",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteFcr = (object?: { officeId: string }) =>
    ["Delete", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Delete",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewFcr = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Read",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateFcr = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-fcr-form", object) : "WorkingDocument-fcr-form"] as AbilityTuple<
      "Update",
      "WorkingDocument-fcr-form" | (ForcedSubject<"WorkingDocument-fcr-form"> & { officeId: string })
    >;
