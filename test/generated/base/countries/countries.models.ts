...
export namespace CountriesModels {
   ...
   */
  export const CountryResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the country"),
      name: z.string().describe("Name of the country"),
      isoCode2: z.string().describe("ISO 2-letter code"),
      isoCode3: z.string().describe("ISO 3-letter code"),
      currencyNotation: z.string().describe("Currency notation"),
      createdById: z.string().nullish(),
      createdBy: CountryEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: CountryEmployeeDTOSchema.nullish(),
   ...
   * @type { enum }
   */
  export const CountriesPaginateOrderParamEnumSchema = z.enum([
    "name",
    "isoCode2",
    "isoCode3",
    "createdAt",
   ...
   */
  export const CountriesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(CountryResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const PaginateCountryLabelsOrderParamEnumSchema = z.enum([
    "name",
    "isoCode2",
    "isoCode3",
    "createdAt",
   ...
   */
  export const PaginateCountryLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
