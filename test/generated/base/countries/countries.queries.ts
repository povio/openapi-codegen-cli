...
export namespace CountriesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/countries/paginate", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: CountriesModels.CountryPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/countries/paginate", "infinite", limit, order, filter, cursor] as const,
    paginateCountryLabels: (
      limit?: number,
      order?: string,
      filter?: CountriesModels.CountryPaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/countries/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateCountryLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: CountriesModels.CountryPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/countries/labels/paginate", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof CountriesApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CountriesModels.CountryPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CountriesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateCountryLabels = <TData>(
    {
      limit,
      order,
      filter,
    ...
    options?: AppQueryOptions<typeof CountriesApi.paginateCountryLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateCountryLabelsInfinite = <TData>(
    {
      limit,
      order,
      filter,
    ...
    options?: AppInfiniteQueryOptions<typeof CountriesApi.paginateCountryLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCountryById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof CountriesApi.getCountryById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
