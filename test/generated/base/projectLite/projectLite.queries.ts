...
export namespace ProjectLiteQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      limit?: number,
      order?: string,
      filter?: ProjectLiteModels.ProjectLiteFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/project-lite", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: ProjectLiteModels.ProjectLiteFilterDto,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/project-lite", "infinite", officeId, limit, order, filter, cursor] as const,
    paginateProjectLabels: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: ProjectLiteModels.ProjectLiteFilterDto,
    ...
    findById: (id: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/project-lite/:id", id, officeId] as const,
  };
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof ProjectLiteApi.create,
      { officeId: string; data: ProjectLiteModels.CreateProjectLiteRequestDTO }
    > &
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof ProjectLiteApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof ProjectLiteApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateProjectLabels = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppQueryOptions<typeof ProjectLiteApi.paginateProjectLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateProjectLabelsInfinite = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppInfiniteQueryOptions<typeof ProjectLiteApi.paginateProjectLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof ProjectLiteApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof ProjectLiteApi.update,
      { id: string; officeId: string; data: ProjectLiteModels.UpdateProjectLiteRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof ProjectLiteApi.archive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof ProjectLiteApi.unarchive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
