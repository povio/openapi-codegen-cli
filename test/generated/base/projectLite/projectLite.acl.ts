...
export namespace ProjectLiteAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("ProjectLite", object) : "ProjectLite"] as AbilityTuple<
      "Create",
      "ProjectLite" | (ForcedSubject<"ProjectLite"> & { officeId: string })
    >;
  ...
  export const canUsePaginate = (object?: { officeId: string }) =>
    ["Read", object ? subject("ProjectLite", object) : "ProjectLite"] as AbilityTuple<
      "Read",
      "ProjectLite" | (ForcedSubject<"ProjectLite"> & { officeId: string })
    >;
   ...
   */
  export const canUsePaginateProjectLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("ProjectLite", object) : "ProjectLite"] as AbilityTuple<
      "Read",
      "ProjectLite" | (ForcedSubject<"ProjectLite"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("ProjectLite", object) : "ProjectLite"] as AbilityTuple<
      "Update",
      "ProjectLite" | (ForcedSubject<"ProjectLite"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("ProjectLite", object) : "ProjectLite"] as AbilityTuple<
      "Archive",
      "ProjectLite" | (ForcedSubject<"ProjectLite"> & { officeId: string })
    >;
