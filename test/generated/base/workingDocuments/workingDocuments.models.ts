...
export namespace WorkingDocumentsModels {
   ...
   */
  export const WorkingDocumentCreatedByResponseDTOSchema = z
    .object({ id: z.string().describe("Employee ID"), name: z.string().describe("Employee name").nullable() })
    .readonly();
   ...
   */
  export const WorkingDocumentResponseDTOSchema = z
    .object({
      id: z.string(),
      positionId: z.string().describe("Position ID"),
      name: z.string().describe("Working document name"),
      nameSuffix: z.string().describe("Working document name suffix").nullish(),
      type: TypeEnumSchema.describe("Working document type"),
      referenceTable: z.string().describe("Reference table"),
      referenceId: z.string().describe("Reference ID"),
      createdById: z.string().describe("Created by"),
      createdAt: z.iso.datetime({ offset: true }).describe("Created at"),
      createdBy: WorkingDocumentCreatedByResponseDTOSchema.describe("Created by"),
    })
    .readonly();
   ...
   */
  export const WorkingDocumentsListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(WorkingDocumentResponseDTOSchema).readonly() }).readonly().shape,
  });
