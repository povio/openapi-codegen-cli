...
export namespace WorkingDocumentsQueries {
  ...
  export const keys = {
    ...
    list: (
      ...
      limit?: number,
      order?: string,
      filter?: WorkingDocumentsModels.WorkingDocumentFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    findById: (positionId: string, id: string, officeId: string) =>
      [
        ...keys.all,
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof WorkingDocumentsApi.list, TData>,
  ...
  export const useListInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof WorkingDocumentsApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { positionId, id, officeId }: { positionId: string; id: string; officeId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
