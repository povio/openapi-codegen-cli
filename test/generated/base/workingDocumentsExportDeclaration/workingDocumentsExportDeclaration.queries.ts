...
export namespace WorkingDocumentsExportDeclarationQueries {
  ...
  export const keys = {
    ...
    getExportDeclarationData: (officeId: string, positionId: string, exportDeclarationId: string) =>
      [
        ...keys.all,
    ...
    previewExportDeclaration: (officeId: string, positionId: string, exportDeclarationId: string) =>
      [
        ...keys.all,
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsExportDeclarationApi.create,
   ...
   * @statusCodes [200, 401]
   */
  export const useGetExportDeclarationData = <TData>(
    {
      officeId,
      positionId,
      exportDeclarationId,
    }: { officeId: string; positionId: string; exportDeclarationId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsExportDeclarationApi.getExportDeclarationData, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return WorkingDocumentsExportDeclarationApi.getExportDeclarationData(
          officeId,
          positionId,
          exportDeclarationId,
          config,
  ...
  export const useUpdateExportDeclarationData = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsExportDeclarationApi.updateExportDeclarationData,
      {
        officeId: string;
        positionId: string;
        exportDeclarationId: string;
        data: WorkingDocumentsExportDeclarationModels.UpdateExportDeclarationDocumentRequestDTO;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, exportDeclarationId, data }) => {
        ...
        return WorkingDocumentsExportDeclarationApi.updateExportDeclarationData(
          officeId,
          positionId,
          exportDeclarationId,
          data,
  ...
  export const useDeleteExportDeclaration = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsExportDeclarationApi.deleteExportDeclaration,
      { positionId: string; exportDeclarationId: string; officeId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ positionId, exportDeclarationId, officeId }) => {
        ...
        return WorkingDocumentsExportDeclarationApi.deleteExportDeclaration(
          positionId,
          exportDeclarationId,
          officeId,
          config,
   ...
   * @statusCodes [200, 401]
   */
  export const usePreviewExportDeclaration = <TData>(
    {
      officeId,
      positionId,
      exportDeclarationId,
    }: { officeId: string; positionId: string; exportDeclarationId: string },
    options?: AppQueryOptions<typeof WorkingDocumentsExportDeclarationApi.previewExportDeclaration, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return WorkingDocumentsExportDeclarationApi.previewExportDeclaration(
          officeId,
          positionId,
          exportDeclarationId,
          config,
  ...
  export const usePreviewExportDeclarationMutation = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsExportDeclarationApi.previewExportDeclaration,
      { officeId: string; positionId: string; exportDeclarationId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
   ...
   * @statusCodes [201, 401]
   */
  export const useGenerateExportDeclaration = (
    options?: AppMutationOptions<
      typeof WorkingDocumentsExportDeclarationApi.generateExportDeclaration,
      {
        officeId: string;
        positionId: string;
        exportDeclarationId: string;
    ...
    return useMutation({
      mutationFn: ({ officeId, positionId, exportDeclarationId, data }) => {
        ...
        return WorkingDocumentsExportDeclarationApi.generateExportDeclaration(
          officeId,
          positionId,
          exportDeclarationId,
          data,
