...
export namespace WarehousesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/warehouses", limit, order, filter, page, cursor] as const,
    paginateInfinite: (limit?: number, order?: string, filter?: WarehousesModels.WarehouseFilterDto, cursor?: string) =>
      [...keys.all, "/warehouses", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/warehouses/paginate/labels", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: WarehousesModels.WarehouseLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/warehouses/paginate/labels", "infinite", limit, order, filter, cursor] as const,
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof WarehousesApi.create, { data: WarehousesModels.CreateWarehouseRequestDTO }> &
  ...
  export const usePaginate = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: WarehousesModels.WarehouseFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof WarehousesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: WarehousesModels.WarehouseFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof WarehousesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof WarehousesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: WarehousesModels.WarehouseLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof WarehousesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof WarehousesApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof WarehousesApi.update,
      { id: string; data: WarehousesModels.UpdateWarehouseRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof WarehousesApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof WarehousesApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
