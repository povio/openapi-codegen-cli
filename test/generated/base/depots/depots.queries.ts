...
export namespace DepotsQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/depots", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: DepotsModels.DepotPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/depots", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/depots/paginate/labels", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: DepotsModels.DepotLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/depots/paginate/labels", "infinite", limit, order, filter, cursor] as const,
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof DepotsApi.create, { data: DepotsModels.CreateDepotRequestDTO }> &
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof DepotsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: DepotsModels.DepotPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof DepotsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabels = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: DepotsModels.DepotLabelFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof DepotsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: DepotsModels.DepotLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof DepotsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof DepotsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<typeof DepotsApi.update, { id: string; data: DepotsModels.UpdateDepotRequestDTO }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof DepotsApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof DepotsApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
