...
export namespace PositionProfitChangeTrackingAcl {
   ...
   */
  export const canUseFindProfitChangeGroups = (object?: { officeId: string; positionId: string }) =>
    ["Read", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Read",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string; positionId: string })
    >;
   ...
   */
  export const canUseFindProfitChangeGroupDetail = (object?: { officeId: string; positionId: string }) =>
    ["Read", object ? subject("PositionAccount", object) : "PositionAccount"] as AbilityTuple<
      "Read",
      "PositionAccount" | (ForcedSubject<"PositionAccount"> & { officeId: string; positionId: string })
    >;
