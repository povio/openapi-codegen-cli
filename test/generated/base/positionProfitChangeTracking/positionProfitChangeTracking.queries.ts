...
export namespace PositionProfitChangeTrackingQueries {
  ...
  export const keys = {
    ...
    findProfitChangeGroupsInfinite: (
      officeId: string,
      positionId: string,
      limit?: number,
      order?: string,
    ...
    findProfitChangeGroupDetail: (groupId: string, officeId: string, positionId: string) =>
      [
        ...keys.all,
  ...
  export const useFindProfitChangeGroups = <TData>(
    ...
    options?: AppQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroups, TData>,
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return PositionProfitChangeTrackingApi.findProfitChangeGroups(
          officeId,
          positionId,
          limit,
          order,
  ...
  export const useFindProfitChangeGroupsInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroups, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindProfitChangeGroupDetail = <TData>(
    { groupId, officeId, positionId }: { groupId: string; officeId: string; positionId: string },
    options?: AppQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroupDetail, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
