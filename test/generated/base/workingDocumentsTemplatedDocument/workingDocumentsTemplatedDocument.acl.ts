...
export namespace WorkingDocumentsTemplatedDocumentAcl {
   ...
   */
  export const canUseGetTemplatedDocument = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-templated-document", object) : "WorkingDocument-templated-document",
    ] as AbilityTuple<
   ...
   */
  export const canUseUpdateTemplatedDocument = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-templated-document", object) : "WorkingDocument-templated-document",
    ] as AbilityTuple<
   ...
   */
  export const canUseDeleteTemplatedDocument = (object?: { officeId: string }) =>
    [
      "Delete",
      object ? subject("WorkingDocument-templated-document", object) : "WorkingDocument-templated-document",
    ] as AbilityTuple<
   ...
   */
  export const canUsePreviewTemplatedDocument = (object?: { officeId: string }) =>
    [
      "Read",
      object ? subject("WorkingDocument-templated-document", object) : "WorkingDocument-templated-document",
    ] as AbilityTuple<
   ...
   */
  export const canUseIssueTemplatedDocument = (object?: { officeId: string }) =>
    [
      "Update",
      object ? subject("WorkingDocument-templated-document", object) : "WorkingDocument-templated-document",
    ] as AbilityTuple<
