...
export namespace PortsModels {
   ...
   */
  export const PortCountryDtoSchema = z
   ...
   */
  export const PortAddressDtoSchema = z
    .object({
      street: z.string().describe("Street address"),
      zip: z.string().describe("ZIP/Postal code"),
      city: PortCityDtoSchema.nullish(),
      district: z.string().describe("District name").nullish(),
      country: PortCountryDtoSchema.nullish(),
    })
    .readonly();
   ...
   */
  export const PortResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the port"),
      name: z.string().describe("Name of the port"),
      matchCode: z.string().describe("Match code for the port"),
      address: PortAddressDtoSchema.describe("Address details of the port"),
      createdById: z.string().nullish(),
      createdBy: PortEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: PortEmployeeDTOSchema.nullish(),
   ...
   */
  export const PortPaginationFilterDtoSchema = z
    .object({ search: z.string().describe("Search term to filter ports by name or match code") })
    .readonly();
   ...
   */
  export const CreatePortRequestDTOSchema = z
    .object({
      name: z.string(),
      matchCode: z.string(),
      street: z.string().describe("Street address"),
   ...
   * @property { string } district
   */
  export const UpdatePortRequestDTOSchema = z
    .object({
      ...
      secondaryStreet: z.string().describe("Updated secondary street"),
      zip: z.string().describe("Updated ZIP/Postal code"),
      cityId: z.string().describe("Updated city id"),
      countryId: z.string().describe("Updated country id"),
      district: z.string(),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const PortsPaginateOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "createdAt",
    "updatedAt",
   ...
   */
  export const PortsPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(PortResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const PortsPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "createdAt",
    "updatedAt",
   ...
   */
  export const PortsPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
