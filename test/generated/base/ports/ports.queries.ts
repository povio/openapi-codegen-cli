...
export namespace PortsQueries {
  ...
  export const keys = {
    ...
    paginate: (
      limit?: number,
      order?: string,
      filter?: PortsModels.PortPaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/ports", limit, order, filter, page, cursor] as const,
    paginateInfinite: (limit?: number, order?: string, filter?: PortsModels.PortPaginationFilterDto, cursor?: string) =>
      [...keys.all, "/ports", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      filter?: PortsModels.PortLabelFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/ports/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: PortsModels.PortLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/ports/labels/paginate", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: PortsModels.PortPaginationFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof PortsApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: PortsModels.PortPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof PortsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof PortsApi.create, { data: PortsModels.CreatePortRequestDTO }> &
  ...
  export const usePaginateLabels = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: PortsModels.PortLabelFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof PortsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: PortsModels.PortLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof PortsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<typeof PortsApi.update, { id: string; data: PortsModels.UpdatePortRequestDTO }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof PortsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
