...
export namespace CustomersModels {
   ...
   */
  export const CustomerProfileResponseDTOSchema = z
    .object({
      ...
      email: z.email().describe("Email of the customer"),
      phone: z.string().describe("Phone number of the customer"),
      companyId: z.string().describe("Company id of the customer").nullish(),
      businessPartnerId: z.string().describe("Business partner id of the customer").nullish(),
      businessPartner: CustomerProfileBusinessPartnerDtoSchema.nullish(),
    })
    .readonly();
   ...
   */
  export const CustomerResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the customer"),
      firstName: z.string().describe("First name of the customer"),
      lastName: z.string().describe("Last name of the customer"),
      ...
      companyId: z.string().describe("Company Id of the customer").nullish(),
      businessPartnerId: z.string().describe("Business partner Id of the customer").nullish(),
      archived: z.boolean().describe("Wether the customer is archived"),
      businessPartner: CustomerBusinessPartnerResponseDtoSchema.nullish(),
    })
    .readonly();
   ...
   */
  export const CustomerListItemDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the customer"),
      firstName: z.string().describe("First name of the customer"),
      lastName: z.string().describe("Last name of the customer"),
      ...
      companyId: z.string().describe("Company id of the customer").nullish(),
      businessPartnerId: z.string().describe("Business partner id of the customer").nullish(),
      businessPartner: CustomerListItemBusinessPartnerDtoSchema.nullish(),
    })
    .readonly();
   ...
   * @property { string } businessPartnerId Business partner id of the customer
   */
  export const CreateCustomerDTOSchema = z
    .object({
      firstName: z.string().describe("First name of the customer"),
      lastName: z.string().describe("Last name of the customer"),
      email: z.email().describe("Email of the customer"),
      phone: z.string().describe("Phone number of the customer").nullish(),
      companyId: z.string().describe("Company id of the customer").nullish(),
      businessPartnerId: z.string().describe("Business partner id of the customer").nullish(),
    })
    .readonly();
   ...
   */
  export const CustomerPaginationFilterDtoSchema = z
    .object({
      firstName: z.string(),
      lastName: z.string(),
      email: z.string(),
  ...
  export const UpdateCustomerDTOSchema = z
    .object({
      ...
      lastName: z.string().describe("Last name of the customer"),
      phone: z.string().describe("Phone number of the customer"),
      companyId: z.string().describe("Company id of the customer"),
      businessPartnerId: z.string().describe("Business partner id of the customer"),
    })
    .readonly();
  ...
  export const CustomersListResponseSchema = z.object({
    ...
    ...z.object({ items: z.array(CustomerListItemDTOSchema).readonly() }).readonly().shape,
  });
