...
export namespace DunningAccountStatementModels {
   ...
   */
  export const AccountStatementPdfPayloadInvoiceDtoSchema = z
    .object({
      number: z.string(),
   ...
   */
  export const AccountStatementInvoicesByCurrencyAndDirectionDtoSchema = z
    .object({
      direction: CommonModels.InvoiceDirectionEnumSchema,
      currency: z.string(),
      invoices: z.array(AccountStatementPdfPayloadInvoiceDtoSchema).readonly(),
      totalOutstandingAmount: z.number(),
    })
    .readonly();
  export type AccountStatementInvoicesByCurrencyAndDirectionDto = z.infer<
    typeof AccountStatementInvoicesByCurrencyAndDirectionDtoSchema
  >;
   ...
   */
  export const AccountStatementPdfPayloadBusinessPartnerDtoSchema = z
    .object({ name: z.string(), address: z.string().nullish(), referenceNumber: z.string().nullish() })
    .readonly();
  export type AccountStatementPdfPayloadBusinessPartnerDto = z.infer<
    typeof AccountStatementPdfPayloadBusinessPartnerDtoSchema
  >;
   ...
   */
  export const AccountStatementPdfPayloadBankAccountDtoSchema = z
   ...
   */
  export const AccountStatementPdfPayloadDTOSchema = z
    .object({
      businessPartner: AccountStatementPdfPayloadBusinessPartnerDtoSchema,
      invoicesByCurrencyAndDirection: z.array(AccountStatementInvoicesByCurrencyAndDirectionDtoSchema).readonly(),
      bankAccount: AccountStatementPdfPayloadBankAccountDtoSchema,
      employeeName: z.string().nullable(),
      config: CommonModels.ConfigBlockDtoSchema,
    })
    .readonly();
   ...
   */
  export const OfficeInvoiceListQueryDtoSchema = z
    .object({
      order: z
        .string()
        .describe(
        ...
        .nullish(),
      filter: CommonModels.OfficeInvoiceFilterDtoSchema.nullish(),
      limit: z.number().gte(1).lte(100).describe("Items per response").default(20),
   ...
   * @type { enum }
   */
  export const GenerateAccountStatementOrderParamEnumSchema = z.enum([
    "invoiceNumber",
    "issuingDate",
    "invoiceType",
    "amount",
