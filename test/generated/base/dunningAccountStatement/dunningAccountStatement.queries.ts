...
export namespace DunningAccountStatementQueries {
  ...
  export const keys = {
    ...
    generateAccountStatementInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: CommonModels.OfficeInvoiceFilterDto,
  ...
  export const useDataGenFake = <TData>(
    options?: AppQueryOptions<typeof DunningAccountStatementApi.dataGenFake, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.dataGenFake(),
      queryFn: () => DunningAccountStatementApi.dataGenFake(config),
      ...options,
    });
  };
   ...
   * @statusCodes [200, 401]
   */
  export const useGenerateAccountStatement = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppQueryOptions<typeof DunningAccountStatementApi.generateAccountStatement, TData>,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return DunningAccountStatementApi.generateAccountStatement(
          officeId,
          limit,
          order,
          filter,
   ...
   * @statusCodes [200, 401]
   */
  export const useGenerateAccountStatementMutation = (
    options?: AppMutationOptions<
      typeof DunningAccountStatementApi.generateAccountStatement,
      {
        officeId: string;
        limit: number;
        order?: string;
   ...
   * @statusCodes [200, 401]
   */
  export const useGenerateAccountStatementInfinite = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppInfiniteQueryOptions<typeof DunningAccountStatementApi.generateAccountStatement, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useGetAccountStatementEml = (
    options?: AppMutationOptions<
      typeof DunningAccountStatementApi.getAccountStatementEml,
      { officeId: string; data: DunningAccountStatementModels.OfficeInvoiceListQueryDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
