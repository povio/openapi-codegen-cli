...
export const listAvailablePartnersFor = (officeId: string, quoteId: string, search?: string, useCase?: CommonModels.PositionAvailablePartnersUseCase, ) => {
    return AppRestClient.get(
...
export const createInvolvedParty = (officeId: string, quoteId: string, data: CommonModels.CreateInvolvedPartyRequestDto, ) => {
    return AppRestClient.post(
...
export const updateInvolvedParty = (officeId: string, quoteId: string, partyId: string, data: CommonModels.UpdateInvolvedPartyDto, ) => {
    return AppRestClient.patch(
        { resSchema: CommonModels.InvolvedPartyResponseDtoSchema },
