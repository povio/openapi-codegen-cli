...
export namespace CurrenciesModels {
   ...
   */
  export const CurrencyResponseDtoSchema = z
    .object({
      isoCode: z.string().describe("isoCode of the currency"),
      name: z.string().describe("Name of the currency"),
      symbol: z.string().describe("Symbol of the currency").nullish(),
      alignment: z.string().describe("Alignment of the currency").nullish(),
      createdById: z.string().describe("ID of the employee who created this currency").nullish(),
      createdBy: CurrencyEmployeeDTOSchema.describe("Employee who created this currency").nullish(),
      createdAt: z.iso.datetime({ offset: true }).describe("Date when the currency was created"),
      updatedById: z.string().describe("ID of the employee who last updated this currency").nullish(),
      updatedBy: CurrencyEmployeeDTOSchema.describe("Employee who last updated this currency").nullish(),
      updatedAt: z.iso.datetime({ offset: true }).describe("Date when the currency was last updated"),
    })
    .readonly();
   ...
   * @property { string } alignment Alignment of the currency
   */
  export const CreateCurrencyRequestDTOSchema = z
    .object({
      isoCode: z.string().describe("Unique identifier for the currency"),
      name: z.string().describe("Name of the currency"),
      symbol: z.string().describe("Symbol of the currency"),
      alignment: z.string().describe("Alignment of the currency"),
    })
    .readonly();
   ...
   * @property { string } name Name of the currency
   */
  export const UpdateCurrencyRequestDTOSchema = z
    .object({ name: z.string().describe("Name of the currency") })
    .readonly();
   ...
   * @type { enum }
   */
  export const CurrenciesListOrderParamEnumSchema = z.enum([
    "isoCode",
    "name",
    "createdAt",
    "updatedAt",
  ...
  export const CurrenciesListResponseSchema = z.object({
    ...
    ...z.object({ items: z.array(CurrencyResponseDtoSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const PaginateCurrencyLabelsOrderParamEnumSchema = z.enum([
    "isoCode",
    "name",
    "createdAt",
    "updatedAt",
   ...
   */
  export const PaginateCurrencyLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
   ...
   * @type { enum }
   */
  export const PaginateCurrencyLabelsByOfficeOrderParamEnumSchema = z.enum([
    "isoCode",
    "name",
    "createdAt",
    "updatedAt",
  ...
  export type PaginateCurrencyLabelsByOfficeOrderParamEnum = z.infer<
    typeof PaginateCurrencyLabelsByOfficeOrderParamEnumSchema
  >;
   ...
   * @property { CommonModels.LabelResponseDTO[] } items
   */
  export const PaginateCurrencyLabelsByOfficeResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(CommonModels.LabelResponseDTOSchema).readonly() }).readonly().shape,
  });
