...
export namespace ContainerYardsQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/container-yards", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: ContainerYardsModels.ContainerYardFilterDto,
      cursor?: string,
    ) => [...keys.all, "/container-yards", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/container-yards/paginate/labels", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: ContainerYardsModels.ContainerYardLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/container-yards/paginate/labels", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof ContainerYardsApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: ContainerYardsModels.ContainerYardFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof ContainerYardsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof ContainerYardsApi.create,
      { data: ContainerYardsModels.CreateContainerYardRequestDTO }
    > &
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof ContainerYardsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: ContainerYardsModels.ContainerYardLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof ContainerYardsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetLabelById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof ContainerYardsApi.getLabelById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof ContainerYardsApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof ContainerYardsApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof ContainerYardsApi.update,
      { id: string; data: ContainerYardsModels.UpdateContainerYardRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof ContainerYardsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
