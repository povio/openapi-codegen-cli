...
export namespace DunningManagementAcl {
   ...
   */
  export const canUseListDunnings = (object?: { officeId: string }) =>
    ["Read", object ? subject("Dunning", object) : "Dunning"] as AbilityTuple<
      "Read",
      "Dunning" | (ForcedSubject<"Dunning"> & { officeId: string })
    >;
   ...
   */
  export const canUseCreateDunningWithInvoices = (object?: { officeId: string }) =>
    ["Create", object ? subject("Dunning", object) : "Dunning"] as AbilityTuple<
      "Create",
      "Dunning" | (ForcedSubject<"Dunning"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetDunningEml = (object?: { officeId: string }) =>
    ["Read", object ? subject("Dunning", object) : "Dunning"] as AbilityTuple<
      "Read",
      "Dunning" | (ForcedSubject<"Dunning"> & { officeId: string })
    >;
