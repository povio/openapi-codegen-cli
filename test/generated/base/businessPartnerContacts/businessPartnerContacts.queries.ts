...
export namespace BusinessPartnerContactsQueries {
  ...
  export const keys = {
    ...
    getContacts: (officeId: string, businessPartnerId: string) =>
      [
        ...keys.all,
   ...
   * @statusCodes [200, 401]
   */
  export const useGetContacts = <TData>(
    { officeId, businessPartnerId }: { officeId: string; businessPartnerId: string },
    options?: AppQueryOptions<typeof BusinessPartnerContactsApi.getContacts, TData>,
  ...
  export const useCreateContact = (
    options?: AppMutationOptions<
      typeof BusinessPartnerContactsApi.createContact,
      {
        officeId: string;
        businessPartnerId: string;
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateContactLabels = <TData>(
    {
      officeId,
      businessPartnerId,
      limit,
    ...
    options?: AppQueryOptions<typeof BusinessPartnerContactsApi.paginateContactLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return BusinessPartnerContactsApi.paginateContactLabels(
          officeId,
          businessPartnerId,
          limit,
          order,
   ...
   * @statusCodes [200, 401]
   */
  export const usePaginateContactLabelsInfinite = <TData>(
    {
      officeId,
      businessPartnerId,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof BusinessPartnerContactsApi.paginateContactLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateContact = (
    options?: AppMutationOptions<
      typeof BusinessPartnerContactsApi.updateContact,
      {
        contactId: string;
        officeId: string;
        businessPartnerId: string;
  ...
  export const useDeleteContact = (
    options?: AppMutationOptions<
      typeof BusinessPartnerContactsApi.deleteContact,
      { contactId: string; officeId: string; businessPartnerId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
