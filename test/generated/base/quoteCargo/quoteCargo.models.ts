...
export namespace QuoteCargoModels {
   ...
   */
  export const ListCargosByQuoteIdOrderParamSchema = z
   ...
   */
  export const ListCargosByQuoteIdResponseSchema = z.object({
   ...
   * @type { array }
   */
  export const QuoteCargoCreateBulkCargosResponseSchema = z
