...
export namespace QuoteCargoQueries {
  ...
  export const keys = {
    ...
    listCargoLabels: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/cargos/labels", officeId, quoteId] as const,
    getCargoSummary: (officeId: string, quoteId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/cargos/summary", officeId, quoteId] as const,
    getCargoById: (officeId: string, quoteId: string, cargoId: string) =>
      [...keys.all, "/offices/:officeId/quotes/:quoteId/cargos/:cargoId", officeId, quoteId, cargoId] as const,
  };
   ...
   * @statusCodes [200, 401]
   */
  export const useListCargosByQuoteId = <TData>(
    {
      officeId,
      quoteId,
      limit,
    ...
    options?: AppQueryOptions<typeof QuoteCargoApi.listCargosByQuoteId, TData>,
   ...
   * @statusCodes [200, 401]
   */
  export const useListCargosByQuoteIdInfinite = <TData>(
    {
      officeId,
      quoteId,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof QuoteCargoApi.listCargosByQuoteId, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useListCargoLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof QuoteCargoApi.listCargoLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useGetCargoSummary = <TData>(
    { officeId, quoteId }: { officeId: string; quoteId: string },
    options?: AppQueryOptions<typeof QuoteCargoApi.getCargoSummary, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useGetCargoById = <TData>(
    { officeId, quoteId, cargoId }: { officeId: string; quoteId: string; cargoId: string },
    options?: AppQueryOptions<typeof QuoteCargoApi.getCargoById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateCargo = (
    options?: AppMutationOptions<
      typeof QuoteCargoApi.updateCargo,
      { officeId: string; quoteId: string; cargoId: string; data: CommonModels.UpdatePositionCargoDTO }
    > &
  ...
  export const useDeleteCargo = (
    options?: AppMutationOptions<
      typeof QuoteCargoApi.deleteCargo,
      { officeId: string; quoteId: string; cargoId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useCreateBulkCargos = (
    options?: AppMutationOptions<
      typeof QuoteCargoApi.createBulkCargos,
      { numberOfCargos: number; officeId: string; quoteId: string; data: CommonModels.CreatePositionCargoDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDuplicateCargo = (
    options?: AppMutationOptions<
      typeof QuoteCargoApi.duplicateCargo,
      { officeId: string; quoteId: string; cargoId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
