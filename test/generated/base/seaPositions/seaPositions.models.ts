...
export namespace SeaPositionsModels {
   ...
   */
  export const SeaPositionResponseDTOSchema = z
    .object({
      id: z.string(),
      bookingMatchingCode: z.string().nullish(),
      houseBillOfLadingNumber: z.string().nullish(),
      masterBillOfLadingNumber: z.string().nullish(),
      hblRequired: z.boolean(),
      mblRequired: z.boolean(),
      ...
      buyServiceContract: z.string().nullish(),
      sellServiceContract: z.string().nullish(),
      quoteReference: z.string().nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedAt: z.iso.datetime({ offset: true }),
      routing: CommonModels.SeaRoutingEnumSchema.nullish(),
      defaultBookingNumber: z
        .string()
        .describe("Default booking number from the port of loading point of the default route")
        .nullish(),
    })
    .readonly();
   ...
   * @property { CommonModels.SeaRoutingEnum } routing
   */
  export const UpdateSeaPositionRequestDTOSchema = z
    .object({
      bookingMatchingCode: z.string(),
      houseBillOfLadingNumber: z.string(),
      mblRequired: z.boolean(),
      hblRequired: z.boolean(),
      masterBillOfLadingNumber: z.string(),
      blfromCostumerDate: z.iso.datetime({ offset: true }),
      blfromCarrierDate: z.iso.datetime({ offset: true }),
      customsDate: z.iso.datetime({ offset: true }),
      vgmCustomerDate: z.iso.datetime({ offset: true }),
      buyServiceContract: z.string(),
      quoteReference: z.string(),
      sellServiceContract: z.string(),
