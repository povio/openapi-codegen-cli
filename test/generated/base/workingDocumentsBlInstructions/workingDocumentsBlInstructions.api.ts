...
export namespace WorkingDocumentsBlInstructionsApi {
  ...
  export const getBlInstructionsData = (
    positionId: string,
  ...
  export const updateBlInstructionsData = (
    positionId: string,
    blInstructionsId: string,
    officeId: string,
  ...
  export const deleteBlInstructions = (
    positionId: string,
    blInstructionsId: string,
    officeId: string,
    config?: AxiosRequestConfig,
  ...
  export const previewBlInstructions = (
    positionId: string,
    blInstructionsId: string,
    officeId: string,
    config?: AxiosRequestConfig,
  ...
  export const generateBlInstructions = (
    positionId: string,
    blInstructionsId: string,
    officeId: string,
