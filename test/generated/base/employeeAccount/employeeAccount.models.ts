...
export namespace EmployeeAccountModels {
   ...
   */
  export const EmployeeAccountEmploymentDtoSchema = z
    .object({ officeId: z.string().describe("Office ID"), officeName: z.string().describe("Office name") })
    .readonly();
   ...
   * @property { string } officeName Office name
   */
  export const EmployeeAccountPrimaryOfficeDtoSchema = z
    .object({ officeId: z.string().describe("Office ID"), officeName: z.string().describe("Office name") })
    .readonly();
   ...
   * @property { string } officeId Office ID
   */
  export const EmployeeAccountRoleDtoSchema = z
    .object({
      name: z.string().describe("Role name"),
      permissions: z.array(z.string()).readonly().describe("Role permissions"),
      officeId: z.string().describe("Office ID").nullish(),
    })
    .readonly();
   ...
   */
  export const EmployeeAccountDtoSchema = z
    .object({
      ...
      settings: z
        ...
        .describe("Employee settings keyed by setting name"),
      id: z.string().describe("Employee ID"),
      email: z.email().describe("Email"),
      firstName: z.string().describe("First name"),
      lastName: z.string().describe("Last name"),
      phone: z.string().describe("Phone number").nullish(),
      employments: z.array(EmployeeAccountEmploymentDtoSchema).readonly().describe("Employments"),
      primaryOffice: EmployeeAccountPrimaryOfficeDtoSchema.describe("Primary office"),
      roles: z.array(EmployeeAccountRoleDtoSchema).readonly().describe("Roles"),
    })
    .readonly();
