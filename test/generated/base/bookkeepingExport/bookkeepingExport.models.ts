...
export namespace BookkeepingExportModels {
   ...
   */
  export const CreateBookkeepingExportBatchRequestDtoSchema = z
    .object({
      format: BookkeepingExportFormatEnumSchema.nullish(),
   ...
   * @type { enum }
   */
  export const BookkeepingExportFileTypeEnumSchema = z.enum([
    "Invoices",
    "BusinessPartners",
    "Report",
    "AbraAddressBook",
    "AbraIssuedInvoices",
    "AbraIssuedInvoiceItems",
    "AbraReceivedInvoices",
    "AbraReceivedInvoiceItems",
    "PantheonInvoicesOutgoingEur",
    "PantheonInvoicesOutgoingUsd",
    "PantheonInvoicesIncomingEur",
    "PantheonInvoicesIncomingUsd",
    "PantheonCostCenters",
  ]);
   ...
   */
  export const BookkeepingExportFileDtoSchema = z
    .object({ variant: BookkeepingExportFileTypeEnumSchema, downloadUrl: z.string().nullable(), fileName: z.string() })
    .readonly();
   ...
   * @type { enum }
   */
  export const BookkeepingExportBatchStatusEnumSchema = z.enum([
    "Initializing",
    "Preparing",
    "Exported",
    "Reverted",
   ...
   */
  export const BookkeepingExportBatchSummaryDtoSchema = z
    .object({
      totalCount: z.number(),
      needsReviewCount: z.number(),
      readyForExportCount: z.number(),
      excludedCount: z.number(),
      invoiceNumberRange: z.object({ from: z.string(), to: z.string() }).readonly().nullish(),
      dateRange: z
   ...
   */
  export const BookkeepingExportBatchDetailsDtoSchema = z
    .object({
      id: z.string(),
      format: BookkeepingExportFormatEnumSchema,
      status: BookkeepingExportBatchStatusEnumSchema,
      totalInvoiceCount: z.number(),
      exportedInvoiceCount: z.number(),
      createdBy: z.object({ id: z.string(), fullName: z.string(), email: z.string() }).readonly(),
      createdAt: z.iso.datetime({ offset: true }),
      exportedAt: z.iso.datetime({ offset: true }).nullish(),
      revertedAt: z.iso.datetime({ offset: true }).nullish(),
      revertedBy: z.object({ id: z.string(), fullName: z.string(), email: z.string() }).readonly().nullish(),
      summary: BookkeepingExportBatchSummaryDtoSchema,
      files: z.array(BookkeepingExportFileDtoSchema).readonly().nullish(),
    })
    .readonly();
   ...
   * @property { BookkeepingExportFormatEnum } format
   */
  export const UpdateBookkeepingExportBatchRequestDtoSchema = z
    .object({ format: BookkeepingExportFormatEnumSchema })
    .readonly();
   ...
   * @property { BookkeepingExportFileDto[] } files
   */
  export const BookkeepingExportBatchPreviewDtoSchema = z
    .object({
      id: z.string(),
      format: BookkeepingExportFormatEnumSchema,
      status: BookkeepingExportBatchStatusEnumSchema,
   ...
   */
  export const BookkeepingExportBatchPreviewFilterDtoSchema = z
    .object({
      createdDate: DateRangeSchema,
      status: z.array(BookkeepingExportBatchStatusEnumSchema).readonly(),
      format: z.array(BookkeepingExportFormatEnumSchema).readonly(),
      createdBy: z.array(z.string()).readonly(),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const BookkeepingExportBatchItemStatusEnumSchema = z.enum([
    "Selected",
    "NeedsReview",
    "ReadyForExport",
    "Exported",
   ...
   */
  export const BookkeepingExportItemDetailDtoSchema = z
    .object({
      id: z.string(),
      invoiceId: z.string(),
      status: BookkeepingExportBatchItemStatusEnumSchema,
      includedInExport: z.boolean(),
      validationIssues: z.array(z.string()).readonly().nullish(),
      invoice: z
        .object({
          invoiceNumber: z.string(),
          issuingDate: z.iso.datetime({ offset: true }),
          currency: z.string(),
          amount: z.number(),
          tax: z.number(),
          vatRules: z.array(z.string()).readonly(),
        })
        .readonly(),
      receiver: z
        .object({
   ...
   * @property { BookkeepingExportBatchItemStatusEnum[] } status
   */
  export const BookkeepingExportItemDetailFilterDtoSchema = z
    .object({ status: z.array(BookkeepingExportBatchItemStatusEnumSchema).readonly() })
    .readonly();
   ...
   */
  export const BookkeepingExportVatLineItemDtoSchema = z
    .object({
      invoiceId: z.string(),
      batchId: z.string(),
   ...
   */
  export const UpdateBookkeepingExportBatchItemRequestDtoSchema = z
    .object({
      includedInExport: z.boolean().describe("Whether the item should be included in the export").nullish(),
      itemIds: z.array(z.string()).readonly(),
      vatOk: z.boolean().nullish(),
      invoiceOk: z.boolean().nullish(),
    })
    .readonly();
  export type UpdateBookkeepingExportBatchItemRequestDto = z.infer<
    typeof UpdateBookkeepingExportBatchItemRequestDtoSchema
  >;
   ...
   */
  export const PaginateBatchesResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(BookkeepingExportBatchPreviewDtoSchema).readonly() }).readonly().shape,
  });
   ...
   */
  export const PaginateBatchItemsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(BookkeepingExportItemDetailDtoSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const GetVatLineItemsOrderParamEnumSchema = z.enum([
    "account",
    "contraAccount",
    "issuingDate",
    "invoiceNumber",
