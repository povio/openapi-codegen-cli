...
export namespace ChecklistTemplatesModels {
   ...
   */
  export const ChecklistTemplateItemResponseDTOSchema = z
    .object({
      checklistItemId: z.string().describe("Checklist item id"),
      order: z.number().describe("Order index"),
      name: z.string().describe("Checklist item name").nullish(),
    })
    .readonly();
   ...
   */
  export const ChecklistTemplateResponseDTOSchema = z
    .object({
      ...
      createdBy: ChecklistTemplateEmployeeDTOSchema.describe("Employee who created this template").nullish(),
      ...
      updatedBy: ChecklistTemplateEmployeeDTOSchema.describe("Employee who last updated this template").nullish(),
      updatedAt: z.iso.datetime({ offset: true }).describe("Updated at"),
      items: z.array(ChecklistTemplateItemResponseDTOSchema).readonly().describe("Ordered items"),
    })
    .readonly();
   ...
   */
  export const CreateChecklistTemplateRequestDTOSchema = z
    .object({ name: z.string().min(3).max(120).describe("Checklist template name") })
    .readonly();
   ...
   */
  export const UpdateChecklistTemplateRequestDTOSchema = z
    .object({
      name: z.string().min(3).max(120).describe("Checklist template name"),
      items: z.array(z.uuid()).readonly().describe("Ordered checklist item ids"),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const ChecklistTemplatesPaginateOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const ChecklistTemplatesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(ChecklistTemplateResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const ChecklistTemplatesPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
  ...
  export type ChecklistTemplatesPaginateLabelsOrderParamEnum = z.infer<
    typeof ChecklistTemplatesPaginateLabelsOrderParamEnumSchema
  >;
  export const ChecklistTemplatesPaginateLabelsOrderParamEnum =
    ChecklistTemplatesPaginateLabelsOrderParamEnumSchema.enum;
   ...
   */
  export const ChecklistTemplatesPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
