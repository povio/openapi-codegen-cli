...
export namespace ChecklistTemplatesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      limit?: number,
      order?: string,
      filter?: ChecklistTemplatesModels.ChecklistTemplateFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/checklist-templates", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
    ...
    paginateLabels: (
      ...
      limit?: number,
      order?: string,
      filter?: ChecklistTemplatesModels.ChecklistTemplateLabelFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    findById: (id: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/checklist-templates/:id", id, officeId] as const,
  };
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof ChecklistTemplatesApi.create,
      { officeId: string; data: ChecklistTemplatesModels.CreateChecklistTemplateRequestDTO }
    > &
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistTemplatesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof ChecklistTemplatesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistTemplatesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof ChecklistTemplatesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistTemplatesApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof ChecklistTemplatesApi.update,
      { id: string; officeId: string; data: ChecklistTemplatesModels.UpdateChecklistTemplateRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof ChecklistTemplatesApi.archive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof ChecklistTemplatesApi.unarchive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
