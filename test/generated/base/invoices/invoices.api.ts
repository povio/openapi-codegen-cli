...
export namespace InvoicesApi {
  export const getInvoicesEml = (
    officeId: string,
    invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.get({ resSchema: z.instanceof(Blob) }, `/offices/${officeId}/invoices/eml`, {
      ...config,
      params: {
        invoiceIds: ZodExtended.parse(InvoicesModels.GetInvoicesEmlInvoiceIdsParamSchema.optional(), invoiceIds, {
          type: "query",
          name: "invoiceIds",
        }),
      },
      ...
      `/offices/${officeId}/positions/${positionId}/invoices`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(InvoicesModels.InvoicesFindOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(InvoicesModels.InvoiceFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const changeIncomingCustomer = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.ChangeInvoiceCustomerRequestDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const findByOffice = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/invoices`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(InvoicesModels.FindByOfficeOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
  ...
  export const createDraft = (
    officeId: string,
    data: InvoicesModels.CreateDraftInvoiceRequestDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const exportInvoices = (
    officeId: string,
    data: InvoicesModels.InvoiceExportRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
  ...
  export const getUnCharges = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/positions/${positionId}/uninvoiced-charges`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(InvoicesModels.GetUnChargesOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(InvoicesModels.UninvoicedChargePaginationDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const getOfficeUnCharges = (
    officeId: string,
    limit: number,
    order?: string,
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/uninvoiced-charges`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(InvoicesModels.GetOfficeUnChargesOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(InvoicesModels.UninvoicedChargesFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const exportUnCharges = (
    officeId: string,
    data: InvoicesModels.UninvoicedChargesExportRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
      { resSchema: z.instanceof(Blob) },
  ...
  export const createDirect = (officeId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.post({ resSchema: z.void() }, `/offices/${officeId}/direct-invoices`, undefined, config);
  };

  export const addChargeToDirect = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.CreateDirectInvoiceChargeRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const updateCharges = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.UpdateInvoiceChargesRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const removeChargeFromDirect = (
    officeId: string,
    invoiceId: string,
    chargeId: string,
    config?: AxiosRequestConfig,
  ...
  export const update = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.UpdateInvoiceRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const fix = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.FixInvoiceRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const updateIssuedVatRules = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.UpdateIssuedInvoiceVatRulesRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const updateIssuedCharges = (
    officeId: string,
    invoiceId: string,
    data: InvoicesModels.UpdateIssuedInvoiceChargesRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.patch(
      { resSchema: InvoicesModels.InvoiceDetailDtoSchema },
  ...
  export const getPreview = (officeId: string, invoiceId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get({ resSchema: z.instanceof(Blob) }, `/offices/${officeId}/invoices/${invoiceId}/preview`, {
      ...config,
      headers: {
        Accept: "application/pdf",
      },
  ...
  export const getInvoiceEml = (officeId: string, invoiceId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get({ resSchema: z.instanceof(Blob) }, `/offices/${officeId}/invoices/${invoiceId}/eml`, {
      ...config,
      headers: {
        Accept: "application/octet-stream",
      },
