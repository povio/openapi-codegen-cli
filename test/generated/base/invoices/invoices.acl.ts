 ...
 */
export const canUseGetInvoicesEml = (
 ...
 */
export const canUseChangeIncomingCustomer = (
  object?: { officeId: string,  } 
) => [
  "Fix",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"Fix", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseFindByOffice = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseCreateDraft = (
  object?: { officeId: string,  } 
) => [
  "Create",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"Create", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseExportInvoices = (
  object?: { officeId: string,  } 
) => [
  "Export",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"Export", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseExportCharges = (
  object?: { officeId: string,  } 
) => [
  "Export",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseGetUnCharges = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseGetOfficeUnCharges = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseExportUnCharges = (
  object?: { officeId: string,  } 
) => [
  "Export",
  object ? subject("UninvoicedCharge", object) : "UninvoicedCharge"
] as AbilityTuple<"Export", "UninvoicedCharge" | ForcedSubject<"UninvoicedCharge"> & { officeId: string, }>;
 ...
 */
export const canUseCreateDirect = (
  object?: { officeId: string,  } 
) => [
  "CreateDirectInvoice",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"CreateDirectInvoice", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseAddChargeToDirect = (
  object?: { officeId: string,  } 
) => [
  "UpdateDirectInvoice",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"UpdateDirectInvoice", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseUpdateCharges = (
  object?: { officeId: string,  } 
) => [
  "Update",
 ...
 */
export const canUseRemoveChargeFromDirect = (
  object?: { officeId: string,  } 
) => [
  "UpdateDirectInvoice",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseDeleteInvoice = (
  object?: { officeId: string,  } 
) => [
  "Delete",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
] as AbilityTuple<"Delete", "PositionInvoice" | ForcedSubject<"PositionInvoice"> & { officeId: string, }>;
 ...
 */
export const canUseUpdateIssuedVatRules = (
  object?: { officeId: string,  } 
) => [
  "Fix",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseUpdateIssuedCharges = (
  object?: { officeId: string,  } 
) => [
  "Fix",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseReportHungarian = (
  object?: { officeId: string,  } 
) => [
  "Fix",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseGetInvoiceEml = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUsePrepareDocumentUpload = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
 ...
 */
export const canUseIssueCreditNote = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("PositionInvoice", object) : "PositionInvoice"
