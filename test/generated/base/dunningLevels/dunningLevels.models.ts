...
export namespace DunningLevelsModels {
   ...
   */
  export const DunningLevelOfficeDTOSchema = z
    .object({ id: z.string(), name: z.string(), currencyNotation: z.string() })
    .readonly();
   ...
   */
  export const DunningLevelResponseDTOSchema = z
    .object({
      id: z.string(),
      level: z.number(),
      ...
      usedInOfficeId: z.string(),
      usedInOffice: DunningLevelOfficeDTOSchema.nullish(),
      dunningSystem: CommonModels.DunningSystemReferenceDTOSchema.nullish(),
      createdById: z.string().nullish(),
      createdBy: DunningLevelEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: DunningLevelEmployeeDTOSchema.nullish(),
   ...
   */
  export const CreateDunningLevelRequestDTOSchema = z
    .object({
      level: z.number().gte(1).describe("Dunning level number"),
      daysOverdue: z.number().gte(1).describe("Days overdue before this level applies"),
      dunningFee: z.number().gte(0).describe("Fee amount for this dunning level"),
      dunningSystemId: z.string().describe("Dunning system ID").nullish(),
      interestRate: z.number().gte(0).lte(100).nullish(),
      bodyRemarks: CommonModels.EditorContentUpdateDtoSchema.describe("Body remarks").nullish(),
      footerRemarks: CommonModels.EditorContentUpdateDtoSchema.describe("Footer remarks").nullish(),
    })
    .readonly();
   ...
   * @property { CommonModels.EditorContentUpdateDto } footerRemarks Footer remarks
   */
  export const UpdateDunningLevelRequestDTOSchema = z
    .object({
      level: z.number().gte(1).describe("Dunning level number"),
      daysOverdue: z.number().gte(1).describe("Days overdue before this level applies"),
      dunningFee: z.number().gte(0).describe("Fee amount for this dunning level"),
      interestRate: z.number().gte(0).lte(100),
   ...
   */
  export const DunningLevelFilterDtoSchema = z
    .object({
      dunningSystemId: z.string().describe("Dunning system ID to filter by"),
   ...
   * @type { enum }
   */
  export const DunningLevelsPaginateLabelsOrderParamEnumSchema = z.enum([
    "level",
    "daysOverdue",
    "dunningFee",
    "createdAt",
  ...
  export type DunningLevelsPaginateLabelsOrderParamEnum = z.infer<
    typeof DunningLevelsPaginateLabelsOrderParamEnumSchema
  >;
   ...
   */
  export const DunningLevelsPaginateLabelsResponseSchema = z.object({
   ...
   * @type { enum }
   */
  export const DunningLevelsListOrderParamEnumSchema = z.enum([
    "level",
    "daysOverdue",
    "dunningFee",
    "createdAt",
   ...
   */
  export const DunningLevelsListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(DunningLevelResponseDTOSchema).readonly() }).readonly().shape,
  });
