...
export namespace DunningLevelsApi {
      ...
      `/offices/${officeId}/dunning-levels/paginate/labels`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(DunningLevelsModels.DunningLevelsPaginateLabelsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(DunningLevelsModels.DunningLevelLabelFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const list = (
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/dunning-levels`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(DunningLevelsModels.DunningLevelsListOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(DunningLevelsModels.DunningLevelFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
          limit: ZodExtended.parse(z.number().gte(1).lte(100).describe("Items per response").default(20), limit, {
  ...
  export const create = (
    officeId: string,
    data: DunningLevelsModels.CreateDunningLevelRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const update = (
    id: string,
    officeId: string,
    data: DunningLevelsModels.UpdateDunningLevelRequestDTO,
    config?: AxiosRequestConfig,
  ) => {
