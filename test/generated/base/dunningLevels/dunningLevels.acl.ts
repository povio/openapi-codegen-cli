...
export namespace DunningLevelsAcl {
  ...
  export const canUsePaginateLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("DunningLevel", object) : "DunningLevel"] as AbilityTuple<
      "Read",
      "DunningLevel" | (ForcedSubject<"DunningLevel"> & { officeId: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("DunningLevel", object) : "DunningLevel"] as AbilityTuple<
      "Create",
      "DunningLevel" | (ForcedSubject<"DunningLevel"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("DunningLevel", object) : "DunningLevel"] as AbilityTuple<
      "Update",
      "DunningLevel" | (ForcedSubject<"DunningLevel"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("DunningLevel", object) : "DunningLevel"] as AbilityTuple<
      "Archive",
      "DunningLevel" | (ForcedSubject<"DunningLevel"> & { officeId: string })
    >;
  ...
  export const canUseUnarchive = (object?: { officeId: string }) =>
    ["Unarchive", object ? subject("DunningLevel", object) : "DunningLevel"] as AbilityTuple<
      "Unarchive",
      "DunningLevel" | (ForcedSubject<"DunningLevel"> & { officeId: string })
    >;
}
