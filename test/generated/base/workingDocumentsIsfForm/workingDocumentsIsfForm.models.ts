...
export namespace WorkingDocumentsIsfFormModels {
   ...
   */
  export const IsfDocumentCargoCountryResponseDTOSchema = z
   ...
   */
  export const IsfDocumentCargoResponseDTOSchema = z
    .object({
      productCode: z.string().describe("Product code of the cargo"),
      descriptionOfGoods: z.string().describe("Description of goods"),
      htsCode: z.string().describe("HTS code of the cargo"),
      manufacturerSupplier: z.string().describe("Manufacturer supplier of the cargo"),
      seal1: z.string().describe("Seal number 1 of the cargo"),
      seal2: z.string().describe("Seal number 2 of the cargo"),
      countryOfOrigin: IsfDocumentCargoCountryResponseDTOSchema.describe("Country of origin of the cargo"),
    })
    .readonly();
   ...
   */
  export const IsfDocumentPortResponseDTOSchema = z
   ...
   */
  export const IsfDocumentBusinessPartnerResponseDTOSchema = z
    .object({
   ...
   */
  export const IsfDocumentContainerLocationResponseDTOSchema = z
    .object({
      id: z.string().describe("ID of the container location"),
      name: z.string().describe("Name of the container location"),
      address: z.string().describe("Address of the container location"),
    })
    .readonly();
   ...
   */
  export const IsfDocumentResponseDTOSchema = z
    .object({
      ...
      vessel: z.string().describe("Vessel name").nullish(),
      voyage: z.string().describe("Voyage number").nullish(),
      hBLNumber: z.string().describe("HBL number").nullish(),
      mBLNumber: z.string().describe("MBL number").nullish(),
      scacCodeHBL: z.string().describe("SCAC code for HBL").nullish(),
      scacCodeMBL: z.string().describe("SCAC code for MBL").nullish(),
      portOfDischarge: IsfDocumentPortResponseDTOSchema.describe("Port of discharge").nullish(),
      issueLocation: z.string().describe("Issue location").nullish(),
      issueDate: z.iso.datetime({ offset: true }).describe("Issue date").nullish(),
      companyName: z.string().describe("Company name").nullish(),
      completedBy: z.object({ name: z.string(), email: z.string() }).readonly().nullish(),
      container: z.object({ id: z.string(), name: z.string() }).readonly().nullish(),
      consignee: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Consignee information").nullish(),
      manufacturer: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Manufacturer information").nullish(),
      seller: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Seller information").nullish(),
      buyer: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Buyer information").nullish(),
      consolidator: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Consolidator information").nullish(),
      containerLocation: IsfDocumentContainerLocationResponseDTOSchema.describe(
        "Container location information",
      ).nullish(),
      shipTo: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Ship to information").nullish(),
      importer: IsfDocumentBusinessPartnerResponseDTOSchema.describe("Importer information").nullish(),
      cargo: z.array(IsfDocumentCargoResponseDTOSchema).readonly().describe("List of cargo information").nullish(),
   ...
   */
  export const UpdateIsfDocumentBusinessPartnerRequestDTOSchema = z
    .object({
      id: z.string().describe("Business partner ID"),
      address: z.string().describe("Business partner address"),
      number: z.string().describe("Business partner number"),
    })
    .readonly();
  export type UpdateIsfDocumentBusinessPartnerRequestDTO = z.infer<
    typeof UpdateIsfDocumentBusinessPartnerRequestDTOSchema
  >;
   ...
   */
  export const UpdateIsfDocumentCargoRequestDTOSchema = z
    .object({
      productCode: z.string().describe("Product code"),
      descriptionOfGoods: z.string().describe("Description of goods"),
      htsCode: z.string().describe("HTS code"),
      manufacturerSupplier: z.string().describe("Manufacturer supplier"),
      countryOfOriginId: z.string().describe("Country of origin ID"),
    })
    .readonly();
   ...
   */
  export const UpdateIsfDocumentRequestDTOSchema = z
    .object({
      nameSuffix: z.string().describe("Name suffix"),
      vessel: z.string().describe("Vessel name"),
      voyage: z.string().describe("Voyage number"),
      hBLNumber: z.string().describe("HBL number"),
      mBLNumber: z.string().describe("MBL number"),
      scacCodeHBL: z.string().describe("SCAC code for HBL"),
      scacCodeMBL: z.string().describe("SCAC code for MBL"),
      portOfDischargeId: z.string().describe("Port of discharge Id"),
      issueLocation: z.string().describe("Issue location"),
      issueDate: z.iso.datetime({ offset: true }).describe("Issue date"),
      companyName: z.string().describe("Company name"),
      completedByName: z.string().describe("Completed by name"),
      completedByEmail: z.string().describe("Completed by email"),
      containerId: z.string().describe("Container ID"),
      consignee: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Consignee information"),
      manufacturer: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Manufacturer information"),
      seller: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Seller information"),
      buyer: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Buyer information"),
      consolidator: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Consolidator information"),
      containerLocation: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Container location information"),
      shipTo: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Ship to information"),
      importer: UpdateIsfDocumentBusinessPartnerRequestDTOSchema.describe("Importer information"),
      cargo: z.array(UpdateIsfDocumentCargoRequestDTOSchema).readonly().describe("Cargo information"),
