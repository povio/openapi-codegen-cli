...
export namespace HsCodesAcl {
   ...
   */
  export const canUsePaginate = () => ["Read", "HsCode"] as AbilityTuple<"Read", "HsCode">;
   ...
   */
  export const canUseCreate = () => ["Create", "HsCode"] as AbilityTuple<"Create", "HsCode">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "HsCode"] as AbilityTuple<"Read", "HsCode">;
   ...
   */
  export const canUseFindById = () => ["Read", "HsCode"] as AbilityTuple<"Read", "HsCode">;
   ...
   */
  export const canUseUpdate = () => ["Update", "HsCode"] as AbilityTuple<"Update", "HsCode">;
   ...
   */
  export const canUseArchive = () => ["Archive", "HsCode"] as AbilityTuple<"Archive", "HsCode">;
   ...
   */
  export const canUseUnarchive = () => ["Archive", "HsCode"] as AbilityTuple<"Archive", "HsCode">;
}
