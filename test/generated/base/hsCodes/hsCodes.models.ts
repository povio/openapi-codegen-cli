...
export namespace HsCodesModels {
   ...
   */
  export const HsCodeResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier for the HS Code"),
      name: z.string().describe("Name of the HS Code"),
      description: z.string().describe("Description of the HS Code"),
      customArea: z.string().describe("Custom area associated with the HS Code"),
      archived: z.boolean().describe("Indicates if the HS Code is archived"),
      createdById: z.string().nullish(),
      createdBy: HsCodeEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: HsCodeEmployeeDTOSchema.nullish(),
   ...
   */
  export const HsCodePaginationFilterDtoSchema = z
    .object({ archived: z.boolean().describe("Archived status"), search: z.string() })
    .readonly();
   ...
   * @property { string } customArea Custom area associated with the HS Code
   */
  export const CreateHsCodeRequestDTOSchema = z
    .object({
      name: z.string().describe("Unique name for the HS Code"),
      description: z.string().describe("Description of the HS Code"),
      customArea: z.string().describe("Custom area associated with the HS Code"),
    })
    .readonly();
   ...
   */
  export const UpdateHsCodeRequestDTOSchema = z
    .object({
      name: z.string().describe("Updated name of the HS Code."),
      description: z.string().describe("Updated description of the HS Code."),
      customArea: z.string().describe("Updated custom area associated with the HS Code."),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const HsCodesPaginateOrderParamEnumSchema = z.enum([
    "matchCode",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const HsCodesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(HsCodeResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const HsCodesPaginateLabelsOrderParamEnumSchema = z.enum([
    "matchCode",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const HsCodesPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
