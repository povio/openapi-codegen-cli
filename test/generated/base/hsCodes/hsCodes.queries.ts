...
export namespace HsCodesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/hs-codes", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: HsCodesModels.HsCodePaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/hs-codes", "infinite", limit, order, filter, cursor] as const,
    paginateLabels: (
      limit?: number,
      order?: string,
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/hs-codes/labels/paginate", limit, order, filter, page, cursor] as const,
    paginateLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: HsCodesModels.HsCodeLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/hs-codes/labels/paginate", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof HsCodesApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: HsCodesModels.HsCodePaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof HsCodesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof HsCodesApi.create, { data: HsCodesModels.CreateHsCodeRequestDTO }> &
  ...
  export const usePaginateLabels = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: HsCodesModels.HsCodeLabelFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof HsCodesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: HsCodesModels.HsCodeLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof HsCodesApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof HsCodesApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<typeof HsCodesApi.update, { id: string; data: HsCodesModels.UpdateHsCodeRequestDTO }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof HsCodesApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof HsCodesApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
