...
export namespace WorkingDocumentsMasterAwbAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Create",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetMasterAwbData = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Read",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateMasterAwbData = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Update",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteMasterAwb = (object?: { officeId: string }) =>
    ["Delete", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Delete",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewMasterAwb = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Read",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateMasterAwb = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-master-awb", object) : "WorkingDocument-master-awb"] as AbilityTuple<
      "Update",
      "WorkingDocument-master-awb" | (ForcedSubject<"WorkingDocument-master-awb"> & { officeId: string })
    >;
