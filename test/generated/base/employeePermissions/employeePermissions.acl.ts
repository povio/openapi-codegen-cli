...
export namespace EmployeePermissionsAcl {
   ...
   */
  export const canUsePaginatePermissions = () => ["Read", "Permission"] as AbilityTuple<"Read", "Permission">;
   ...
   */
  export const canUseFindAll = () => ["Read", "Permission"] as AbilityTuple<"Read", "Permission">;
}
