      ...
      `/employees/permissions`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(
              EmployeePermissionsModels.EmployeePermissionsPaginatePermissionsOrderParamEnumSchema,
            ).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(EmployeePermissionsModels.EmployeePermissionFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
