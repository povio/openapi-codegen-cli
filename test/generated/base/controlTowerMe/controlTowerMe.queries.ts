...
export namespace ControlTowerMeQueries {
   ...
   * @statusCodes [200]
   */
  export const useGetUserProfile = <TData>(
    options?: AppQueryOptions<typeof ControlTowerMeApi.getUserProfile, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.getUserProfile(),
      queryFn: () => ControlTowerMeApi.getUserProfile(config),
      ...options,
    });
  };
  ...
  export const useUpdateUserData = (
    options?: AppMutationOptions<
      typeof ControlTowerMeApi.updateUserData,
      { data: ControlTowerMeModels.UserUpdateDto }
    > &
    ...
    return useMutation({
      mutationFn: ({ data }) => ControlTowerMeApi.updateUserData(data, config),
      ...options,
  ...
  export const useUpdateUserProfile = (
    options?: AppMutationOptions<
      typeof ControlTowerMeApi.updateUserProfile,
      { data: ControlTowerMeModels.UserBasicUpdateDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ data }) => ControlTowerMeApi.updateUserProfile(data, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
  ...
  export const useUpdatePassword = (
    options?: AppMutationOptions<
      typeof ControlTowerMeApi.updatePassword,
      { data: ControlTowerMeModels.UserPasswordUpdateDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ data }) => ControlTowerMeApi.updatePassword(data, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
  ...
  export const useUpdateEmailPreferences = (
    options?: AppMutationOptions<
      typeof ControlTowerMeApi.updateEmailPreferences,
    ...
    return useMutation({
      mutationFn: ({ data }) => ControlTowerMeApi.updateEmailPreferences(data, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
  ...
  export const useUpdateProjectAccess = (
    options?: AppMutationOptions<typeof ControlTowerMeApi.updateProjectAccess, {}> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });

    return useMutation({
      mutationFn: () => ControlTowerMeApi.updateProjectAccess(config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
