...
export namespace BusinessPartnerBookkeepingMappingsQueries {
  ...
  export const keys = {
    ...
    getBookkeepingMappings: (officeId: string, businessPartnerId: string) =>
      [
        ...keys.all,
   ...
   * @statusCodes [200, 401]
   */
  export const useGetBookkeepingMappings = <TData>(
    { officeId, businessPartnerId }: { officeId: string; businessPartnerId: string },
    options?: AppQueryOptions<typeof BusinessPartnerBookkeepingMappingsApi.getBookkeepingMappings, TData>,
  ...
  export const useCreateBookkeepingMapping = (
    options?: AppMutationOptions<
      typeof BusinessPartnerBookkeepingMappingsApi.createBookkeepingMapping,
      {
        officeId: string;
    ...
    return useMutation({
      mutationFn: ({ officeId, businessPartnerId, data }) => {
        ...
        return BusinessPartnerBookkeepingMappingsApi.createBookkeepingMapping(
          officeId,
          businessPartnerId,
          data,
          config,
  ...
  export const useUpdateBookkeepingMapping = (
    options?: AppMutationOptions<
      typeof BusinessPartnerBookkeepingMappingsApi.updateBookkeepingMapping,
      {
        officeId: string;
        businessPartnerId: string;
  ...
  export const useUpdateBookkeepingMappingById = (
    options?: AppMutationOptions<
      typeof BusinessPartnerBookkeepingMappingsApi.updateBookkeepingMappingById,
      {
        officeId: string;
        businessPartnerId: string;
        id: string;
    ...
    return useMutation({
      mutationFn: ({ officeId, businessPartnerId, id, data }) => {
        ...
        return BusinessPartnerBookkeepingMappingsApi.updateBookkeepingMappingById(
          officeId,
          businessPartnerId,
          id,
          data,
   ...
   * @statusCodes [204, 401]
   */
  export const useDeleteBookkeepingMapping = (
    options?: AppMutationOptions<
      typeof BusinessPartnerBookkeepingMappingsApi.deleteBookkeepingMapping,
      { officeId: string; businessPartnerId: string; id: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
