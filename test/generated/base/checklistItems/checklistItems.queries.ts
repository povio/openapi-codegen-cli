...
export namespace ChecklistItemsQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      limit?: number,
      order?: string,
      filter?: ChecklistItemsModels.ChecklistItemFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/checklist-items", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      ...
      [...keys.all, "/offices/:officeId/checklist-items", "infinite", officeId, limit, order, filter, cursor] as const,
    paginateLabels: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: ChecklistItemsModels.ChecklistItemLabelFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    findById: (id: string, officeId: string) =>
      [...keys.all, "/offices/:officeId/checklist-items/:id", id, officeId] as const,
  };
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof ChecklistItemsApi.create,
      { officeId: string; data: ChecklistItemsModels.CreateChecklistItemRequestDTO }
    > &
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistItemsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof ChecklistItemsApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistItemsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof ChecklistItemsApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    ...
    options?: AppQueryOptions<typeof ChecklistItemsApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof ChecklistItemsApi.update,
      { id: string; officeId: string; data: ChecklistItemsModels.UpdateChecklistItemRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof ChecklistItemsApi.archive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof ChecklistItemsApi.unarchive, { id: string; officeId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
