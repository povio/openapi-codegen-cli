      ...
      `/containers`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(
              ControlTowerContainersModels.ControlTowerContainersFindAllOrderParamEnumSchema,
            ).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(ControlTowerContainersModels.ContainerFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
