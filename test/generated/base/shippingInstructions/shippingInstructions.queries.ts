...
export namespace ShippingInstructionsQueries {
  ...
  export const keys = {
    ...
    get: (officeId: string, positionId: string, id: string) =>
      [
        ...keys.all,
    ...
    preview: (officeId: string, positionId: string, id: string) =>
      [
        ...keys.all,
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof ShippingInstructionsApi.create, { officeId: string; positionId: string }> &
  ...
  export const useGet = <TData>(
    { officeId, positionId, id }: { officeId: string; positionId: string; id: string },
    options?: AppQueryOptions<typeof ShippingInstructionsApi.get, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof ShippingInstructionsApi.update,
      {
        officeId: string;
        positionId: string;
        id: string;
   ...
   */
  export const useDeleteOfficesPositionsShippingInstructionsById = (
    options?: AppMutationOptions<
      typeof ShippingInstructionsApi.deleteOfficesPositionsShippingInstructionsById,
      { officeId: string; positionId: string; id: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const usePreview = <TData>(
    { officeId, positionId, id }: { officeId: string; positionId: string; id: string },
    options?: AppQueryOptions<typeof ShippingInstructionsApi.preview, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePreviewMutation = (
    options?: AppMutationOptions<
      typeof ShippingInstructionsApi.preview,
      { officeId: string; positionId: string; id: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ...
  export const useGenerate = (
    options?: AppMutationOptions<
      typeof ShippingInstructionsApi.generate,
      { officeId: string; positionId: string; id: string; data: CommonModels.GenerateWorkingDocumentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
