...
export namespace CitiesQueries {
  ...
  export const keys = {
    ...
    paginate: (
      limit?: number,
      order?: string,
      filter?: CitiesModels.CityPaginationFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/cities", limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      limit?: number,
      order?: string,
      filter?: CitiesModels.CityPaginationFilterDto,
      cursor?: string,
    ) => [...keys.all, "/cities", "infinite", limit, order, filter, cursor] as const,
    listCityLabels: (
      limit?: number,
      order?: string,
      filter?: CitiesModels.CityLabelFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/cities/paginate/labels", limit, order, filter, page, cursor] as const,
    listCityLabelsInfinite: (
      limit?: number,
      order?: string,
      filter?: CitiesModels.CityLabelFilterDto,
      cursor?: string,
    ) => [...keys.all, "/cities/paginate/labels", "infinite", limit, order, filter, cursor] as const,
  ...
  export const usePaginate = <TData>(
    {
      ...
      page,
      cursor,
    }: { limit: number; order?: string; filter?: CitiesModels.CityPaginationFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof CitiesApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    {
      ...
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CitiesModels.CityPaginationFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CitiesApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof CitiesApi.create, { data: CitiesModels.CreateCityRequestDTO }> &
   ...
   * @statusCodes [200, 401]
   */
  export const useListCityLabels = <TData>(
    {
      limit,
      order,
      filter,
      page,
      cursor,
    }: { limit: number; order?: string; filter?: CitiesModels.CityLabelFilterDto; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof CitiesApi.listCityLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useListCityLabelsInfinite = <TData>(
    {
      limit,
      order,
      filter,
      cursor,
    }: { limit: number; order?: string; filter?: CitiesModels.CityLabelFilterDto; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof CitiesApi.listCityLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCityLabelById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof CitiesApi.getCityLabelById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useFindById = <TData>(
    { id }: { id: string },
    options?: AppQueryOptions<typeof CitiesApi.findById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<typeof CitiesApi.update, { id: string; data: CitiesModels.UpdateCityRequestDTO }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof CitiesApi.archive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof CitiesApi.unarchive, { id: string }> & MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
