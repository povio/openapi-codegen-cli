...
export namespace CitiesAcl {
   ...
   */
  export const canUsePaginate = () => ["Read", "City"] as AbilityTuple<"Read", "City">;
   ...
   */
  export const canUseCreate = () => ["Create", "City"] as AbilityTuple<"Create", "City">;
   ...
   */
  export const canUseListCityLabels = () => ["Read", "City"] as AbilityTuple<"Read", "City">;
   ...
   */
  export const canUseGetCityLabelById = () => ["Read", "City"] as AbilityTuple<"Read", "City">;
   ...
   */
  export const canUseFindById = () => ["Read", "City"] as AbilityTuple<"Read", "City">;
   ...
   */
  export const canUseUpdate = () => ["Update", "City"] as AbilityTuple<"Update", "City">;
   ...
   */
  export const canUseArchive = () => ["Archive", "City"] as AbilityTuple<"Archive", "City">;
   ...
   */
  export const canUseUnarchive = () => ["Archive", "City"] as AbilityTuple<"Archive", "City">;
}
