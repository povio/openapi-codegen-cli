...
export namespace RemarkTemplatesModels {
   ...
   */
  export const RemarkTemplateLabelResponseDTOSchema = z
    .object({
      id: z.string(),
      label: z.string(),
      content: CommonModels.EditorContentResponseDtoSchema.describe("Remark template content"),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const OnlyUsedForEnumSchema = z.enum([
    "transport-order",
    "export-declaration",
    "house-bl",
    "master-bl",
    ...
    "position-office-notes",
    "invoice-body-remarks",
    "business-partner-office-notes",
  ]);
   ...
   */
  export const RemarkTemplateResponseDTOSchema = z
    .object({
      id: z.string(),
      officeId: z.string(),
      name: z.string().describe("Template name"),
      content: CommonModels.EditorContentResponseDtoSchema.describe("Template content"),
      onlyUsedFor: z
        .array(OnlyUsedForEnumSchema)
        .readonly()
        .describe("Restrict template usage to specific document types")
        .nullish(),
      archived: z.boolean(),
      createdById: z.string().nullish(),
      createdBy: RemarkTemplateEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: RemarkTemplateEmployeeDTOSchema.nullish(),
   ...
   */
  export const CreateRemarkTemplateRequestDTOSchema = z
    .object({
      name: z.string().describe("Template name"),
      content: CommonModels.EditorContentUpdateDtoSchema.describe("Template content"),
      onlyUsedFor: z
        .array(OnlyUsedForEnumSchema)
        .readonly()
        .describe("Restrict template usage to specific document types")
   ...
   */
  export const UpdateRemarkTemplateRequestDTOSchema = z
    .object({
      name: z.string().describe("Template name"),
      content: CommonModels.EditorContentUpdateDtoSchema.describe("Template content"),
      onlyUsedFor: z
   ...
   */
  export const RemarkTemplateFilterDtoSchema = z
    .object({
      archived: z.boolean(),
      search: z.string(),
      onlyUsedFor: OnlyUsedForEnumSchema.describe("Filter by document type"),
    })
    .readonly();
   ...
   * @type { enum }
   */
  export const RemarkTemplatesPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
  ...
  export type RemarkTemplatesPaginateLabelsOrderParamEnum = z.infer<
    typeof RemarkTemplatesPaginateLabelsOrderParamEnumSchema
  >;
   ...
   */
  export const RemarkTemplatesPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(RemarkTemplateLabelResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const RemarkTemplatesListOrderParamEnumSchema = z.enum([
    "name",
    "createdAt",
    "updatedAt",
    "createdBy",
   ...
   */
  export const RemarkTemplatesListResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(RemarkTemplateResponseDTOSchema).readonly() }).readonly().shape,
  });
