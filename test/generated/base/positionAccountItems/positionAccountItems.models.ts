...
export namespace PositionAccountItemsModels {
   ...
   */
  export const CreatePositionChargeDataRequestDtoSchema = z
    .object({
   ...
   */
  export const CreatePositionTextDataRequestDtoSchema = z
    .object({ content: z.string().describe("Text content") })
    .readonly();
   ...
   */
  export const CreatePositionAccountItemRequestDtoSchema = z
    .object({
      type: CommonModels.PositionAccountItemTypeEnumSchema.describe("Item type"),
      charge: CreatePositionChargeDataRequestDtoSchema.describe("Charge data if type is CHARGE").nullish(),
      text: CreatePositionTextDataRequestDtoSchema.describe("Text data if type is TEXT").nullish(),
    })
    .readonly();
   ...
   */
  export const CreatePositionAccountItemsRequestDtoSchema = z
    .object({
      items: z
        .array(CreatePositionAccountItemRequestDtoSchema)
        .readonly()
        .describe(
          "Array of items to create. All items in a single request must be of the same type (CHARGE, TEXT, or DIVIDER)",
        ),
    })
    .readonly();
   ...
   * @property { number } sellExchangeRate Sell exchange rate with up to 4 decimal places accuracy
   */
  export const UpdatePositionChargeDataRequestDtoSchema = z
    .object({
      chargeTypeId: z.string().describe("Charge type ID"),
      additionalText: z.string().describe("Additional text for the charge"),
      quantity: z.number().gte(1).describe("Quantity of the charge"),
   ...
   * @property { string } content Text content
   */
  export const UpdatePositionTextDataRequestDtoSchema = z
    .object({ content: z.string().describe("Text content") })
    .readonly();
   ...
   */
  export const UpdatePositionAccountItemRequestDtoSchema = z
    .object({
      type: CommonModels.PositionAccountItemTypeEnumSchema.describe("Item type"),
      charge: UpdatePositionChargeDataRequestDtoSchema.describe("Charge data if type is CHARGE").nullish(),
      text: UpdatePositionTextDataRequestDtoSchema.describe("Text data if type is TEXT").nullish(),
    })
    .readonly();
   ...
   */
  export const UpdatePositionAccountItemWithIdRequestDtoSchema = z
    .object({
      id: z.string().describe("ID of the item to update"),
      data: UpdatePositionAccountItemRequestDtoSchema.describe("Data to update"),
    })
    .readonly();
  export type UpdatePositionAccountItemWithIdRequestDto = z.infer<
    typeof UpdatePositionAccountItemWithIdRequestDtoSchema
  >;
   ...
   */
  export const UpdatePositionAccountItemsRequestDtoSchema = z
    .object({
      items: z.array(UpdatePositionAccountItemWithIdRequestDtoSchema).readonly().describe("Array of items to update"),
    })
    .readonly();
   ...
   */
  export const DeletePositionAccountItemsRequestDtoSchema = z
    .object({ ids: z.array(z.string()).readonly().describe("Array of item IDs to delete") })
    .readonly();
   ...
   */
  export const DuplicatePositionAccountItemsRequestDtoSchema = z
    .object({ ids: z.array(z.string()).readonly().describe("Array of item IDs to duplicate") })
    .readonly();
   ...
   */
  export const ReassignPositionAccountItemsRequestDtoSchema = z
    .object({
      ids: z.array(z.string()).readonly().describe("Array of item IDs to reassign"),
      targetPositionId: z.string().describe("Target position ID to reassign items to"),
    })
    .readonly();
   ...
   */
  export const ReorderPositionAccountItemRequestDtoSchema = z
    .object({ orderPosition: z.number().describe("New order position for the item") })
    .readonly();
   ...
   * @type { array }
   */
  export const PositionAccountItemsCreateResponseSchema = z
    .array(CommonModels.PositionAccountItemDtoResponseSchema)
    .readonly();
   ...
   * @type { array }
   */
  export const PositionAccountItemsUpdateResponseSchema = z
    .array(CommonModels.PositionAccountItemDtoResponseSchema)
    .readonly();
   ...
   * @type { array }
   */
  export const PositionAccountItemsDuplicateResponseSchema = z
    .array(CommonModels.PositionAccountItemDtoResponseSchema)
    .readonly();
