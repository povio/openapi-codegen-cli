...
export namespace PositionAccountItemsQueries {
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.create,
      { positionId: string; officeId: string; data: PositionAccountItemsModels.CreatePositionAccountItemsRequestDto }
    > &
   ...
   * @statusCodes [204, 401]
   */
  export const useDeletePositionAccountItems = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.deletePositionAccountItems,
      { positionId: string; officeId: string; data: PositionAccountItemsModels.DeletePositionAccountItemsRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.update,
      { positionId: string; officeId: string; data: PositionAccountItemsModels.UpdatePositionAccountItemsRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useDuplicate = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.duplicate,
      { positionId: string; officeId: string; data: PositionAccountItemsModels.DuplicatePositionAccountItemsRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useReassign = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.reassign,
      { positionId: string; officeId: string; data: PositionAccountItemsModels.ReassignPositionAccountItemsRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useReorder = (
    options?: AppMutationOptions<
      typeof PositionAccountItemsApi.reorder,
      {
        positionId: string;
        itemId: string;
        officeId: string;
