...
export namespace DocumentTemplatesAcl {
  ...
  export const canUsePaginateLabels = (object?: { officeId: string }) =>
    ["Read", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Read",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Create",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
  ...
  export const canUseUpdate = (object?: { officeId: string }) =>
    ["Update", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Update",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
   ...
   */
  export const canUseAddRemarkBlock = (object?: { officeId: string }) =>
    ["Update", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Update",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteRemarkBlock = (object?: { officeId: string }) =>
    ["Update", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Update",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
  ...
  export const canUseArchive = (object?: { officeId: string }) =>
    ["Archive", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Archive",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
  ...
  export const canUseUnarchive = (object?: { officeId: string }) =>
    ["Unarchive", object ? subject("DocumentTemplate", object) : "DocumentTemplate"] as AbilityTuple<
      "Unarchive",
      "DocumentTemplate" | (ForcedSubject<"DocumentTemplate"> & { officeId: string })
    >;
}
