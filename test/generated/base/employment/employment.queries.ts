...
export namespace EmploymentQueries {
  ...
  export const keys = {
    ...
    list: (
      ...
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/employees/employments", limit, order, populate, filter, page, cursor] as const,
    listInfinite: (
      limit?: number,
      order?: string,
      populate?: EmploymentModels.EmploymentListPopulateParam,
      filter?: EmploymentModels.EmploymentFilterDto,
      cursor?: string,
    ) => [...keys.all, "/employees/employments", "infinite", limit, order, populate, filter, cursor] as const,
    listRoles: (officeId: string, employmentId: string) =>
      [...keys.all, "/offices/:officeId/employments/:employmentId/roles", officeId, employmentId] as const,
  };
  ...
  export const useCreate = (
    options?: AppMutationOptions<typeof EmploymentApi.create, { data: EmploymentModels.EmploymentCreateRequest }> &
  ...
  export const useList = <TData>(
    ...
    options?: AppQueryOptions<typeof EmploymentApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useListInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof EmploymentApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useListRoles = <TData>(
    ...
    options?: AppQueryOptions<typeof EmploymentApi.listRoles, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateRoles = (
    options?: AppMutationOptions<
      typeof EmploymentApi.updateRoles,
      { officeId: string; employmentId: string; data: EmploymentModels.EmploymentRoleMembershipsUpdateRequest }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof EmploymentApi.update,
      { officeId: string; employmentId: string; data: EmploymentModels.UpdateEmploymentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof EmploymentApi.archive, { officeId: string; employmentId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof EmploymentApi.unarchive, { officeId: string; employmentId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
