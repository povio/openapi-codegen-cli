...
export namespace VatRulesAcl {
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "VatRule"] as AbilityTuple<"Read", "VatRule">;

  /**
   * Use for `useList` query ability.
   * @returns { AbilityTuple } An ability tuple indicating the user's ability to use `useList` query
   */
  export const canUseList = () => ["Read", "VatRule"] as AbilityTuple<"Read", "VatRule">;
   ...
   */
  export const canUseCreate = () => ["Create", "VatRule"] as AbilityTuple<"Create", "VatRule">;
   ...
   */
  export const canUseFindById = () => ["Read", "VatRule"] as AbilityTuple<"Read", "VatRule">;
   ...
   */
  export const canUseUpdate = () => ["Update", "VatRule"] as AbilityTuple<"Update", "VatRule">;
   ...
   */
  export const canUseArchive = () => ["Update", "VatRule"] as AbilityTuple<"Update", "VatRule">;
   ...
   */
  export const canUseUnarchive = () => ["Update", "VatRule"] as AbilityTuple<"Update", "VatRule">;
}
