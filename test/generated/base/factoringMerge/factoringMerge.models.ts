...
export namespace FactoringMergeModels {
   ...
   */
  export const FileMetadataDtoSchema = z
    .object({
   ...
   */
  export const PrepareFactoringMergeRequestDtoSchema = z
    .object({
      eurDebtorFile: FileMetadataDtoSchema.describe("EUR debtor file metadata"),
      eurOperationsFile: FileMetadataDtoSchema.describe("EUR operations file metadata"),
      eurExistingFactoringFile: FileMetadataDtoSchema.describe(
        "EUR existing factoring file metadata (optional)",
      ).nullish(),
      usdDebtorFile: FileMetadataDtoSchema.describe("USD debtor file metadata"),
      usdOperationsFile: FileMetadataDtoSchema.describe("USD operations file metadata"),
      usdExistingFactoringFile: FileMetadataDtoSchema.describe(
        "USD existing factoring file metadata (optional)",
      ).nullish(),
    })
    .readonly();
   ...
   * @property { string } url
   */
  export const MediaUploadInstructionsDtoSchema = z
    .object({ id: z.string(), method: z.string(), url: z.string() })
    .readonly();
   ...
   */
  export const FactoringMergeUploadInstructionsResponseDtoSchema = z
    .object({
      batchId: z.string(),
      eurDebtorFile: MediaUploadInstructionsDtoSchema,
      eurOperationsFile: MediaUploadInstructionsDtoSchema,
      eurExistingFactoringFile: MediaUploadInstructionsDtoSchema.nullish(),
      usdDebtorFile: MediaUploadInstructionsDtoSchema,
      usdOperationsFile: MediaUploadInstructionsDtoSchema,
      usdExistingFactoringFile: MediaUploadInstructionsDtoSchema.nullish(),
    })
    .readonly();
  export type FactoringMergeUploadInstructionsResponseDto = z.infer<
    typeof FactoringMergeUploadInstructionsResponseDtoSchema
  >;
   ...
   */
  export const FactoringMergeBatchResponseDtoSchema = z
    .object({
      id: z.string(),
      officeId: z.string(),
      status: FactoringMergeBatchStatusEnumSchema,
      eurDebtorFileMediaId: z.string(),
      eurOperationsFileMediaId: z.string(),
      eurExistingFactoringFileMediaId: z.string().nullish(),
      usdDebtorFileMediaId: z.string(),
      usdOperationsFileMediaId: z.string(),
      usdExistingFactoringFileMediaId: z.string().nullish(),
      eurResultFileMediaId: z.string().nullish(),
      eurResultFileUrl: z.string().nullish(),
      usdResultFileMediaId: z.string().nullish(),
      usdResultFileUrl: z.string().nullish(),
