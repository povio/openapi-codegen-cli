...
export namespace BusinessPartnersQueries {
  ...
  export const keys = {
    ...
    paginate: (
      ...
      limit?: number,
      order?: string,
      filter?: BusinessPartnersModels.BusinessPartnerFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/business-partners", officeId, limit, order, filter, page, cursor] as const,
    paginateInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
    ...
    paginateLabels: (
      ...
      limit?: number,
      order?: string,
      filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
    ...
    getById: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/business-partners/:id", officeId, id] as const,
    getRemarks: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/business-partners/:id/remarks", officeId, id] as const,
    getBasicInfo: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/business-partners/:id/basic", officeId, id] as const,
    getCargoAgentInfo: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/business-partners/:id/cargo-agent", officeId, id] as const,
    getCarrierInformation: (officeId: string, id: string) =>
      [...keys.all, "/offices/:officeId/business-partners/:id/carrier", officeId, id] as const,
  };
  ...
  export const usePaginate = <TData>(
    ...
    options?: AppQueryOptions<typeof BusinessPartnersApi.paginate, TData>,
  ...
  export const usePaginateInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof BusinessPartnersApi.paginate, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.create,
      { officeId: string; data: BusinessPartnersModels.CreateBusinessPartnerRequestDTO }
    > &
  ...
  export const usePaginateLabels = <TData>(
    ...
    options?: AppQueryOptions<typeof BusinessPartnersApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const usePaginateLabelsInfinite = <TData>(
    ...
    options?: AppInfiniteQueryOptions<typeof BusinessPartnersApi.paginateLabels, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useGetById = <TData>(
    { officeId, id }: { officeId: string; id: string },
    options?: AppQueryOptions<typeof BusinessPartnersApi.getById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.update,
      { officeId: string; id: string; data: BusinessPartnersModels.UpdateBusinessPartnerRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useArchive = (
    options?: AppMutationOptions<typeof BusinessPartnersApi.archive, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnarchive = (
    options?: AppMutationOptions<typeof BusinessPartnersApi.unarchive, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useLock = (
    options?: AppMutationOptions<typeof BusinessPartnersApi.lock, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUnlock = (
    options?: AppMutationOptions<typeof BusinessPartnersApi.unlock, { officeId: string; id: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useGetRemarks = <TData>(
    { officeId, id }: { officeId: string; id: string },
    options?: AppQueryOptions<typeof BusinessPartnersApi.getRemarks, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreateRemark = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.createRemark,
      { officeId: string; id: string; data: BusinessPartnersModels.CreateBusinessPartnerRemarkRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useUpdateRemark = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.updateRemark,
      {
        officeId: string;
        id: string;
        remarkId: string;
        data: BusinessPartnersModels.UpdateBusinessPartnerRemarkRequestDto;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ...
  export const useDeleteRemark = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.deleteRemark,
      { officeId: string; id: string; remarkId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGetBasicInfo = <TData>(
    { officeId, id }: { officeId: string; id: string },
    options?: AppQueryOptions<typeof BusinessPartnersApi.getBasicInfo, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateBasicInfo = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.updateBasicInfo,
      { officeId: string; id: string; data: BusinessPartnersModels.UpdateBusinessPartnerBasicRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [201, 401]
   */
  export const useCreateSignatureUploadInstructions = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.createSignatureUploadInstructions,
      {
        officeId: string;
        id: string;
        data: BusinessPartnersModels.BusinessPartnerSignatureUploadRequestDTO;
        file?: File;
    ...
    return useMutation({
      mutationFn: async ({ officeId, id, data, file, abortController, onUploadProgress }) => {
        ...
        const uploadInstructions = await BusinessPartnersApi.createSignatureUploadInstructions(
          officeId,
          id,
          data,
          config,
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCargoAgentInfo = <TData>(
    { officeId, id }: { officeId: string; id: string },
    options?: AppQueryOptions<typeof BusinessPartnersApi.getCargoAgentInfo, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
   ...
   * @statusCodes [200, 401]
   */
  export const useUpdateCargoAgent = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.updateCargoAgent,
      { officeId: string; id: string; data: BusinessPartnersModels.UpdateCargoAgentDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGetCarrierInformation = <TData>(
    { officeId, id }: { officeId: string; id: string },
    options?: AppQueryOptions<typeof BusinessPartnersApi.getCarrierInformation, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdateCarrier = (
    options?: AppMutationOptions<
      typeof BusinessPartnersApi.updateCarrier,
      { officeId: string; id: string; data: BusinessPartnersModels.UpdateCarrierDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
