...
export namespace BusinessPartnersModels {
   ...
   */
  export const BusinessPartnerRemarkResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the remark"),
      visibility: RemarkVisibilitySchema.describe("Visibility level of the remark"),
      content: z.string().describe("Content of the remark"),
      type: RemarkTypeSchema.describe("Type of the remark"),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerAddressDtoSchema = z
    .object({
      street: z.string().describe("Street address"),
      zip: z.string().describe("ZIP/Postal code"),
      city: z.string().describe("City name"),
      isoCode: z.string().describe("Country code"),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerListResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the business partner"),
      name: z.string().describe("Name of the business partner"),
      matchCode: z.string().describe("Match code of the business partner"),
      address: BusinessPartnerAddressDtoSchema.describe("Address information"),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("List of business partner types"),
      archived: z.boolean().describe("Archive status"),
      shortName: z.string().describe("Short name of the business partner").nullish(),
      vat: z.string().describe("VAT number of the business partner").nullish(),
      debtorId: z.string().describe("Debtor ID for the local currency").nullish(),
      creditorId: z.string().describe("Creditor ID for the local currency").nullish(),
      locked: z.boolean().describe("Whether the business partner is locked"),
      currency: z.string().describe("Currency (invoice currency)").nullish(),
      remarks: z.array(BusinessPartnerRemarkResponseDTOSchema).readonly().describe("Remarks for the business partner"),
      createdById: z.string().describe("ID of the employee who created this business partner").nullish(),
      createdBy: BusinessPartnerEmployeeDTOSchema.describe("Employee who created this business partner").nullish(),
      createdAt: z.iso.datetime({ offset: true }).describe("Date when the business partner was created"),
      updatedById: z.string().describe("ID of the employee who last updated this business partner").nullish(),
      updatedBy: BusinessPartnerEmployeeDTOSchema.describe("Employee who last updated this business partner").nullish(),
      updatedAt: z.iso.datetime({ offset: true }).describe("Date when the business partner was last updated"),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerFilterDtoSchema = z
    .object({
      search: z.string(),
      ...
      creditorId: z.string(),
      matchCode: z.string(),
      archived: z.boolean().describe("Filter by archived status"),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerPaginatedLabelResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the business partner"),
      label: z.string().describe("Label of the business partner"),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("Array of business partner types"),
    })
    .readonly();
   ...
   * @property { boolean } archived Filter by archived status
   */
  export const BusinessPartnerLabelsFilterDtoSchema = z
    .object({
      search: z.string(),
      ids: z.array(z.string()).readonly().describe("Business partner ids to filter by"),
      types: z
        .array(CommonModels.BusinessPartnerTypeSchema)
        .readonly()
        .describe("Array of business partner types to filter by"),
      archived: z.boolean().describe("Filter by archived status"),
    })
    .readonly();
   ...
   */
  export const CreateBusinessPartnerAddressDtoSchema = z
    .object({
      street: z.string(),
   ...
   */
  export const CreateBusinessPartnerRequestDTOSchema = z
    .object({
      name: z.string().min(3).describe("Full name of the business partner"),
      secondaryName: z.string().min(3).describe("Full name of the business partner").nullish(),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("Types/roles of the business partner"),
      matchCode: z.string().describe("Unique identifier code").nullish(),
      shortName: z.string().describe("Short name for the business partner").nullish(),
      address: CreateBusinessPartnerAddressDtoSchema.describe("Address information").nullish(),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the business partner"),
      name: z.string().describe("Name of the business partner"),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("Types/roles of the business partner"),
      rootFolderId: z.string().describe("Root folder identifier associated with this business partner").nullish(),
    })
    .readonly();
   ...
   * @property { string } name Name of the business partner
   */
  export const BusinessPartnerLabelResponseDtoSchema = z
    .object({
      id: z.string().describe("Unique identifier of the business partner"),
      name: z.string().describe("Name of the business partner"),
    })
   ...
   */
  export const ContactResponseDTOSchema = z
    .object({
   ...
   */
  export const BusinessPartnerDetailResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the business partner"),
      createdById: z.string().describe("ID of the employee who created this record").nullish(),
      createdBy: BusinessPartnerEmployeeDTOSchema.describe("Employee who created this record").nullish(),
      createdAt: z.iso.datetime({ offset: true }).describe("Creation timestamp"),
      updatedById: z.string().describe("ID of the employee who last updated this record").nullish(),
      updatedBy: BusinessPartnerEmployeeDTOSchema.describe("Employee who last updated this record").nullish(),
      updatedAt: z.iso.datetime({ offset: true }).describe("Last update timestamp"),
      matchCode: z.string().describe("Match code of the business partner"),
      shortName: z.string().describe("Short name"),
      name: z.string().describe("Full name"),
      secondaryName: z.string().describe("Secondary name"),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("List of business partner types"),
      archived: z.boolean().describe("Archived status"),
      address: CommonModels.BusinessPartnerAddressResponseDTOSchema.describe("Main address information"),
      blAddress: CommonModels.BusinessPartnerAddressResponseDTOSchema.describe("BL address information"),
      similar: z
        .array(BusinessPartnerLabelResponseDtoSchema)
        .readonly()
        .describe("Similar named business partners")
        .nullish(),
      locked: z.boolean(),
      addressIsDifferentForBl: z.boolean(),
      lockedById: z.string().describe("Unique identifier of the employee who locked the business partner").nullish(),
      lockedByName: z.string().nullish(),
      lockedAt: z.iso
        .datetime({ offset: true })
        .describe("Unique identifier of the employee who locked the business partner")
        .nullish(),
      belongsTo: ContactResponseDTOSchema.describe("Parent business partner"),
      salesRep: ContactResponseDTOSchema.describe("Sales representative"),
      operations: ContactResponseDTOSchema.describe("Operations contact"),
    })
    .readonly();
   ...
   * @property { string } countryId
   */
  export const UpdateBusinessPartnerAddressDtoSchema = z
    .object({
      street: z.string(),
      secondaryStreet: z.string(),
      zip: z.string(),
   ...
   */
  export const UpdateBusinessPartnerRequestDTOSchema = z
    .object({
      matchCode: z.string().describe("Updated match code"),
      shortName: z.string().describe("Updated short name"),
      name: z.string().describe("Updated full name"),
      secondaryName: z.string().describe("Updated secondary name"),
      types: z.array(CommonModels.BusinessPartnerTypeSchema).readonly().describe("Types/roles of the business partner"),
      address: UpdateBusinessPartnerAddressDtoSchema.describe("Address information"),
      blAddress: UpdateBusinessPartnerAddressDtoSchema.describe("Bl address information"),
      belongsToId: z.string().describe("Parent business partner"),
      salesRepId: z.string().describe("Sales representative"),
      operationsId: z.string().describe("Operations contact"),
      addressIsDifferentForBl: z.boolean().describe("Different address for BL"),
    })
    .readonly();
   ...
   */
  export const CreateBusinessPartnerRemarkRequestDTOSchema = z
    .object({
      visibility: RemarkVisibilitySchema.describe("Visibility level of the remark"),
      content: z.string().describe("Content of the remark"),
      type: RemarkTypeSchema.describe("Type of remark"),
    })
    .readonly();
   ...
   * @property { RemarkType } type Type of remark
   */
  export const UpdateBusinessPartnerRemarkRequestDtoSchema = z
    .object({
      visibility: RemarkVisibilitySchema.describe("Visibility level of the remark"),
      content: z.string().describe("Content of the remark"),
      type: RemarkTypeSchema.describe("Type of remark"),
   ...
   */
  export const BusinessPartnerPaymentTermsResponseDtoSchema = z
    .object({ relativeTo: CommonModels.OfficePaymentTermsDateTypeSchema, days: z.number().gte(0) })
    .readonly();
   ...
   */
  export const PartnerNetworkInfoDtoSchema = z
    .object({ id: z.string().describe("Partner network ID"), name: z.string().describe("Partner network name") })
    .readonly();
   ...
   */
  export const BusinessPartnerBasicResponseDTOSchema = z
    .object({
      businessPartnerId: z.string().describe("Reference to the business partner"),
      relationship: z.array(z.string()).readonly().describe("List of relationships"),
      accountType: AccountTypeEnumSchema.nullish(),
      vat: z.string().describe("VAT number"),
      legacySystemId: z.string().describe("Legacy system (move) id").nullish(),
      registrationNumber: z.string().nullish(),
      eori: z.string().describe("EORI number"),
      authorization: BusinessPartnerAuthorizationSchema.describe("Authorization status").nullable(),
      creditLimit: z.number().describe("Credit limit"),
      invoiceLanguage: z.string().describe("Invoice language"),
      invoiceCurrency: z.string().describe("Invoice currency"),
      iban: z.string().describe("IBAN"),
      bankNumber: z.string().describe("Bank number"),
      bankAccountNumber: z.string().describe("Bank account number"),
      termsExport: BusinessPartnerPaymentTermsResponseDtoSchema,
      termsImport: BusinessPartnerPaymentTermsResponseDtoSchema,
      notes: CommonModels.EditorContentResponseDtoSchema.describe("Notes").nullish(),
      bankAccountId: z.string().nullish(),
      bankAccount: BusinessPartnerBankAccountResponseDtoSchema.nullish(),
      partnerNetworks: z.array(PartnerNetworkInfoDtoSchema).readonly().describe("Partner networks"),
      dunningSystemId: z.string().nullish(),
      dunningSystem: CommonModels.DunningSystemReferenceDTOSchema.nullish(),
      hblIssuerSigner: z.string().describe("HBL issuer/signer prefill"),
      signatureFileAttachmentId: z.string().describe("Signature file attachment ID"),
      signatureFileAttachmentUrl: z.string().describe("Signed URL for signature file attachment").nullish(),
    })
    .readonly();
   ...
   * @property { number } days Minimum: `0`
   */
  export const UpdateBusinessPartnerPaymentTermsDtoSchema = z
    .object({ relativeTo: CommonModels.OfficePaymentTermsDateTypeSchema, days: z.number().gte(0) })
    .readonly();
   ...
   * @property { string } signatureFileAttachmentId Signature file attachment ID
   */
  export const UpdateBusinessPartnerBasicRequestDTOSchema = z
    .object({
      relationship: z.array(z.string()).readonly().describe("Updated relationships"),
      vat: z.string().describe("Updated VAT number"),
      eori: z.string().describe("Updated EORI number"),
      accountType: AccountTypeEnumSchema,
      authorization: BusinessPartnerAuthorizationSchema.describe("Updated authorization status"),
      creditLimit: z.number().describe("Updated credit limit"),
      invoiceLanguage: z.string().describe("Invoice language"),
      invoiceCurrency: z.string().describe("Invoice currency"),
      iban: z.string().describe("IBAN"),
      bankNumber: z.string().describe("Bank number"),
      bankAccountNumber: z.string().describe("Bank account number"),
      legacySystemId: z.string().describe("Legacy system (move) id"),
      registrationNumber: z.string(),
      termsExport: UpdateBusinessPartnerPaymentTermsDtoSchema,
      termsImport: UpdateBusinessPartnerPaymentTermsDtoSchema,
      notes: CommonModels.EditorContentUpdateDtoSchema.describe("Notes"),
      bankAccountId: z.string().nullable(),
      partnerNetworkIds: z.array(z.string()).readonly().describe("Partner network IDs"),
      dunningSystemId: z.string().describe("Dunning system ID").nullable(),
      hblIssuerSigner: z.string().describe("HBL issuer/signer prefill").nullable(),
      signatureFileAttachmentId: z.string().describe("Signature file attachment ID").nullable(),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerSignatureUploadRequestDTOSchema = z
    .object({
      fileName: z.string().describe("File name"),
      mimeType: z.string().describe("Mime type"),
      fileSize: z.number().gte(1).describe("File size in bytes"),
    })
    .readonly();
   ...
   */
  export const BusinessPartnerSignatureUploadResponseDTOSchema = z
    .object({
      mediaId: z.string().describe("Media ID for the uploaded signature"),
      method: z.string().describe("HTTP method to use for upload"),
      url: z.string().describe("URL to upload the file to"),
    })
    .readonly();
  export type BusinessPartnerSignatureUploadResponseDTO = z.infer<
    typeof BusinessPartnerSignatureUploadResponseDTOSchema
  >;
   ...
   */
  export const CargoAgentResponseDTOSchema = z
    .object({
      businessPartnerId: z.string().describe("Business partner identifier"),
      portOfHamburgAccountNumber: z.string().describe("Port of Hamburg account number"),
      iataAccountNumber: z.string().describe("IATA account number"),
      regulatedAgentCode: z.string().describe("Regulated agent code"),
    })
    .readonly();
   ...
   * @property { string } regulatedAgentCode Regulated agent code
   */
  export const UpdateCargoAgentDTOSchema = z
    .object({
      portOfHamburgAccountNumber: z.string().describe("Hamburg port account number"),
      iataAccountNumber: z.string().describe("IATA account number"),
      regulatedAgentCode: z.string().describe("Regulated agent code"),
    })
    .readonly();
   ...
   */
  export const CarrierResponseDTOSchema = z
    .object({
      businessPartnerId: z.string().describe("Business partner identifier"),
      scac: z.string().describe("SCAC code"),
      iataAirlinePrefix: z.string().describe("IATA airline prefix"),
      iataCode: z.string().describe("IATA code"),
      registrationAddress: z.string().describe("Registration address"),
      masterBlSuffix: z.string().describe("Master BL suffix"),
      houseBlSuffix: z.string().describe("House BL suffix"),
      airWaybillSuffix: z.string().describe("Air waybill suffix"),
      cargoManifestSuffix: z.string().describe("Cargo manifest suffix"),
      fundReportSuffix: z.string().describe("Fund report suffix"),
      invoiceSuffix: z.string().describe("Invoice suffix"),
    })
    .readonly();
   ...
   * @property { string } invoiceSuffix Invoice suffix
   */
  export const UpdateCarrierDTOSchema = z
    .object({
      scac: z.string().describe("SCAC code"),
      iataAirlinePrefix: z.string().describe("IATA airline prefix"),
      iataCode: z.string().describe("IATA code"),
   ...
   * @type { enum }
   */
  export const BusinessPartnersPaginateOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "createdAt",
    "updatedAt",
   ...
   */
  export const BusinessPartnersPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(BusinessPartnerListResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const BusinessPartnersPaginateLabelsOrderParamEnumSchema = z.enum([
    "name",
    "matchCode",
    "createdAt",
    "updatedAt",
  ...
  export type BusinessPartnersPaginateLabelsOrderParamEnum = z.infer<
    typeof BusinessPartnersPaginateLabelsOrderParamEnumSchema
  >;
   ...
   */
  export const BusinessPartnersPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(BusinessPartnerPaginatedLabelResponseDTOSchema).readonly() }).readonly().shape,
  });
