...
export namespace QuoteCargoPackageAcl {
   ...
   */
  export const canUseCreatePackage = (object?: { officeId: string }) =>
    ["Create", object ? subject("QuoteCargo", object) : "QuoteCargo"] as AbilityTuple<
      "Create",
      "QuoteCargo" | (ForcedSubject<"QuoteCargo"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdatePackage = (object?: { officeId: string }) =>
    ["Update", object ? subject("QuoteCargo", object) : "QuoteCargo"] as AbilityTuple<
      "Update",
      "QuoteCargo" | (ForcedSubject<"QuoteCargo"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeletePackage = (object?: { officeId: string }) =>
    ["Delete", object ? subject("QuoteCargo", object) : "QuoteCargo"] as AbilityTuple<
      "Delete",
      "QuoteCargo" | (ForcedSubject<"QuoteCargo"> & { officeId: string })
    >;
   ...
   */
  export const canUseDuplicatePackage = (object?: { officeId: string }) =>
    ["Duplicate", object ? subject("QuoteCargo", object) : "QuoteCargo"] as AbilityTuple<
      "Duplicate",
      "QuoteCargo" | (ForcedSubject<"QuoteCargo"> & { officeId: string })
    >;
   ...
   */
  export const canUseMovePackage = (object?: { officeId: string }) =>
    ["Update", object ? subject("QuoteCargo", object) : "QuoteCargo"] as AbilityTuple<
      "Update",
      "QuoteCargo" | (ForcedSubject<"QuoteCargo"> & { officeId: string })
    >;
