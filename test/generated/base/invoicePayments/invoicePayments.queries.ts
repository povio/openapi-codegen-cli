...
export namespace InvoicePaymentsQueries {
  ...
  export const keys = {
    ...
    listOfficePayments: (
      ...
      limit?: number,
      order?: string,
      filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto,
      page?: number,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/payments", officeId, limit, order, filter, page, cursor] as const,
    listOfficePaymentsInfinite: (
      officeId: string,
      limit?: number,
      order?: string,
      filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto,
      cursor?: string,
    ) => [...keys.all, "/offices/:officeId/payments", "infinite", officeId, limit, order, filter, cursor] as const,
    list: (officeId: string, invoiceId: string, limit?: number, page?: number, cursor?: string) =>
      [
        ...keys.all,
    ...
    listInfinite: (officeId: string, invoiceId: string, limit?: number, cursor?: string) =>
      [
        ...keys.all,
        "/offices/:officeId/invoices/:invoiceId/payments",
        "infinite",
    ...
    getPaymentById: (officeId: string, invoiceId: string, paymentId: string) =>
      [
        ...keys.all,
   ...
   * @statusCodes [200, 401]
   */
  export const useListOfficePayments = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppQueryOptions<typeof InvoicePaymentsApi.listOfficePayments, TData>,
   ...
   * @statusCodes [200, 401]
   */
  export const useListOfficePaymentsInfinite = <TData>(
    {
      officeId,
      limit,
      order,
    ...
    options?: AppInfiniteQueryOptions<typeof InvoicePaymentsApi.listOfficePayments, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useBulkCreatePayments = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.bulkCreatePayments,
      { officeId: string; data: InvoicePaymentsModels.BulkCreatePaymentsRequestDto }
    > &
  ...
  export const useCalculatePayments = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.calculatePayments,
      { officeId: string; data: InvoicePaymentsModels.CalculatePaymentsRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useExportOfficePayments = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.exportOfficePayments,
      { officeId: string; data: InvoicePaymentsModels.OfficeInvoicePaymentExportRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useList = <TData>(
    {
      ...
      page,
      cursor,
    }: { officeId: string; invoiceId: string; limit: number; page?: number; cursor?: string },
    options?: AppQueryOptions<typeof InvoicePaymentsApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useListInfinite = <TData>(
    { officeId, invoiceId, limit, cursor }: { officeId: string; invoiceId: string; limit: number; cursor?: string },
    options?: AppInfiniteQueryOptions<typeof InvoicePaymentsApi.list, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.create,
      { officeId: string; invoiceId: string; data: InvoicePaymentsModels.CreateInvoicePaymentRequestDto }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
   ...
   * @statusCodes [200, 401]
   */
  export const useGetPaymentById = <TData>(
    { officeId, invoiceId, paymentId }: { officeId: string; invoiceId: string; paymentId: string },
    options?: AppQueryOptions<typeof InvoicePaymentsApi.getPaymentById, TData>,
    config?: AxiosRequestConfig,
  ) => {
    const { checkAcl } = useAclCheck();
  ...
  export const useUpdate = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.update,
      {
        officeId: string;
        invoiceId: string;
        paymentId: string;
        data: InvoicePaymentsModels.UpdateInvoicePaymentRequestDto;
      }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ...
  export const useDeleteInvoicePayment = (
    options?: AppMutationOptions<
      typeof InvoicePaymentsApi.deleteInvoicePayment,
      { officeId: string; invoiceId: string; paymentId: string }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
