...
export namespace InvoicePaymentsApi {
  export const listOfficePayments = (
    officeId: string,
    limit: number,
    order?: string,
      ...
      `/offices/${officeId}/payments`,
      {
        ...
        params: {
          order: ZodExtended.parse(
            ZodExtended.sortExp(InvoicePaymentsModels.ListOfficePaymentsOrderParamEnumSchema).optional(),
            order,
            { type: "query", name: "order" },
          ),
          filter: ZodExtended.parse(InvoicePaymentsModels.OfficeInvoicePaymentFilterDtoSchema.optional(), filter, {
            type: "query",
            name: "filter",
          }),
  ...
  export const bulkCreatePayments = (
    officeId: string,
    data: InvoicePaymentsModels.BulkCreatePaymentsRequestDto,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const calculatePayments = (
    officeId: string,
    data: InvoicePaymentsModels.CalculatePaymentsRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
  ...
  export const exportOfficePayments = (
    officeId: string,
    data: InvoicePaymentsModels.OfficeInvoicePaymentExportRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
  ...
  export const create = (
    officeId: string,
    invoiceId: string,
    data: InvoicePaymentsModels.CreateInvoicePaymentRequestDto,
    config?: AxiosRequestConfig,
  ) => {
    return AppRestClient.post(
