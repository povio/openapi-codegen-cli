...
export namespace InvoicePaymentsAcl {
   ...
   */
  export const canUseListOfficePayments = (object?: { officeId: string }) =>
   ...
   */
  export const canUseBulkCreatePayments = (object?: { officeId: string }) =>
   ...
   */
  export const canUseCalculatePayments = (object?: { officeId: string }) =>
    ["Read", object ? subject("PositionInvoice", object) : "PositionInvoice"] as AbilityTuple<
      "Read",
      "PositionInvoice" | (ForcedSubject<"PositionInvoice"> & { officeId: string })
    >;
   ...
   */
  export const canUseExportOfficePayments = (object?: { officeId: string }) =>
    ["Export", object ? subject("InvoicePayment", object) : "InvoicePayment"] as AbilityTuple<
      "Export",
      "InvoicePayment" | (ForcedSubject<"InvoicePayment"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetPaymentById = (object?: { officeId: string }) =>
    ["Update", object ? subject("PositionInvoice", object) : "PositionInvoice"] as AbilityTuple<
      "Update",
      "PositionInvoice" | (ForcedSubject<"PositionInvoice"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteInvoicePayment = (object?: { officeId: string }) =>
    ["Update", object ? subject("PositionInvoice", object) : "PositionInvoice"] as AbilityTuple<
      "Update",
      "PositionInvoice" | (ForcedSubject<"PositionInvoice"> & { officeId: string })
    >;
