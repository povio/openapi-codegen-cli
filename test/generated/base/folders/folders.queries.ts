...
export namespace FoldersQueries {
  ...
  export const keys = {
    ...
    getTree: (officeId: string, folderId: string) =>
      [...keys.all, "/offices/:officeId/folders/:folderId/tree", officeId, folderId] as const,
    getContent: (
      officeId: string,
      folderId: string,
      limit?: number,
      order?: FoldersModels.GetContentOrderParam,
      filter?: FoldersModels.FolderContentFilterDto,
      page?: number,
      cursor?: string,
    ) =>
      [
   ...
   * @statusCodes [200, 401]
   */
  export const useGetTree = <TData>(
    { officeId, folderId }: { officeId: string; folderId: string },
    options?: AppQueryOptions<typeof FoldersApi.getTree, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.getTree(officeId, folderId),
      queryFn: () => FoldersApi.getTree(officeId, folderId, config),
      ...options,
    });
  };
   ...
   * @statusCodes [200, 401]
   */
  export const useGetContent = <TData>(
    {
      officeId,
      folderId,
      limit,
    ...
    options?: AppQueryOptions<typeof FoldersApi.getContent, TData>,
    config?: AxiosRequestConfig,
  ) => {
    return useQuery({
      queryKey: keys.getContent(officeId, folderId, limit, order, filter, page, cursor),
      queryFn: () => FoldersApi.getContent(officeId, folderId, limit, order, filter, page, cursor, config),
      ...options,
    });
  };
   ...
   * @statusCodes [200, 401]
   */
  export const useGetContentInfinite = <TData>(
    {
      officeId,
      folderId,
      limit,
    ...
    options?: AppInfiniteQueryOptions<typeof FoldersApi.getContent, TData>,
    config?: AxiosRequestConfig,
  ) => {
  ...
  export const useRename = (
    options?: AppMutationOptions<
      typeof FoldersApi.rename,
      { officeId: string; folderId: string; data: FoldersModels.RenameFolderRequestDTO }
    > &
    ...
    return useMutation({
      mutationFn: ({ officeId, folderId, data }) => FoldersApi.rename(officeId, folderId, data, config),
      ...options,
  ...
  export const useDeleteFolder = (
    options?: AppMutationOptions<typeof FoldersApi.deleteFolder, { officeId: string; folderId: string }> &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
    ...
    return useMutation({
      mutationFn: ({ officeId, folderId }) => FoldersApi.deleteFolder(officeId, folderId, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
  ...
  export const useCreate = (
    options?: AppMutationOptions<
      typeof FoldersApi.create,
      { officeId: string; data: FoldersModels.CreateFolderRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ officeId, data }) => FoldersApi.create(officeId, data, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
  ...
  export const useMove = (
    options?: AppMutationOptions<
      typeof FoldersApi.move,
      { officeId: string; data: FoldersModels.MoveFoldersRequestDTO }
    > &
      MutationEffectsOptions,
    config?: AxiosRequestConfig,
  ) => {
    ...
    return useMutation({
      mutationFn: ({ officeId, data }) => FoldersApi.move(officeId, data, config),
      ...options,
      onSuccess: async (resData, variables, onMutateResult, context) => {
        await runMutationEffects(resData, variables, options);
        options?.onSuccess?.(resData, variables, onMutateResult, context);
