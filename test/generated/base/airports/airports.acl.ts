...
export namespace AirportsAcl {
   ...
   */
  export const canUsePaginate = () => ["Read", "Airport"] as AbilityTuple<"Read", "Airport">;
   ...
   */
  export const canUseCreate = () => ["Create", "Airport"] as AbilityTuple<"Create", "Airport">;
   ...
   */
  export const canUsePaginateLabels = () => ["Read", "Airport"] as AbilityTuple<"Read", "Airport">;
   ...
   */
  export const canUseUpdate = () => ["Update", "Airport"] as AbilityTuple<"Update", "Airport">;
   ...
   */
  export const canUseFindById = () => ["Read", "Airport"] as AbilityTuple<"Read", "Airport">;
}
