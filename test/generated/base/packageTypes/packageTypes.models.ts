...
export namespace PackageTypesModels {
   ...
   * @type { enum }
   */
  export const PackageTypeCodeEnumSchema = z.enum([
    "1A",
    "1B",
    "1D",
    "1F",
   ...
   */
  export const PackageTypeResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier for the package type"),
      name: z.string().describe("Unique name for the package type"),
      length: z.number().describe("Length of the package type").nullish(),
      width: z.number().describe("Width of the package type").nullish(),
      height: z.number().describe("Height of the package type").nullish(),
      unit: z.string().describe("Measurement unit for dimensions"),
      archived: z.boolean().describe("Indicates if the package type is archived"),
      code: PackageTypeCodeEnumSchema.nullish(),
      createdById: z.string().nullish(),
      createdBy: PackageTypeEmployeeDTOSchema.nullish(),
      createdAt: z.iso.datetime({ offset: true }),
      updatedById: z.string().nullish(),
      updatedBy: PackageTypeEmployeeDTOSchema.nullish(),
   ...
   * @property { PackageTypeCodeEnum } code
   */
  export const CreatePackageTypeRequestDTOSchema = z
    .object({
      name: z.string().describe("Unique name for the package type"),
      length: z.number().describe("Length of the package type").nullish(),
      width: z.number().describe("Width of the package type").nullish(),
   ...
   * @property { PackageTypeCodeEnum } code
   */
  export const UpdatePackageTypeRequestDTOSchema = z
    .object({
      name: z.string().describe("Updated name for package type"),
      length: z.number().describe("Updated length of the package type").nullable(),
      width: z.number().describe("Updated width of the package type").nullable(),
      height: z.number().describe("Updated height of the package type").nullable(),
      unit: z.string().describe("Updated measurement unit for dimensions"),
      code: PackageTypeCodeEnumSchema,
    })
    .readonly();
   ...
   */
  export const PackageTypePaginationFilterDtoSchema = z
    .object({ archived: z.boolean().describe("Archived"), search: z.string() })
    .readonly();
   ...
   * @type { enum }
   */
  export const PackageTypesPaginateOrderParamEnumSchema = z.enum([
    "matchCode",
    "description",
    "length",
    "width",
   ...
   */
  export const PackageTypesPaginateResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
    ...z.object({ items: z.array(PackageTypeResponseDTOSchema).readonly() }).readonly().shape,
  });
   ...
   * @type { enum }
   */
  export const PackageTypesPaginateLabelsOrderParamEnumSchema = z.enum([
    "matchCode",
    "description",
    "length",
    "width",
   ...
   */
  export const PackageTypesPaginateLabelsResponseSchema = z.object({
    ...CommonModels.PaginationDtoSchema.shape,
