...
export namespace PositionCargoApi {
  export const listCargosByPositionId = (
    officeId: string,
    positionId: string,
    limit: number,
    ...
    return AppRestClient.get(
      ...
      `/offices/${officeId}/positions/${positionId}/cargos`,
      {
        ...config,
        params: {
          order: ZodExtended.parse(PositionCargoModels.ListCargosByPositionIdOrderParamSchema.optional(), order, {
            type: "query",
            name: "order",
          }),
