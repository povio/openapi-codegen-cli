...
export namespace BankAccountsModels {
   ...
   */
  export const BankAccountFilterDtoSchema = z
    .object({
      search: z.string().describe("Search by name or bank name"),
   ...
   */
  export const BankAccountsPaginateLabelsResponseSchema = z.object({
