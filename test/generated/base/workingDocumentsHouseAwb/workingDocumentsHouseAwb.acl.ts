...
export namespace WorkingDocumentsHouseAwbAcl {
  ...
  export const canUseCreate = (object?: { officeId: string }) =>
    ["Create", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Create",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseGetHouseAwbData = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Read",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseUpdateHouseAwbData = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Update",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseDeleteHouseAwb = (object?: { officeId: string }) =>
    ["Delete", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Delete",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUsePreviewHouseAwb = (object?: { officeId: string }) =>
    ["Read", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Read",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
   ...
   */
  export const canUseGenerateHouseAwb = (object?: { officeId: string }) =>
    ["Update", object ? subject("WorkingDocument-house-awb", object) : "WorkingDocument-house-awb"] as AbilityTuple<
      "Update",
      "WorkingDocument-house-awb" | (ForcedSubject<"WorkingDocument-house-awb"> & { officeId: string })
    >;
