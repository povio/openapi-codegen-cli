...
export namespace WorkingDocumentsHouseAwbModels {
   ...
   */
  export const HouseAwbDocumentOtherChargeDTOSchema = z
    .object({
   ...
   */
  export const HouseAwbDocumentChargesDTOSchema = z
    .object({
      ...
      otherCharges: z.array(HouseAwbDocumentOtherChargeDTOSchema).readonly().describe("Other charges"),
    })
    .readonly();
   ...
   */
  export const HouseAwbDocumentCargoDTOSchema = z
    .object({
   ...
   */
  export const HouseAwbDocumentRouteDTOSchema = z
    .object({
   ...
   */
  export const HouseAwbDocumentBusinessPartnerResponseDTOSchema = z
    .object({
    ...
    .readonly();
  export type HouseAwbDocumentBusinessPartnerResponseDTO = z.infer<
    typeof HouseAwbDocumentBusinessPartnerResponseDTOSchema
  >;
   ...
   */
  export const HouseAwbDocumentResponseDTOSchema = z
    .object({
      id: z.string().describe("Unique identifier of the House AWB document"),
      ...
      name: z.string().describe("Name of the House AWB document"),
      ...
      hawbNumber: z.string().describe("HAWB number").nullish(),
      ...
      cargo: z.array(HouseAwbDocumentCargoDTOSchema).readonly().describe("Cargo packages").nullish(),
      charges: HouseAwbDocumentChargesDTOSchema.describe("Charges").nullish(),
      ...
      route: HouseAwbDocumentRouteDTOSchema.describe("Route").nullish(),
      issuer: HouseAwbDocumentBusinessPartnerResponseDTOSchema.describe("Issuer").nullish(),
      consignee: HouseAwbDocumentBusinessPartnerResponseDTOSchema.describe("Consignee").nullish(),
      shipper: HouseAwbDocumentBusinessPartnerResponseDTOSchema.describe("Shipper").nullish(),
   ...
   * @property { number } sellRate Sell rate
   */
  export const UpdateHouseAwbDocumentChargesOtherChargeDTOSchema = z
    .object({ chargeTypeId: z.string().describe("Charge type ID"), sellRate: z.number().describe("Sell rate") })
    .readonly();
  export type UpdateHouseAwbDocumentChargesOtherChargeDTO = z.infer<
    typeof UpdateHouseAwbDocumentChargesOtherChargeDTOSchema
  >;
   ...
   */
  export const UpdateHouseAwbDocumentChargesDTOSchema = z
    .object({
      weightCharge: z.number().describe("Weight charge"),
      otherCharges: z.array(UpdateHouseAwbDocumentChargesOtherChargeDTOSchema).readonly().describe("Other charges"),
    })
    .readonly();
   ...
   */
  export const UpdateHouseAwbDocumentBusinessPartnerRequestDTOSchema = z
    .object({
      id: z.string().describe("Business partner ID"),
      address: z.string().describe("Business partner address"),
    })
    .readonly();
  export type UpdateHouseAwbDocumentBusinessPartnerRequestDTO = z.infer<
    typeof UpdateHouseAwbDocumentBusinessPartnerRequestDTOSchema
  >;
   ...
   */
  export const UpdateHouseAwbDocumentRequestDTOSchema = z
    .object({
      nameSuffix: z.string().describe("Document name suffix"),
      hawbNumber: z.string().describe("HAWB number"),
      ...
      suppressContainerWeight: z.boolean().describe("Suppress container weight"),
      suppressCargoMeasurement: z.boolean().describe("Suppress cargo measurement"),
      charges: UpdateHouseAwbDocumentChargesDTOSchema.describe("Charges"),
      ...
      consignee: UpdateHouseAwbDocumentBusinessPartnerRequestDTOSchema.describe("Consignee"),
      shipper: UpdateHouseAwbDocumentBusinessPartnerRequestDTOSchema.describe("Shipper"),
