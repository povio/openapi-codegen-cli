...
export const getListDunningsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, page?: number, cursor?: string }) => ({
...
export const useListDunnings = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof DunningManagementApi.listDunnings, TData>) => {
  ...
  return useQuery({
    ...getListDunningsQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(DunningManagementAcl.canUseListDunnings({ officeId } ));
      return getListDunningsQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListDunnings = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListDunningsQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getListDunningsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, cursor?: string }) => ({
...
export const useListDunningsInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof DunningManagementApi.listDunnings, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListDunningsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(DunningManagementAcl.canUseListDunnings({ officeId } ));
      return getListDunningsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListDunningsInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningManagementModels.DunningFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListDunningsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getGetDunningEmlQueryOptions = ({ officeId, dunningId }: { officeId: string, dunningId: string }) => ({
...
export const useGetDunningEml = <TData>({ officeId, dunningId }: { officeId: string, dunningId: string }, options?: AppQueryOptions<typeof DunningManagementApi.getDunningEml, TData>) => {
  ...
  return useQuery({
    ...getGetDunningEmlQueryOptions({ officeId, dunningId }),
    queryFn: async () => {
    checkAcl(DunningManagementAcl.canUseGetDunningEml({ officeId } ));
      return getGetDunningEmlQueryOptions({ officeId, dunningId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetDunningEml = (queryClient: QueryClient, { officeId, dunningId }: { officeId: string, dunningId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetDunningEmlQueryOptions({ officeId, dunningId }), ...options });
};
