...
export const getGetBlInstructionsDataQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
...
export const useGetBlInstructionsData = <TData>({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsBlInstructionsApi.getBlInstructionsData, TData>) => {
  ...
  return useQuery({
    ...getGetBlInstructionsDataQueryOptions({ positionId, blInstructionsId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsBlInstructionsAcl.canUseGetBlInstructionsData({ officeId } ));
      return getGetBlInstructionsDataQueryOptions({ positionId, blInstructionsId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetBlInstructionsData = (queryClient: QueryClient, { positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetBlInstructionsDataQueryOptions({ positionId, blInstructionsId, officeId }), ...options });
};
...
export const getPreviewBlInstructionsQueryOptions = ({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }) => ({
...
export const usePreviewBlInstructions = <TData>({ positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsBlInstructionsApi.previewBlInstructions, TData>) => {
  ...
  return useQuery({
    ...getPreviewBlInstructionsQueryOptions({ positionId, blInstructionsId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsBlInstructionsAcl.canUsePreviewBlInstructions({ officeId } ));
      return getPreviewBlInstructionsQueryOptions({ positionId, blInstructionsId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchPreviewBlInstructions = (queryClient: QueryClient, { positionId, blInstructionsId, officeId }: { positionId: string, blInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewBlInstructionsQueryOptions({ positionId, blInstructionsId, officeId }), ...options });
};
