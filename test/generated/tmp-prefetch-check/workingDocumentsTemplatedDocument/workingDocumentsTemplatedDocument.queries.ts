...
export const getGetTemplatedDocumentQueryOptions = ({ officeId, positionId, templatedDocumentId }: { officeId: string, positionId: string, templatedDocumentId: string }) => ({
...
export const useGetTemplatedDocument = <TData>({ officeId, positionId, templatedDocumentId }: { officeId: string, positionId: string, templatedDocumentId: string }, options?: AppQueryOptions<typeof WorkingDocumentsTemplatedDocumentApi.getTemplatedDocument, TData>) => {
  ...
  return useQuery({
    ...getGetTemplatedDocumentQueryOptions({ officeId, positionId, templatedDocumentId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsTemplatedDocumentAcl.canUseGetTemplatedDocument({ officeId } ));
      return getGetTemplatedDocumentQueryOptions({ officeId, positionId, templatedDocumentId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetTemplatedDocument = (queryClient: QueryClient, { officeId, positionId, templatedDocumentId }: { officeId: string, positionId: string, templatedDocumentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetTemplatedDocumentQueryOptions({ officeId, positionId, templatedDocumentId }), ...options });
};
