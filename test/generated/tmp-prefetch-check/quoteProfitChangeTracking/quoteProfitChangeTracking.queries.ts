...
export const getFindProfitChangeGroupsQueryOptions = ({ officeId, quoteId, limit, page, cursor }: { officeId: string, quoteId: string, limit: number, page?: number, cursor?: string }) => ({
...
export const useFindProfitChangeGroups = <TData>({ officeId, quoteId, limit, page, cursor }: { officeId: string, quoteId: string, limit: number, page?: number, cursor?: string }, options?: AppQueryOptions<typeof QuoteProfitChangeTrackingApi.findProfitChangeGroups, TData>) => {
  ...
  return useQuery({
    ...getFindProfitChangeGroupsQueryOptions({ officeId, quoteId, limit, page, cursor }),
    queryFn: async () => {
    checkAcl(QuoteProfitChangeTrackingAcl.canUseFindProfitChangeGroups({ officeId, quoteId } ));
      return getFindProfitChangeGroupsQueryOptions({ officeId, quoteId, limit, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindProfitChangeGroups = (queryClient: QueryClient, { officeId, quoteId, limit, page, cursor }: { officeId: string, quoteId: string, limit: number, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindProfitChangeGroupsQueryOptions({ officeId, quoteId, limit, page, cursor }), ...options });
};

export const getFindProfitChangeGroupsInfiniteQueryOptions = ({ officeId, quoteId, limit, cursor }: { officeId: string, quoteId: string, limit: number, cursor?: string }) => ({
...
export const useFindProfitChangeGroupsInfinite = <TData>({ officeId, quoteId, limit, cursor }: { officeId: string, quoteId: string, limit: number, cursor?: string }, options?: AppInfiniteQueryOptions<typeof QuoteProfitChangeTrackingApi.findProfitChangeGroups, TData>) => {
  ...
  return useInfiniteQuery({
    ...getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, quoteId, limit, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(QuoteProfitChangeTrackingAcl.canUseFindProfitChangeGroups({ officeId, quoteId } ));
      return getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, quoteId, limit, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchFindProfitChangeGroupsInfinite = (queryClient: QueryClient, { officeId, quoteId, limit, cursor }: { officeId: string, quoteId: string, limit: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, quoteId, limit, cursor }), ...options });
};

export const getFindProfitChangeGroupDetailQueryOptions = ({ groupId, officeId, quoteId }: { groupId: string, officeId: string, quoteId: string }) => ({
...
export const useFindProfitChangeGroupDetail = <TData>({ groupId, officeId, quoteId }: { groupId: string, officeId: string, quoteId: string }, options?: AppQueryOptions<typeof QuoteProfitChangeTrackingApi.findProfitChangeGroupDetail, TData>) => {
  ...
  return useQuery({
    ...getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, quoteId }),
    queryFn: async () => {
    checkAcl(QuoteProfitChangeTrackingAcl.canUseFindProfitChangeGroupDetail({ officeId, quoteId } ));
      return getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, quoteId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindProfitChangeGroupDetail = (queryClient: QueryClient, { groupId, officeId, quoteId }: { groupId: string, officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, quoteId }), ...options });
};
