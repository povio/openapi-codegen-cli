...
export const getFindAllQueryOptions = ({ officeId, types, search }: { officeId: string, types: MasterDataModels.MasterDataFindAllTypesParam, search?: string }) => ({
...
export const useFindAll = <TData>({ officeId, types, search }: { officeId: string, types: MasterDataModels.MasterDataFindAllTypesParam, search?: string }, options?: AppQueryOptions<typeof MasterDataApi.findAll, TData>) => {
  ...
  return useQuery({
    ...getFindAllQueryOptions({ officeId, types, search }),
    queryFn: async () => {
    checkAcl(MasterDataAcl.canUseFindAll());
      return getFindAllQueryOptions({ officeId, types, search }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindAll = (queryClient: QueryClient, { officeId, types, search }: { officeId: string, types: MasterDataModels.MasterDataFindAllTypesParam, search?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindAllQueryOptions({ officeId, types, search }), ...options });
};

export const getPaginateQueryOptions = ({ officeId, types, limit, search, page, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, page?: number, cursor?: string }) => ({
...
export const usePaginate = <TData>({ officeId, types, limit, search, page, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, page?: number, cursor?: string }, options?: AppQueryOptions<typeof MasterDataApi.paginate, TData>) => {
  ...
  return useQuery({
    ...getPaginateQueryOptions({ officeId, types, limit, search, page, cursor }),
    queryFn: async () => {
    checkAcl(MasterDataAcl.canUsePaginate());
      return getPaginateQueryOptions({ officeId, types, limit, search, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginate = (queryClient: QueryClient, { officeId, types, limit, search, page, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateQueryOptions({ officeId, types, limit, search, page, cursor }), ...options });
};

export const getPaginateInfiniteQueryOptions = ({ officeId, types, limit, search, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, cursor?: string }) => ({
...
export const usePaginateInfinite = <TData>({ officeId, types, limit, search, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, cursor?: string }, options?: AppInfiniteQueryOptions<typeof MasterDataApi.paginate, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateInfiniteQueryOptions({ officeId, types, limit, search, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(MasterDataAcl.canUsePaginate());
      return getPaginateInfiniteQueryOptions({ officeId, types, limit, search, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateInfinite = (queryClient: QueryClient, { officeId, types, limit, search, cursor }: { officeId: string, types: MasterDataModels.MasterDataPaginateTypesParam, limit: number, search?: string, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateInfiniteQueryOptions({ officeId, types, limit, search, cursor }), ...options });
};
