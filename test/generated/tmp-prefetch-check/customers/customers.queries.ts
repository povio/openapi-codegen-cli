...
export const getFindProfileQueryOptions = () => ({
...
export const prefetchFindProfile = (queryClient: QueryClient, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindProfileQueryOptions(), ...options });
};
...
export const getListQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CustomersModels.CustomerPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const getListInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CustomersModels.CustomerPaginationFilterDto, cursor?: string }) => ({
...
export const getFindByIdQueryOptions = ({ customerId }: { customerId: string }) => ({
...
export const useFindById = <TData>({ customerId }: { customerId: string }, options?: AppQueryOptions<typeof CustomersApi.findById, TData>) => {
  ...
  return useQuery({
    ...getFindByIdQueryOptions({ customerId }),
    queryFn: async () => {
    checkAcl(CustomersAcl.canUseFindById());
      return getFindByIdQueryOptions({ customerId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindById = (queryClient: QueryClient, { customerId }: { customerId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindByIdQueryOptions({ customerId }), ...options });
};
