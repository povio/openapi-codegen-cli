...
export const getPaginateBatchesQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateBatches = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof BookkeepingExportApi.paginateBatches, TData>) => {
  ...
  return useQuery({
    ...getPaginateBatchesQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(BookkeepingExportAcl.canUsePaginateBatches({ officeId } ));
      return getPaginateBatchesQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginateBatches = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateBatchesQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateBatchesInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, cursor?: string }) => ({
...
export const usePaginateBatchesInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof BookkeepingExportApi.paginateBatches, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateBatchesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(BookkeepingExportAcl.canUsePaginateBatches({ officeId } ));
      return getPaginateBatchesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateBatchesInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateBatchesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};

export const getGetBatchQueryOptions = ({ officeId, batchId }: { officeId: string, batchId: string }) => ({
...
export const useGetBatch = <TData>({ officeId, batchId }: { officeId: string, batchId: string }, options?: AppQueryOptions<typeof BookkeepingExportApi.getBatch, TData>) => {
  ...
  return useQuery({
    ...getGetBatchQueryOptions({ officeId, batchId }),
    queryFn: async () => {
    checkAcl(BookkeepingExportAcl.canUseGetBatch({ officeId } ));
      return getGetBatchQueryOptions({ officeId, batchId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetBatch = (queryClient: QueryClient, { officeId, batchId }: { officeId: string, batchId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetBatchQueryOptions({ officeId, batchId }), ...options });
};
...
export const getPaginateBatchItemsQueryOptions = ({ officeId, batchId, limit, order, filter, page, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateBatchItems = <TData>({ officeId, batchId, limit, order, filter, page, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof BookkeepingExportApi.paginateBatchItems, TData>) => {
  ...
  return useQuery({
    ...getPaginateBatchItemsQueryOptions({ officeId, batchId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(BookkeepingExportAcl.canUsePaginateBatchItems({ officeId } ));
      return getPaginateBatchItemsQueryOptions({ officeId, batchId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginateBatchItems = (queryClient: QueryClient, { officeId, batchId, limit, order, filter, page, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateBatchItemsQueryOptions({ officeId, batchId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateBatchItemsInfiniteQueryOptions = ({ officeId, batchId, limit, order, filter, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, cursor?: string }) => ({
...
export const usePaginateBatchItemsInfinite = <TData>({ officeId, batchId, limit, order, filter, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof BookkeepingExportApi.paginateBatchItems, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateBatchItemsInfiniteQueryOptions({ officeId, batchId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(BookkeepingExportAcl.canUsePaginateBatchItems({ officeId } ));
      return getPaginateBatchItemsInfiniteQueryOptions({ officeId, batchId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateBatchItemsInfinite = (queryClient: QueryClient, { officeId, batchId, limit, order, filter, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateBatchItemsInfiniteQueryOptions({ officeId, batchId, limit, order, filter, cursor }), ...options });
};
...
export const getGetVatLineItemsQueryOptions = ({ officeId, batchId, order }: { officeId: string, batchId: string, order?: string }) => ({
...
export const useGetVatLineItems = <TData>({ officeId, batchId, order }: { officeId: string, batchId: string, order?: string }, options?: AppQueryOptions<typeof BookkeepingExportApi.getVatLineItems, TData>) => {
  ...
  return useQuery({
    ...getGetVatLineItemsQueryOptions({ officeId, batchId, order }),
    queryFn: async () => {
    checkAcl(BookkeepingExportAcl.canUseGetVatLineItems({ officeId } ));
      return getGetVatLineItemsQueryOptions({ officeId, batchId, order }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetVatLineItems = (queryClient: QueryClient, { officeId, batchId, order }: { officeId: string, batchId: string, order?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetVatLineItemsQueryOptions({ officeId, batchId, order }), ...options });
};
