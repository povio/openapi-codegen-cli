...
export const getListCargosByPositionIdQueryOptions = ({ officeId, positionId, limit, order, page, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, page?: number, cursor?: string }) => ({
...
export const useListCargosByPositionId = <TData>({ officeId, positionId, limit, order, page, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, page?: number, cursor?: string }, options?: AppQueryOptions<typeof PositionCargoApi.listCargosByPositionId, TData>) => {
  ...
  return useQuery({
    ...getListCargosByPositionIdQueryOptions({ officeId, positionId, limit, order, page, cursor }),
    queryFn: async () => {
    checkAcl(PositionCargoAcl.canUseListCargosByPositionId({ officeId } ));
      return getListCargosByPositionIdQueryOptions({ officeId, positionId, limit, order, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListCargosByPositionId = (queryClient: QueryClient, { officeId, positionId, limit, order, page, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListCargosByPositionIdQueryOptions({ officeId, positionId, limit, order, page, cursor }), ...options });
};

export const getListCargosByPositionIdInfiniteQueryOptions = ({ officeId, positionId, limit, order, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, cursor?: string }) => ({
...
export const useListCargosByPositionIdInfinite = <TData>({ officeId, positionId, limit, order, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, cursor?: string }, options?: AppInfiniteQueryOptions<typeof PositionCargoApi.listCargosByPositionId, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListCargosByPositionIdInfiniteQueryOptions({ officeId, positionId, limit, order, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(PositionCargoAcl.canUseListCargosByPositionId({ officeId } ));
      return getListCargosByPositionIdInfiniteQueryOptions({ officeId, positionId, limit, order, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListCargosByPositionIdInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, cursor }: { officeId: string, positionId: string, limit: number, order?: PositionCargoModels.ListCargosByPositionIdOrderParam, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListCargosByPositionIdInfiniteQueryOptions({ officeId, positionId, limit, order, cursor }), ...options });
};
...
export const getListCargoLabelsQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const useListCargoLabels = <TData>({ officeId, positionId }: { officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionCargoApi.listCargoLabels, TData>) => {
  ...
  return useQuery({
    ...getListCargoLabelsQueryOptions({ officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionCargoAcl.canUseListCargoLabels({ officeId } ));
      return getListCargoLabelsQueryOptions({ officeId, positionId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListCargoLabels = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListCargoLabelsQueryOptions({ officeId, positionId }), ...options });
};

export const getGetCargoSummaryQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const useGetCargoSummary = <TData>({ officeId, positionId }: { officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionCargoApi.getCargoSummary, TData>) => {
  ...
  return useQuery({
    ...getGetCargoSummaryQueryOptions({ officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionCargoAcl.canUseGetCargoSummary({ officeId } ));
      return getGetCargoSummaryQueryOptions({ officeId, positionId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetCargoSummary = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetCargoSummaryQueryOptions({ officeId, positionId }), ...options });
};

export const getGetCargoByIdQueryOptions = ({ officeId, positionId, cargoId }: { officeId: string, positionId: string, cargoId: string }) => ({
...
export const useGetCargoById = <TData>({ officeId, positionId, cargoId }: { officeId: string, positionId: string, cargoId: string }, options?: AppQueryOptions<typeof PositionCargoApi.getCargoById, TData>) => {
  ...
  return useQuery({
    ...getGetCargoByIdQueryOptions({ officeId, positionId, cargoId }),
    queryFn: async () => {
    checkAcl(PositionCargoAcl.canUseGetCargoById({ officeId } ));
      return getGetCargoByIdQueryOptions({ officeId, positionId, cargoId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetCargoById = (queryClient: QueryClient, { officeId, positionId, cargoId }: { officeId: string, positionId: string, cargoId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetCargoByIdQueryOptions({ officeId, positionId, cargoId }), ...options });
};
