...
export const getListQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: IntegrationChannelsModels.IntegrationChannelFilterDto, page?: number, cursor?: string }) => ({
...
export const getListInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: IntegrationChannelsModels.IntegrationChannelFilterDto, cursor?: string }) => ({
...
export const getPaginateLabelsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: IntegrationChannelsModels.IntegrationChannelLabelsFilterDto, page?: number, cursor?: string }) => ({
...
export const getPaginateLabelsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: IntegrationChannelsModels.IntegrationChannelLabelsFilterDto, cursor?: string }) => ({
...
export const getFindByIdQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useFindById = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof IntegrationChannelsApi.findById, TData>) => {
  ...
  return useQuery({
    ...getFindByIdQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(IntegrationChannelsAcl.canUseFindById({ officeId } ));
      return getFindByIdQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindById = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindByIdQueryOptions({ officeId, id }), ...options });
};
