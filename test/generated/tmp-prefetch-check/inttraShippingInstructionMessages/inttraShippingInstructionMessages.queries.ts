...
export const getListQueryOptions = ({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, page?: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }) => ({
...
export const useList = <TData>({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, page?: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: AppQueryOptions<typeof InttraShippingInstructionMessagesApi.list, TData>) => {
  ...
  return useQuery({
    ...getListQueryOptions({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }),
    queryFn: async () => {
    checkAcl(InttraShippingInstructionMessagesAcl.canUseList({ officeId } ));
      return getListQueryOptions({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }).queryFn();
    },
    ...options,
  });
};

export const prefetchList = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, page?: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListQueryOptions({ officeId, positionId, shippingInstructionsId, limit, page, cursor, filter }), ...options });
};

export const getListInfiniteQueryOptions = ({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }) => ({
...
export const useListInfinite = <TData>({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: AppInfiniteQueryOptions<typeof InttraShippingInstructionMessagesApi.list, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListInfiniteQueryOptions({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InttraShippingInstructionMessagesAcl.canUseList({ officeId } ));
      return getListInfiniteQueryOptions({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListInfinite = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, limit, cursor, filter }: { officeId: string, positionId: string, shippingInstructionsId: string, limit: number, cursor?: string, filter?: InttraShippingInstructionMessagesModels.ShippingInstructionMessageFilterDto }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListInfiniteQueryOptions({ officeId, positionId, shippingInstructionsId, limit, cursor, filter }), ...options });
};
...
export const getGetByIdQueryOptions = ({ officeId, positionId, shippingInstructionsId, messageId }: { officeId: string, positionId: string, shippingInstructionsId: string, messageId: string }) => ({
...
export const useGetById = <TData>({ officeId, positionId, shippingInstructionsId, messageId }: { officeId: string, positionId: string, shippingInstructionsId: string, messageId: string }, options?: AppQueryOptions<typeof InttraShippingInstructionMessagesApi.getById, TData>) => {
  ...
  return useQuery({
    ...getGetByIdQueryOptions({ officeId, positionId, shippingInstructionsId, messageId }),
    queryFn: async () => {
    checkAcl(InttraShippingInstructionMessagesAcl.canUseGetById({ officeId } ));
      return getGetByIdQueryOptions({ officeId, positionId, shippingInstructionsId, messageId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetById = (queryClient: QueryClient, { officeId, positionId, shippingInstructionsId, messageId }: { officeId: string, positionId: string, shippingInstructionsId: string, messageId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetByIdQueryOptions({ officeId, positionId, shippingInstructionsId, messageId }), ...options });
};
