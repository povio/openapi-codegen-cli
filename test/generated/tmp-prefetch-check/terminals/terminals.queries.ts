...
export const getPaginateQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: TerminalsModels.TerminalPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const getPaginateInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: TerminalsModels.TerminalPaginationFilterDto, cursor?: string }) => ({
...
export const getPaginateLabelsQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: TerminalsModels.TerminalLabelFilterDto, page?: number, cursor?: string }) => ({
...
export const getPaginateLabelsInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: TerminalsModels.TerminalLabelFilterDto, cursor?: string }) => ({
...
export const getGetByIdQueryOptions = ({ id }: { id: string }) => ({
...
export const useGetById = <TData>({ id }: { id: string }, options?: AppQueryOptions<typeof TerminalsApi.getById, TData>) => {
  ...
  return useQuery({
    ...getGetByIdQueryOptions({ id }),
    queryFn: async () => {
    checkAcl(TerminalsAcl.canUseGetById());
      return getGetByIdQueryOptions({ id }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetById = (queryClient: QueryClient, { id }: { id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetByIdQueryOptions({ id }), ...options });
};
