...
export const getPaginateQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: QuotesModels.QuoteFilterDto, page?: number, cursor?: string }) => ({
...
export const getPaginateInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: QuotesModels.QuoteFilterDto, cursor?: string }) => ({
...
export const getListAvailablePartnersForQueryOptions = ({ officeId, quoteId, search, useCase }: { officeId: string, quoteId: string, search?: string, useCase?: QuotesModels.PositionAvailablePartnersUseCase }) => ({
...
export const useListAvailablePartnersFor = <TData>({ officeId, quoteId, search, useCase }: { officeId: string, quoteId: string, search?: string, useCase?: QuotesModels.PositionAvailablePartnersUseCase }, options?: AppQueryOptions<typeof QuotesApi.listAvailablePartnersFor, TData>) => {
  ...
  return useQuery({
    ...getListAvailablePartnersForQueryOptions({ officeId, quoteId, search, useCase }),
    queryFn: async () => {
    checkAcl(QuotesAcl.canUseListAvailablePartnersFor({ officeId } ));
      return getListAvailablePartnersForQueryOptions({ officeId, quoteId, search, useCase }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListAvailablePartnersFor = (queryClient: QueryClient, { officeId, quoteId, search, useCase }: { officeId: string, quoteId: string, search?: string, useCase?: QuotesModels.PositionAvailablePartnersUseCase }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListAvailablePartnersForQueryOptions({ officeId, quoteId, search, useCase }), ...options });
};
...
export const getGetByIdQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
export const useGetById = <TData>({ officeId, quoteId }: { officeId: string, quoteId: string }, options?: AppQueryOptions<typeof QuotesApi.getById, TData>) => {
  ...
  return useQuery({
    ...getGetByIdQueryOptions({ officeId, quoteId }),
    queryFn: async () => {
    checkAcl(QuotesAcl.canUseGetById({ officeId } ));
      return getGetByIdQueryOptions({ officeId, quoteId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetById = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetByIdQueryOptions({ officeId, quoteId }), ...options });
};
...
export const getGetInvolvedPartiesQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
export const useGetInvolvedParties = <TData>({ officeId, quoteId }: { officeId: string, quoteId: string }, options?: AppQueryOptions<typeof QuotesApi.getInvolvedParties, TData>) => {
  ...
  return useQuery({
    ...getGetInvolvedPartiesQueryOptions({ officeId, quoteId }),
    queryFn: async () => {
    checkAcl(QuotesAcl.canUseGetInvolvedParties({ officeId } ));
      return getGetInvolvedPartiesQueryOptions({ officeId, quoteId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetInvolvedParties = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetInvolvedPartiesQueryOptions({ officeId, quoteId }), ...options });
};
