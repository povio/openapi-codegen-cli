...
export const getFindAllQueryOptions = ({ officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }) => ({
...
export const useFindAll = <TData>({ officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof PositionsApi.findAll, TData>) => {
  ...
  return useQuery({
    ...getFindAllQueryOptions({ officeId, limit, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseFindAll({ officeId } ));
      return getFindAllQueryOptions({ officeId, limit, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchFindAll = (queryClient: QueryClient, { officeId, limit, filter, page, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindAllQueryOptions({ officeId, limit, filter, page, cursor }), ...options });
};

export const getFindAllInfiniteQueryOptions = ({ officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }) => ({
...
export const useFindAllInfinite = <TData>({ officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof PositionsApi.findAll, TData>) => {
  ...
  return useInfiniteQuery({
    ...getFindAllInfiniteQueryOptions({ officeId, limit, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(PositionsAcl.canUseFindAll({ officeId } ));
      return getFindAllInfiniteQueryOptions({ officeId, limit, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};

export const prefetchFindAllInfinite = (queryClient: QueryClient, { officeId, limit, filter, cursor }: { officeId: string, limit: number, filter?: PositionsModels.PositionLabelsFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getFindAllInfiniteQueryOptions({ officeId, limit, filter, cursor }), ...options });
};

export const getPaginateQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchPaginate = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: PositionsModels.PositionFilterDto, cursor?: string }) => ({
...
export const getTotalProfitQueryOptions = ({ officeId }: { officeId: string }) => ({
...
export const useTotalProfit = <TData>({ officeId }: { officeId: string }, options?: AppQueryOptions<typeof PositionsApi.totalProfit, TData>) => {
  ...
  return useQuery({
    ...getTotalProfitQueryOptions({ officeId }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseTotalProfit({ officeId } ));
      return getTotalProfitQueryOptions({ officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchTotalProfit = (queryClient: QueryClient, { officeId }: { officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getTotalProfitQueryOptions({ officeId }), ...options });
};

export const getListAvailablePartnersForQueryOptions = ({ officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }) => ({
...
export const useListAvailablePartnersFor = <TData>({ officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }, options?: AppQueryOptions<typeof PositionsApi.listAvailablePartnersFor, TData>) => {
  ...
  return useQuery({
    ...getListAvailablePartnersForQueryOptions({ officeId, positionId, search, useCase }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseListAvailablePartnersFor({ officeId } ));
      return getListAvailablePartnersForQueryOptions({ officeId, positionId, search, useCase }).queryFn();
    },
    ...options,
  });
};

export const prefetchListAvailablePartnersFor = (queryClient: QueryClient, { officeId, positionId, search, useCase }: { officeId: string, positionId: string, search?: string, useCase?: PositionsModels.PositionAvailablePartnersUseCase }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListAvailablePartnersForQueryOptions({ officeId, positionId, search, useCase }), ...options });
};
...
export const getGetQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const useGet = <TData>({ officeId, positionId }: { officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionsApi.get, TData>) => {
  ...
  return useQuery({
    ...getGetQueryOptions({ officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseGet({ officeId } ));
      return getGetQueryOptions({ officeId, positionId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGet = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetQueryOptions({ officeId, positionId }), ...options });
};
...
export const getListRouteLabelsQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const useListRouteLabels = <TData>({ officeId, positionId }: { officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionsApi.listRouteLabels, TData>) => {
  ...
  return useQuery({
    ...getListRouteLabelsQueryOptions({ officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseListRouteLabels({ officeId } ));
      return getListRouteLabelsQueryOptions({ officeId, positionId }).queryFn();
    },
    ...options,
  });
};

export const prefetchListRouteLabels = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListRouteLabelsQueryOptions({ officeId, positionId }), ...options });
};

export const getGetDuplicateDefaultParametersQueryOptions = ({ officeId, positionId }: { officeId: string, positionId: string }) => ({
...
export const useGetDuplicateDefaultParameters = <TData>({ officeId, positionId }: { officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionsApi.getDuplicateDefaultParameters, TData>) => {
  ...
  return useQuery({
    ...getGetDuplicateDefaultParametersQueryOptions({ officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseGetDuplicateDefaultParameters({ officeId } ));
      return getGetDuplicateDefaultParametersQueryOptions({ officeId, positionId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetDuplicateDefaultParameters = (queryClient: QueryClient, { officeId, positionId }: { officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetDuplicateDefaultParametersQueryOptions({ officeId, positionId }), ...options });
};
...
export const getListChildQueryOptions = ({ officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }) => ({
...
export const useListChild = <TData>({ officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }, options?: AppQueryOptions<typeof PositionsApi.listChild, TData>) => {
  ...
  return useQuery({
    ...getListChildQueryOptions({ officeId, positionId, limit, page, cursor }),
    queryFn: async () => {
    checkAcl(PositionsAcl.canUseListChild({ officeId } ));
      return getListChildQueryOptions({ officeId, positionId, limit, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchListChild = (queryClient: QueryClient, { officeId, positionId, limit, page, cursor }: { officeId: string, positionId: string, limit: number, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListChildQueryOptions({ officeId, positionId, limit, page, cursor }), ...options });
};

export const getListChildInfiniteQueryOptions = ({ officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }) => ({
...
export const useListChildInfinite = <TData>({ officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }, options?: AppInfiniteQueryOptions<typeof PositionsApi.listChild, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListChildInfiniteQueryOptions({ officeId, positionId, limit, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(PositionsAcl.canUseListChild({ officeId } ));
      return getListChildInfiniteQueryOptions({ officeId, positionId, limit, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};

export const prefetchListChildInfinite = (queryClient: QueryClient, { officeId, positionId, limit, cursor }: { officeId: string, positionId: string, limit: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListChildInfiniteQueryOptions({ officeId, positionId, limit, cursor }), ...options });
};
