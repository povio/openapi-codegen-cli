...
export const getGetMasterAwbDataQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
...
export const useGetMasterAwbData = <TData>({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsMasterAwbApi.getMasterAwbData, TData>) => {
  ...
  return useQuery({
    ...getGetMasterAwbDataQueryOptions({ positionId, mawbId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsMasterAwbAcl.canUseGetMasterAwbData({ officeId } ));
      return getGetMasterAwbDataQueryOptions({ positionId, mawbId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetMasterAwbData = (queryClient: QueryClient, { positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetMasterAwbDataQueryOptions({ positionId, mawbId, officeId }), ...options });
};
...
export const getPreviewMasterAwbQueryOptions = ({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }) => ({
...
export const usePreviewMasterAwb = <TData>({ positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsMasterAwbApi.previewMasterAwb, TData>) => {
  ...
  return useQuery({
    ...getPreviewMasterAwbQueryOptions({ positionId, mawbId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsMasterAwbAcl.canUsePreviewMasterAwb({ officeId } ));
      return getPreviewMasterAwbQueryOptions({ positionId, mawbId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchPreviewMasterAwb = (queryClient: QueryClient, { positionId, mawbId, officeId }: { positionId: string, mawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewMasterAwbQueryOptions({ positionId, mawbId, officeId }), ...options });
};
