...
export const getPaginateQueryOptions = ({ limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginate = <TData>({ limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof EmployeeApi.paginate, TData>) => {
  ...
  return useQuery({
    ...getPaginateQueryOptions({ limit, order, populate, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUsePaginate());
      return getPaginateQueryOptions({ limit, order, populate, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginate = (queryClient: QueryClient, { limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateQueryOptions({ limit, order, populate, filter, page, cursor }), ...options });
};

export const getPaginateInfiniteQueryOptions = ({ limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, cursor?: string }) => ({
...
export const usePaginateInfinite = <TData>({ limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof EmployeeApi.paginate, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateInfiniteQueryOptions({ limit, order, populate, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(EmployeeAcl.canUsePaginate());
      return getPaginateInfiniteQueryOptions({ limit, order, populate, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateInfinite = (queryClient: QueryClient, { limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateInfiniteQueryOptions({ limit, order, populate, filter, cursor }), ...options });
};
...
export const getFindAllQueryOptions = ({ search }: { search?: string }) => ({
...
export const useFindAll = <TData>({ search }: { search?: string }, options?: AppQueryOptions<typeof EmployeeApi.findAll, TData>) => {
  ...
  return useQuery({
    ...getFindAllQueryOptions({ search }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUseFindAll());
      return getFindAllQueryOptions({ search }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindAll = (queryClient: QueryClient, { search }: { search?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindAllQueryOptions({ search }), ...options });
};

export const getPaginateLabelsQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateLabels = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof EmployeeApi.paginateLabels, TData>) => {
  ...
  return useQuery({
    ...getPaginateLabelsQueryOptions({ limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUsePaginateLabels());
      return getPaginateLabelsQueryOptions({ limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginateLabels = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateLabelsQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

export const getPaginateLabelsInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, cursor?: string }) => ({
...
export const usePaginateLabelsInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof EmployeeApi.paginateLabels, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateLabelsInfiniteQueryOptions({ limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(EmployeeAcl.canUsePaginateLabels());
      return getPaginateLabelsInfiniteQueryOptions({ limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchPaginateLabelsInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateLabelsInfiniteQueryOptions({ limit, order, filter, cursor }), ...options });
};
...
export const getGetQueryOptions = ({ employeeId, populate }: { employeeId: string, populate?: EmployeeModels.EmployeeGetPopulateParam }) => ({
...
export const useGet = <TData>({ employeeId, populate }: { employeeId: string, populate?: EmployeeModels.EmployeeGetPopulateParam }, options?: AppQueryOptions<typeof EmployeeApi.get, TData>) => {
  ...
  return useQuery({
    ...getGetQueryOptions({ employeeId, populate }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUseGet());
      return getGetQueryOptions({ employeeId, populate }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGet = (queryClient: QueryClient, { employeeId, populate }: { employeeId: string, populate?: EmployeeModels.EmployeeGetPopulateParam }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetQueryOptions({ employeeId, populate }), ...options });
};
...
export const getGetWithOfficeQueryOptions = ({ officeId, employeeId, populate }: { officeId: string, employeeId: string, populate?: EmployeeModels.GetWithOfficePopulateParam }) => ({
...
export const useGetWithOffice = <TData>({ officeId, employeeId, populate }: { officeId: string, employeeId: string, populate?: EmployeeModels.GetWithOfficePopulateParam }, options?: AppQueryOptions<typeof EmployeeApi.getWithOffice, TData>) => {
  ...
  return useQuery({
    ...getGetWithOfficeQueryOptions({ officeId, employeeId, populate }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUseGetWithOffice({ officeId } ));
      return getGetWithOfficeQueryOptions({ officeId, employeeId, populate }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetWithOffice = (queryClient: QueryClient, { officeId, employeeId, populate }: { officeId: string, employeeId: string, populate?: EmployeeModels.GetWithOfficePopulateParam }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetWithOfficeQueryOptions({ officeId, employeeId, populate }), ...options });
};
...
export const getListRolesQueryOptions = ({ employeeId }: { employeeId: string }) => ({
...
export const useListRoles = <TData>({ employeeId }: { employeeId: string }, options?: AppQueryOptions<typeof EmployeeApi.listRoles, TData>) => {
  ...
  return useQuery({
    ...getListRolesQueryOptions({ employeeId }),
    queryFn: async () => {
    checkAcl(EmployeeAcl.canUseListRoles());
      return getListRolesQueryOptions({ employeeId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListRoles = (queryClient: QueryClient, { employeeId }: { employeeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListRolesQueryOptions({ employeeId }), ...options });
};
