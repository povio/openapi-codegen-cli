...
export const getGetContactsQueryOptions = ({ officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }) => ({
...
export const useGetContacts = <TData>({ officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }, options?: AppQueryOptions<typeof BusinessPartnerContactsApi.getContacts, TData>) => {
  ...
  return useQuery({
    ...getGetContactsQueryOptions({ officeId, businessPartnerId }),
    queryFn: async () => {
    checkAcl(BusinessPartnerContactsAcl.canUseGetContacts({ officeId } ));
      return getGetContactsQueryOptions({ officeId, businessPartnerId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetContacts = (queryClient: QueryClient, { officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetContactsQueryOptions({ officeId, businessPartnerId }), ...options });
};
...
export const getPaginateContactLabelsQueryOptions = ({ officeId, businessPartnerId, limit, order, filter, page, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, page?: number, cursor?: string }) => ({
...
export const usePaginateContactLabels = <TData>({ officeId, businessPartnerId, limit, order, filter, page, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof BusinessPartnerContactsApi.paginateContactLabels, TData>) => {
  ...
  return useQuery({
    ...getPaginateContactLabelsQueryOptions({ officeId, businessPartnerId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(BusinessPartnerContactsAcl.canUsePaginateContactLabels({ officeId } ));
      return getPaginateContactLabelsQueryOptions({ officeId, businessPartnerId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchPaginateContactLabels = (queryClient: QueryClient, { officeId, businessPartnerId, limit, order, filter, page, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateContactLabelsQueryOptions({ officeId, businessPartnerId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateContactLabelsInfiniteQueryOptions = ({ officeId, businessPartnerId, limit, order, filter, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, cursor?: string }) => ({
...
export const usePaginateContactLabelsInfinite = <TData>({ officeId, businessPartnerId, limit, order, filter, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof BusinessPartnerContactsApi.paginateContactLabels, TData>) => {
  ...
  return useInfiniteQuery({
    ...getPaginateContactLabelsInfiniteQueryOptions({ officeId, businessPartnerId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(BusinessPartnerContactsAcl.canUsePaginateContactLabels({ officeId } ));
      return getPaginateContactLabelsInfiniteQueryOptions({ officeId, businessPartnerId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};

export const prefetchPaginateContactLabelsInfinite = (queryClient: QueryClient, { officeId, businessPartnerId, limit, order, filter, cursor }: { officeId: string, businessPartnerId: string, limit: number, order?: string, filter?: BusinessPartnerContactsModels.BusinessPartnerContactFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getPaginateContactLabelsInfiniteQueryOptions({ officeId, businessPartnerId, limit, order, filter, cursor }), ...options });
};
