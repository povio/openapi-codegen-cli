...
export const getPaginateQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchPaginate = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerFilterDto, cursor?: string }) => ({
...
export const getPaginateLabelsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchPaginateLabels = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateLabelsQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getPaginateLabelsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BusinessPartnersModels.BusinessPartnerLabelsFilterDto, cursor?: string }) => ({
...
export const getGetByIdQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useGetById = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof BusinessPartnersApi.getById, TData>) => {
  ...
  return useQuery({
    ...getGetByIdQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(BusinessPartnersAcl.canUseGetById({ officeId } ));
      return getGetByIdQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetById = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetByIdQueryOptions({ officeId, id }), ...options });
};
...
export const getGetRemarksQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useGetRemarks = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof BusinessPartnersApi.getRemarks, TData>) => {
  ...
  return useQuery({
    ...getGetRemarksQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(BusinessPartnersAcl.canUseGetRemarks({ officeId } ));
      return getGetRemarksQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetRemarks = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetRemarksQueryOptions({ officeId, id }), ...options });
};
...
export const getGetBasicInfoQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useGetBasicInfo = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof BusinessPartnersApi.getBasicInfo, TData>) => {
  ...
  return useQuery({
    ...getGetBasicInfoQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(BusinessPartnersAcl.canUseGetBasicInfo({ officeId } ));
      return getGetBasicInfoQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetBasicInfo = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetBasicInfoQueryOptions({ officeId, id }), ...options });
};
...
export const getGetCargoAgentInfoQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useGetCargoAgentInfo = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof BusinessPartnersApi.getCargoAgentInfo, TData>) => {
  ...
  return useQuery({
    ...getGetCargoAgentInfoQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(BusinessPartnersAcl.canUseGetCargoAgentInfo({ officeId } ));
      return getGetCargoAgentInfoQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetCargoAgentInfo = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetCargoAgentInfoQueryOptions({ officeId, id }), ...options });
};
...
export const getGetCarrierInformationQueryOptions = ({ officeId, id }: { officeId: string, id: string }) => ({
...
export const useGetCarrierInformation = <TData>({ officeId, id }: { officeId: string, id: string }, options?: AppQueryOptions<typeof BusinessPartnersApi.getCarrierInformation, TData>) => {
  ...
  return useQuery({
    ...getGetCarrierInformationQueryOptions({ officeId, id }),
    queryFn: async () => {
    checkAcl(BusinessPartnersAcl.canUseGetCarrierInformation({ officeId } ));
      return getGetCarrierInformationQueryOptions({ officeId, id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetCarrierInformation = (queryClient: QueryClient, { officeId, id }: { officeId: string, id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetCarrierInformationQueryOptions({ officeId, id }), ...options });
};
