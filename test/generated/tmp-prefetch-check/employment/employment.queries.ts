...
export const getListQueryOptions = ({ limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string }) => ({
...
export const useList = <TData>({ limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof EmploymentApi.list, TData>) => {
  ...
  return useQuery({
    ...getListQueryOptions({ limit, order, populate, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(EmploymentAcl.canUseList());
      return getListQueryOptions({ limit, order, populate, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchList = (queryClient: QueryClient, { limit, order, populate, filter, page, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListQueryOptions({ limit, order, populate, filter, page, cursor }), ...options });
};

export const getListInfiniteQueryOptions = ({ limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, cursor?: string }) => ({
...
export const useListInfinite = <TData>({ limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof EmploymentApi.list, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListInfiniteQueryOptions({ limit, order, populate, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(EmploymentAcl.canUseList());
      return getListInfiniteQueryOptions({ limit, order, populate, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListInfinite = (queryClient: QueryClient, { limit, order, populate, filter, cursor }: { limit: number, order?: string, populate?: EmploymentModels.EmploymentListPopulateParam, filter?: EmploymentModels.EmploymentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListInfiniteQueryOptions({ limit, order, populate, filter, cursor }), ...options });
};

export const getListRolesQueryOptions = ({ officeId, employmentId }: { officeId: string, employmentId: string }) => ({
...
export const useListRoles = <TData>({ officeId, employmentId }: { officeId: string, employmentId: string }, options?: AppQueryOptions<typeof EmploymentApi.listRoles, TData>) => {
  ...
  return useQuery({
    ...getListRolesQueryOptions({ officeId, employmentId }),
    queryFn: async () => {
    checkAcl(EmploymentAcl.canUseListRoles({ officeId } ));
      return getListRolesQueryOptions({ officeId, employmentId }).queryFn();
    },
    ...options,
  });
};

export const prefetchListRoles = (queryClient: QueryClient, { officeId, employmentId }: { officeId: string, employmentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListRolesQueryOptions({ officeId, employmentId }), ...options });
};
