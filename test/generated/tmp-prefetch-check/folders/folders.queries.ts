...
export const getGetTreeQueryOptions = ({ officeId, folderId }: { officeId: string, folderId: string }) => ({
...
export const useGetTree = <TData>({ officeId, folderId }: { officeId: string, folderId: string }, options?: AppQueryOptions<typeof FoldersApi.getTree, TData>) => {
  ...
  return useQuery({
    ...getGetTreeQueryOptions({ officeId, folderId }),
    ...options,
  });
};

export const prefetchGetTree = (queryClient: QueryClient, { officeId, folderId }: { officeId: string, folderId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetTreeQueryOptions({ officeId, folderId }), ...options });
};

export const getGetContentQueryOptions = ({ officeId, folderId, limit, order, filter, page, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, page?: number, cursor?: string }) => ({
...
export const useGetContent = <TData>({ officeId, folderId, limit, order, filter, page, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof FoldersApi.getContent, TData>) => {
  ...
  return useQuery({
    ...getGetContentQueryOptions({ officeId, folderId, limit, order, filter, page, cursor }),
    ...options,
  });
};

export const prefetchGetContent = (queryClient: QueryClient, { officeId, folderId, limit, order, filter, page, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetContentQueryOptions({ officeId, folderId, limit, order, filter, page, cursor }), ...options });
};

export const getGetContentInfiniteQueryOptions = ({ officeId, folderId, limit, order, filter, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, cursor?: string }) => ({
...
export const useGetContentInfinite = <TData>({ officeId, folderId, limit, order, filter, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof FoldersApi.getContent, TData>) => {
  ...
  return useInfiniteQuery({
    ...getGetContentInfiniteQueryOptions({ officeId, folderId, limit, order, filter, cursor }),
    ...options,
  });
};
...
export const prefetchGetContentInfinite = (queryClient: QueryClient, { officeId, folderId, limit, order, filter, cursor }: { officeId: string, folderId: string, limit: number, order?: FoldersModels.GetContentOrderParam, filter?: FoldersModels.FolderContentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getGetContentInfiniteQueryOptions({ officeId, folderId, limit, order, filter, cursor }), ...options });
};
