...
export const getGetInvoicesEmlQueryOptions = ({ officeId, invoiceIds }: { officeId: string, invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam }) => ({
...
export const useGetInvoicesEml = <TData>({ officeId, invoiceIds }: { officeId: string, invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam }, options?: AppQueryOptions<typeof InvoicesApi.getInvoicesEml, TData>) => {
  ...
  return useQuery({
    ...getGetInvoicesEmlQueryOptions({ officeId, invoiceIds }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetInvoicesEml({ officeId } ));
      return getGetInvoicesEmlQueryOptions({ officeId, invoiceIds }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetInvoicesEml = (queryClient: QueryClient, { officeId, invoiceIds }: { officeId: string, invoiceIds?: InvoicesModels.GetInvoicesEmlInvoiceIdsParam }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetInvoicesEmlQueryOptions({ officeId, invoiceIds }), ...options });
};
...
export const getFindQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, page?: number, cursor?: string }) => ({
...
export const useFind = <TData>({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicesApi.find, TData>) => {
  ...
  return useQuery({
    ...getFindQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseFind({ officeId } ));
      return getFindQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchFind = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }), ...options });
};

export const getFindInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, cursor?: string }) => ({
...
export const useFindInfinite = <TData>({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicesApi.find, TData>) => {
  ...
  return useInfiniteQuery({
    ...getFindInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicesAcl.canUseFind({ officeId } ));
      return getFindInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchFindInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.InvoiceFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getFindInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }), ...options });
};
...
export const getFindByOfficeQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }) => ({
...
export const useFindByOffice = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicesApi.findByOffice, TData>) => {
  ...
  return useQuery({
    ...getFindByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseFindByOffice({ officeId } ));
      return getFindByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchFindByOffice = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindByOfficeQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getFindByOfficeInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }) => ({
...
export const useFindByOfficeInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicesApi.findByOffice, TData>) => {
  ...
  return useInfiniteQuery({
    ...getFindByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicesAcl.canUseFindByOffice({ officeId } ));
      return getFindByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchFindByOfficeInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.OfficeInvoiceFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getFindByOfficeInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getGetUnChargesQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, page?: number, cursor?: string }) => ({
...
export const useGetUnCharges = <TData>({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicesApi.getUnCharges, TData>) => {
  ...
  return useQuery({
    ...getGetUnChargesQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetUnCharges({ officeId } ));
      return getGetUnChargesQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetUnCharges = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetUnChargesQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }), ...options });
};

export const getGetUnChargesInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, cursor?: string }) => ({
...
export const useGetUnChargesInfinite = <TData>({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicesApi.getUnCharges, TData>) => {
  ...
  return useInfiniteQuery({
    ...getGetUnChargesInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicesAcl.canUseGetUnCharges({ officeId } ));
      return getGetUnChargesInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchGetUnChargesInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargePaginationDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getGetUnChargesInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }), ...options });
};

export const getListAvailablePartnersForQueryOptions = ({ officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }) => ({
...
export const useListAvailablePartnersFor = <TData>({ officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }, options?: AppQueryOptions<typeof InvoicesApi.listAvailablePartnersFor, TData>) => {
  ...
  return useQuery({
    ...getListAvailablePartnersForQueryOptions({ officeId, invoiceId, search, useCase }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseListAvailablePartnersFor({ officeId } ));
      return getListAvailablePartnersForQueryOptions({ officeId, invoiceId, search, useCase }).queryFn();
    },
    ...options,
  });
};

export const prefetchListAvailablePartnersFor = (queryClient: QueryClient, { officeId, invoiceId, search, useCase }: { officeId: string, invoiceId: string, search?: string, useCase?: InvoicesModels.PositionAvailablePartnersUseCase }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListAvailablePartnersForQueryOptions({ officeId, invoiceId, search, useCase }), ...options });
};

export const getGetOfficeUnChargesQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, page?: number, cursor?: string }) => ({
...
export const useGetOfficeUnCharges = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicesApi.getOfficeUnCharges, TData>) => {
  ...
  return useQuery({
    ...getGetOfficeUnChargesQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetOfficeUnCharges({ officeId } ));
      return getGetOfficeUnChargesQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetOfficeUnCharges = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetOfficeUnChargesQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getGetOfficeUnChargesInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, cursor?: string }) => ({
...
export const useGetOfficeUnChargesInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicesApi.getOfficeUnCharges, TData>) => {
  ...
  return useInfiniteQuery({
    ...getGetOfficeUnChargesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicesAcl.canUseGetOfficeUnCharges({ officeId } ));
      return getGetOfficeUnChargesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchGetOfficeUnChargesInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicesModels.UninvoicedChargesFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getGetOfficeUnChargesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getGetDetailQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
...
export const useGetDetail = <TData>({ officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: AppQueryOptions<typeof InvoicesApi.getDetail, TData>) => {
  ...
  return useQuery({
    ...getGetDetailQueryOptions({ officeId, invoiceId }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetDetail({ officeId } ));
      return getGetDetailQueryOptions({ officeId, invoiceId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetDetail = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetDetailQueryOptions({ officeId, invoiceId }), ...options });
};
...
export const getGetPreviewQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
...
export const useGetPreview = <TData>({ officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: AppQueryOptions<typeof InvoicesApi.getPreview, TData>) => {
  ...
  return useQuery({
    ...getGetPreviewQueryOptions({ officeId, invoiceId }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetPreview({ officeId } ));
      return getGetPreviewQueryOptions({ officeId, invoiceId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetPreview = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetPreviewQueryOptions({ officeId, invoiceId }), ...options });
};
...
export const getGetInvoiceEmlQueryOptions = ({ officeId, invoiceId }: { officeId: string, invoiceId: string }) => ({
...
export const useGetInvoiceEml = <TData>({ officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: AppQueryOptions<typeof InvoicesApi.getInvoiceEml, TData>) => {
  ...
  return useQuery({
    ...getGetInvoiceEmlQueryOptions({ officeId, invoiceId }),
    queryFn: async () => {
    checkAcl(InvoicesAcl.canUseGetInvoiceEml({ officeId } ));
      return getGetInvoiceEmlQueryOptions({ officeId, invoiceId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetInvoiceEml = (queryClient: QueryClient, { officeId, invoiceId }: { officeId: string, invoiceId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetInvoiceEmlQueryOptions({ officeId, invoiceId }), ...options });
};
