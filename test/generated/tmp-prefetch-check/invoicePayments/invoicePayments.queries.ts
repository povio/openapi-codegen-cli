...
export const getListOfficePaymentsQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }) => ({
...
export const useListOfficePayments = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicePaymentsApi.listOfficePayments, TData>) => {
  ...
  return useQuery({
    ...getListOfficePaymentsQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicePaymentsAcl.canUseListOfficePayments({ officeId } ));
      return getListOfficePaymentsQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchListOfficePayments = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListOfficePaymentsQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getListOfficePaymentsInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }) => ({
...
export const useListOfficePaymentsInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicePaymentsApi.listOfficePayments, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListOfficePaymentsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicePaymentsAcl.canUseListOfficePayments({ officeId } ));
      return getListOfficePaymentsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListOfficePaymentsInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: InvoicePaymentsModels.OfficeInvoicePaymentFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListOfficePaymentsInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};
...
export const getListQueryOptions = ({ officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }) => ({
...
export const useList = <TData>({ officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }, options?: AppQueryOptions<typeof InvoicePaymentsApi.list, TData>) => {
  ...
  return useQuery({
    ...getListQueryOptions({ officeId, invoiceId, limit, page, cursor }),
    queryFn: async () => {
    checkAcl(InvoicePaymentsAcl.canUseList({ officeId } ));
      return getListQueryOptions({ officeId, invoiceId, limit, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchList = (queryClient: QueryClient, { officeId, invoiceId, limit, page, cursor }: { officeId: string, invoiceId: string, limit: number, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListQueryOptions({ officeId, invoiceId, limit, page, cursor }), ...options });
};

export const getListInfiniteQueryOptions = ({ officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }) => ({
...
export const useListInfinite = <TData>({ officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }, options?: AppInfiniteQueryOptions<typeof InvoicePaymentsApi.list, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListInfiniteQueryOptions({ officeId, invoiceId, limit, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(InvoicePaymentsAcl.canUseList({ officeId } ));
      return getListInfiniteQueryOptions({ officeId, invoiceId, limit, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};

export const prefetchListInfinite = (queryClient: QueryClient, { officeId, invoiceId, limit, cursor }: { officeId: string, invoiceId: string, limit: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListInfiniteQueryOptions({ officeId, invoiceId, limit, cursor }), ...options });
};
...
export const getGetPaymentByIdQueryOptions = ({ officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }) => ({
...
export const useGetPaymentById = <TData>({ officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }, options?: AppQueryOptions<typeof InvoicePaymentsApi.getPaymentById, TData>) => {
  ...
  return useQuery({
    ...getGetPaymentByIdQueryOptions({ officeId, invoiceId, paymentId }),
    queryFn: async () => {
    checkAcl(InvoicePaymentsAcl.canUseGetPaymentById({ officeId } ));
      return getGetPaymentByIdQueryOptions({ officeId, invoiceId, paymentId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetPaymentById = (queryClient: QueryClient, { officeId, invoiceId, paymentId }: { officeId: string, invoiceId: string, paymentId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetPaymentByIdQueryOptions({ officeId, invoiceId, paymentId }), ...options });
};
