...
export const getGetFcrDataQueryOptions = ({ positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }) => ({
...
export const useGetFcrData = <TData>({ positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsFcrFormApi.getFcrData, TData>) => {
  ...
  return useQuery({
    ...getGetFcrDataQueryOptions({ positionId, fcrId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsFcrFormAcl.canUseGetFcrData({ officeId } ));
      return getGetFcrDataQueryOptions({ positionId, fcrId, officeId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetFcrData = (queryClient: QueryClient, { positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetFcrDataQueryOptions({ positionId, fcrId, officeId }), ...options });
};
...
export const getPreviewFcrQueryOptions = ({ positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }) => ({
...
export const usePreviewFcr = <TData>({ positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsFcrFormApi.previewFcr, TData>) => {
  ...
  return useQuery({
    ...getPreviewFcrQueryOptions({ positionId, fcrId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsFcrFormAcl.canUsePreviewFcr({ officeId } ));
      return getPreviewFcrQueryOptions({ positionId, fcrId, officeId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPreviewFcr = (queryClient: QueryClient, { positionId, fcrId, officeId }: { positionId: string, fcrId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewFcrQueryOptions({ positionId, fcrId, officeId }), ...options });
};
