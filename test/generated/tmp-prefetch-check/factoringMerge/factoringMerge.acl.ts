 ...
 */
export const canUsePrepareUpload = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("FactoringExport", object) : "FactoringExport"
] as AbilityTuple<"Update", "FactoringExport" | ForcedSubject<"FactoringExport"> & { officeId: string, }>;
 ...
 */
export const canUseProcessMerge = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("FactoringExport", object) : "FactoringExport"
 ...
 */
export const canUseGetMergeBatch = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("FactoringExport", object) : "FactoringExport"
