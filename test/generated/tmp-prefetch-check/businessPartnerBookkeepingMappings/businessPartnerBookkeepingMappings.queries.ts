...
export const getGetBookkeepingMappingsQueryOptions = ({ officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }) => ({
...
export const useGetBookkeepingMappings = <TData>({ officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }, options?: AppQueryOptions<typeof BusinessPartnerBookkeepingMappingsApi.getBookkeepingMappings, TData>) => {
  ...
  return useQuery({
    ...getGetBookkeepingMappingsQueryOptions({ officeId, businessPartnerId }),
    queryFn: async () => {
    checkAcl(BusinessPartnerBookkeepingMappingsAcl.canUseGetBookkeepingMappings({ officeId } ));
      return getGetBookkeepingMappingsQueryOptions({ officeId, businessPartnerId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetBookkeepingMappings = (queryClient: QueryClient, { officeId, businessPartnerId }: { officeId: string, businessPartnerId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetBookkeepingMappingsQueryOptions({ officeId, businessPartnerId }), ...options });
};
