...
export const getListQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const getListInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: EmployeeRolesModels.EmployeeRolePaginationFilterDto, cursor?: string }) => ({
...
export const getLabelsQueryOptions = ({ search, context }: { search?: string, context?: EmployeeRolesModels.EmployeeRoleContext }) => ({
...
export const useLabels = <TData>({ search, context }: { search?: string, context?: EmployeeRolesModels.EmployeeRoleContext }, options?: AppQueryOptions<typeof EmployeeRolesApi.labels, TData>) => {
  ...
  return useQuery({
    ...getLabelsQueryOptions({ search, context }),
    queryFn: async () => {
    checkAcl(EmployeeRolesAcl.canUseLabels());
      return getLabelsQueryOptions({ search, context }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchLabels = (queryClient: QueryClient, { search, context }: { search?: string, context?: EmployeeRolesModels.EmployeeRoleContext }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getLabelsQueryOptions({ search, context }), ...options });
};

export const getFindQueryOptions = ({ roleId }: { roleId: string }) => ({
...
export const useFind = <TData>({ roleId }: { roleId: string }, options?: AppQueryOptions<typeof EmployeeRolesApi.find, TData>) => {
  ...
  return useQuery({
    ...getFindQueryOptions({ roleId }),
    queryFn: async () => {
    checkAcl(EmployeeRolesAcl.canUseFind());
      return getFindQueryOptions({ roleId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFind = (queryClient: QueryClient, { roleId }: { roleId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindQueryOptions({ roleId }), ...options });
};
...
export const getPaginatePermissionsQueryOptions = ({ roleId }: { roleId: string }) => ({
...
export const usePaginatePermissions = <TData>({ roleId }: { roleId: string }, options?: AppQueryOptions<typeof EmployeeRolesApi.paginatePermissions, TData>) => {
  ...
  return useQuery({
    ...getPaginatePermissionsQueryOptions({ roleId }),
    queryFn: async () => {
    checkAcl(EmployeeRolesAcl.canUsePaginatePermissions());
      return getPaginatePermissionsQueryOptions({ roleId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPaginatePermissions = (queryClient: QueryClient, { roleId }: { roleId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginatePermissionsQueryOptions({ roleId }), ...options });
};
