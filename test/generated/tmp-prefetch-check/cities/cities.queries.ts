...
export const getPaginateQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityPaginationFilterDto, page?: number, cursor?: string }) => ({
...
export const prefetchPaginate = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityPaginationFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPaginateQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

export const getPaginateInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityPaginationFilterDto, cursor?: string }) => ({
...
export const prefetchPaginateInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityPaginationFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
...
export const getListCityLabelsQueryOptions = ({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, page?: number, cursor?: string }) => ({
...
export const useListCityLabels = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof CitiesApi.listCityLabels, TData>) => {
  ...
  return useQuery({
    ...getListCityLabelsQueryOptions({ limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(CitiesAcl.canUseListCityLabels());
      return getListCityLabelsQueryOptions({ limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};

export const prefetchListCityLabels = (queryClient: QueryClient, { limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListCityLabelsQueryOptions({ limit, order, filter, page, cursor }), ...options });
};

export const getListCityLabelsInfiniteQueryOptions = ({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, cursor?: string }) => ({
...
export const useListCityLabelsInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof CitiesApi.listCityLabels, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListCityLabelsInfiniteQueryOptions({ limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(CitiesAcl.canUseListCityLabels());
      return getListCityLabelsInfiniteQueryOptions({ limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};

export const prefetchListCityLabelsInfinite = (queryClient: QueryClient, { limit, order, filter, cursor }: { limit: number, order?: string, filter?: CitiesModels.CityLabelFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListCityLabelsInfiniteQueryOptions({ limit, order, filter, cursor }), ...options });
};

export const getGetCityLabelByIdQueryOptions = ({ id }: { id: string }) => ({
...
export const useGetCityLabelById = <TData>({ id }: { id: string }, options?: AppQueryOptions<typeof CitiesApi.getCityLabelById, TData>) => {
  ...
  return useQuery({
    ...getGetCityLabelByIdQueryOptions({ id }),
    queryFn: async () => {
    checkAcl(CitiesAcl.canUseGetCityLabelById());
      return getGetCityLabelByIdQueryOptions({ id }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetCityLabelById = (queryClient: QueryClient, { id }: { id: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetCityLabelByIdQueryOptions({ id }), ...options });
};
