...
export const getGetAMSInstructionsDataQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
...
export const useGetAMSInstructionsData = <TData>({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsAmsInstructionsApi.getAMSInstructionsData, TData>) => {
  ...
  return useQuery({
    ...getGetAMSInstructionsDataQueryOptions({ positionId, amsInstructionsId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsAmsInstructionsAcl.canUseGetAMSInstructionsData({ officeId } ));
      return getGetAMSInstructionsDataQueryOptions({ positionId, amsInstructionsId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetAMSInstructionsData = (queryClient: QueryClient, { positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetAMSInstructionsDataQueryOptions({ positionId, amsInstructionsId, officeId }), ...options });
};
...
export const getPreviewAMSInstructionsQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
...
export const usePreviewAMSInstructions = <TData>({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsAmsInstructionsApi.previewAMSInstructions, TData>) => {
  ...
  return useQuery({
    ...getPreviewAMSInstructionsQueryOptions({ positionId, amsInstructionsId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsAmsInstructionsAcl.canUsePreviewAMSInstructions({ officeId } ));
      return getPreviewAMSInstructionsQueryOptions({ positionId, amsInstructionsId, officeId }).queryFn();
    },
    ...options,
  });
};

export const prefetchPreviewAMSInstructions = (queryClient: QueryClient, { positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewAMSInstructionsQueryOptions({ positionId, amsInstructionsId, officeId }), ...options });
};
