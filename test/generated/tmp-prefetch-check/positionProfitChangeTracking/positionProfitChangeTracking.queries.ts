...
export const getFindProfitChangeGroupsQueryOptions = ({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, page?: number, cursor?: string }) => ({
...
export const useFindProfitChangeGroups = <TData>({ officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroups, TData>) => {
  ...
  return useQuery({
    ...getFindProfitChangeGroupsQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(PositionProfitChangeTrackingAcl.canUseFindProfitChangeGroups({ officeId, positionId } ));
      return getFindProfitChangeGroupsQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchFindProfitChangeGroups = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, page, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindProfitChangeGroupsQueryOptions({ officeId, positionId, limit, order, filter, page, cursor }), ...options });
};

export const getFindProfitChangeGroupsInfiniteQueryOptions = ({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, cursor?: string }) => ({
...
export const useFindProfitChangeGroupsInfinite = <TData>({ officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroups, TData>) => {
  ...
  return useInfiniteQuery({
    ...getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(PositionProfitChangeTrackingAcl.canUseFindProfitChangeGroups({ officeId, positionId } ));
      return getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchFindProfitChangeGroupsInfinite = (queryClient: QueryClient, { officeId, positionId, limit, order, filter, cursor }: { officeId: string, positionId: string, limit: number, order?: string, filter?: PositionProfitChangeTrackingModels.PositionProfitChangeTrackingFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getFindProfitChangeGroupsInfiniteQueryOptions({ officeId, positionId, limit, order, filter, cursor }), ...options });
};

export const getFindProfitChangeGroupDetailQueryOptions = ({ groupId, officeId, positionId }: { groupId: string, officeId: string, positionId: string }) => ({
...
export const useFindProfitChangeGroupDetail = <TData>({ groupId, officeId, positionId }: { groupId: string, officeId: string, positionId: string }, options?: AppQueryOptions<typeof PositionProfitChangeTrackingApi.findProfitChangeGroupDetail, TData>) => {
  ...
  return useQuery({
    ...getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, positionId }),
    queryFn: async () => {
    checkAcl(PositionProfitChangeTrackingAcl.canUseFindProfitChangeGroupDetail({ officeId, positionId } ));
      return getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, positionId }).queryFn();
    },
    ...options,
  });
};

export const prefetchFindProfitChangeGroupDetail = (queryClient: QueryClient, { groupId, officeId, positionId }: { groupId: string, officeId: string, positionId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getFindProfitChangeGroupDetailQueryOptions({ groupId, officeId, positionId }), ...options });
};
