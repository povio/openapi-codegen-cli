...
export const getGetExportDeclarationDataQueryOptions = ({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }) => ({
...
export const useGetExportDeclarationData = <TData>({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }, options?: AppQueryOptions<typeof WorkingDocumentsExportDeclarationApi.getExportDeclarationData, TData>) => {
  ...
  return useQuery({
    ...getGetExportDeclarationDataQueryOptions({ officeId, positionId, exportDeclarationId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsExportDeclarationAcl.canUseGetExportDeclarationData({ officeId } ));
      return getGetExportDeclarationDataQueryOptions({ officeId, positionId, exportDeclarationId }).queryFn();
    },
    ...options,
  });
};

export const prefetchGetExportDeclarationData = (queryClient: QueryClient, { officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetExportDeclarationDataQueryOptions({ officeId, positionId, exportDeclarationId }), ...options });
};
...
export const getPreviewExportDeclarationQueryOptions = ({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }) => ({
...
export const usePreviewExportDeclaration = <TData>({ officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }, options?: AppQueryOptions<typeof WorkingDocumentsExportDeclarationApi.previewExportDeclaration, TData>) => {
  ...
  return useQuery({
    ...getPreviewExportDeclarationQueryOptions({ officeId, positionId, exportDeclarationId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsExportDeclarationAcl.canUsePreviewExportDeclaration({ officeId } ));
      return getPreviewExportDeclarationQueryOptions({ officeId, positionId, exportDeclarationId }).queryFn();
    },
    ...options,
  });
};

export const prefetchPreviewExportDeclaration = (queryClient: QueryClient, { officeId, positionId, exportDeclarationId }: { officeId: string, positionId: string, exportDeclarationId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewExportDeclarationQueryOptions({ officeId, positionId, exportDeclarationId }), ...options });
};
