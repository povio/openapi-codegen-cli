...
export const getListPartnerOutstandingInvoiceSummariesQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, page?: number, cursor?: string }) => ({
...
export const useListPartnerOutstandingInvoiceSummaries = <TData>({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof DunningPartnerOutstandingInvoicesApi.listPartnerOutstandingInvoiceSummaries, TData>) => {
  ...
  return useQuery({
    ...getListPartnerOutstandingInvoiceSummariesQueryOptions({ officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(DunningPartnerOutstandingInvoicesAcl.canUseListPartnerOutstandingInvoiceSummaries({ officeId } ));
      return getListPartnerOutstandingInvoiceSummariesQueryOptions({ officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListPartnerOutstandingInvoiceSummaries = (queryClient: QueryClient, { officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListPartnerOutstandingInvoiceSummariesQueryOptions({ officeId, limit, order, filter, page, cursor }), ...options });
};

export const getListPartnerOutstandingInvoiceSummariesInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, cursor?: string }) => ({
...
export const useListPartnerOutstandingInvoiceSummariesInfinite = <TData>({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof DunningPartnerOutstandingInvoicesApi.listPartnerOutstandingInvoiceSummaries, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListPartnerOutstandingInvoiceSummariesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(DunningPartnerOutstandingInvoicesAcl.canUseListPartnerOutstandingInvoiceSummaries({ officeId } ));
      return getListPartnerOutstandingInvoiceSummariesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListPartnerOutstandingInvoiceSummariesInfinite = (queryClient: QueryClient, { officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceSummaryFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListPartnerOutstandingInvoiceSummariesInfiniteQueryOptions({ officeId, limit, order, filter, cursor }), ...options });
};

export const getListPartnerOutstandingInvoicesQueryOptions = ({ partnerId, officeId, limit, order, filter, page, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, page?: number, cursor?: string }) => ({
...
export const useListPartnerOutstandingInvoices = <TData>({ partnerId, officeId, limit, order, filter, page, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof DunningPartnerOutstandingInvoicesApi.listPartnerOutstandingInvoices, TData>) => {
  ...
  return useQuery({
    ...getListPartnerOutstandingInvoicesQueryOptions({ partnerId, officeId, limit, order, filter, page, cursor }),
    queryFn: async () => {
    checkAcl(DunningPartnerOutstandingInvoicesAcl.canUseListPartnerOutstandingInvoices({ officeId } ));
      return getListPartnerOutstandingInvoicesQueryOptions({ partnerId, officeId, limit, order, filter, page, cursor }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchListPartnerOutstandingInvoices = (queryClient: QueryClient, { partnerId, officeId, limit, order, filter, page, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getListPartnerOutstandingInvoicesQueryOptions({ partnerId, officeId, limit, order, filter, page, cursor }), ...options });
};

export const getListPartnerOutstandingInvoicesInfiniteQueryOptions = ({ partnerId, officeId, limit, order, filter, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, cursor?: string }) => ({
...
export const useListPartnerOutstandingInvoicesInfinite = <TData>({ partnerId, officeId, limit, order, filter, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof DunningPartnerOutstandingInvoicesApi.listPartnerOutstandingInvoices, TData>) => {
  ...
  return useInfiniteQuery({
    ...getListPartnerOutstandingInvoicesInfiniteQueryOptions({ partnerId, officeId, limit, order, filter, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(DunningPartnerOutstandingInvoicesAcl.canUseListPartnerOutstandingInvoices({ officeId } ));
      return getListPartnerOutstandingInvoicesInfiniteQueryOptions({ partnerId, officeId, limit, order, filter, cursor }).queryFn({ pageParam });
    },
    ...options,
  });
};
...
export const prefetchListPartnerOutstandingInvoicesInfinite = (queryClient: QueryClient, { partnerId, officeId, limit, order, filter, cursor }: { partnerId: string, officeId: string, limit: number, order?: string, filter?: DunningPartnerOutstandingInvoicesModels.PartnerOutstandingInvoiceFilterDto, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">) => {
  return queryClient.prefetchInfiniteQuery({ ...getListPartnerOutstandingInvoicesInfiniteQueryOptions({ partnerId, officeId, limit, order, filter, cursor }), ...options });
};
