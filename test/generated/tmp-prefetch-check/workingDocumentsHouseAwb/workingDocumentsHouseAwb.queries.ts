...
export const getGetHouseAwbDataQueryOptions = ({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }) => ({
...
export const useGetHouseAwbData = <TData>({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsHouseAwbApi.getHouseAwbData, TData>) => {
  ...
  return useQuery({
    ...getGetHouseAwbDataQueryOptions({ positionId, hawbId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsHouseAwbAcl.canUseGetHouseAwbData({ officeId } ));
      return getGetHouseAwbDataQueryOptions({ positionId, hawbId, officeId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchGetHouseAwbData = (queryClient: QueryClient, { positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getGetHouseAwbDataQueryOptions({ positionId, hawbId, officeId }), ...options });
};
...
export const getPreviewHouseAwbQueryOptions = ({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }) => ({
...
export const usePreviewHouseAwb = <TData>({ positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsHouseAwbApi.previewHouseAwb, TData>) => {
  ...
  return useQuery({
    ...getPreviewHouseAwbQueryOptions({ positionId, hawbId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsHouseAwbAcl.canUsePreviewHouseAwb({ officeId } ));
      return getPreviewHouseAwbQueryOptions({ positionId, hawbId, officeId }).queryFn();
    },
    ...options,
  });
};
...
export const prefetchPreviewHouseAwb = (queryClient: QueryClient, { positionId, hawbId, officeId }: { positionId: string, hawbId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">) => {
  return queryClient.prefetchQuery({ ...getPreviewHouseAwbQueryOptions({ positionId, hawbId, officeId }), ...options });
};
