...
export const listCargosByQuoteId = (officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const updateCargo = (officeId: string, quoteId: string, cargoId: string, data: CommonModels.UpdatePositionCargoDTO, config?: AxiosRequestConfig) => {
...
export const createBulkCargos = (numberOfCargos: number, officeId: string, quoteId: string, data: CommonModels.CreatePositionCargoDTO, config?: AxiosRequestConfig) => {
