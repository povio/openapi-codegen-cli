...
export const issueTemplatedDocument = (officeId: string, positionId: string, templatedDocumentId: string, data: CommonModels.GenerateWorkingDocumentRequestDto, ) => {
    return AppRestClient.post(
        { resSchema: z.void() },
...
export const generateDocumentEml = (officeId: string, positionId: string, templatedDocumentId: string, data: CommonModels.GenerateWorkingDocumentRequestDto, ) => {
    return AppRestClient.post(
        { resSchema: z.instanceof(Blob) },
