 ...
 */
export const BlInstructionsDocumentSettingsDtoDTOSchema = z.object({ quantityOfOriginals: CommonModels.QuantityOfOriginalBlDocumentsEnumSchema.describe("Quantity of originals"), date: z.iso.datetime({ offset: true }).describe("Date"), location: z.string().describe("Location"), signer: z.string().describe("Siger") }).readonly();
 ...
 */
export const BlInstructionsDocumentCountryResponseDTOSchema = z.object({ id: z.string().describe("ID of the country"), name: z.string().describe("Name of the country") }).readonly();
 ...
 */
export const BlInstructionsDocumentPlaceResponseDTOSchema = z.object({ id: z.string().describe("ID of the place"), name: z.string().describe("Name of the place") }).readonly();
 ...
 */
export const BlInstructionsDocumentPortResponseDTOSchema = z.object({ id: z.string().describe("ID of the port"), name: z.string().describe("Name of the port"), countryCode: z.string().describe("Country ISO2 code of the port") }).readonly();
 ...
 * @property { string } date Date 
 */
export const UpdateBlInstructionsDocumentSettingsRequestDTOSchema = z.object({ quantityOfOriginals: CommonModels.QuantityOfOriginalBlDocumentsEnumSchema.describe("Quantity of originals"), blNumber: z.string().describe("BL number"), exportReference: z.string().describe("Export reference number"), location: z.string().describe("Location"), signer: z.string().describe("Signer"), date: z.iso.datetime({ offset: true }).describe("Date") }).readonly();
 ...
 */
export const UpdateBlInstructionsDocumentBusinessPartnerRequestDTOSchema = z.object({ id: z.string().describe("Business partner ID"), address: z.string().describe("Business partner address") }).readonly();
