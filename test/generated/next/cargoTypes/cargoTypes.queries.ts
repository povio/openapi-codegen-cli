 ...
 * @statusCodes [200, 401]
 */
export const usePaginate = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CargoTypesModels.CargoTypePaginationFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof CargoTypesApi.paginate, TData>, config?: AxiosRequestConfig) => {
  ...
  return useQuery({
    ...
    return CargoTypesApi.paginate(limit, order, filter, page, cursor, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CargoTypesModels.CargoTypePaginationFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof CargoTypesApi.paginate, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => { 
    checkAcl(CargoTypesAcl.canUsePaginate());
    return CargoTypesApi.paginate(limit, order, filter, pageParam, cursor, config) },
    initialPageParam: 1,
 ...
 * @statusCodes [201, 401]
 */
export const useCreate = (options?: AppMutationOptions<typeof CargoTypesApi.create, { data: CargoTypesModels.CreateCargoTypeRequestDTO }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useMutation({
    mutationFn: ({ data }) => { 
      ...
      return CargoTypesApi.create(data, config)
    },
    ...options,
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateLabels = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: CargoTypesModels.CargoTypeLabelFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof CargoTypesApi.paginateLabels, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useQuery({
    ...
    return CargoTypesApi.paginateLabels(limit, order, filter, page, cursor, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateLabelsInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: CargoTypesModels.CargoTypeLabelFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof CargoTypesApi.paginateLabels, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => { 
    checkAcl(CargoTypesAcl.canUsePaginateLabels());
    return CargoTypesApi.paginateLabels(limit, order, filter, pageParam, cursor, config) },
    initialPageParam: 1,
    getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
      const pageParam = page ?? 1;
      return pageParam * limitParam < totalItems ? pageParam + 1 : null;
 ...
 * @statusCodes [200, 401]
 */
export const useFindById = <TData>({ id }: { id: string }, options?: AppQueryOptions<typeof CargoTypesApi.findById, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useQuery({
    ...
    return CargoTypesApi.findById(id, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const useUpdate = (options?: AppMutationOptions<typeof CargoTypesApi.update, { id: string, data: CargoTypesModels.UpdateCargoTypeRequestDTO }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id, data }) => { 
      ...
      return CargoTypesApi.update(id, data, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      const { id } = variables;
 ...
 * @statusCodes [200, 401]
 */
export const useArchive = (options?: AppMutationOptions<typeof CargoTypesApi.archive, { id: string }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id }) => { 
      ...
      return CargoTypesApi.archive(id, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      const { id } = variables;
 ...
 * @statusCodes [200, 401]
 */
export const useUnarchive = (options?: AppMutationOptions<typeof CargoTypesApi.unarchive, { id: string }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id }) => { 
      ...
      return CargoTypesApi.unarchive(id, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      const { id } = variables;
