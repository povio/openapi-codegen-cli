...
export const paginate = (limit: number, order?: string, populate?: EmployeeModels.EmployeePaginatePopulateParam, filter?: EmployeeModels.EmployeeFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const paginateLabels = (limit: number, order?: string, filter?: EmployeeModels.EmployeeLabelFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const get = (employeeId: string, populate?: EmployeeModels.EmployeeGetPopulateParam, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
        { resSchema: EmployeeModels.EmployeeResponseSchema },
...
export const update = (employeeId: string, data: EmployeeModels.EmployeeUpdateRequest, config?: AxiosRequestConfig) => {
...
export const getWithOffice = (officeId: string, employeeId: string, populate?: EmployeeModels.GetWithOfficePopulateParam, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
        { resSchema: EmployeeModels.EmployeeResponseSchema },
...
export const updateWithOffice = (officeId: string, employeeId: string, data: EmployeeModels.EmployeeUpdateRequest, config?: AxiosRequestConfig) => {
    return AppRestClient.put(
        { resSchema: EmployeeModels.EmployeeResponseSchema },
        `/offices/${officeId}/employees/${employeeId}`,
        ZodExtended.parse(EmployeeModels.EmployeeUpdateRequestSchema, data),
...
export const updateRoles = (employeeId: string, data: EmployeeModels.EmployeeRoleMembershipsUpdateRequest, config?: AxiosRequestConfig) => {
    return AppRestClient.put(
