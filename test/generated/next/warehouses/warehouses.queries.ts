 ...
 * @statusCodes [201, 401]
 */
export const useCreate = (options?: AppMutationOptions<typeof WarehousesApi.create, { data: WarehousesModels.CreateWarehouseRequestDTO }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  ...
  return useMutation({
    mutationFn: ({ data }) => { 
      ...
      return WarehousesApi.create(data, config)
    },
    ...options,
 ...
 * @statusCodes [200, 401]
 */
export const usePaginate = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: WarehousesModels.WarehouseFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof WarehousesApi.paginate, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useQuery({
    ...
    return WarehousesApi.paginate(limit, order, filter, page, cursor, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: WarehousesModels.WarehouseFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof WarehousesApi.paginate, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => { 
    checkAcl(WarehousesAcl.canUsePaginate());
    return WarehousesApi.paginate(limit, order, filter, pageParam, cursor, config) },
    initialPageParam: 1,
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateLabels = <TData>({ limit, order, filter, page, cursor }: { limit: number, order?: string, filter?: WarehousesModels.WarehouseLabelFilterDto, page?: number, cursor?: string }, options?: AppQueryOptions<typeof WarehousesApi.paginateLabels, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useQuery({
    ...
    return WarehousesApi.paginateLabels(limit, order, filter, page, cursor, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const usePaginateLabelsInfinite = <TData>({ limit, order, filter, cursor }: { limit: number, order?: string, filter?: WarehousesModels.WarehouseLabelFilterDto, cursor?: string }, options?: AppInfiniteQueryOptions<typeof WarehousesApi.paginateLabels, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => { 
    checkAcl(WarehousesAcl.canUsePaginateLabels());
    return WarehousesApi.paginateLabels(limit, order, filter, pageParam, cursor, config) },
    initialPageParam: 1,
    getNextPageParam: ({ page, totalItems, limit: limitParam }) => {
      const pageParam = page ?? 1;
      return pageParam * limitParam < totalItems ? pageParam + 1 : null;
 ...
 * @statusCodes [200, 401]
 */
export const useFindById = <TData>({ id }: { id: string }, options?: AppQueryOptions<typeof WarehousesApi.findById, TData>, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  ...
  return useQuery({
    ...
    return WarehousesApi.findById(id, config) },
    ...options,
  });
};
 ...
 * @statusCodes [200, 401]
 */
export const useUpdate = (options?: AppMutationOptions<typeof WarehousesApi.update, { id: string, data: WarehousesModels.UpdateWarehouseRequestDTO }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id, data }) => { 
      ...
      return WarehousesApi.update(id, data, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      const { id } = variables;
 ...
 * @statusCodes [200, 401]
 */
export const useArchive = (options?: AppMutationOptions<typeof WarehousesApi.archive, { id: string }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id }) => { 
      ...
      return WarehousesApi.archive(id, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      await runMutationEffects(resData, variables, options);
 ...
 * @statusCodes [200, 401]
 */
export const useUnarchive = (options?: AppMutationOptions<typeof WarehousesApi.unarchive, { id: string }> & MutationEffectsOptions, config?: AxiosRequestConfig) => {
  const { checkAcl } = useAclCheck();
  const { runMutationEffects } = useMutationEffects({ currentModule: moduleName });
  ...
  return useMutation({
    mutationFn: ({ id }) => { 
      ...
      return WarehousesApi.unarchive(id, config)
    },
    ...options,
    onSuccess: async (resData, variables, onMutateResult, context) => {
      await runMutationEffects(resData, variables, options);
