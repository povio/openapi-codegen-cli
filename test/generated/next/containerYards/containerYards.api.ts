...
export const paginateLabels = (limit: number, order?: string, filter?: ContainerYardsModels.ContainerYardLabelFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const update = (id: string, data: ContainerYardsModels.UpdateContainerYardRequestDTO, config?: AxiosRequestConfig) => {
    return AppRestClient.patch(
        { resSchema: ContainerYardsModels.ContainerYardResponseDTOSchema },
        `/container-yards/${id}`,
