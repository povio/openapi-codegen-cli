...
export const getAMSInstructionsData = (positionId: string, amsInstructionsId: string, officeId: string, config?: AxiosRequestConfig) => {
...
export const updateAMSInstructionsData = (positionId: string, amsInstructionsId: string, officeId: string, data: WorkingDocumentsAmsInstructionsModels.UpdateAMSInstructionsDocumentRequestDTO, config?: AxiosRequestConfig) => {
...
export const deleteAMSInstructions = (positionId: string, amsInstructionsId: string, officeId: string, config?: AxiosRequestConfig) => {
...
export const previewAMSInstructions = (positionId: string, amsInstructionsId: string, officeId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
