...
export const paginateLabels = (limit: number, order?: string, filter?: PartnerNetworksModels.PartnerNetworkLabelFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
...
export const paginate = (limit: number, order?: string, filter?: PartnerNetworksModels.PartnerNetworkPaginationFilterDto, page?: number, cursor?: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
...
export const update = (id: string, data: PartnerNetworksModels.UpdatePartnerNetworkRequestDTO, config?: AxiosRequestConfig) => {
