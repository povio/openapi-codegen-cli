...
export const create = (officeId: string, positionId: string, data: CommonModels.CreateInvolvedPartyRequestDto, config?: AxiosRequestConfig) => {
...
export const update = (officeId: string, positionId: string, partyId: string, data: CommonModels.UpdateInvolvedPartyDto, config?: AxiosRequestConfig) => {
...
export const deleteOfficesPositionsInvolvedPartiesByPartyId = (officeId: string, positionId: string, partyId: string, config?: AxiosRequestConfig) => {
