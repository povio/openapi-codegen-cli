...
export const getHouseAwbData = (positionId: string, hawbId: string, officeId: string, config?: AxiosRequestConfig) => {
...
export const updateHouseAwbData = (positionId: string, hawbId: string, officeId: string, data: WorkingDocumentsHouseAwbModels.UpdateHouseAwbDocumentRequestDTO, config?: AxiosRequestConfig) => {
...
export const previewHouseAwb = (positionId: string, hawbId: string, officeId: string, config?: AxiosRequestConfig) => {
    return AppRestClient.get(
