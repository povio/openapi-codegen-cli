...
export const update = (officeId: string, positionId: string, id: string, data: ShippingInstructionsModels.UpdateShippingInstructionsRequestDto, config?: AxiosRequestConfig) => {
...
export const deleteOfficesPositionsShippingInstructionsById = (officeId: string, positionId: string, id: string, config?: AxiosRequestConfig) => {
