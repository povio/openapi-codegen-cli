 ...
 */
export const HouseBlDocumentBusinessPartnerResponseDTOSchema = z.object({ id: z.string().describe("ID of the business partner"), name: z.string().describe("Name of the business partner"), address: z.string().describe("Address of the business partner") }).readonly();
 ...
 */
export const HouseBlDocumentCountryResponseDTOSchema = z.object({ id: z.string().describe("ID of the country"), name: z.string().describe("Name of the country") }).readonly();
 ...
 */
export const HouseBlDocumentPlaceResponseDTOSchema = z.object({ id: z.string().describe("ID of the place"), name: z.string().describe("Name of the place") }).readonly();
 ...
 */
export const HouseBlDocumentPortResponseDTOSchema = z.object({ id: z.string().describe("ID of the port"), name: z.string().describe("Name of the port") }).readonly();
 ...
 */
export const HouseBlDocumentTerminalResponseDTOSchema = z.object({ id: z.string().describe("ID of the terminal"), name: z.string().describe("Name of the terminal") }).readonly();
 ...
 * @property { string } documentTitle Document title 
 */
export const UpdateHouseBlDocumentSettingsRequestDTOSchema = z.object({ quantityOfOriginals: CommonModels.QuantityOfOriginalBlDocumentsEnumSchema.describe("Quantity of originals"), quantityOfCopies: z.number().describe("Quantity of copies"), blNumber: z.string().describe("BL number"), exportReference: z.string().describe("Export reference number"), location: z.string().describe("Location"), signer: z.string().describe("Signer"), hideSignature: z.boolean().describe("Hide signature"), capsLock: z.boolean().describe("Render issuer/signer in caps lock"), date: z.iso.datetime({ offset: true }).describe("Date"), documentTitle: z.string().describe("Document title") }).readonly();
 ...
 */
export const UpdateHouseBlDocumentBusinessPartnerRequestDTOSchema = z.object({ id: z.string().describe("Business partner ID"), address: z.string().describe("Business partner address") }).readonly();
