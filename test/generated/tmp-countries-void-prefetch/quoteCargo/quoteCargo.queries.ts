...
export const listCargosByQuoteIdQueryOptions = ({ officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }) => ({
...
export const useListCargosByQuoteId = <TData>({ officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }, options?: AppQueryOptions<typeof QuoteCargoApi.listCargosByQuoteId, TData>) => {
  ...
  return useQuery({
    ...listCargosByQuoteIdQueryOptions({ officeId, quoteId, limit, order, page, cursor }),
    queryFn: async () => {
    checkAcl(QuoteCargoAcl.canUseListCargosByQuoteId({ officeId } ));
      return listCargosByQuoteIdQueryOptions({ officeId, quoteId, limit, order, page, cursor }).queryFn();
    },
    ...options,
...
export const prefetchListCargosByQuoteId = (queryClient: QueryClient, { officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listCargosByQuoteIdQueryOptions({ officeId, quoteId, limit, order, page, cursor }), ...options });
};

export const listCargosByQuoteIdInfiniteQueryOptions = ({ officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }) => ({
...
export const useListCargosByQuoteIdInfinite = <TData>({ officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }, options?: AppInfiniteQueryOptions<typeof QuoteCargoApi.listCargosByQuoteId, TData>) => {
  ...
  return useInfiniteQuery({
    ...listCargosByQuoteIdInfiniteQueryOptions({ officeId, quoteId, limit, order, cursor }),
    queryFn: async ({ pageParam }) => {
      checkAcl(QuoteCargoAcl.canUseListCargosByQuoteId({ officeId } ));
      return listCargosByQuoteIdInfiniteQueryOptions({ officeId, quoteId, limit, order, cursor }).queryFn({ pageParam });
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchListCargosByQuoteIdInfinite = (queryClient: QueryClient, { officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }, options?: Omit<Parameters<QueryClient["prefetchInfiniteQuery"]>[0], "queryKey" | "queryFn" | "initialPageParam" | "getNextPageParam">): void => {
  void queryClient.prefetchInfiniteQuery({ ...listCargosByQuoteIdInfiniteQueryOptions({ officeId, quoteId, limit, order, cursor }), ...options });
};

export const listCargoLabelsQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
export const useListCargoLabels = <TData>({ officeId, quoteId }: { officeId: string, quoteId: string }, options?: AppQueryOptions<typeof QuoteCargoApi.listCargoLabels, TData>) => {
  ...
  return useQuery({
    ...listCargoLabelsQueryOptions({ officeId, quoteId }),
    queryFn: async () => {
    checkAcl(QuoteCargoAcl.canUseListCargoLabels({ officeId } ));
      return listCargoLabelsQueryOptions({ officeId, quoteId }).queryFn();
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchListCargoLabels = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...listCargoLabelsQueryOptions({ officeId, quoteId }), ...options });
};

export const getCargoSummaryQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
export const useGetCargoSummary = <TData>({ officeId, quoteId }: { officeId: string, quoteId: string }, options?: AppQueryOptions<typeof QuoteCargoApi.getCargoSummary, TData>) => {
  ...
  return useQuery({
    ...getCargoSummaryQueryOptions({ officeId, quoteId }),
    queryFn: async () => {
    checkAcl(QuoteCargoAcl.canUseGetCargoSummary({ officeId } ));
      return getCargoSummaryQueryOptions({ officeId, quoteId }).queryFn();
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchGetCargoSummary = (queryClient: QueryClient, { officeId, quoteId }: { officeId: string, quoteId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCargoSummaryQueryOptions({ officeId, quoteId }), ...options });
};

export const getCargoByIdQueryOptions = ({ officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }) => ({
...
export const useGetCargoById = <TData>({ officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }, options?: AppQueryOptions<typeof QuoteCargoApi.getCargoById, TData>) => {
  ...
  return useQuery({
    ...getCargoByIdQueryOptions({ officeId, quoteId, cargoId }),
    queryFn: async () => {
    checkAcl(QuoteCargoAcl.canUseGetCargoById({ officeId } ));
      return getCargoByIdQueryOptions({ officeId, quoteId, cargoId }).queryFn();
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchGetCargoById = (queryClient: QueryClient, { officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCargoByIdQueryOptions({ officeId, quoteId, cargoId }), ...options });
};
