...
export const getCmrDataQueryOptions = ({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }) => ({
...
export const useGetCmrData = <TData>({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsCmrFormApi.getCmrData, TData>) => {
  ...
  return useQuery({
    ...getCmrDataQueryOptions({ positionId, cmrId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsCmrFormAcl.canUseGetCmrData({ officeId } ));
      return getCmrDataQueryOptions({ positionId, cmrId, officeId }).queryFn();
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchGetCmrData = (queryClient: QueryClient, { positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...getCmrDataQueryOptions({ positionId, cmrId, officeId }), ...options });
};
...
export const previewCmrQueryOptions = ({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }) => ({
...
export const usePreviewCmr = <TData>({ positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }, options?: AppQueryOptions<typeof WorkingDocumentsCmrFormApi.previewCmr, TData>) => {
  ...
  return useQuery({
    ...previewCmrQueryOptions({ positionId, cmrId, officeId }),
    queryFn: async () => {
    checkAcl(WorkingDocumentsCmrFormAcl.canUsePreviewCmr({ officeId } ));
      return previewCmrQueryOptions({ positionId, cmrId, officeId }).queryFn();
    },
    ...options,
    onError: options?.onError ?? queryConfig.onError,
  });
...
export const prefetchPreviewCmr = (queryClient: QueryClient, { positionId, cmrId, officeId }: { positionId: string, cmrId: string, officeId: string }, options?: Omit<Parameters<QueryClient["prefetchQuery"]>[0], "queryKey" | "queryFn">): void => {
  void queryClient.prefetchQuery({ ...previewCmrQueryOptions({ positionId, cmrId, officeId }), ...options });
};
