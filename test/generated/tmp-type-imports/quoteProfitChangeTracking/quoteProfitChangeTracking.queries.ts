...
const findProfitChangeGroupsQueryOptions = ({ officeId, quoteId, limit, page, cursor }: { officeId: string, quoteId: string, limit: number, page?: number, cursor?: string }) => ({
...
const findProfitChangeGroupsInfiniteQueryOptions = ({ officeId, quoteId, limit, cursor }: { officeId: string, quoteId: string, limit: number, cursor?: string }) => ({
...
const findProfitChangeGroupDetailQueryOptions = ({ groupId, officeId, quoteId }: { groupId: string, officeId: string, quoteId: string }) => ({
