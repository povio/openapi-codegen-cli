...
const generateAccountStatementQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningAccountStatementModels.OfficeInvoiceFilterDto, page?: number, cursor?: string }) => ({
...
const generateAccountStatementInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: DunningAccountStatementModels.OfficeInvoiceFilterDto, cursor?: string }) => ({
