...
const getAMSInstructionsDataQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
...
const previewAMSInstructionsQueryOptions = ({ positionId, amsInstructionsId, officeId }: { positionId: string, amsInstructionsId: string, officeId: string }) => ({
