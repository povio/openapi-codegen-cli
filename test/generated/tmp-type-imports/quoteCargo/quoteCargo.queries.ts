...
const listCargosByQuoteIdQueryOptions = ({ officeId, quoteId, limit, order, page, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, page?: number, cursor?: string }) => ({
...
const listCargosByQuoteIdInfiniteQueryOptions = ({ officeId, quoteId, limit, order, cursor }: { officeId: string, quoteId: string, limit: number, order?: QuoteCargoModels.ListCargosByQuoteIdOrderParam, cursor?: string }) => ({
...
const listCargoLabelsQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
const getCargoSummaryQueryOptions = ({ officeId, quoteId }: { officeId: string, quoteId: string }) => ({
...
const getCargoByIdQueryOptions = ({ officeId, quoteId, cargoId }: { officeId: string, quoteId: string, cargoId: string }) => ({
