...
const paginateBatchesQueryOptions = ({ officeId, limit, order, filter, page, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, page?: number, cursor?: string }) => ({
...
const paginateBatchesInfiniteQueryOptions = ({ officeId, limit, order, filter, cursor }: { officeId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportBatchPreviewFilterDto, cursor?: string }) => ({
...
const getBatchQueryOptions = ({ officeId, batchId }: { officeId: string, batchId: string }) => ({
...
const paginateBatchItemsQueryOptions = ({ officeId, batchId, limit, order, filter, page, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, page?: number, cursor?: string }) => ({
...
const paginateBatchItemsInfiniteQueryOptions = ({ officeId, batchId, limit, order, filter, cursor }: { officeId: string, batchId: string, limit: number, order?: string, filter?: BookkeepingExportModels.BookkeepingExportItemDetailFilterDto, cursor?: string }) => ({
...
const getVatLineItemsQueryOptions = ({ officeId, batchId, order }: { officeId: string, batchId: string, order?: string }) => ({
