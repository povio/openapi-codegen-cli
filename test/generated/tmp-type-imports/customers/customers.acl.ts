...
export const canUseCreate = (
  ...
  "Create",
  "Customer"
] as AbilityTuple<"Create", "Customer">;
...
export const canUseUpdate = (
  ...
  "Update",
  "Customer"
] as AbilityTuple<"Update", "Customer">;
 ...
 */
export const canUseDeactivate = (
) => [
  "Deactivate",
  "Customer"
] as AbilityTuple<"Deactivate", "Customer">;
 ...
 */
export const canUseReactivate = (
) => [
  "Reactivate",
  "Customer"
] as AbilityTuple<"Reactivate", "Customer">;
