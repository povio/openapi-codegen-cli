 ...
 * @property { QuoteRoadDetailsDto } roadDetails Road-specific quote overview details 
 * @property { QuoteAirDetailsDto } airDetails Air-specific quote overview details 
 * @property { QuoteSeaDetailsDto } seaDetails Sea-specific quote overview details 
 */
 ...
 * @property { number } volumetricWeightModifier Volumetric weight modifier 
 * @property { UpdateQuoteRoadDetailsDto } roadDetails Road-specific quote overview details 
 * @property { UpdateQuoteAirDetailsDto } airDetails Air-specific quote overview details 
 * @property { UpdateQuoteSeaDetailsDto } seaDetails Sea-specific quote overview details 
 */
