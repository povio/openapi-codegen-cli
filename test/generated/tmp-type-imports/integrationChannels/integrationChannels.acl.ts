...
export const canUseList = (
  ...
  "Read",
  object ? subject("IntegrationChannel", object) : "IntegrationChannel"
] as AbilityTuple<"Read", "IntegrationChannel" | ForcedSubject<"IntegrationChannel"> & { officeId: string, }>;
...
export const canUseCreate = (
  ...
  "Create",
  object ? subject("IntegrationChannel", object) : "IntegrationChannel"
] as AbilityTuple<"Create", "IntegrationChannel" | ForcedSubject<"IntegrationChannel"> & { officeId: string, }>;

/**
 * Use for `usePaginateLabels` query ability. For global ability, omit the object parameter.
 * @description List integration channel labels
 * @param { string } object.officeId officeId from officeId path parameter
...
export const canUseUpdate = (
  ...
  "Update",
  object ? subject("IntegrationChannel", object) : "IntegrationChannel"
] as AbilityTuple<"Update", "IntegrationChannel" | ForcedSubject<"IntegrationChannel"> & { officeId: string, }>;
...
export const canUseArchive = (
  ...
  "Archive",
  object ? subject("IntegrationChannel", object) : "IntegrationChannel"
] as AbilityTuple<"Archive", "IntegrationChannel" | ForcedSubject<"IntegrationChannel"> & { officeId: string, }>;
 ...
 */
export const canUseTestConnection = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("IntegrationChannel", object) : "IntegrationChannel"
