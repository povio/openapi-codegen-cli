...
export const canUseCreate = (
  ...
  "Create",
  object ? subject("Position", object) : "Position"
] as AbilityTuple<"Create", "Position" | ForcedSubject<"Position"> & { officeId: string, }>;
 ...
 */
export const canUseTotalProfit = (
  object?: { officeId: string,  } 
) => [
  "TotalProfitView",
  object ? subject("PositionAccount", object) : "PositionAccount"
] as AbilityTuple<"TotalProfitView", "PositionAccount" | ForcedSubject<"PositionAccount"> & { officeId: string, }>;
 ...
 */
export const canUseExportPositions = (
  object?: { officeId: string,  } 
) => [
  "Export",
  object ? subject("Position", object) : "Position"
] as AbilityTuple<"Export", "Position" | ForcedSubject<"Position"> & { officeId: string, }>;
 ...
 */
export const canUseListRouteLabels = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("Position", object) : "Position"
 ...
 */
export const canUseGetDuplicateDefaultParameters = (
  object?: { officeId: string,  } 
) => [
  "Read",
  object ? subject("Position", object) : "Position"
 ...
 */
export const canUseRevertCancel = (
  object?: { officeId: string,  } 
) => [
  "RevertCancel",
  object ? subject("Position", object) : "Position"
] as AbilityTuple<"RevertCancel", "Position" | ForcedSubject<"Position"> & { officeId: string, }>;
 ...
 */
export const canUseUnlinkChild = (
  object?: { officeId: string,  } 
) => [
  "Update",
  object ? subject("Position", object) : "Position"
